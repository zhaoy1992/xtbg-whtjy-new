...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.tjy.officesupplies.list.OsHavaMoreList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		{
			name: 't_ha_rkuser_date',
			index: 't_ha_rkuser_date',
			width: '100',
			search: true
		}
		],
		...
		toolbar: [true,"top","<input class='but_y_01' id=add value='添加' type='button' onclick='add()' /><input class='but_y_01' id=del value='删除' type='button' onclick='del()' />"],
		multiselect: true,
...
var toUserParamJosn = function() {
	 var str = "{'oftype_id':'"+oftype_id+"','ofustype_name':'"+jQuery("#ofustype_name").val()+"'}";
	 return descape(escape(str));
}
//添加常用物品
var add = function(){
	var url = "../../../tjy/officesupplies2/jsp/osupplieusetypeinfo2.jsp?windowsId=windowId&actionName=insert";
	var pageName ="添加常用物品";
	openWindows('windowId',pageName,url,'windowId',false,window);
	//openAlertWindows('windowId',"../../../tjy/officesupplies2/jsp/osupplieusetypeinfo2.jsp?windowsId=windowId&actionName=insert",pageName,500,300,'25%','25%');
...
var update = function(id){
	...
	var pageName ="修改常用物品";
	openAlertWindows('windowId','../../../tjy/officesupplies2/jsp/osupplieusetypeinfo.jsp?windowsId=windowId&actionName=update&t_ha_id='+model.t_ha_id,pageName,500,270,'25%','25%');
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								...
								<td width="385" class="cx_title_td">
									<input id="ofustype_name" name="ofustype_name" type="text" class="input_cx_title_283" /></td>
...
<form id="delForm2" name="delForm2" method="post" action="osupplieusetypeinfodo.jsp">
	<input type="hidden" name="ids" id="ids"> 
	<input type="hidden" name="it_ids" id="it_ids">
