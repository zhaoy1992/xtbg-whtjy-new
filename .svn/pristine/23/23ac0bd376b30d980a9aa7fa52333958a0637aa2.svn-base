			...
			<table width="184" height="341" border="0" align="center">
				...
				<tr>
					<td colspan="3" valign="top" align="center">
						<div align="center" class="win" id="dd_1" style="width: 160" title="下拉选择框的右边可以左右拖动">
							<select name="userList" multiple style="width:96%"  size="18" title="下拉选择框的右边可以左右拖动">
				...
				<tr>
				 ...
				 <tr>
					<td colspan="3" valign="top" align="center">
						<div align="center" class="win" id="dd_2" style="width: 160" title="下拉选择框的右边可以左右拖动">
							<select name="roleList" multiple style="width:96%"  size="15" title="下拉选择框的右边可以左右拖动">
