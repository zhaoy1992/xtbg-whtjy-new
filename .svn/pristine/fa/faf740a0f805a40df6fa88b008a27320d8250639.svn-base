			...
			<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" class="thin">
				  ...
				  <tr>
					...
					if (flag1 == true) {%>
							<tr>
			        <td>
			        <input type="checkBox" hideFocus=true name="checkBoxAll2" onClick="checkAll2('checkBoxAll2','alloper2')"checked disabled="true">
			        </td>
			        <td>>>>>全选</td>
			        <td>&nbsp;<input name="isRecursion2" onclick="" type="checkbox" checked disabled="true">递归授权子频道</td>
			      </tr>
			      ...
			      <tr class="tr">
			        ...
			        %>
			        value="<pg:cell colName="id"/>" onclick="changebox2(this,'<pg:cell colName="priority" defaultValue=""/>','<pg:cell colName="id"/>')"checked disabled="true">
			        </td>
