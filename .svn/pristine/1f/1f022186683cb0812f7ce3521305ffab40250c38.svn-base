...
public class AddOrUpdateOsAppRegObject extends XtDbBaseDao implements FlowBusiDataSaveDao{
	...
	public boolean saveBusiInfo(HttpServletRequest request, Connection conn)
	   ...
	   // String[] IT_NAME_VALUE_Arr = request.getParameterValues("IT_NAME_VALUE");
		...
		//相关计划表IDs
		String osAppIds = request.getParameter("TA_OA_CANOSAPPREGYHP__T_APPREGYHP_APPIDS");
		...
		//填写人ID
		String user_id = request.getParameter("TA_OA_CANOSAPPREGYHP__T_APPREGYHP_USER_ID");
		
		//填写人名称
		String user_name = request.getParameter("TA_OA_CANOSAPPREGYHP__T_APPREGYHP_USER_NAME");
		
		//领用日期
		String lyDate = request.getParameter("TA_OA_CANOSAPPREGYHP__T_APPREGYHP_DATE");
