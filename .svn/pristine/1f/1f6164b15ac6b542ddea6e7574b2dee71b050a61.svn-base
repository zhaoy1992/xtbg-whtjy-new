...
import com.chinacreator.xtbg.tjy.detectionsupplies.dao.impl.OsofficeAccountDaoImpl;
...
public class OfficeDetailServiceImpl implements OfficeDetailService{
	...
	public Map<String, String> getOfficeDetailBean(String id) {
	  ...
	  * @param bean
	  * @return 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.service.OfficeDetailService
	  * #insertOrUpdateOfficeDetail(com.chinacreator.xtbg.tjy.officesupplies.entity.OsofficeAccountBean) 
	  */
	@Override
