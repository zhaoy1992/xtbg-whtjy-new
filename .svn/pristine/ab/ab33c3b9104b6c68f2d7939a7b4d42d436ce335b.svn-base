...
{    //远程自动获取
	...
	out.println("<HTML><HEAD><TITLE>远程上传</TITLE><meta http-equiv='Content-Type' content='text/html; charset=gb2312'></head><%@ include file="/epp/css/cssControl.jsp"%><body >");
...
else if(sAction.equalsIgnoreCase("save"))
{
 ...
 out.println("<HTML>");
        ...
        out.println("</script>");
        out.println("</head>");
        out.println("<%@ include file="/epp/css/cssControl.jsp"%><body  bgcolor=menu>");
