...
if(IsSpace(djbh))
{
    location.href += "&djbh=123";
}*/

var djbh = creator_getQueryString("djbh");

var PageParms = {
    businessId : IsSpace(creator_getQueryString("id"))? "":creator_getQueryString("id"),  //业务主键
    modeName : IsSpace(creator_getQueryString("mode_name"))? "":creator_getQueryString("mode_name")  //上传还是下载
}
var allowDelete = IsSpace(creator_getQueryString("allowDelete"))? "":creator_getQueryString("allowDelete");
var allowAdd = IsSpace(creator_getQueryString("allowAdd"))? "":creator_getQueryString("allowAdd");

/* 页面初始化 */
function init(){
//alert(PageParms.businessId);
pubdjbh = PageParms.businessId;
/*
    pubdjbh = PageParms.businessId;
    if(PageParms.modeName == "上传"){
        $('modeNameTD').innerHTML = "上传附件";
        $('uploadTD').getElementsByTagName("font")[0].innerText = "增加附件";
    }else{
        $('modeNameTD').innerHTML = "下载附件";
        // $('uploadTD').getElementsByTagName("font")[0].innerText = "";
        //陈志武 改  时间： 2009-6-17
        $('uploadTD').style.display="none";    
    }
*/
//alert("测试附件"+window.document.location.href);
}


/*
*对控件的空能进行控制
*不用写在初始换函数中，控件会自动加载此函数

function onUpPanelLoaded(){
 if(allowAdd!="true"){
      creator_pt_uppanels[0].obj.setActiveTab(1);

     creator_pt_uppanels[0].obj.items.item(0).setDisabled(true);
  }
  ...
  if(allowDelete!="true"){
    ...
    creator_pt_uppanels[0].obj.items.item(1).getTopToolbar().hide();
 }
 }
*/


/* 覆写window.onbeforeunload函数：窗口关闭时，返回第一个材料的ID */
function window.onbeforeunload() {

 var attachidArr=new Array();
    try{
         attachidArr=getExtAttachIds();
    }catch(e){
       
    }
    if(attachidArr.length > 0){
        window.returnValue = attachidArr;  //只取第一个附件
    }   
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();init();" contxml="<root><button><id>btnClose</id></button><ExtUpload><id>ExtUpload1</id></ExtUpload></root>" billtaborder="<root><taborder>btnClose</taborder></root>" dj_sn="20100920113019725484" caption="附件" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:0;text:0;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:2;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName="app_xzcf" creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="否" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100902181609484868" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js">

<TABLE class=table_function style="WIDTH: 100%; HEIGHT: 321px">
   <TBODY>
      <TR>
         <TD><DIV id=div_ExtUpload1 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV>&nbsp;<SCRIPT type=text/javascript>
Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';
var w_ExtUpload1 = 600;
var h_ExtUpload1 = 258;
...
upobj_ExtUpload1.startUpload();
      ...
      <TR>
         <TD align=middle><BUTTON id=btnClose style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("window.close();")'>关闭</BUTTON></TD>
      </TR>
   </TBODY>
</TABLE>
</DIV>
