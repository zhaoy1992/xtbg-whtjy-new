...
<html>
  <head>
	...
	if(issuccess)
	out.println("<script language=\"javascript\">alert(\"取消委托成功！\");location.href=\"assignmentDevolve.jsp\";</script>");
	else
	out.println("<script language=\"javascript\">alert(\"取消委托失败！\");history.back();</script>");
    %>  
