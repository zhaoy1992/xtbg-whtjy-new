...
返回值: 无
*/
function saveInfo_type(){
	var info_type = jQuery("#info_type").val();
	getParentWindow("windowIds").isInfoTypeConfigReset(info_type);
...
<body>
<button id=button4 class="but_y_01" onclick="saveInfo_type()">保存</button>
