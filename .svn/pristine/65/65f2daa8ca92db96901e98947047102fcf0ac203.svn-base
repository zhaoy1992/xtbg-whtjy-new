...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%=path%>/pubListServlet?classNameId=com.chinacreator.xtbg.core.file.list.MyFileLendingForMeBeforeList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
			...
			<table border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable_box" style="width: 100%" id="queryTable">
				...
				<table width="80%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					    ...
					    <th class="input_cx_title_th" style="width:40px;">申请日期：</th>
					    <td class="cx_title_td" style="width:100px;">
