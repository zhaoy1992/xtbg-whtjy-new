...
/**
 * 
 *<p>Title:OsHavaMoreList.java</p>
 *<p>Description: 易耗品库存列表</p>
 ...
 *2014-3-10
 */
public class OsHavaMoreList extends DataInfoImpl {
	private static final Log LOG=LogFactory.getLog(OsHavaMoreList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = osHavaObjectDao.findOsHavaObjectList(osHavaObjectBean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
