...
function addCss(){
	...
	var p = ["/ccapp/xtbg/resources/plug/jquery-ui-1.8.17.custom/"+style+"/css/custom-theme/jquery-ui-1.8.17.custom.css",
	            "/ccapp/xtbg/resources/plug/jquery.jqGrid-4.3.1/"+style+"/css/ui.jqgrid.css",
	            "/ccapp/xtbg/resources/plug/formvalidation/css/validationEngine.jquery.css",
	            ...
	            "/ccapp/xtbg/resources/"+style+"/css/layer.css",
	        	"/ccapp/xtbg/resources/"+style+"/css/style.css",
	        	"/ccapp/xtbg/public/resourcesTreeConfig/resources/"+style+"/css/tree.css"
	        	];
