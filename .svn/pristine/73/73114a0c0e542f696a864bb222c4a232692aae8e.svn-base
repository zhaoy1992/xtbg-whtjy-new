...
xyTree.TreeConfig = {
   ...
   * 打开的文件夹，叶节点
   */
  rootIcon        : '../../../sysmanager/applymanager/xyTree/images/foldericon.gif',
  openRootIcon    : '../../../sysmanager/applymanager/xyTree/images/openfoldericon.gif',
  folderIcon      : '../../../sysmanager/applymanager/xyTree/images/foldericon.gif',
  openFolderIcon  : '../../../sysmanager/applymanager/xyTree/images/openfoldericon.gif',
  fileIcon        : '../../../sysmanager/applymanager/xyTree/images/file.gif',
  iIcon           : '../../../sysmanager/applymanager/xyTree/images/I.gif',
  lIcon           : '../../../sysmanager/applymanager/xyTree/images/L.gif',
  lMinusIcon      : '../../../sysmanager/applymanager/xyTree/images/Lminus.gif',
  lPlusIcon       : '../../../sysmanager/applymanager/xyTree/images/Lplus.gif',
  tIcon           : '../../../sysmanager/applymanager/xyTree/images/T.gif',
  tMinusIcon      : '../../../sysmanager/applymanager/xyTree/images/Tminus.gif',
  tPlusIcon       : '../../../sysmanager/applymanager/xyTree/images/Tplus.gif',
  blankIcon       : '../../../sysmanager/applymanager/xyTree/images/blank.gif',
  buzhongIcon     : '../../../sysmanager/applymanager/xyTree/images/buzhong.gif',
  quanzhongIcon   : '../../../sysmanager/applymanager/xyTree/images/quanzhong.gif',
  jubuzhongIcon   : '../../../sysmanager/applymanager/xyTree/images/jubuzhong.gif',
  loadingIcon     : '../../../sysmanager/applymanager/xyTree/images/loading.gif',
  defaultText     : 'Tree Item',
  defaultAction   : 'javascript:void(0);',
  defaultBehavior : 'classic', 
  usePersistence  : true,
  jianju1         : '15px',   /*这是复选框到文件夹的距离*/
  jianju3         : '15px',   /*这是头部复选框到第一图标的距离*/
...
/**add by wen.zhu
 * 得到被选中的叶节点ID数组
 * @return 得到被选中的叶节点ID数组
 * @type Array:xyTree.Node  
 */
xyTree.DivTree.prototype.getNodesMojiId = function() {
