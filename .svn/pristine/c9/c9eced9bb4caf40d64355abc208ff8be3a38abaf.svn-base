...
function ok(){ 
	...
	var s_File = d_file.value;
	     ...
	     s_File_continue = s_File;

	alert(s_File_continue); 	 
	...
	eWebEditorClient.ImportWord(s_File_continue, s_PostUrl, b_VML);
    ...
    var s_Body_continue="";
	     s_Body_continue=s_Body+s_Body_continue;
    //alert(s_Body_continue);
...
<tr>
	...
	<tr><td>
		...
		<tr>
			<td noWrap><input type=file id="d_file1" size=30></td>
		</tr>
		<tr>
