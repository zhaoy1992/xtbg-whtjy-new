...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
  ...
  <td align="center">
	...
	if(!orguser_modify_forbidden){
		...
		{
	  	%>
	    <td align="center"><a onclick="neworg()">新增机构</a></td>
	    </tr><tr>
	    <td align="center" colspan="2"><a onclick="orguser_tb()">机构用户同步</a></td>
	   	<%
	   	}
	}
   	%>  
    ...
    <table >
        <tr><td align="left">
         <tree:tree tree="org_tree_userorgmanager"
    			   ...
    			   mode="static-dynamic"
    			   >     			    
    			   <tree:treedata treetype="com.chinacreator.sysmgrcore.purviewmanager.PurviewManagerOrgTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="机构树"
    	                   expandLevel="1"
