		            ...
		            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		                ...
		                <tr>
		                    ...
		                    <td width="43%">
		                  	...
		                  	<td height="23" style="display:block">
			                  	<span><strong>编稿时间:</strong></span>
		                  		<span class="cms_title_blue">
										<input name="docwtime" class="cms_text" type="text" size="23" value="<%=riqi%>" readonly="true">
					    ...
					    <td height="23"> 
						    ...
						    <span class="black">
								<span class="cms_title_blue">
									<input type="text" name="seq" value="<%if(document.getSeq()==999999){out.print("");}else{out.print(document.getSeq());}%>" class="cms_text" size="10"/>
								</span>
							</span>	
											</td>
						</tr>
...
&nbsp;							  </span>					  	  </td>
						...
						<tr>
							...
							<td height="23">
								...
								<input type="button" name="addpic" class="Channel_5wordsBtn" onClick="chooseImage()" value="选择图片"/> <input type="button" name="clearpicpath" class="Channel_5wordsBtn" value="清空" onclick="document.myform.picpath.value=''"/>							</td>
							<td height="23" style="display:none"> 
								<strong>发布名称:</strong>
							    <input type="text" name="publishfilename" value="<%=document.getPublishfilename()%>"  class="cms_text"  size="30"/>							</td>
						</tr>
						<tr style="display:none">
					        <td height="26">&nbsp;</td>
					        <td colspan="3">
