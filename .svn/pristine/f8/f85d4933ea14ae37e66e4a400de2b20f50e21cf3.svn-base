	...
	function saveform(closeFlag){
		...
		if(inputsource==null||inputsource=="")
		{
		  ...
		  return false;
			...
			{
				myform.target = "updategather";
				myform.action="<%=request.getContextPath()%>/cms/normativeFile/update_document.jsp?closeFlag=" + closeFlag+"&detailtemplate_id="+myform.detailtemplate_id.value;
				win = window.open("<%=request.getContextPath()%>/cms/doing.html","doinghtml","height="+(screen.availHeight-200)+",width="+(screen.availWidth-300)+",top=100,left=150,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no");
			}
			myform.submit();
            ...
            <tr>
	            <td height="18" colspan="3">
		            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		            	<tr background="<%=request.getContextPath()%>/cms/images/Gather_Content_topbg.gif" >
		                	<td width="4%" height="35" align="right" background="<%=request.getContextPath()%>/cms/images/Gather_Content_topbg.gif">
		                  	...
		                  	<td colspan="3" background="<%=request.getContextPath()%>/cms/images/Gather_Content_topbg.gif" class="cms_title_blue">
			                  	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				                    <tr>
				                        <td width="100" height="35" class="cms_title_blue">文档信息填写111</td>
				                    	<td>
						...
						<td height="23">
							<input name="secondtitle" type="text" class="cms_text" size="60" value="<%=document.getSecondtitle()%>">
						</td>
						<td height="23"> 
						<span><strong><strong>登 记 号:</strong></strong></span>
							<span>
								<input name="ext_djh" type="text" class="cms_text" value="<%=filterStr((String)document.getExtColumn().get("ext_djh"))%>" size="20" maxlength="50"> <span class="red_star">*</span>
							</span>	
						</td>							
					</tr>
		                <tr>
							<td height="26">&nbsp;</td>
							<td height="23"><strong>索引号:</strong></td>
							<td height="23"><input name="ext_index" type="text" value="<%=filterStr((String)document.getExtColumn().get("ext_index"))%>" class="cms_text" size="60">
		                ...
		                <tr>
		                	<td height="26">&nbsp;</td>
		                	<td height="23"><strong>文号:</strong></td>
							<td height="23">
								<input name="ext_wh" type="text" class="cms_text" value="<%=filterStr((String)document.getExtColumn().get("ext_wh"))%>" size="60">
							</td>
		                  	<td height="23">
		                  		<strong>编稿时间:</strong>
	                  			<span class="black">
	                  				<span class="cms_title_blue">
										<input name="docwtime" class="cms_text" type="text" size="23" validator="datetime" cnname="编稿时间"  value="<%=riqi%>" >
		                ...
		                <tr>
						    <td height="26">&nbsp;</td>
						    <td height="26"><strong>文档来源:</strong></td>
						    <td height="23">
		                    	<span class="cms_title_blue">
						...
						<tr>
							...
							<td height="23">
								...
								<input type="button" name="addpic" class="Channel_7wordsBtn" onClick="chooseImage()" value="选择图片或flash"/>
							</td>
							<td height="23"> 
								<strong>发布名称:</strong>
		                    		...
		                    		<tr>
				                    	<td width="7%"><strong>关 键 词<br>(主题词):</strong></td>
				                      	<td>
				                      		...
				                      		<span>*</span>(<span class="red_star">多个关键词之间用逗号“,”分隔</span>)
			                      		</td>
			                      	</tr>
		                  		</table>
		                  	</td>
