...
public class OsHavaObjectDaoImpl extends XtDbBaseDao implements OsHavaObjectDao {
	...
	public boolean updateOsExaState(String osExaIds) throws Exception {
		...
		sql.append(" update  TA_OA_CANOSEXAMINATION t set t.t_osexa_isrk = '1' ");
	...
	public List<Map<String, String>> queryHavaIdByItId(String it_id)
		...
		sql.append(" select t.*,nvl(t.t_ha_no,0) as t_ha_nos from TA_OA_CANHAVA_OBJECT t ");
	...
	public boolean insertOsHavaInfo(OsHavaObjectBean osHavaObjectBean)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" insert into TA_OA_CANHAVA_OBJECT( ");
	...
	* @throws Exception
	...
	public boolean deleteOsHavaById(Connection conn,String beanId)throws Exception{
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_CANHAVA_OBJECT ");
	...
	public boolean updateOsHavaInfo(OsHavaObjectBean osHavaObjectBean)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_CANHAVA_OBJECT t set t.oftype_id = ?, t.oftype_name = ?, t.ofustype_id = ?, t.ofustype_name = ?, ");
	...
	public List<Map<String, String>> queryNoMoveTypeSelect() throws Exception {
		StringBuffer sql = new StringBuffer();
		List<Map<String, String>> havaValueList = new ArrayList<Map<String,String>>();
		sql.append(" select * from TA_OA_CANOSUPPLIETYPE t ");
	...
	public PagingBean findOsHavaObjectList(OsHavaObjectBean osHavaObjectBean,
		...
		sql.append("                   from TA_OA_CANHAVA_OBJECT objs, TA_OA_CANNOMOVE_OBJECT mobjs");
		sql.append("                  where objs.t_ha_id = t.t_ha_id");
		sql.append("                    and objs.t_ha_id = mobjs.t_ha_id) as amidAct");//没有关联任何在办流程的物品
		sql.append("   from TA_OA_CANHAVA_OBJECT t, TA_OA_CANOSUPPLIETYPE os ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsHavaObjectDao
	  * #findOsHavaNoMoveObjectList(com.chinacreator.xtbg.tjy.officesupplies.entity.OsHavaObjectBean, java.lang.String, java.lang.String, long, int)
	 */
	public PagingBean findOsHavaNoMoveObjectList(
		...
		sql.append("    from TA_OA_CANHAVA_OBJECT t ");
		sql.append("       left join TA_OA_CANOSUPPLIETYPE os");
	...
	public PagingBean findOsAppList(OsApplanBean osApplanBean, String sortName,
		...
		sql.append("   from TA_OA_CANOSAPPLAN t, view_oa_instance v ");
	...
	public List<Map<String, String>> selectOsAppObjectByIds(String osAppIds,
		...
		sql2.append(" select v.STATUS_CODE from view_oa_instance v,TA_OA_CANOSAPPREGYHP t");
		...
		sql.append("   from TA_OA_CANOSAPP_OBJECT t left join TA_OA_CANOSAPPLAN o on t.t_id=o.t_id");
		sql.append("   left join  TA_OA_CANOSUPPLIEUSETYPE op on t.ofustype_id=op.ofustype_id");
		sql.append("   left join  TA_OA_CANOSUPPLIETYPE os on op.oftype_id=os.oftype_id");
	...
	public boolean deleteOsAppRegObject(String t_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_CANOSAPPREG_OBJECT ");
	...
	public boolean updateOsApplanState(String ids, Connection conn)
		...
		sql.append(" update TA_OA_CANOSAPPLAN t set t.T_IS_LQ='1' ");
	...
	public String queryAppIdsForAppRegId(String appRegid) throws Exception {
		...
		sql.append(" from TA_OA_CANOSAPPREGYHP t ");
	...
	public List<Map<String, String>> selectOsAppRegObjectByregId(String appRegId)
		...
		sql.append("  from TA_OA_CANOSAPPREG_OBJECT t");
		sql.append("  left join ta_oa_canosusertypeitem item on t.it_id=item.it_id");
		sql.append("  left join ta_oa_canosupplieusetype usertype on t.ofustype_id = usertype.ofustype_id");
		sql.append("  left join ta_oa_canosupplietype ostype on t.oftype_id = ostype.oftype_id");
	...
	public boolean updateOsHavaObjectAfterLY(OsHavaObjectBean osHavaObjectBean)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_CANHAVA_OBJECT t set ");
	...
	public List<Map<String, String>> queryHavaObjectByHaIds(String haIds,String bus_id)
		...
		StringBuffer sql2 = new StringBuffer();
		sql2.append(" select v.STATUS_CODE from view_oa_instance v,TA_OA_CANOSNOMOVE t");
	...
	public boolean insertHavaLYObject(OsHavaLYObjectBean osHavaLYObjectBean)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" insert into ta_oa_canlingyong_object( ");
	...
	public boolean updateHavaLYObject(OsHavaLYObjectBean osHavaLYObjectBean)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update ta_oa_canlingyong_object t set t_ly_id = ?, oftype_id = ?, oftype_name = ?, ofustype_id = ?, ofustype_name = ?, ");
	...
	public boolean deleteOsNoMoveObject(String busi_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_CANNOMOVE_OBJECT ");
	...
	public boolean updateHavaObjectForIds(String havaIds) throws Exception {
		...
		sql.append(" update  TA_OA_CANHAVA_OBJECT t set t.t_ha_sbstate = '2' ");
	...
	public List<Map<String, String>> queryNoMoveObjectForRegId(String bus_id)
		...
		sql.append("  select t.*,t1.t_ha_sbno from TA_OA_CANNOMOVE_OBJECT t");
		sql.append("  left join ta_oa_canhava_object t1 on t.t_ha_id = t1.t_ha_id");
	...
	public String queryHavaIdsForRegId(String bus_id) throws Exception {
		...
		sql.append(" from TA_OA_CANOSNOMOVE t ");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsHavaObjectDao
	  * #findOsHavaLYObjectList(com.chinacreator.xtbg.tjy.officesupplies.entity.OsHavaLYObjectBean, java.lang.String, java.lang.String, long, int)
	 */
	public PagingBean findOsHavaLYObjectList(
		...
		sql.append("   from TA_OA_CANLINGYONG_OBJECT t, TA_OA_CANOSUPPLIETYPE os ");
		sql.append("       where t.oftype_id = os.oftype_id");
	...
	public boolean updateHavaObjectStateByHaIds(String havaIds, String state)
		...
		StringBuffer sql = new StringBuffer();
		havaIds = StringUtil.splitString(havaIds, ",", "'");
		sql.append(" update  TA_OA_CANHAVA_OBJECT t set t.t_ha_sbstate = '"+state+"'");
		sql.append(" where t.t_ha_id in ("+havaIds+")");
	...
	public boolean updateOsexaObjectRKNO(String osexa_id, String t_osexa_obrk_no)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_CANOSEXA_OBJECT t set t.t_osexa_obrk_no = '"+t_osexa_obrk_no+"'");
	...
	public boolean updateHavaObjectOrg(OsHavaObjectBean osHavaObjectBean)
		...
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_CANHAVA_OBJECT t set t.t_ha_org_id = ?, t.t_ha_org_name = ?,t.t_ha_sbno=? ");
		sql.append(" where t.t_ha_id = ?");
	...
	* @throws Exception
	...
	public List<Map<String, String>> queryHavaObjectBySbCode(String t_ha_sbno) throws Exception{
		...
		sql.append("  from TA_OA_CANHAVA_OBJECT ");
