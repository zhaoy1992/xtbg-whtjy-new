...
<%@page import="com.chinacreator.xtbg.core.directory.data.BirthdayExcelToData"%>
...
<%
	...
	BirthdayExcelToData birthdayExcelToData = new BirthdayExcelToData();
	...
	PagingBean pagingbean = directorydaoimpl.getBirthdayList(directoryBean,"","",0,2000);
	...
	try {
		String exportTempFilePath = birthdayExcelToData.exportExcelToData(userArray);
		...
		if (tempExportFile.exists()) {
			...
			response.addHeader("Content-disposition",
					"attachment; filename="+toChinese("生日提醒.xls"));
		...
		birthdayExcelToData.deleteExportTempFile(tempExportFile);
	}
%>
