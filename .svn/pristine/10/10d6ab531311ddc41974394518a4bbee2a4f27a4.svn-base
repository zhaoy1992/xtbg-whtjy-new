											...
											if (a.p.reccount === 0 && !a.p.pagerintoolbar)
												...
												var _m_pager_string = function(
													...
													//t_taoobar_string += "</span></div>";
														...
														t_taoobar_string+="<div class='_pg_next_but_div'><input type='button' id='_pg_go_end"+idNames+"' class='_pg_go_end but_y_01' value='"+a.p.pager_end+"'></div>"
														t_taoobar_string += "<div class='_pg_next_but"+ idNames+"_div'><input type='button' id='_pg_next_but"
														+ idNames
													...
													t_taoobar_string += "<div class='_pg_up_but_div '><input type='button' id='_pg_up_but"
														...
														+ a.p.pgup
														+ "'/></div>";
													t_taoobar_string+="<div class='_pg_next_but_div'><input type='button' id='_pg_go_first"+idNames+"' class='_pg_go_first but_y_01' value='"+a.p.pager_farst+"'></div>"
												...
												if (_pager_count > 1
													...
													var _fn_set_button = function(
															_pager_count) {
															if (a.p.page <= 1) {
																jQuery("#_pg_up_but"+a.id)
																		.removeClass(
																				"_pg_up_but_valid");
																jQuery("#_pg_up_but"+a.id)
																		.addClass(
																				"_pg_up_but_invalid");
																jQuery("#_pg_up_but"+a.id).attr("disabled","disabled");
															...
															if (a.p.page > 1) {
																...
																jQuery("#_pg_up_but"+a.id)
																		.addClass(
																				"_pg_up_but_valid");
																jQuery("#_pg_up_but"+a.id).removeAttr("disabled");
															}
															if(a.p.page > 1){
																jQuery("#_pg_go_first"+a.id)
																.removeClass(
																		"_pg_up_but_invalid");
																jQuery("#_pg_go_first"+a.id)
																.addClass(
																		"_pg_up_but_valid");
																jQuery("#_pg_go_first"+a.id).removeAttr("disabled");
															}else{
																jQuery("#_pg_go_first"+a.id)
																.removeClass(
																		"_pg_up_but_valid");
																...
																.addClass(
																		"_pg_up_but_invalid");
																jQuery("#_pg_go_first"+a.id).attr("disabled","disabled");
															}
															
															if(a.p.page < _pager_count){
																jQuery("#_pg_go_end"+a.id)
																.removeClass(
																		"_pg_up_but_invalid");
																jQuery("#_pg_go_end"+a.id)
																.addClass(
																		"_pg_up_but_valid");
																jQuery("#_pg_go_end"+a.id).removeAttr("disabled");
															}else{
																jQuery("#_pg_go_end"+a.id)
																.removeClass(
																		"_pg_up_but_valid");
																...
																.addClass(
																		"_pg_up_but_invalid");
																jQuery("#_pg_go_end"+a.id).attr("disabled","disabled");
															}
															if (a.p.page >= _pager_count) {
																jQuery("#_pg_next_but"+a.id)
																		.removeClass(
																				"_pg_next_but_valid");
																jQuery("#_pg_next_but"+a.id)
																		.addClass(
																				"_pg_up_next_invalid");
																jQuery("#_pg_next_but"+a.id).attr("disabled","disabled");
															}
															if (a.p.page < _pager_count) {
																jQuery("#_pg_next_but"+a.id)
																		.removeClass(
																...
																jQuery("#_pg_next_but"+a.id)
																		.addClass(
																				"_pg_up_next_valid");
																jQuery("#_pg_next_but"+a.id).removeAttr("disabled");
															}
