...
<%
    ...
    //传入的会议id
    String noticeId = StringUtil.deNull(request.getParameter("m_notice_id"));
%>
...
$(function() {
    ...
    $("#gridTable").jqGrid({
       ...
       //表头设置       
        ...
        toolbar : [ true, "top","<span style='font-weight:bold;'>会议通知对应会议纪要列表</span>"],
        multiselect : false,
