...
$(function() {
	...
	$("#gridTable").jqGrid({
		...
		toolbar: [true,"top",
		          ...
		          "<input class='but_y_06' id=add value='检测耗材申购表' type='button' onclick='newosxaFlow()'/>"
		          <%}%>
		          ],
		multiselect: true,
...
function newosxaFlow(){
	var url="<%=path%>/ccapp/xtbg/tjy/detectionsupplies/jsp/osexamination.jsp?busiTypeCode=uuid_521";
	var flowname="检测耗材申购审批表";
