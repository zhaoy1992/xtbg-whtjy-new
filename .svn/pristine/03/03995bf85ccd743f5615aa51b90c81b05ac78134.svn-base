<%--
	...
	日期：2013-7-23
--%>
<%@page import="com.chinacreator.xtbg.core.common.util.StringSplitUtil"%>
...
<%
	...
	//事务申请业务类型code
	String busitype_type_code = ProFlowBusiConstant.FLOWTREE_BUSITYPECODES;
	...
	StringBuffer typeurltree=new StringBuffer();
	if(!StringUtil.isBlank(busitype_type_code)){
		busitype_type_code = busitype_type_code.substring(1,busitype_type_code.length()-1);
