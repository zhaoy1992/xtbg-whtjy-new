...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();" contxml="<root><tab><id>tab2</id></tab><div><id>div3</id><id>div4</id><id>div5</id></div><dataset><id>dataset1</id></dataset><ExtGrid><id>ExtGrid7</id></ExtGrid><ExtUpload><id>ExtUpload2</id></ExtUpload><ExtTree><id>ExtTree1</id></ExtTree></root>" billtaborder="<root></root>" dj_sn="20090915143815203716" caption="测试ext控件长宽设置为百分比" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:2;div:5;DsMain_field:0;a:0;button:0;text:0;hr:0;checkboxlist:1;radiolist:0;dropdownlist:0;grid:0;dataset:1;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:7;ExtUpload:2;ExtTree:1;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100802194908031953" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js" creator_allTab="<tabs><tab><id>tab2</id><content><index>0</index><gridid></gridid><iframeid></iframeid><index>1</index><gridid></gridid><iframeid></iframeid><index>2</index><gridid></gridid><iframeid></iframeid></content></tab></tabs>">

<?xml:namespace prefix = fc />

<fc:dataset id=dataset1 format="<fields><field><fieldname>AA</fieldname><datatype>字符</datatype><displaylabel>AA</displaylabel><size>30</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1><columnWidth2>200</columnWidth2></columnWidth1></field><field><fieldname>BB</fieldname><datatype>字符</datatype><displaylabel>BB</displaylabel><size>30</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1><columnWidth2></columnWidth2></columnWidth1></field></fields>" onSetText='bill_ondatasetsettext("<dsid><AA></AA><BB></BB></dsid>")' onGetText='bill_ondatasetgettext("<dsid><AA></AA><BB></BB></dsid>")' onValid='bill_ondatasetvalid("<dsid><AA></AA><BB></BB></dsid>")' opensortno="1" temptable="TMP_DATASET1" multiResult="否"></fc:dataset>

&nbsp;

<DIV class=tab-pane id=tab2 style="LEFT: 134px; WIDTH: 80%; POSITION: absolute; TOP: 1px; HEIGHT: 50%" showtype="luna" IsHideTitle="否">
   <DIV class=tab-page style="WIDTH: 80%; HEIGHT: 32px">
      <H2 class=tab>页签1</H2>
      <DIV id=div3 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; OVERFLOW-Y: hidden; LEFT: 0px; OVERFLOW-X: hidden; OVERFLOW: auto; BORDER-LEFT: black 1px solid; WIDTH: 441px; BORDER-BOTTOM: black 1px solid; POSITION: static; TOP: 0px; HEIGHT: 362px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="div" NotBg="否">
         <DIV id=div_ExtUpload2 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV>
         &nbsp;
         <SCRIPT type=text/javascript>
Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';
var w_ExtUpload2 = 408;
var h_ExtUpload2 = 348;
var upobj_ExtUpload2;var refidtemp;var attachidtemp;
var fileListGrid_ExtUpload2;
var del_ExtUpload2 = eval('true');
var isflow = IsSpace(fcpubdata.cc_form_instanceid)?-1:1;
var ExtUpload2_retint = 0;
var ExtUpload2_onReady = function(){ 
 Ext.QuickTips.init();
if(ExtUpload2_retint==0) {ExtUpload2_retint = setInterval(ExtUpload2_onReady,200);return;}
if(document.readyState!="complete") return;
clearInterval(ExtUpload2_retint);ExtUpload2_retint = null ;
...
var uploadFinishFlag = false;
	...
	var uploader = new Ext.ux.SwfUploadPanel({
		title: '上传文件'
		, width: w_ExtUpload2		, height: h_ExtUpload2		,collapsible : true
 ...
 fileListGrid_ExtUpload2.store.reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});uploadFinishFlag=true;
});	upobj_ExtUpload2 = uploader;
	return uploader;
	}
...
cm.setHidden(1,!del_ExtUpload2);
	...
	fileListGrid_ExtUpload2  = grid ;
    return grid;
}
function deleteGrid(){
 var rows = fileListGrid_ExtUpload2.getSelectionModel().getSelections();
				if(rows.length==0){
                      ...
                      success: function(response, options) {
                       var responseArray = Ext.util.JSON.decode(response.responseText);
                            if(responseArray.success==true){
								fileListGrid_ExtUpload2.getStore().reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});
                            }
                            else{
             ...
             title : '上传控件面板',
             renderTo:'div_ExtUpload2',
             id : 'div_ExtUpload2',
					width: w_ExtUpload2+10,
					height: h_ExtUpload2+10,
             frame:true,
			 activeTab: 0,
             margins : '0 0 0 0',
             minHeight : 100,
...
creator_pt_uppanels.push({id:'ExtUpload2',obj:panel});
if(typeof(onUpPanelLoaded)=='function') setTimeout(onUpPanelLoaded,0);
};
function dodoupload(){
upobj_ExtUpload2.startUpload();
}ExtUpload2_onReady();</SCRIPT>
      </DIV>
   </DIV>
   <DIV class=tab-page style="WIDTH: 80%; HEIGHT: 32px">
      <H2 class=tab>页签2</H2>
      <DIV id=div4 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; OVERFLOW-Y: hidden; LEFT: 0px; OVERFLOW-X: hidden; OVERFLOW: auto; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; POSITION: static; TOP: 0px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="div" NotBg="否">
         <IMG style="DISPLAY: none" src="undefined">
         <DIV id=div_ExtGrid7 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV>
         <SCRIPT type=text/javascript>var ExtGrid7;
Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';
var ExtGrid7_retint = 0;
var ExtGrid7_onReady = function(){ 
 Ext.QuickTips.init();
var dataset = document.getElementById("dataset1");
try{var temp = dataset.Fields.Field.length;}catch(e){if(ExtGrid7_retint==0) ExtGrid7_retint = setInterval(ExtGrid7_onReady,200);dataset =null;return;}finally{if(temp!=null)temp=null;}
clearInterval(ExtGrid7_retint);ExtGrid7_retint = null ;var pagesize =10;
...
if(typeof(retcm[0].getCount)!='undefined') sm = retcm[0] ;
 ExtGrid7 = new Ext.grid.GridPanel({
		el: 'div_ExtGrid7',        store: store,
        cm:cm,
		sm: sm,
 			 bodyStyle : 'width:100%',
		viewConfig: {
	...
	width: '100%',
					height: eval(parseFloat(document.getElementById('div3').style.height)*(parseFloat('100%')))/100-60,
		split: true,
		region: 'north',
		title:'fdasfdasf',
		frame:true
...
creator_pt_grids.push({id:'ExtGrid7',obj:ExtGrid7,dataset:'dataset1',isEdit:'false'});
if(typeof(onGridPanelLoaded)=='function') setTimeout(onGridPanelLoaded,0);
};
ExtGrid7_onReady();</SCRIPT>
      </DIV>
   </DIV>
   <DIV class=tab-page style="WIDTH: 80%; HEIGHT: 32px">
      <H2 class=tab>页签3</H2>
      <DIV id=div5 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; LEFT: 0px; OVERFLOW: auto; BORDER-LEFT: black 1px solid; WIDTH: 442px; BORDER-BOTTOM: black 1px solid; POSITION: static; TOP: 0px; HEIGHT: 363px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="div">&nbsp;
         ...
         &nbsp;
         <SCRIPT type=text/javascript>var tree;Ext.onReady(function(){	Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';    tree = new Ext.tree.TreePanel({		el:'ExtTreeDiv_ExtTree1',		title:'树',		frame:true,	height:100%,	width:100%,		autoScroll:'true',		loader:new Ext.tree.TreeLoader({		}),		tbar:[			new Ext.form.TextField({				emptyText:'输入过滤字符',				allowBlank:true,				listeners:{					render:function(f){						   f.el.on('keydown', filterTree, f, {								buffer: 350						   });					}				}			})		]	});	var root = new Ext.tree.AsyncTreeNode({text:"treeItem",qtip:"treeItem",id:"",children:[{text:"增加节点1",qtip:"1",id:"",children:[{text:"增加节点",qtip:"增加节点",id:"",leaf:true},{text:"增加节点",qtip:"增加节点",id:"",leaf:true}]},{text:"增加节点2",qtip:"2",id:"",leaf:true},{text:"增加节点3",qtip:"3",id:"",children:[{text:"增加节点",qtip:"增加节点",id:"",leaf:true},{text:"增加节点",qtip:"增加节点",id:"",children:[{text:"增加节点",qtip:"增加节点",id:"",leaf:true},{text:"增加节点",qtip:"增加节点",id:"",leaf:true},{text:"增加节点",qtip:"增加节点",id:"",leaf:true}]},{text:"增加节点",qtip:"增加节点",id:"",leaf:true}]}]});	tree.setRootNode(root);/**
使用说明                      
1.注释不要用 //。
