...
$(function() {
    ...
    $("#gridTable").jqGrid({
        ...
        url: '<%=path%>/pubListServlet?classNameId=com.chinacreator.xtbg.core.file.list.FileTJList2', 
       ...
       //表头设置       
        colModel : [ 
        {
        	...
        	label : "所属分类",
        	width:200,
            name : 'f_type_parentname',
            index : 'f_type_parentname'
        }, {	
            label : "阅读次数",
            name : 'a',
            index : 'a'
...
var className="com.chinacreator.xtbg.core.file.entity.FileTJList2ExportBean";
function exportExcel(){
	...
	html.push("<input type='hidden' name='sidx' value='a' /> ");
	html.push("<input type='hidden' name='sord' value='desc' /> ");
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td width="120" class="cx_title_td">
									<input id="f_doc_year" name="f_doc_year" style="width: 120px"
