...
public class FileTJList2ExportBean extends ExportBean{
	
	private static final Logger LOG = Logger.getLogger(FileTJList2ExportBean.class);
	/**
	 * 
	 * <b>Summary: </b>
	 *     复写方法 getFieldName
	...
	public List<Map<String, String>> getData(HttpServletRequest request,
		...
		try {
		    ...
		    PagingBean pb = dao.queryList2(model, sortName, sortOrder, offset, maxPagesize,"excel");
