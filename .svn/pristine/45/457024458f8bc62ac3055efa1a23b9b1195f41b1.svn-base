...
<script>
function init(){
    var frameObj = window.frames["fcSub"];
//    alert(frameObj.location.href);
    var sql = "select sysdate a from dual";
    dataset1.Open(sql);
    var grid = creator_pt_grids[0].obj;
alert(grid.getView(0,0).innerText);
}
...
function chooseFcAttach(){
    var frameObj = window.frames["fcSub"];
    alert(frameObj.location.href);
    frameObj.location.href= "http://172.16.17.229:7000/creatorepp/eformsys/jxc/dj/20100920113019725484.jsp?djbh=1&workflowId=undefined&oid=undefined&creator_dbtest=app_xzcf&moduleId=&cc_form_instanceid=undefined";
return;
...
//var url = "http://172.16.17.229:7000/creatorepp/eformsys/jxc/dj/20100920113019725484.jsp?id=1&creator_dbtest=app_xzcf&allowDelete=true&allowAdd=true&cc_form_instanceid=undefined&mode_name=&djbh=1&fileCount=10";
//   var rtn = window.showModalDialog(url,"",""); 
...
//return;
    ...
    var allowAdd = true;
    var name = "app_xzcf";
    var cc_form_id = creator_getQueryString("cc_form_instanceid");
/*      var viewAddr =getOpenUrlByDjid("20100920113019725484")+"&id="+id+"&allowDelete="+isAllowDelete+
             "&allowAdd="+allowAdd+"&cc_form_instanceid="+cc_form_id+"&mode_name="+name+"&djbh="+id +"&fileCount=10" ;
*/
    var viewAddr ="20100920113019725484.jsp?id="+id+"&allowDelete="+isAllowDelete+
             "&allowAdd="+allowAdd+"&cc_form_instanceid="+cc_form_id+
             "&mode_name="+name+"&djbh="+id +"&fileCount=10";
...
//    var rtn = window.showModalDialog(viewAddr,"",""); 
//    return rtn ;
}
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();init();" contxml="<root><button><id>button1</id></button><dataset><id>dataset1</id></dataset><creatorSubForm><id>fcSub</id></creatorSubForm><ExtGrid><id>ExtGrid1</id></ExtGrid></root>" billtaborder="<root><taborder>button1</taborder></root>" dj_sn="20100920164412772930" caption="附件测试" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:1;text:1;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:1;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:1;ExtUpload:1;ExtTree:1;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName="app_xzcf" creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="否" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100902181609484868" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Namespace.js&#13;&#10;../../../ccapp/app_xzcf/js/common/nsreg.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Common.js&#13;&#10;../../../ccapp/app_xzcf/js/util/HTMLUtil.js&#13;&#10;../../../ccapp/app_xzcf/js/util/WorkflowUtil.js&#13;&#10;../../../ccapp/app_xzcf/js/vo/AjslVo.js&#13;&#10;../../../ccapp/app_xzcf/js/vo/AttachVo.js&#13;&#10;../../../ccapp/app_xzcf/js/vo/publicVO.js&#13;&#10;../../../ccapp/app_xzcf/js/business/Ajsl.js&#13;&#10;../../../ccapp/app_xzcf/js/dao/AjslDao.js">

<BUTTON id=button1 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("chooseFcAttach()")'>button1</BUTTON>

<IFRAME id=fcSub style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 350px" onmovestart=moveStart() src="" frameBorder=yes scrolling=no controltype="creatorSubForm" id_load="3" objType="eform" reportname urlargs autoload="yes" autoSetSize="no" url="../../jxc/dj/20100920113019725484.jsp?djbh=0"></IFRAME>
