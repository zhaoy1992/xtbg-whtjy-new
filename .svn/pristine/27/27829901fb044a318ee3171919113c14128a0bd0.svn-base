...
public class OsupplieUseTypeDaoImpl extends XtDbBaseDao implements OsupplieUseTypeDao{
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsupplieUseTypeDao#selOsupplieUseTypeList(java.lang.String, java.lang.String, java.lang.String, long, int) 
	  */
	@Override
	public PagingBean selOsupplieUseTypeList(String parmjson, String sortName,
		...
		try {
			...
			sql.append("  from ta_oa_osupplieusetype t");
	...
	public List<Map<String, String>> queryAllOsupplieUseType(String unit_id) throws Exception {
		...
		sql.append("  from ta_oa_osupplieusetype ");
