...
/**
 * 
 *<p>Title:TasksTJList.java</p>
 *<p>Description:任务交办统计列表</p>
 ...
 *2014-4-2
 */
public class TasksTJList extends DataInfoImpl{

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(TasksTJList.class);
	...
	public PagingBean getDataList(String paramjson, String sortName,
		...
		PagingBean pb = null;
		TaskBaseInfoBean bean = StringUtil.convertStringToBean(paramjson, TaskBaseInfoBean.class);
		 
		try {
			TasksReportDao daojson = (TasksReportDao)LoadSpringContext
			.getApplicationContext().getBean("tasksReportDaoImpl");
			pb = daojson.findTasksTJList(bean, sortName, sortOrder, offset, maxPagesize);
