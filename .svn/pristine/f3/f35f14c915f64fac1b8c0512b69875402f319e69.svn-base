											...
											<tr>
												...
												<td align="right"><strong>主题图片:</strong></td>
							                  	<td>
													...
													<input type="button" class="Channel_5wordsBtn" name="addpic" onClick="chooseImage()" value="选择图片"/> <input type="button" name="clearpicpath" class="Channel_5wordsBtn" value="清空" onclick="document.myform.picpath.value=''"/>
												</td>
												<td height="23"> 
												    <strong>排序时间:</strong>
												    <span class="black">
