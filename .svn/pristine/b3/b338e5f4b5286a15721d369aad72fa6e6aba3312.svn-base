...
String m_check_flag = request.getParameter("m_check_flag");   //checked
...
function modifyRow(id) {
	...
	window.parent.location="meetingnoticetab.jsp?issaved=dochecked&m_notice_id="+model.m_notice_id
