...
-->
	...
	function submitSD(){
		...
		document.forms[0].action="<%=rootpath%>/sysmanager/schedularmanage/action/schManager.jsp?method=reRequestSchedular";
	...
	<%@ include file="/epp/css/cssControl.jsp"%><body  class="info" scrolling="no">
		...
		<form name="SchedularForm" action="" method="post">
            ...
            </strong><span class="style5">重新请求他人安排&nbsp; </span></strong></p>
				...
				<table width="100%" height="206" border="0" cellpadding="0" cellspacing="2" class="thin">
					...
					<tr>
						...
						<td height="23" width="30%">
							<input name="beginTime" type="text" readonly="true" value="<pg:cell colName="beginTime"  defaultValue=""/>"
						...
						<td height="23" width="30%">
							<input name="endTime" type="text" readonly="true" value="<pg:cell colName="endTime"  defaultValue=""/>"
							onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
					...
					<tr>
						...
						<td height="23" width="29%">
							...
							<input name="plannerName" type="text" style="width:100%" value="<pg:cell colName="plannerRealName"  defaultValue=""/>" readonly="true">
