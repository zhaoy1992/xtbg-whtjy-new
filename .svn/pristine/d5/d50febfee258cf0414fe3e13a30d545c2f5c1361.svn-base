						...
						<pg:pager maxPageItems="10" scope="request" data="ResSearchList" isList="false">
							...
							<pg:list>
								<tr class="cms_data_tr" onMouseOver="high(this)" onMouseOut="unhigh(this)">
									...
									<td onclick="openWin('operList_res.jsp?resId2=<pg:cell colName="title" defaultValue="" />&resTypeId2=<%=restype%>&resTypeName=<pg:cell colName="title" defaultValue="" />&title=<pg:cell colName="title" defaultValue="" />',600,500)">
