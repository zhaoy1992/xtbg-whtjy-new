...
<div id="vcenter" style="float: left; width: 100%; overflow: scroll" scrolling="yes">
	<div style="float: left; width: 775px;">
			...
			<div class="content_02_box_div" id="jbxx">
				<table border="0" cellspacing="0" cellpadding="0" class="content_02_box_div_table">
					...
					<tr>
						...
						<th class="content_02_box_div_table_th">公告类型：</th>
						<td class="content_02_box_div_table_td"><%=StringUtil.deNull(viewMap.get("n_select_type")) %></td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="content_02_box">
			<div class="content_02_box_title_bg">
				<div class="content_02_box_add show_content" style="cursor: hand">
					<span onclick="changerContetDiv2('dworry','imgdiv2')">更多</span> 
					<em id="imgdiv2" onclick="changerContetDiv2('dworry','imgdiv2')" class="up_d">&nbsp;</em>
				</div>
				<span>接收单位和人员：</span>
			</div>
			<div class="content_02_box_div" id="dworry">
		...
		<div class="content_02_box" id="otherinfo">
			<div class="content_02_box_title_bg">
				<div class="content_02_box_add show_content" style="cursor: hand">
					<span onclick="changerContetDiv2('qtxx','imgdiv1')">更多</span> 
					<em id="imgdiv1" onclick="changerContetDiv2('qtxx','imgdiv1')" class="up_d">&nbsp;</em>
				</div>
				<span>其他信息</span>
			</div>
