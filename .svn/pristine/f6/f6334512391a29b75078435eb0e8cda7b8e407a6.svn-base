	...
	<head>
		...
		<script language="javascript">
			...
			function usercheckorg(){
				...
				var url = "usercheckorg/userCheckOrgMain.jsp?checkBoxOne="+checks + "&orgId=<%=curOrgId%>";
					...
					<table cellspacing="1" cellpadding="0" border="0" bordercolor="#EEEEEE" width=100% class="thin">
         				<tr style="align:left">
         					...
         					%>        						
								...
								<a href="#" onClick="usercheckorg()"><u>用户调动</u></a> |
							<%
	         					//判断是否禁用机构用户增删改菜单开关
	         				  	//minghua.guo[2010-12-13]
         						if(!orguser_modify_forbidden && accesscontroler.checkPermission("orgunit",
         			...
         			<table cellspacing="1" cellpadding="0" border="0" bordercolor="#EEEEEE" width=100% class="thin" height="70%">
         				<tr>
         					<td>
         						<iframe name="orgUserList" src="org_userlistIframe.jsp?orgId=<%=curOrgId%>" style="width:100%" height="100%" scrolling="auto" frameborder="0" marginwidth="1" marginheight="1"></iframe>
         					</td>
         				</tr>
				  	</table>
				</form>
