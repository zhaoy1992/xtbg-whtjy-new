...
var updateFileDocDetail = function(bean) {
    ...
    openAlertWindows('update_fileFiles'
            ,'<%=path%>/ccapp/oa/file/jsp/filefilesaddmain.jsp?openPage=tijiaoJSP&windowId=update_fileFiles&id='+bean.f_files_id+"&f_files_state="+bean.f_files_state
			...
			<div class="cGridArea">
				<div id="tool_buttons" class="ui-jqgrid .ui-userdata ui_t_bottombar_content" 
         			style="height:28px;margin-left:10px;margin-bottom:0px;float: none;border: #ebebeb 1px solid;">            
			           <input onclick="tijiao()" value="提交" type="button" class="but_y_01" style="float: left;margin-left: 10px;"/>
			     </div>
