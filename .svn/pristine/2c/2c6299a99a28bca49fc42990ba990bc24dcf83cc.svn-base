...
<title>设备借用归还界面</title>
	...
	var busiTypeCode = "<%=busiTypeCode%>";
	  jQuery(function(){
			...
			if("sbjygh_wp1_act1"==action_defid){
    			...
    			//出租日期
    			jQuery("#TA_OA_DEVTRANSFER__T_CZDATE").val("<%=r_creater_time%>");
	...
	*/
	function setDevInfo(sbid,sbcode,sbname,sbstat,type,make_users,technical_parameters,
			arrive_time,custos_userid,custos_username){
		//设备标题
		...
		//设备管理员
		jQuery("#TA_OA_DEVTRANSFER__T_SBGLY_MC").val(custos_username);
		jQuery("#TA_OA_DEVTRANSFER__T_SBGLY_ID").val(custos_userid);
...
<div id="tabs1" style="width:90%">
	...
	<div class="vcenter" style="float: left; overflow-x: hidden;" scrolling="yes">
			...
			<div class="content_02_box_div" style="width: 996px;">
				<table id="dayTable" class="content_02_box_div_table_02" width="98%" cellspacing="0" cellpadding="0" border="0">
					 	<tr>
							<td class="content_02_box_div_table_th" >租用单位：</td>
							<td class="content_02_box_div_table_td" >
							...
							<td class="content_02_box_div_table_th">出租日期：</td>
							<td class="content_02_box_div_table_th">
								<oa:date dateFmt='yyyy-MM-dd HH:mm:ss' column="T_CZDATE" table="TA_OA_DEVTRANSFER" 
								other="class='input_cx_title_188' readonly='readonly'"  />
							</td>
							<td class="content_02_box_div_table_th">出租金额：</td>
							<td class="content_02_box_div_table_th">
								<oa:input type="text" column="T_CZMONEY" table="TA_OA_DEVTRANSFER" other="class='input_cx_title_1881'"  />
							</td>
						</tr>
				</table>
				</div>
			...
			<div class="content_02_box_div" style="width: 996px;">
				<table id="dayTable" class="content_02_box_div_table_02" width="98%" cellspacing="0" cellpadding="0" border="0">
					 	<tr>
							...
							<td class="content_02_box_div_table_td" >
								<oa:date dateFmt='yyyy-MM-dd HH:mm:ss' column="T_GHDATE" table="TA_OA_DEVTRANSFER" other="class='input_cx_title_188' readonly='readonly'"  />
							</td>
							<td class="content_02_box_div_table_th">状况：</td>
							<td class="content_02_box_div_table_th">
								<select style="width: 180px;" name="dev_state" id="dev_state" disabled="disabled">
								    <option value="1" selected="selected">完好</option>
							...
							<td class="content_02_box_div_table_td">
								<oa:input type="hidden" column="T_SBGLY_ID" table="TA_OA_DEVTRANSFER" />
								<oa:input type="text" column="T_SBGLY_MC" table="TA_OA_DEVTRANSFER"  other="class='input_cx_title_188' readonly='readonly'"  />
							</td>
						</tr>
				</table>
				</div>
