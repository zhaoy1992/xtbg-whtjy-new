...
/**
 * 
 *<p>Title:KbmDocFavoritesList.java</p>
 *<p>Description:我的收藏列表</p>
 ...
 *2013-8-12
 */
public class KbmDocFavoritesList extends DataInfoImpl {

	private static final Log LOG=LogFactory.getLog(KbmDocFavoritesList.class);
	/**
	 * 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = dao.queryKbmDocFavoritesList(model, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
