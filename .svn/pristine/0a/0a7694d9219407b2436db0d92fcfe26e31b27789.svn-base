					...
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								...
								<li><a href="#tabs-3">电器</a></li>
								<li><a href="#tabs-4">家具</a></li>
							</ul>
						</div>
						<div id="tabs-1">
							<iframe src="unitmain.jsp?classify=1" id="frame1" frameborder="0"
								width="100%" height="400px" scrolling="yes"></iframe>
						</div>
						<div id="tabs-2">
							<iframe src="unitmain.jsp?classify=2" id="frame2" frameborder="0"
								width="100%" height="400px" scrolling="yes"></iframe>
						</div>
						<div id="tabs-3">
							<iframe src="unitmain.jsp?classify=4" id="frame3" frameborder="0"
								width="100%" height="400px" scrolling="yes"></iframe>
						</div>
						<div id="tabs-4">
							<iframe src="unitmain.jsp?classify=6" id="frame4" frameborder="0"
								width="100%" height="400px" scrolling="yes"></iframe>
						</div>
