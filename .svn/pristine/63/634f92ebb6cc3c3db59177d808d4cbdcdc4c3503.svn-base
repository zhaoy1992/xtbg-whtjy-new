			...
			<table width="100%" height="35" border="0" align="left"	cellpadding="0" cellspacing="1" class="table">								
				<tr>
				   <td width="" class="detailcontent">
			         <tree:tree tree="myapp_org_tree_radio"
			    	           node="myapp_org_tree_radio.node"
			    		...
			    		<tree:radio name="orgid" defaultValue=""/>
			    		<tree:treedata treetype="com.chinacreator.eform.systemManager.OrgTreeRadio"
			    	                   scope="request"
			    	                   rootid="0"  
			    	                   rootName="组织机构"
			    	                   expandLevel="1"
