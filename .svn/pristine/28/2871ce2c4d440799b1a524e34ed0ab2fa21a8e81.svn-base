 ...
 * @exception
 */
public class GuestreceptionList extends DataInfoImpl {

	private static final Logger LOG = Logger.getLogger(GuestreceptionList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		if (!StringUtil.isBlank(parmjson)) {
			...
			guestreceptionBean = (GuestreceptionBean) JSONObject.parseObject(parmjson,
					GuestreceptionBean.class);
		}
		try {
			...
			pb = guestreceptionDao.queryGuestInfo(guestreceptionBean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
