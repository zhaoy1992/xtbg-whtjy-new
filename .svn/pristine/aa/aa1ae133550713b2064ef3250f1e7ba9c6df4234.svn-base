...
var opentype ="undone";
var accunit = "<%=accunit%>";
var p_flag_id = "<%=PaperConstants.STATUS_UNDONE%>";
    ...
    $("#gridTable").jqGrid({
       ...
       //表头设置       
        colModel : [ 
        {
            ...
            label : "退回人",
            name : 'p_undone_user_name',
            index : 'p_undone_user_name',
            width: '100'
        }, {	
            label : "p_flag_id",
            name : 'p_flag_id',
        ...
        onCellSelect:function (id,icol)
		{
			if(icol != 0)
			{
        		...
        		urlTmp = "&loadurl=paperlist4publishundone&actionName=updatefromundone&p_manage_id="+model.p_manage_id;
				toNewPage2(urlTmp,"已退回");
			}
		}
    });
