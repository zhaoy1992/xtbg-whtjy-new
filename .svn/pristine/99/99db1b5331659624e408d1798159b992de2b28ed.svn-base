 ...
 *2012-11-15
 */
public class YjSendMailList implements DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(YjSendMailList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = carManageWxbyDao.findMailInfoListByYjSend(mailBean, sortName, sortOrder, offset, maxPagesize);	
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
