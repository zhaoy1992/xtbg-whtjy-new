...
function showitem(id,name) {
    return ("<span><a href='"+id+"' target=Main class='left1'>"+name+"</a></span><br>");
}
    ...
    if(number!=i && outlooksmoothstat==0) {
        if(number!=-1) {
            if(i==-1) {
                ...
                /*document.all("outlooktitle"+i).style.background = "#ffffff";
                document.all("outlooktitle"+i).style.background-image = "<%out.print("blue/images/");%>menu-bg.gif";*/
            ...
            /*document.all("outlooktitle"+number).style.background = "#ffffff"; //title
            document.all("outlooktitle"+i).style.background-image=url("<%out.print("blue/images/");%>menu-bg.gif");*/
...
function getOutLine() {
    ...
    for(i=0;i<(outlookbar.titlelist.length);i++) {
        outline+="<tr><td background='style/office/images/menu-bg.gif' name=outlooktitle" + i + " id=outlooktitle" + i + " ";
        if(i!=outlookbar.opentitle)
            outline+=" nowrap align=center style='cursor:hand;background-color:#ffffff;color:#000000;height:5;border:1 none navy' ";
        else
            outline+=" nowrap align=center style='cursor:hand;background-color:#ffffff;color:#000000;height:5;border:1 none white' ";
