...
$(function() {
	...
	$("#gridTable").jqGrid({
		...
		colNames: ['apply_id','申请人ID','用车人','用车人id','用车时间','用车结束时间','申请时间','所有车辆','car_id','状态'],
...
var viewApplyinfo = function(id) {
	...
	var url = "<%=path%>/ccapp/xtbg/yimingju/carmanage/jsp/carFpInfo.jsp?apply_id="+model.apply_id;
