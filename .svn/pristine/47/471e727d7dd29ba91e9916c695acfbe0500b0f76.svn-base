	...
	<table class="cQueryTableArea">
		<tr>
			<td colspan="4" align="left">
				<!--  <input class="cButton_4text" type="button" name="operation" value="送审" onclick="submitedInfo()" id="reportinfo"/>-->
				<input class="cButton_4text" type="button" name="operation" value="退稿" onclick="rejectionInfo()" id="reportinfo"/>
				<!--<input class="cButton_4text" type="button" name="operation" value="发布" onclick="publishInfo()" id="reportinfo"/>-->
