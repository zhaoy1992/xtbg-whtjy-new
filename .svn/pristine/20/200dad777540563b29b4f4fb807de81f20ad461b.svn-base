...
<script type="text/javascript">
	...
	iframeSrcArr[iframeSrcArr.length] = "noticeaduitlist.jsp";
	iframeSrcArr[iframeSrcArr.length] = "noticeisaduitlist.jsp";
		$(function() {
			$("#tabs").tabs({
			...
			jQuery("#frame1").attr("src","noticeaduitlist.jsp");
		});
	</script>
<title>公告列表</title>
</head>
...
<table style="WIDTH: 100%;">
	<tr>
		...
		<ul>
			<li><a href="#tabs-1">未审核列表</a></li>
			<li><a href="#tabs-2">已审核列表</a></li>
		</ul>
		</div>
