		...
		if (userName != null) {
			try {
				...
				if (successRedirect == null) {
					successRedirect = "../../common/main/index.jsp?subsystem_id=" + subsystem;
				}
				islogin = true;
				/** 
...
<title>湖南省特种设备检测中心办公自动化系统</title>
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td background="../resources/images/kechuang.jpg"><table width="1024" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <tr>
        <td height="50"><input name="" type="button" value="" class="xin_denglu_k2" onmouseover="this.style.backgroundImage='url(../resources/images/xin_denglu_k21.gif)'" onmouseout="this.style.backgroundImage='url(../resources/images/xin_denglu_k2.gif)'" onclick="login(true)"/></td>
      </tr>
      <tr>
