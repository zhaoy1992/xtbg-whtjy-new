...
public class OsHavaObjectDaoImpl extends XtDbBaseDao implements OsHavaObjectDao {
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#updateOsExaState(java.lang.String)
	 */
	public boolean updateOsExaState(String osExaIds) throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		osExaIds = StringUtil.splitString(osExaIds, ",", "'");
		sql.append(" update  TA_OA_DETOSEXAMINATION t set t.t_osexa_isrk = '1' ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryHavaIdByItId(java.lang.String)
	 */
	public List<Map<String, String>> queryHavaIdByItId(String it_id)
		...
		sql.append(" select t.*,nvl(t.t_ha_no,0) as t_ha_nos from TA_OA_DETHAVA_OBJECT t ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #insertOsHavaInfo(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaObjectBean)
	 */
	public boolean insertOsHavaInfo(OsHavaObjectBean osHavaObjectBean)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" insert into TA_OA_DETHAVA_OBJECT( ");
		sql.append(" oftype_id,oftype_name,ofustype_id,ofustype_name,it_id,it_name, ");
		sql.append(" t_ha_buydate,t_ha_no,t_ha_dj,t_ha_bz,t_ha_id,t_ha_sbno,t_ha_ghman,");
		sql.append(" t_ha_overtel,t_ha_sbstate,t_ha_ghuser,t_ha_rkuser_id,t_ha_rkuser_name,t_ha_org_id,t_ha_org_name,unit_id,unit_name) ");
	...
	* @throws Exception
	...
	public boolean deleteOsHavaById(Connection conn,String beanId)throws Exception{
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_DETHAVA_OBJECT ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#updateOsHavaInfo(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaObjectBean)
	 */
	public boolean updateOsHavaInfo(OsHavaObjectBean osHavaObjectBean)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update TA_OA_DETHAVA_OBJECT t set t.oftype_id = ?, t.oftype_name = ?, t.ofustype_id = ?, t.ofustype_name = ?, ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryNoMoveTypeSelect()
	 */
	public List<Map<String, String>> queryNoMoveTypeSelect() throws Exception {
		StringBuffer sql = new StringBuffer();
		List<Map<String, String>> havaValueList = new ArrayList<Map<String,String>>();
		sql.append(" select * from TA_OA_DETOSUPPLIETYPE t ");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #findOsHavaObjectList(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaObjectBean, java.lang.String, java.lang.String, long, int)
	 */
	public PagingBean findOsHavaObjectList(OsHavaObjectBean osHavaObjectBean,
		...
		StringBuffer sql = new StringBuffer();
		sql.append("   select distinct(t.t_ha_id)t_ha_id ,os.oftype_id,os.oftype_name,");
		...
		sql.append("                   from TA_OA_DETHAVA_OBJECT objs, TA_OA_DETNOMOVE_OBJECT mobjs");
		sql.append("                  where objs.t_ha_id = t.t_ha_id");
		sql.append("                    and objs.t_ha_id = mobjs.t_ha_id) as amidAct");//没有关联任何在办流程的物品
		sql.append("   from TA_OA_DETHAVA_OBJECT t, TA_OA_DETOSUPPLIETYPE os ");
		...
		if (!StringUtil.isBlank(osHavaObjectBean.getT_ha_sbstate())) {
			sql.append("   and t.t_ha_sbstate = ? ");
		}
		if (!StringUtil.isBlank(osHavaObjectBean.getT_ha_org_id())) {
			sql.append("   and t.t_ha_org_id = ? ");
		}
		if (!StringUtil.isBlank(osHavaObjectBean.getIt_name())) {
			sql.append("   and t.it_name like '%"+osHavaObjectBean.getIt_name()+"%' ");
		}
		sql.append(" order by " + sortName + " " + sortOrder);
    	db.preparedSelect(sql.toString(), offset, maxPagesize);
    	int k = 1;
    	if (!StringUtil.isBlank(osHavaObjectBean.getUnit_id())) {
    		db.setString(k++, osHavaObjectBean.getUnit_id());
		}
    	if (!StringUtil.isBlank(osHavaObjectBean.getT_ha_iswhat())) {
    	...
    	if (!StringUtil.isBlank(osHavaObjectBean.getT_ha_sbstate())) {
    		db.setString(k++, osHavaObjectBean.getT_ha_sbstate());
		}
    	if (!StringUtil.isBlank(osHavaObjectBean.getT_ha_org_id())) {
    		db.setString(k++, osHavaObjectBean.getT_ha_org_id());
		}
    	db.executePrepared();
		for(int i = 0;i < db.size();i++){
			OsHavaObjectBean osHavaObjectBeanDb = new OsHavaObjectBean();
			osHavaObjectBeanDb.setIt_id(db.getString(i, "it_id"));
			osHavaObjectBeanDb.setIt_name(db.getString(i, "it_name"));
			osHavaObjectBeanDb.setOftype_id(db.getString(i, "oftype_id"));
			osHavaObjectBeanDb.setOftype_name(db.getString(i, "oftype_name"));
			osHavaObjectBeanDb.setOfustype_id(db.getString(i, "ofustype_id"));
			osHavaObjectBeanDb.setOfustype_name(db.getString(i, "ofustype_name"));
			osHavaObjectBeanDb.setT_ha_buydate(db.getString(i, "t_ha_buydate"));
			osHavaObjectBeanDb.setT_ha_no(db.getString(i, "t_ha_no"));
			osHavaObjectBeanDb.setT_ha_dj(db.getString(i, "t_ha_dj"));
			osHavaObjectBeanDb.setT_ha_bz(db.getString(i, "t_ha_bz"));
			osHavaObjectBeanDb.setT_ha_id(db.getString(i, "t_ha_id"));
			osHavaObjectBeanDb.setT_ha_rkuser_id(db.getString(i, "t_ha_rkuser_id"));
			osHavaObjectBeanDb.setT_ha_rkuser_name(db.getString(i, "t_ha_rkuser_name"));
			osHavaObjectBeanDb.setT_ha_sbno(db.getString(i, "t_ha_sbno"));
			osHavaObjectBeanDb.setT_ha_ghman(db.getString(i, "t_ha_ghman"));
			osHavaObjectBeanDb.setT_ha_overtel(db.getString(i, "t_ha_overtel"));
			osHavaObjectBeanDb.setT_ha_sbstate(db.getString(i, "t_ha_sbstate"));//状态  1在库  2领用   3在修  4报废
			osHavaObjectBeanDb.setT_ha_ghuser(db.getString(i, "t_ha_ghuser"));
			osHavaObjectBeanDb.setT_ha_org_id(db.getString(i, "t_ha_org_id"));
			osHavaObjectBeanDb.setT_ha_org_name(db.getString(i, "t_ha_org_name"));
			//没有关联任何在办流程的物品
			osHavaObjectBeanDb.setAmidAct(db.getString(i, "amidAct")); 
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #findOsHavaNoMoveObjectList(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaObjectBean, java.lang.String, java.lang.String, long, int)
	 */
	public PagingBean findOsHavaNoMoveObjectList(
		...
		sql.append("    from TA_OA_DETHAVA_OBJECT t ");
		sql.append("       left join TA_OA_DETOSUPPLIETYPE os");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #findOsAppList(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsApplanBean, java.lang.String, java.lang.String, long, int)
	 */
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#selectOsAppObjectByIds(java.lang.String, java.lang.String)
	 */
	public List<Map<String, String>> selectOsAppObjectByIds(String osAppIds,
		...
		sql2.append(" select v.STATUS_CODE from view_oa_instance v,TA_OA_DETOSAPPREGYHP t");
		...
		sql.append("   from TA_OA_DETOSAPP_OBJECT t left join TA_OA_DETOSAPPLAN o on t.t_id=o.t_id");
		sql.append("   left join  TA_OA_DETOSUPPLIEUSETYPE op on t.ofustype_id=op.ofustype_id");
		sql.append("   left join  TA_OA_DETOSUPPLIETYPE os on op.oftype_id=os.oftype_id");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#deleteOsAppRegObject(java.lang.String, java.sql.Connection)
	 */
	public boolean deleteOsAppRegObject(String t_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_DETOSAPPREG_OBJECT ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#updateOsApplanState(java.lang.String, java.sql.Connection)
	 */
	public boolean updateOsApplanState(String ids, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		String appIds = StringUtil.splitString(ids, ",", "'");
		sql.append(" update TA_OA_DETOSAPPLAN t set t.T_IS_LQ='1' ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryAppIdsForAppRegId(java.lang.String)
	 */
	public String queryAppIdsForAppRegId(String appRegid) throws Exception {
		StringBuffer sql = new StringBuffer();
		String appIds = "";
		sql.append(" select t.T_APPREGYHP_APPIDS  ");
		sql.append(" from TA_OA_DETOSAPPREGYHP t ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#selectOsAppRegObjectByregId(java.lang.String)
	 */
	public List<Map<String, String>> selectOsAppRegObjectByregId(String appRegId)
		...
		sql.append("  from TA_OA_DETOSAPPREG_OBJECT t");
		...
		sql.append("  left join TA_OA_DETOSUPPLIETYPE ostype on t.oftype_id = ostype.oftype_id");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #updateOsHavaObjectAfterLY(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaObjectBean)
	 */
	public boolean updateOsHavaObjectAfterLY(OsHavaObjectBean osHavaObjectBean)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_DETHAVA_OBJECT t set ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryHavaObjectByHaIds(java.lang.String)
	 */
	public List<Map<String, String>> queryHavaObjectByHaIds(String haIds,String bus_id)
		...
		String staute_code = "";
		StringBuffer sql2 = new StringBuffer();
		sql2.append(" select v.STATUS_CODE from view_oa_instance v,TA_OA_DETOSNOMOVE t");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #insertHavaLYObject(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaLYObjectBean)
	 */
	public boolean insertHavaLYObject(OsHavaLYObjectBean osHavaLYObjectBean)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" insert into TA_OA_DETLINGYONG_OBJECT( ");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #updateHavaLYObject(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaLYObjectBean)
	 */
	public boolean updateHavaLYObject(OsHavaLYObjectBean osHavaLYObjectBean)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update TA_OA_DETLINGYONG_OBJECT t set t_ly_id = ?, oftype_id = ?, oftype_name = ?, ofustype_id = ?, ofustype_name = ?, ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#deleteOsNoMoveObject(java.lang.String, java.sql.Connection)
	 */
	public boolean deleteOsNoMoveObject(String busi_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_DETNOMOVE_OBJECT ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#updateHavaObjectForIds(java.lang.String)
	 */
	public boolean updateHavaObjectForIds(String havaIds) throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		havaIds = StringUtil.splitString(havaIds, ",", "'");
		sql.append(" update  TA_OA_DETHAVA_OBJECT t set t.t_ha_sbstate = '2' ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryNoMoveObjectForRegId(java.lang.String)
	 */
	public List<Map<String, String>> queryNoMoveObjectForRegId(String bus_id)
		...
		sql.append("  select t.*,t1.t_ha_sbno from TA_OA_DETNOMOVE_OBJECT t");
		sql.append("  left join TA_OA_DETHAVA_OBJECT t1 on t.t_ha_id = t1.t_ha_id");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryHavaIdsForRegId(java.lang.String)
	 */
	public String queryHavaIdsForRegId(String bus_id) throws Exception {
		StringBuffer sql = new StringBuffer();
		String appIds = "";
		sql.append(" select t.T_HAVA_IDS  ");
		sql.append(" from TA_OA_DETOSNOMOVE t ");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #findOsHavaLYObjectList(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaLYObjectBean, java.lang.String, java.lang.String, long, int)
	 */
	public PagingBean findOsHavaLYObjectList(
		...
		sql.append("   from TA_OA_DETLINGYONG_OBJECT t, TA_OA_DETOSUPPLIETYPE os ");
		sql.append("       where t.oftype_id = os.oftype_id");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryHavaObjectByHaId(java.lang.String)
	 */
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#updateHavaObjectStateByHaIds(java.lang.String, java.lang.String)
	 */
	public boolean updateHavaObjectStateByHaIds(String havaIds, String state)
		...
		StringBuffer sql = new StringBuffer();
		havaIds = StringUtil.splitString(havaIds, ",", "'");
		sql.append(" update  TA_OA_DETHAVA_OBJECT t set t.t_ha_sbstate = '"+state+"'");
		sql.append(" where t.t_ha_id in ("+havaIds+")");
		db.preparedUpdate(sql.toString());
		db.executePrepared();
		return true;
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#queryMyObjectByLyId(java.lang.String)
	 */
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao#updateOsexaObjectRKNO(java.lang.String, java.lang.String)
	 */
	public boolean updateOsexaObjectRKNO(String osexa_id, String t_osexa_obrk_no)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_DETOSEXA_OBJECT t set t.t_osexa_obrk_no = '"+t_osexa_obrk_no+"'");
	 ...
	 * 
	  ...
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsHavaObjectDao
	  * #updateHavaObjectOrg(com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsHavaObjectBean)
	 */
	public boolean updateHavaObjectOrg(OsHavaObjectBean osHavaObjectBean)
			throws Exception {
		PreparedDBUtil db = new PreparedDBUtil();
		StringBuffer sql = new StringBuffer();
		sql.append(" update  TA_OA_DETHAVA_OBJECT t set t.t_ha_org_id = ?, t.t_ha_org_name = ?,t.t_ha_sbno=? ");
		sql.append(" where t.t_ha_id = ?");
		db.preparedUpdate(sql.toString());
		int i = 1 ;
		db.setString(i++, osHavaObjectBean.getT_ha_org_id());
	...
	* @throws Exception
	...
	public List<Map<String, String>> queryHavaObjectBySbCode(String t_ha_sbno) throws Exception{
		...
		sql.append("  from TA_OA_DETHAVA_OBJECT ");
