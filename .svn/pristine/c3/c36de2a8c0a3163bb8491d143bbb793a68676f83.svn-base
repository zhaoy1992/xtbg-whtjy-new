...
/**
 *<p>Title:TrainList.java</p>
 *<p>Description:培训记录管理</p>
 ...
 *2014-2-21
 */
public class TrainList extends DataInfoImpl{
	
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(TrainList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = daojson.findTrainList(parmjson, sortName, sortOrder, offset, maxPagesize);
