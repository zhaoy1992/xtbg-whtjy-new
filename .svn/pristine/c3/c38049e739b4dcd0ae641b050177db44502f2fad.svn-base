	...
	%>
				...
				<tr>
					<td>
						<div align="right">
							...
							<input type="button" name="取消" value=" 返 回 " onclick="javascript:window.close();"  class="button2">
						</div>
					</td>
				</tr>
			</table>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="table_wgtm02" width="100%">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="orgName" readonly="true" class="textfield01" value='<%=disposedept%>' defaultValue="">
				...
				<tr>
					...
					<td>
					    <input type="checkbox" name="can_repeat" disabled value="0"  onClick="return chkTimeGap();">
						相同IP不可重复投票 时间间隔
				...
				<tr><td align="right">
					...
					<tr>
					 <td colspan="4">
					  <iframe id="eWebEditor1" src="<%=request.getContextPath()%>/cms/editor/eWebEditor48/ewebeditor.htm?id=content&style=mini500&cusdir=<%=docPath%>" frameborder="0" scrolling="no" width="100%" height="360"></iframe>
					 </td>
		            </tr>
		...
		<tab:tabPane id="bar-question" tabTitle="题目信息">
			<table width="100%" border="0" id="qstTable" name="qstTable" cellpadding="0" cellspacing="0" bgcolor="#F3F4F9" >
				<tr>
					<td>
						<input type="button" name="Submit4" value="添加题目" onclick="return addQuestion()"  class="button2" disabled>
					</td>
				</tr>
				<tr>
					<td>
			...
			<table cellpadding="0" cellspacing="0" bgcolor="#F3F4F9" >
				<tr>
					<td>
						<input type="button" name="Submit4" value="添加题目" disabled onclick="return addQuestion()"  class="button2">
					</td>
				</tr>
			</table>
