 ...
 *2013-7-16
 */
public class FileDocListForVideo extends DataInfoImpl {
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(FileDocListForVideo.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryFileDocVideoList(model, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
