...
public class FileDocPhotoExportBean extends ExportBean{
	
	private static final Logger LOG = Logger.getLogger(FileDocPhotoExportBean.class);
	/**
	 * 
	 * <b>Summary: </b>
	 *     复写方法 getFieldName
