  ...
  <tr>
    <td  height="483" valign=top background="../images/tile.jpg" bgcolor="#FFFFFF"><table width="98%" border="0" align="center">
      ...
      <tr>
        ...
        <td width="21%">&nbsp; 正文类容：
          <input name="textfield" type="text" class="cms_text" size="10"></td>
        <td width="16%" nowrap>&nbsp; 作者：
          <input name="textfield" type="text" class="cms_text" size="10"></td>
        <td width="12%" nowrap>              <div align="left"> 关键词：
      ...
      <tr>
        <td colspan="5"><table width="99%" border="0" align="center">
          <tr class="cms_report_tr">
            <td width="6%" >序号
              <div  style='display:none;cursor:hand' id='div_no' onClick='selectNo(form1)' align='center' >
              <div align="left">全不选</div>
            </div></td>
            <td width="8%" ><div align="center">类型</div></td>
            <td width="59%" height="19"><div align="center">文档标题</div></td>
            <td width="11%"><div align="center">作者</div></td>
            <td width="16%"><div align="center">入库时间</div></td>
          </tr>
          <tr class="cms_data_tr">
            ...
            <td><div align="center"><img src="../images/doc_html.gif" width="20" height="20"></div></td>
          ...
          <tr class="cms_data_tr">
            ...
            <td><div onClick="openWin('template_edit.jsp',900,800)" style="cursor:hand">
              <div align="center"><img src="../images/doc_html.gif" width="20" height="20"></div>
            </div></td>
      ...
      <tr>
        ...
        <td><div align="center">
            <input name="Submit" type="submit" class="cms_button" value="删除">
            <input name="Submit" type="submit" class="cms_button" value="呈送">
            <input name="Submit" type="submit" class="cms_button" value="拟稿">
        </div></td>
      </tr>
    </table></td>
  </tr>
