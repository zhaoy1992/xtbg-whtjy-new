...
$(function() {
    ...
    $("#gridTable").jqGrid({
        ...
        url: '<%=path%>/pubListServlet?classNameId=com.chinacreator.xtbg.core.file.list.FileDocListForDisk', 
   ...
   initAddBtn = function(){
    ...
    var toUserParamJosn = function() {
       	if(window.parent.role=="org"||window.parent.role=="dept"){
        	...
        	var F_BURN_USER_ID_v = $('#F_BURN_USER_ID').val();<%--文号--%>
    		...
    		str += "'f_add':'"+f_add_v+"',";
    		str += "'f_burn_user_id':'"+F_BURN_USER_ID_v+"',";
...
var className="com.chinacreator.xtbg.core.file.entity.FileDocDiskExportBean";
...
var toUserParamJosnA = function(objName,notEscape){
	if(window.parent.role=="org"||window.parent.role=="dept"){
		...
		param[objName+"f_burn_user_id"]= $('#F_BURN_USER_ID').val();<%--文号--%>
        ...
        <tr>
            ...
            <!-- 固定查询 -->
                 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
                    ...
                    <tr>
                        <th style="width:80px;" class="input_cx_title_th">刻录人：</th>
                        <td width="120" class="cx_title_td">
                        	<input type="text" id="F_BURN_USER_ID" name="F_BURN_USER_ID" class="input_cx_title_283" style="width:120px;"/>
                        </td>
                        <th  class="input_cx_title_th" style="width:60px;">地址：</th>
                       	<td width="100" class="cx_title_td">
                    ...
                    <tr>
				        ...
				        <table>
				        	<tr>
								<th class="input_cx_title_th" style="width: 100px;">件号：</th>
								<td width="125" class="cx_title_td">
									<input type="text" id="f_doc_num" name="f_doc_num" class="input_cx_title_283" style="width: 125px;" />
								</td>
							...
							<tr>
								<th class="input_cx_title_th" style="width: 100px;">&nbsp;</th>
								<td width="125" class="cx_title_td">&nbsp;</td>
								<th style="width: 100px" class="input_cx_title_th">刻录时间：</th>
								<td style="width:110px;" class="cx_title_td">
