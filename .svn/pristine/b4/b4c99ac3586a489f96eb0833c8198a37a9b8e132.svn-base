      ...
      <TR>
         <TD>
            <TABLE class=CTable cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
               <TBODY>
                  <TR>
                     <TD class=taobox colSpan=4>执法人员信息查询</TD>
                  </TR>
                  <TR>
                     <TD class=c2 width="15%">姓名</TD>
                     ...
                     <TD class=c2 width="15%">所属执法主体</TD>
                  ...
                  <TR>
                     ...
                     <TD width="35%"><INPUT type=radio CHECKED value=1 name=zhuangtai>有效<INPUT type=radio value=0 name=zhuangtai>无效<INPUT type=radio value=-1 name=zhuangtai>全部</TD>
                     <TD class=c2 width="15%">证件编号</TD>
                  ...
                  <TR>
                     <TD class=c2 width="15%">发证日期</TD>
                     <TD width="85%" colSpan=3><INPUT class=its_out id=ELU_CERTIFICATION_DATE style="LEFT: 0px; WIDTH: 18%; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=8 name=Input2 controltype="text" onclick='bill_onclick("SelectDate()")'>&nbsp;至&nbsp;<INPUT class=its_out id=ELU_CERTIFICATION_DATE1 style="LEFT: 0px; WIDTH: 18%; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=11 name=Input2 controltype="text" onclick='bill_onclick("SelectDate()")'></TD>
                  </TR>
               </TBODY>
            </TABLE>
         </TD>
