...
<%@ include file="/epp/css/cssControl.jsp"%><body  scroll="auto">
<table >
	<tr><td>
	<tree:tree tree="res_tree" 
			...
			<tree:treedata treetype="com.chinacreator.menu.ResourceTypeCMSTree" scope="request" rootid="0" rootName="资源分类" expandLevel="1" 
			showRootHref="false" 
			needObserver="false" 
