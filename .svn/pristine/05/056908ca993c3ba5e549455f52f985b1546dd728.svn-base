...
<script>
	...
	function Ok(){
		...
		form1.action="trainexcelimportdo.jsp?&wdo=batch";
		$("#form1").submit();
	}
	 ...
	 */
	function setChange(){
		$("#impIfr").attr("src","downTrainExcelTemplate.jsp");
	}	
</script>
		...
		<div id="vcenter" style="float:left; width:100%; " >
			<div style="float: left; width: 775px; ">
				<div class="content_02_box_div">	
					<table >
						<tr>
							<th class="content_02_box_div_table_th" rowspan="2"><FONT style="COLOR: red">*</FONT>选择人员持证培训信息表</th>
					...
					<!-- 	<tr>
							<td class="content_02_box_div_table_td" width="250px;">
								&nbsp;请先导出填写人员持证-培训信息表&nbsp;&nbsp;&nbsp;<a onclick="setChange()" href="#"  style="color: blue">人员持证培训信息下载</a>
							</td>
						</tr> -->
					</table>
					<table width="456px">
