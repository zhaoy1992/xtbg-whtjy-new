...
<body bgcolor="#ffffff">
<div align="center"><font size=4 color=ff0000>全文批注中间件应用示例[iWebOffice2009 OCX版]</font></div>
<hr size=1>
<div class=IptStyle>
  <p>注：演示版能打开和保存网络上的文件。正式版可实现更强大的功能，如要正式版，请与金格科技联系。<br>
  &nbsp;&nbsp;&nbsp;&nbsp;如要正确演示本示例，你必须:<br>
    1.安装Office2000系统和IE5.0以上版本，最好在Window 98以上的计算机上运行。<br>
  2.安装iWebOffice2009插件，请你在打开本页面的弹出窗口时，选择[是]按钮,才能正常运行。<br>
  3.如果不能正常自动安装iWebOffice2009插件，<a href="InstallClient.zip">请你在这里下载本地安装程序</a>。<br>
  </p>
</div>
<hr size=1>
