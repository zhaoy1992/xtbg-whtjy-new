	...
	<head>
		...
		<script language="javascript">	 		  
		  ...
		  function saveGroup() 
		  {
			...
			groupForm.action= "submitGroup.jsp?son=1&flag="+submitFlag;
          ...
          function initial()
          {
            ...
            document.all.parentId.value='<%=groupId%>';
            document.all.groupId.value='';
          	document.all.groupName.value='';
          	document.all.oldGroupName.value='';
            document.all.groupDesc.value='';      	 
					...
					<tr>
						<td>
							<table width="60%" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td align="right">
										<input type="button" class="input" value="保存" onclick="saveGroup();" />
									</td>
								</tr>
							</table>
						</td>
