...
<%
    ...
    String month = DateUtil.getCurrentMonth();//当前月
    //获得缓存的机构信息
...
var userId = "<%=StringUtil.deNull(userId) %>";//用户id
    ...
    jQuery(function(){       
        ...
        jQuery("#OA_FILE_FILES__F_FILES_TITLE").focus();
        
            
        //实物类型默认选中 纸质
        jQuery("#OA_FILE_FILES__F_ENTITY_TYPE option[value=1]").attr("selected","selected");
      ...
      //如果只需要展示数据，则进行处理
        if("isview"=="<%=isview%>"){
            //附件重新赋值
            jQuery("#fujianupload").hide();            
            jQuery("#vcenter input[type=text],#vcenter select,#vcenter textarea").each(function(){
                HTMLUtil.readOnly(this,null,jQuery);
             });
            jQuery("#vcenter input[type=button]").hide();
            jQuery("#vcenter input[type=radio]").attr("disabled","disabled");
            //jQuery("#vc enter textarea").attr("readOnly","readOnly");            
        }                 
        //将表单升级为ajax的提交方式
    ...
    */
    ...
    var getFieldValue = function(){
      return jQuery("#form1").fieldValue(); 
    }
    /**
     函数:  ajaxSubmit
     说明:  ajax访问后台
...
function printFileList(){
 ...
 function addNewFile(newId){
        ...
        //重置盒号
        jQuery("#OA_FILE_FILES__F_FILESNO").val("");
        //重置归档人
        ...
        MyFancyupload.createUpload('_fileshow', '#_filebut', path, 
                path+'/servlet/pubFileUpload?buessid='+newId, true, 
                newId,'','','111','',false);
        //附件id赋值
        jQuery("input[name=OA_FILE_FILES_ACC__F_ATTACH_ID]").val(newId);
 }
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="content_02_box_div_table" style="width:780px;">
                     <tr>
                      <th class="content_02_box_div_table_th">
                            <span class="color_red">*</span>案卷题名：
                        </th>
                        <td colspan="3" class="content_02_box_div_table_td" >
                            <oa:input type="text" column="F_FILES_TITLE" table="OA_FILE_FILES"
                                   other='style = "width:547px;" class="validate[required,maxSize[100]] input_160"'/>
                        </td>
                    </tr>    
                    <tr>                        
                        <th class="content_02_box_div_table_th">
                        ...
                        <td colspan="3"  class="content_02_box_div_table_td" >
                            <oa:input type="text" column="F_FILES_NO" table="OA_FILE_FILES"
                                value="" other='style = "width:547px;" class="validate[maxSize[200]] input_160" ' /> 
                           ...
                           <input type="hidden" name="isAccount" id="isAccount" value="Y"/>
                    ...
                    <tr>
                       <th class="content_02_box_div_table_th">
                        ...
                        <td class="content_02_box_div_table_td" >
                            <oa:input type="text" column="F_TYPE_NAME" table="OA_FILE_FILES"
                                   other='readonly="readonly" style = "width:150px;" class="validate[required,maxSize[100]] input_160" ' 
                        ...
                        <td  class="content_02_box_div_table_td" >
                            <oa:input type="text" column="F_TYPENO" table="OA_FILE_FILES"
                                   other='readonly="readonly" style = "width:150px;" class="validate[maxSize[20]] input_160" ' 
                     ...
                     <tr>
                      <th class="content_02_box_div_table_th">
                            <span class="color_red">*</span>档案年月：
                        </th>
                        <td  class="content_02_box_div_table_td" >
                         <oa:input type="text" column="F_DOC_YEAR" table="OA_FILE_FILES"
                                value="<%=StringUtil.deNull(year) %>" other='style = "width:60px;float:none;" class="validate[required,maxSize[4]] date_120 Wdate" onclick="WdatePicker({dateFmt:\'yyyy\',maxDate:\'%y\'})"' /> 
                                                                          年                        
                        <oa:input type="text" column="F_FILE_MONTH" table="OA_FILE_FILES_ACC"
                                value="<%=StringUtil.deNull(month) %>" other='style = "width:60px;float:none;" class="validate[required,maxSize[2]] date_120 Wdate" onclick="WdatePicker({dateFmt:\'MM\'})"' /> 
                                                                         月
                        </td>
                    ...
                    <tr>
                      <th class="content_02_box_div_table_th">
                                          <span class="color_red">*</span>月份内册数：
                        </th>
                        <td  class="content_02_box_div_table_td" style="height: 25px;line-height: 25px;" >
                             <span style="float: left;margin-left: 5px;height: 25px;line-height: 25px;">共&nbsp;</span>
                             <oa:input type="text" column="F_FILE_MONTHBOOKTOTAL" table="OA_FILE_FILES_ACC"
                                value="" other='style = "float:none;width:40px;text-align:center;" maxlength="8" class="validate[required,maxSize[8],custom[positiveinteger]] input_160"  ' /> 
                             <span style="height: 25px;line-height: 25px;">册&nbsp;第</span>
                             <oa:input type="text" column="F_FILE_MONTHBOOKINDEX" table="OA_FILE_FILES_ACC"
                                value="" other='style = "float:none;width:40px;text-align:center;" maxlength="8" class="validate[required,maxSize[8],custom[positiveinteger]] input_160"  ' /> 
                             
                             <span style="margin-right: 5px;height: 25px;line-height: 25px;">&nbsp;册</span>
                        </td>
                   
                      
                        <th class="content_02_box_div_table_th" id="fileCount_td">
                            <span class="color_red">*</span>汇帐凭证起止号码：
                        </th>
                        <td class="content_02_box_div_table_td" style="height: 25px;line-height: 25px;" >
                            <span style="float: left; margin-left: 5px;height: 25px;line-height: 25px;">自第&nbsp;</span>
                             <oa:input type="text" column="F_FILE_STARTNO" table="OA_FILE_FILES_ACC"
                                value="" other='style = "float:none;height:22px;line-height:22px;width:40px;text-align:center;" maxlength="8" class="validate[required,maxSize[8],custom[positiveinteger]] input_160"  ' /> 
                             <span style="margin-left: 5px;height: 25px;line-height: 25px;">号&nbsp;至</span>
                             <oa:input type="text" column="F_FILE_ENDNO" table="OA_FILE_FILES_ACC"
                                value="" other='style = "float:none;width:40px;text-align:center;" maxlength="8" class="validate[required,maxSize[8],custom[positiveinteger]] input_160"  ' /> 
                             
                             <span style="margin-right: 5px;height: 25px;line-height: 25px;">&nbsp;号</span>
                        ...
                        <td  class="content_02_box_div_table_td" >                           
                            <oa:select column="F_FONDSNO" table="OA_FILE_FILES"
                               other='style="width:150px;" class ="validate[required] select_100_box_type"'>       
                                ...
                                <oa:option other='title="<%=name %>"' optionValue="<%=value %>" 
                                   optionName="<%=value %>"></oa:option>
                                <%} %>
                            </oa:select>
                        </td>
                    <th class="content_02_box_div_table_th">
                            <span class="color_red">*</span>案卷号：
                        </th>
                        <td class="content_02_box_div_table_td" >
                     ...
                     <tr id="fujianupload">
                                ...
                                <td class="content_02_box_div_table_td" colspan=3>
                                   <%if("isview".equals(isview)){%>
                                       <oa:affixbut
                                          butName='请选择文件' column='F_ATTACH_ID' table='OA_FILE_FILES_ACC'
                                          operType="000"/>  
                                   <%}else{%>
                                       <oa:affixbut butName='请选择文件' column='F_ATTACH_ID' table='OA_FILE_FILES_ACC' />
                                   <%}%>
                                </td>
                            </tr>
                  <tr>
                                <th class="content_02_box_div_table_th">附件列表：</th>
                                <td class="content_02_box_div_table_td" colspan=3 id="_fileshow"></td>
                            </tr>
                </table>
            </div>
        </div>      
