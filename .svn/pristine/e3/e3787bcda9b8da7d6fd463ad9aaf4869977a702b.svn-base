...
function initFileNumUnit(){
	jQuery("#OA_FILE_DOC__F_FILE_NUM_UNIT OPTION[value!='5']").remove();
	jQuery("#OA_FILE_DOC__F_FILE_NUM_UNIT_NAME").val("盘");
}
				...
				<div class="content_02_box_div" style="width: 98%;">
					<table border="0" cellspacing="0" cellpadding="0"
						class="content_02_box_div_table" style="width: 100%;">
							...
							<tr><%--row5--%>
								<th class="content_02_box_div_table_th">刻录人：</th>
								<td class="content_02_box_div_table_td"><oa:input
										type="text" column="F_BURN_USER_ID" table="OA_FILE_DOC"
										other="class='input_cx_title_240'" />
								</td>
								<th class="content_02_box_div_table_th"><span
									class="color_red">*</span>刻录时间：</th>
							...
							<tr><%--row6--%>
                                ...
                                <td class="content_02_box_div_table_td"><oa:input
                                    ...
                                    （单位：<oa:select column="F_FILE_NUM_UNIT" table="OA_FILE_DOC"
                                        ...
                                        other="style='width:100px'"></oa:select>）
                               		<script>
								//jQuery("#OA_FILE_DOC__F_FILE_NUM_UNIT").find("OPTION[value!='1']").remove();<%--件--%>
									</script>
                                </td>
							</tr>
							<tr><%--row7--%>
							...
							<tr>
								...
								<td class="content_02_box_div_table_td">
									...
									<script>
									jQuery("#OA_FILE_DOC__F_ENTITY_TYPE").find("OPTION[value!='3']").remove();<%--照片文件.信息类型==照片--%>
									</script>
								</td>
							</tr>
							<th class="content_02_box_div_table_th"><span
