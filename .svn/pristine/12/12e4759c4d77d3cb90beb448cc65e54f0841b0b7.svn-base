...
/**
 *<p>Title:DevAccountList.java</p>
 *<p>Description:设备台帐列表</p>
 ...
 *2014-3-3
 */
public class DevAccountInfoList  extends DataInfoImpl{
	
	private static final Log LOG=LogFactory.getLog(DevAccountInfoList.class);
	 /** 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	  * @param parmjson
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = devaccountinfodao.selDevAccountList(parmjson, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
