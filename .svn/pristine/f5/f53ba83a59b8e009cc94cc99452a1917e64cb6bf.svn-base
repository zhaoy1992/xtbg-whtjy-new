...
<%
	String PK_GENERATAL_STR = "主键将在保存时自动生成";
	...
	//新维护两个字段
	String data_name_cn = dicttype.getField_name_cn() == "" ? "名称"
			: dicttype.getField_name_cn();
	String data_value_cn = dicttype.getField_value_cn() == "" ? "真实值"
		...
		<form name="form1" method="post">
			...
			<table cellspacing="1" cellpadding="0" border="0" width=98%
				...
				<tr>
					...
					<td height='30' colspan="1">
						<input name="newbt" type="button" class="input" value="保存"
							onclick="saveit()">
						<input name="advance_newbt" type="button" class="input" value="关闭"
