...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.tjy.officesupplies.list.OsChukuTzList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		colNames: ['主键ID','申购计划ID','物品分类ID','物品分类','物品id','物品名称','物品规格id','物品规格','出库人id','出库人','出库时间','出库数量'],
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<span style='color: red;'>出库总数：<span id='count_data'></span></span>
								</td>
							</tr>
						</table>
						<!-- 固定查询 end-->
					...
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable" id="hiddenArea" style="display:none">
							<!-- 正规 4列 -->
							<tr>
								<th class="input_cx_title_th">出库时间：</th>
							...
							<tr>
								<th class="input_cx_title_th">出库人：</th>
								<td  class="cx_title_td">
