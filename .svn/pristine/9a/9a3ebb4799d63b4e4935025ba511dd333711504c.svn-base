...
%>
	...
	<script src="<%=path%>/ccapp/oa/resources/plug/ifrom/js/ifrom-tools.1.1.js" type="text/javascript"></script>
	...
	var setting = {
		async: {
	    	enable: true,//启用异步加载
	    	url: window.top.getContextPath() + '/commonTreeServlet?classNameId=com.chinacreator.xtbg.core.process.processconfig.dao.impl.Tjy_FlowInfoTree', 
...
<input type="hidden" id="action" name="action" value="deleteType"></input>
	<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="gongwen">		
		<tr>
	    <td height="30" class="gwlink">选择事务类型</td>
	  	</tr>
		<tr>
		  	<td>
