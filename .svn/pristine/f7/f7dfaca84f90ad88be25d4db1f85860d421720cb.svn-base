...
<html>
	<head>
		...
		function editUserMessageResource(r_id, r_state) {
			var retx=window.showModalDialog("<%=request.getContextPath()%>/message/sysmanager/editusermessageresource.jsp?r_id="+r_id + "&r_state="+r_state,window);
			if(retx=='refresh'){
		...
		<div id="contentborder" align="center">
			<form name="MessageResourceForm" id="MessageResourceForm" action="usermessageresourcelist.jsp" method="post">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<pg:listdata
						dataInfo="com.chinacreator.message.menu.UserMessageResourceList"
