...
/**
 *<p>Title:ViewAnswersList.java</p>
 *<p>Description:有问必答查看列表</p>
 ...
 *2015-2-3
 */
public class ViewAnswersList extends DataInfoImpl{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(ViewAnswersList.class);
	/**
	 * 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = fInfodao.findViewAnswersList(workFlowSearchBean, sortName, sortOrder, offset, maxPagesize);
