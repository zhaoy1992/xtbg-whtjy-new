...
import com.chinacreator.xtbg.tjy.officesupplies.entity.OsupplieUseType;
...
public class OsupplieUseTypeServiceImpl implements OsupplieUseTypeService{
	...
	public Map<String, String> getOsupplieUseTypeBean(String ofus_id) {
		...
		try {
			...
			OsupplieUseTypeDao osupplieusetypedao=(OsupplieUseTypeDao)LoadSpringContext.getApplicationContext().getBean("osupplieusetypedaoimpl");
	  ...
	  * @param bean
	  * @return 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.service.OsupplieUseTypeService#insertOrUpdateOsUserTypeBean(com.chinacreator.xtbg.tjy.officesupplies.entity.OsupplieUseType) 
	  */
	@Override
	public String insertOrUpdateOsUserTypeBean(OsupplieUseType bean) {
		...
		try {
			conn = DbManager.getInstance().getTransactionConnection();
			OsupplieUseTypeDao dao=(OsupplieUseTypeDao)LoadSpringContext.getApplicationContext().getBean("osupplieusetypedaoimpl");
