				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								<!-- 
								<li><a href="#tabs-1">固定资产发放</a></li> -->
								<li><a href="#tabs-2">易耗品发放</a></li>
							</ul>
						</div>
						<!-- 
						<div id="tabs-1" >
							<iframe src="osnomoveobjectlylist.jsp" id="frame1" frameborder="0"
								width="100%" height="500px" scrolling="no"></iframe>
						</div> -->
						<div id="tabs-2" >
							<iframe src="osmoreobjectlylist.jsp" id="frame2" frameborder="0"
