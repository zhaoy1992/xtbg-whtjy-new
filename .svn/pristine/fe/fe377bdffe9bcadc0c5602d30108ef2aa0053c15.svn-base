...
<%
	String is_public = request.getParameter("is_public");	//个人通讯录为0，公共通讯录为1
%>
<html>
<head>
...
<script>
	...
	function Ok(){
		...
		form1.action="addressbookimportdo.jsp?is_public=<%=is_public%>&wdo=batch";
		$("#form1").submit();
	}
	 ...
	 */
	function setChange(){
		var hrefPath="/ccapp/oa/personwork/excel/";
