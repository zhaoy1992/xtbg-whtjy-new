...
<script language="JavaScript">
	...
	function goBack(){		
		document.location.href="<%=rootpath%>/sysmanager/schedularmanage/daySchedular.jsp";
	}
	...
	function modify(checkName){
		...
		document.forms[0].action="<%=rootpath%>/sysmanager/schedularmanage/action/schManager.jsp?method=getModifySchedular&path=latest";
	...
	function view(checkName){	
		...
		document.forms[0].action="<%=rootpath%>/sysmanager/schedularmanage/action/schManager.jsp?method=getSchedularAndRemind&path=latest";
		document.forms[0].submit();
	}
	function history(checkName){
		...
		document.forms[0].action="<%=rootpath%>/sysmanager/schedularmanage/action/schManager.jsp?method=history&path=latest";
		document.forms[0].submit();
	}
	...
	function dealRecord(checkName,dealType) {
	    if(!validatecheck(checkName))
		{
	    	...
	    	if (dealType==1){
	        	...
	        	if (confirm(outMsg)){
		        	Org.action="<%=rootpath%>/sysmanager/schedularmanage/action/schManager.jsp?method=deleteSchedular&path=latest";
					Org.submit();
			 		return true;
				}
			} 
