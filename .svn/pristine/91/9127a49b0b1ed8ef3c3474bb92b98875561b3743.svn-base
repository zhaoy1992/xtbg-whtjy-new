...
function myWordTemplateTaohong(busiTypeCode){
   ...
   function creatorFwzh(mb_mc){
		var busiTypeCode = jQuery("#busiTypeCode").val();
		if(action_defid==""&&busiTypeCode=="uuid-1101"){
			var myDate = new Date();
...
<LI style="WIDTH: 124px; DISPLAY: list-item; BACKGROUND: white; MARGIN-RIGHT: -1.5px" id=bce9dbc9-49e7-4b53-9b3f-7faf0cc9ad19 class=gs_w data-sizey="3" data-sizex="4" data-row="21" data-col="1"><oa:span style='font-size: 15px; color: red; padding-left: 23%; line-height: 90px;' column='null'  table='' value= '附件' /></LI>
<LI style="DISPLAY: list-item; BACKGROUND: white" id=d43edb15-4852-4ebe-8dc9-48ae31ff4401 class=gs_w data-sizey="3" data-sizex="8" data-row="21" data-col="5"><input type='hidden' id='field_drag_in_attach' value='OA_FILE_FAWEN__T_FJ_ID'/><oa:affixbut butName='请选择文件' column='T_FJ_ID' table='OA_FILE_FAWEN'  title ='' operType='111' initFjDJBHForArchive ='<%=drag_in_attach%>' />
<br/><br/><span style="width: 250px;height:60px;float: left;color: red;font-weight:bold;" >附件列表仅保存传阅性附件不能编辑或审批只能查阅。若要上传待审批的附件请将附件内容粘贴在正文后面。</span>
</LI>
<LI style="WIDTH: 124px; DISPLAY: list-item; BACKGROUND: white; MARGIN-RIGHT: -1.5px" id=5f9f9244-ac1d-4876-9d13-6d735dd302ca class="gs_w player-revert" data-sizey="3" data-sizex="4" data-row="21" data-col="13"><oa:span style='color:red;font-size: 15px; padding-left: 23%; line-height: 90px;' column='null'  table='' value= '附件列表' /></LI>
<LI style="DISPLAY: list-item; BACKGROUND: white" id=16fa33e8-28eb-4775-b366-368a0bb886be class=gs_w data-sizey="3" data-sizex="14" data-row="21" data-col="17"><oa:affixshow  title ='' style='height:80px;line-height:80px; background-color: white;' 
										ulstyle='overflow-y: auto;overflow-x:hidden;height:80px;line-height:80px;margin:4px ;padding-left:10px;background:white;border:0px;max-height:80px;background:white;border:0;' /></LI>
<LI style="DISPLAY: list-item; BACKGROUND: white" id=ef0a3c7a-b199-4c97-8dbc-860a1a9894c9 class=gs_w data-sizey="1" data-sizex="4" data-row="24" data-col="1"><oa:span style='font-size: 15px; color: red; padding-left: 23%; line-height: 30px;' column='null'  table='' value= '主题词' /></LI>
<LI style="DISPLAY: list-item; BACKGROUND: white" id=df28c598-bf34-4947-a1a7-c3af54e7a930 class=gs_w data-sizey="1" data-sizex="26" data-row="24" data-col="5"><oa:input title='' type='text' column='FW_KEYWORDS' table='OA_FILE_FAWEN' style= 'width: 90%;border: 0px;line-height:26px; height:26px;padding-left:10px;' value = ''/></LI>
<LI style="DISPLAY: list-item; BACKGROUND: white" id=084932db-18a7-407e-9fc6-3ae41587519e class=gs_w data-sizey="2" data-sizex="4" data-row="25" data-col="1"><oa:span style='font-size: 15px; color: red; padding-left: 23%; line-height: 60px;' column='null'  table='' value= '标题' /></LI>
<LI style="DISPLAY: list-item; BACKGROUND: white" id=915110d4-bd19-4e3f-9315-8ad7575304ab class=gs_w data-sizey="2" data-sizex="26" data-row="25" data-col="5"><input type='hidden' id='field_drag_in_title' value='OA_FILE_FAWEN__TITLE'/><oa:input title='' type='text' column='TITLE' table='OA_FILE_FAWEN' style= 'width: 90%;border: 0px;line-height:26px; height:50%;padding-top:16px;padding-left:10px;' value = '<%=drag_in_title%>'/></LI>
