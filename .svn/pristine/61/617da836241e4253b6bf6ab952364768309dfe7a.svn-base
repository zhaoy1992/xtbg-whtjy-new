...
function loadOsAppItemObject(OsAppIds){
	var url = "<%=path %>/ccapp/xtbg/tjy/canteenitemssupplies/jsp/getbackosexaobjectajax.jsp";
...
function choseOsExa(){
	var path ="<%=path%>/ccapp/xtbg/tjy/canteenitemssupplies/jsp/osexaovernohavalist.jsp?windowsId=windowIds2";
