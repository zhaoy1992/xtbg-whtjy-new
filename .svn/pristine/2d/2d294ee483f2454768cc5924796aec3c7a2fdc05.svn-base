...
<%
	...
	String strWhere = " and (d.dictdata_value='"
			+ PaperConstants.STATUS_PENDING + "' or d.dictdata_value='"
			+ PaperConstants.STATUS_UNACCEPT
			+ "' or d.dictdata_value='" + PaperConstants.STATUS_ACCEPT
			+ "') ";
...
//搜索框的控制对象
$(function() {
	//树控件选择 --------------------2013-12-06 ---------begin
	$("#p_rep_unit_name").click(function(){
		chooseOrg();
	});
	//树控件选择 --------------------2013-12-06 ---------end
       ...
       //表头设置       
        ...
        onCellSelect:function (id,icol)
		{
        	if(icol != 0)
			{
        		...
        		urlTmp = "&loadurl=paperlist4acc&actionName=update2acc&p_manage_id="+model.p_manage_id;
				toNewPage(urlTmp,"修改");
			}
		}
    });
				...
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<!-- 敏感字符的问题 -->
							<td width="200" class="cx_title_td" style="padding-left:4px;"><input type="text"
								id="p_rep_title" name="p_rep_title" class="input_cx_title_283"
								style="width: 133px;" /></td>
							<th width="90" class="input_cx_title_th">信息类型：</th>
							<td width="200" class="cx_title_td" style="padding-left:5px;"><%=p_rep_title_selectHtml%>
							</td>
							<th width="90" class="input_cx_title_th">上报单位：</th>
							<td width="200" class="cx_title_td"><input type="text"
								class="input_cx_title_150" id="p_rep_unit_name" name="p_rep_unit_name"
								readonly  style="width:133px;" /> <input type="hidden"
								id="p_rep_unit_id" name="p_rep_unit_id"></td>
						</tr>
						<tr>
							<th width="90" class="input_cx_title_th">上报日期：</th>
							<td width="300" class="cx_title_td" colspan=3 style="padding-left:4px;"><input id="begin_time"
								name="begin_time"
		...
		<table width="100%" style="margin-left: 0" class="tabs_search_ctable_box">
			<tr>
				<td width="100%" align="left" valign="top">
					<input name="BatchAcc" value="信息采编" type="button" onclick="btnClickFn(this)" class="but_y_01" /><span style="width:5px;display:block;float:left;">&nbsp;</span>
				</td>
			</tr>
			<tr>
				<td width="100%" align="left" valign="top">
