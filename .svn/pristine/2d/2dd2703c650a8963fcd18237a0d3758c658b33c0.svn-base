 ...
 *2012-03-01
 */
public class DetailAlreadList implements DataInfoImpl,java.io.Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(DetailAlreadList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = daojson.findDetailAlreadList(instanceBean, sortName, sortOrder, offset, maxPagesize);
