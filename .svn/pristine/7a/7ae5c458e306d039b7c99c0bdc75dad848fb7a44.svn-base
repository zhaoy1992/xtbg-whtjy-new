...
<%@ page
	...
	com.chinacreator.sysmgrcore.entity.Organization,com.chinacreator.sysmgrcore.entity.User,
...
<%@ page import="com.chinacreator.sysmgrcore.web.tag.OrgSubUserList"%>
...
<%
			...
			UserSearchList uselist = new UserSearchList();
	...
	<head>
        ...
        {			
			...
			for(var i = 0; i < userinfoArray.length; i ++ )
			{
				...
				frame.addone("allist",userinfo[0]+" "+userinfo[1],userinfo[0]);				
			}
