 ...
 *2013-6-20
 */
public class NoticeViewList extends DataInfoImpl{

	private static final Logger LOG = Logger.getLogger(NoticeViewList.class);
	/**
	 * 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = noticeBaseInfoDao.selNoticeViewList(parmjson, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
