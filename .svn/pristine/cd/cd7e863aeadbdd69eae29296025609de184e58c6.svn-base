 ...
 * date 2012-1-31
 */
public class AppStoreList implements DataInfoImpl {

	private static final Logger LOG = Logger.getLogger(AppStoreList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = daojson.findAppStoreList(appStoreBean, sortName, sortOrder, offset, maxPagesize);
		}catch (Exception e) {
			LOG.error(e);
		}
		return pb;
