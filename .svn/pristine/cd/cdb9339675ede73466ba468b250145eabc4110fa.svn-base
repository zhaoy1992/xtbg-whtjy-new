...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.canteenitemssupplies.list.OsupplieUseTypeList";
...
var toUserParamJosn = function() {
	var str = "{'ofustype_name':'" + StringCheck($("#ofustype_name").val()) +"','unit_id':'<%=unit_id%>'}";
...
var addLevel = function() {
 	var pageName ="添加常用物品";
	openAlertWindows('windowId',"../../../tjy/canteenitemssupplies/type/jsp/osupplieusetypeinfo.jsp?windowsId=windowId&actionName=insert",pageName,500,175,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改常用物品";
	openAlertWindows('windowId','../../../tjy/canteenitemssupplies/type/jsp/osupplieusetypeinfo.jsp?windowsId=windowId&actionName=update&ofustype_id='+ model.ofustype_id+'&ofustype_id='+model.ofustype_id,pageName,500,175,'25%','25%');
}
...
var delLevel = function(id) {
	...
	$(selectedIds).each(function () {
		...
		if(!IsSpace(model.ofustype_id)){
			idsArrTemp.push(model.ofustype_id);
		}
	});
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								<th width="90" class="input_cx_title_th" >物品名称：</th>
								<td width="296"  class="cx_title_td">
								<input type="text" id="ofustype_name" class="input_cx_title_283" >
								</td>
...
<form id="delForm2" name="delForm2" method="post" action="osupplieusetypeinfodo.jsp">
	...
	<input type="hidden" name="action" value="deleteOsupplieTypeInfo">
</form>
