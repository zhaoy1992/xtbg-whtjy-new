...
import com.chinacreator.xtbg.tjy.officesupplies.dao.OsapPlanItemDao;
import com.chinacreator.xtbg.tjy.officesupplies.entity.OsapPlanItem;
import com.chinacreator.xtbg.tjy.officesupplies.service.OsapPlanItemService;
...
public class OsapPlanItemServiceImpl implements OsapPlanItemService{
	...
	public List<Map<String, String>> getOsapPlanItemBean(String it_planid) {
		...
		try {
			...
			OsapPlanItemDao osapplanitemdao=(OsapPlanItemDao)LoadSpringContext.getApplicationContext().getBean("osapPlanItemDaoImp");
	  ...
	  * @param bean
	  * @return 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.service.OsapPlanItemService#insertOrUpdateOsapPlanItem(com.chinacreator.xtbg.tjy.officesupplies.entity.OsapPlanItem) 
	  */
	@Override
	public String insertOrUpdateOsapPlanItem(OsapPlanItem bean) {
		...
		try {
			conn = DbManager.getInstance().getTransactionConnection();
			OsapPlanItemDao dao=(OsapPlanItemDao)LoadSpringContext.getApplicationContext().getBean("osapPlanItemDaoImp");
