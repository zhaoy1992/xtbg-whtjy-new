...
<div id="contentborder" style="width:100%;height:495;overflow:auto">
    ...
    <table >
    	<tr>
    	<td><input name="roleid" type="radio" value="globalrole:globalrole:global"/> 角色全局资源</td>
    	</tr>
        <tr><td>
         <tree:tree tree="selectrolenode"
    			   ...
    			   <tree:treedata treetype="com.chinacreator.sysmgrcore.purviewmanager.menu.ChargeRoleTypeTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="角色类型树"
    	                   expandLevel="1"
