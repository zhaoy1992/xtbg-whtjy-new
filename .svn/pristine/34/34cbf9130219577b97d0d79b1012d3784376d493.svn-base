...
<html>
	<head>
		<title>属性容器</title>
		<script language="javascript" src="../../../../purviewmanager/scripts/dragdiv.js"></script>
					...
					<tr class="tabletop">
						...
						<tr class="tr">
							<td colspan="3" class="td" align="center">
								<input type="button" name="back" value="关闭" class="input" onclick="removeAlertWindows('',true)"/>
							</td>
						</tr>
					</table>
				</form>
