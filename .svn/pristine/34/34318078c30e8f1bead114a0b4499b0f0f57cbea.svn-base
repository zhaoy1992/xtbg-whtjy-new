...
<%
	...
	String url = "../grantmanager/operList_global.jsp?resTypeId=role&currRoleId="+ roleId + "&role_type=role";
	String lefturl = "../grantmanager/rolesetTree.jsp?resTypeId=role&currRoleId="+ roleId + "&role_type=role";
%>
