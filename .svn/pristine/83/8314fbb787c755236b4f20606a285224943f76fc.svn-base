...
import com.chinacreator.xtbg.suxian.electroniccheck.entity.BriefsEditorBean;
...
public class ElectViewList  implements DataInfoImpl{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(ElectViewList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			ElectViewDao daojson= (ElectViewDao)DaoImplClassUtil.getDaoImplClass("electViewDaoImpls");
			pb = daojson.findViewList(announcementBean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
