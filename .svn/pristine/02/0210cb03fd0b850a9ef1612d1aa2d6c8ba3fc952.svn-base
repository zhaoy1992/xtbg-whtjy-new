...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.tjy.answers.list.ToBeAnswersList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		colNames: ['实例id','业务id','环节实例id','ccformid','流程定义ID','办件编号 ', '标题 ','业务类型CODE','问题类型 ','提出人 ','提出时间', '当前环节 ', '表单','模板ID'],
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable_box">
				<tr>
					...
					<!-- 隐藏查询 -->
					   ...
					   <tr>
					   <th class="input_cx_title_th">提问者：</th>
