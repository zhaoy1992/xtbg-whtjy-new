...
$(function() {
    ...
    $("#gridTable").jqGrid({
        url: path+"/pubListServlet?classNameId=com.chinacreator.xtbg.core.inspect.list.InspectReportList", 
    ...
    var toUserParamJosn = function(){
        var str ="{'user_orgid':'<%=unitId%>','inspect_state':'"+$('#inspect_state').val()
     		+"','inspect_name':'"+$('#inspect_name').val()
     		+"','plan_endtime':'"+$('#plan_endtime').val()
     		+"','send_time':'"+$('#send_time').val()
     		+"','inspect_type':'"+$('#inspect_type').val()+"'}";
    ...
    var inspectSearch = function() {
        var sdata = { //构建查询需要的参数 
      		...
      		$("#gridTable").jqGrid("setGridParam", {
      			inspectSearch: true ,// 将jqGrid的search选项设为true  
                ...
                <table id="searchTable" style="width:830px;" border="0" cellspacing="3" cellpadding="0" >
                    <tr>
                        ...
                        <td style="width:200px;">
                            <input value="搜索" id="sel" type="button" onclick="inspectSearch();" class="but_y_01" />
                        </td>
                    </tr>
                    <tr>                          
                          ...
                          <th  class="input_cx_title_th" style="width:90px;">任务状态：</th>
