...
<%@page import="com.chinacreator.xtbg.core.common.cache.dao.impl.UserCacheDaoImpl"%>
		...
		colModel: [ //最重要的数组之一，用于设定各列的参数
    		...
    		},
    		{
    			...
    			formatter : function(value,column,model){
					...
					+" onMouseOut=javascript:$(this).attr('class','but_y_01');  type='button' onclick='sendArchive(\""+id+"\")' value='收文处理'/>";
    			}
    		}
		],
...
var sendArchive = function(id){
	...
	var width = window.screen.availWidth;
	url = [
		'<%=path%>/ccapp/oa/archive/gwcs/gwreceivehandledo.jsp',
