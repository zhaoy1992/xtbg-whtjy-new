...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.device.list.DevCheckInfoList";
	String path = request.getContextPath();
%>
<title>核查记录列表界面</title>
<!-- 公共部分开始 -->
<!-- 引入jQuery -->
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID', '设备编号 ','设备名称', '规格型号','检查日期','责任人','备注'],
...
var addLevel = function() {
 	var pageName ="新增检查记录";
	openAlertWindows('windowId',"../../../tjy/device/type/jsp/devcheckinfo.jsp?windowsId=windowId&actionName=insert",pageName,530,460,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改检查记录";
	openAlertWindows('windowId','../../../tjy/device/type/jsp/devcheckinfo.jsp?windowsId=windowId&actionName=update&id='+ model.id,pageName,530,460,'25%','25%');
}
...
<form id="delForm2" name="delForm2" method="post" action="devcheckinfodo.jsp">
