...
<DIV id=div1 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; LEFT: 0px; OVERFLOW: auto; BORDER-LEFT: black 1px solid; WIDTH: 485px; BORDER-BOTTOM: black 1px solid; POSITION: static; TOP: 0px; HEIGHT: 351px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="div" NotBg="否">
...
if(typeof(retcm[0].getCount)!='undefined') sm = retcm[0] ;
 ExtGrid1 = new Ext.grid.GridPanel({
	...
	width: '100%',
					height: eval(parseFloat(document.getElementById('div1').style.height)*(parseFloat('115')))/100-60,
		split: true,
		region: 'north',
		title:'43434',
		frame:true
