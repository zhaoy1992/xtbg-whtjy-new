 ...
 * [Product]
  ...
  *     -------- --------- ---------- ------------------------
   ...
   */
package com.chinacreator.xtbg.tjy.processing.list;
...
/**
 * 
 *<p>Title:DoneDeWorkList.java</p>
 *<p>Description:已办列表</p>
 ...
 *2013-4-22
 */
public class DoneDeWorkList extends DataInfoImpl{

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(DoneDeWorkList.class);
