...
var updateactuvuty = function(id) {
	...
	var url = "<%=path%>/ccapp/xtbg/caizhengting/ibrary/jsp/ibraryborrowadd.jsp?subid=queryinfo&whereForm=1&t_regb_id="+model.t_regb_id;
...
<table width="100%" style="margin-left: 0" class="tabs_search_ctable_box">
	...
	<tr>
		...
		function toParamJosn(){
			...
			var str = "{'whatTabs':'1','sq_start_time':'"+sq_start_time+"','sq_end_time':'"+sq_end_time+"','t_regb_dept_id':'<%=dept_id%>'}";
