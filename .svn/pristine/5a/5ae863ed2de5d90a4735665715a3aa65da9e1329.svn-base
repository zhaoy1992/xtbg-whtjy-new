...
<head>
	...
	<script type="text/javascript" language="Javascript">
		function okadd(){	
			selectNode = document.all.item("jobresid");
...
<div id="contentborder" style="width:100%;height:495;overflow:auto">
    ...
    <table >
    <tr>
    	<td><input name="jobresid" type="radio" value="globaljob:globaljob:global"/> 岗位全局资源</td>
    	</tr>
        ...
        <tr><td>
         <tree:tree tree="selectmenunode"
    			   ...
    			   target="abc"
    			   mode="static-dynamic">  			                           
				   <tree:radio name="jobresid"/>
				   
				   <tree:param name="restypeId" />
				   
    			   <tree:treedata treetype="com.chinacreator.sysmgrcore.purviewmanager.menu.ResSelectJobTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="岗位树"
    	                   expandLevel="1"
