...
<%AccessControl accesscontroler = AccessControl.getInstance();
			...
			List hasOper = operManager.getOperResRoleList(role_type, roleid,
					resid, resTypeId);
			if (list == null) {
				list = new ArrayList();
			}
				...
				<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" class="thin">
					...
					<tr>
						<td height='30' colspan="3">
							<LEGEND align=left>
								<strong><FONT size=2>授予操作项</FONT></strong>
							</LEGEND>
						</td>
					</tr>
					<%boolean flag1;
					...
					if (flag1 == true) {%>
							<tr>
						<td>
							<input type="checkBox" hideFocus=true name="checkBoxAll" onClick="checkAll('checkBoxAll','alloper')" checked disabled="true">
						</td>
						<td>
							>>>>全选
						</td>
						<td>
							&nbsp;
							<input name="isRecursion" onclick="" type="checkbox" checked disabled="true">
							递归授权子站点
						</td>
					</tr>
					...
					{%>
						...
						<td>
							&nbsp;
							<input name="isRecursion" onclick="" type="checkbox">
							递归授权子站点
						</td>
					</tr>
					<pg:list requestKey="operList" needClear="false">
