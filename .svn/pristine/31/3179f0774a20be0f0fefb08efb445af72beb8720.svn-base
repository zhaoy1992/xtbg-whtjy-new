...
var userId = "<%=StringUtil.deNull(userId) %>";//用户id
    ...
    jQuery(function(){    	
      ...
      //实物类型默认选中 纸质
        jQuery("#OA_FILE_FILES__F_ENTITY_TYPE option[value=2]").attr("selected","selected");
...
function joinHtml(){
      var html = [
        '<div style="width:100%;">',
        '<table style="width:100%;font: normal 16px/29px \'宋体\';background-color: #000;" border="0" cellspacing="1" cellpadding="0" >',
        '<tr style="height:55px;">',
        '<td style="width:25%;text-align: center;letter-spacing:12px;background-color: #fff">册卷号</td>',
        ...
        '</tr>',
        '</table>',
        '<table style="width:50%;font: normal 16px/29px \'宋体\';float: right;background-color: #000;',
...
function backHtml(){
   ...
   'text-align:center;width:60px;font: normal 16px/29px \'宋体\';border:7px solid #0099CC;',
   ' color:#3F9CC9;font-weight: bold;" cellspacing="0" cellpadding="0" >',
   '<tr><td style="height:7px;border-bottom:2px solid #0099CC;"></td></tr>',
   '<tr>',
   '<td style="border-bottom:2px solid #0099CC;height:250px;" valign="middle" align="center">',
   '   <span style="text-align:center;display:inline;width:20px;font-size:20px;line-height:25px;">',
   jQuery("input[id$=__F_ORG_NAME]").val(),
   '</span>',   
   '</td>',
   '</tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;">全宗号</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;color:#000;">',
   jQuery("select[id$=__F_FONDSNO]").val(),
   '</td></tr>',
   '<tr><td style="height:40px;border-bottom:2px solid #0099CC;text-align:center;line-height: 20px;">',
   ...
   jQuery("select[id$=__F_DOC_DEADLINE] option:selected").text(),
   '</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;">目录号</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;color:#000;">',
   jQuery("input[id$=__F_LISTNO]").val(),
   '</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;">案卷号</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;color:#000;">',
   jQuery("input[id$=__F_FILESNO]").val(),
   '</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;">年&nbsp;度</td></tr>',
   '<tr><td style="height:30px;border-bottom:2px solid #0099CC;text-align:center;color:#000;">',
   jQuery("input[id$=__F_DOC_YEAR]").val(),
   '</td></tr>',
   '<tr>',
   '<td style="border-bottom:2px solid #0099CC;height:180px;" valign="middle" align="center">',
   '   <span style="text-align:center;display:inline;width:20px;line-height:25px;">',
   '<%=typeName%>',
   '   </span>',
   '</td>',
   '</tr>',
