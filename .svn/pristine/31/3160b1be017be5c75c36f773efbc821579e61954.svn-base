...
var bu_name = creator_getQueryString("bu_name"); //执法文体名称
 ...
 */
 function WSLBList() {
     ...
     window.frames["wslbListId"].wslbReload();
 }
...
function submitInformedOrServed() {
    if (confirm("确认结束本阶段?")) {
        var IsInformed = PunishInformed.checkIsInformed(wftId, ndpId);
        if(IsInformed.length > 0) {
           var msg = "如下原因导致不能提交！\n\n";
           for(var i = 0; i < IsInformed.length; i++) {
               msg += "["+IsInformed[i][1]+"] 没有登记回执 \n";
           }
           alert(msg);
           return;
        }
        ...
        tpVo.WFT_ID = wftId; //处罚事项实例ID
        tpVo.NDP_ID = ndpId; //阶段ID
        tpVo.TP_POSTIL = ""; //批注
        tpVo.TP_SYS = ""; //系统批注
        tpVo.TP_STATUS = 1; //状态
        tpVo.TP_EMY = getSysElement("userid"); //批注人
        tpVo.TP_FW_NAME = "";//归属部门
        tpVo.TP_ES_NAME = "";//归属岗位
        tpVo.TP_EMY_SET = "";//批注人组
        tpVo.ISPLATFORM = 0;//是平台结点
        tpVo.SU_ID_INNER = bu_id;//业务单位内码
        tpVo.TP_SYSUNIT_NAME = bu_name;//执法主体
        tpVo.SEGMENT_ID = "";//环节码
        tpVo.TP_INFO = "0";//补充资料
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();init();" contxml="<root><div><id>div1</id><id>div2</id></div><button><id>saveTempBtn</id><id>listBtn</id><id>submitBtn</id><id>rebackBtn</id></button><text><id>ndpId</id></text><creatorSubForm><id>wslbListId</id><id>DJHZListId</id></creatorSubForm></root>" billtaborder="<root><taborder>saveTempBtn</taborder><taborder>listBtn</taborder><taborder>submitBtn</taborder><taborder>rebackBtn</taborder><taborder>ndpId</taborder></root>" dj_sn="20100914085437918144" caption="处罚告知" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:6;label:0;radio:1;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:1;DsMain_field:0;a:0;button:0;text:1;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:0;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName="app_xzcf" creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="否" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100902181230265751" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Common.js&#13;&#10;../../../ccapp/app_xzcf/js/business/PunishInformed.js&#13;&#10;../../../ccapp/app_xzcf/js/dao/PunishInformedDao.js&#13;&#10;../../../ccapp/app_xzcf/js/util/DateUtil.js&#13;&#10;../../../ccapp/app_xzcf/js/util/WorkflowUtil.js&#13;&#10;../../../ccapp/app_xzcf/js/vo/publicVO.js">

<TABLE style="POSITION: static" cellSpacing=2 cellPadding=1 width="98%" align=center border=0>
   <TBODY>
      <TR>
         <TD>
            <TABLE width="100%">
               <TBODY>
                  <TR>
                     <TD id=punishTitle><INPUT id=ndpId style="DISPLAY: none; LEFT: 0px; WIDTH: 110px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly controltype="text"></TD>
                     <TD align=right><BUTTON class=button id=saveTempBtn style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("WSLBList();")'>文书列表</BUTTON><BUTTON class=button id=listBtn style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("DJHZList();")'>登记回执</BUTTON><BUTTON class=button id=submitBtn style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("submitInformedOrServed();")'>提交</BUTTON><BUTTON class=button id=rebackBtn style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("WorkflowUtil.backToWorklist();")'>返回</BUTTON></TD>
                  </TR>
               </TBODY>
            </TABLE>
         </TD>
