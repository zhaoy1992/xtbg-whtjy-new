...
//默认光标停留在文档标题输入框
	...
	<body class="info"  onload="">
		...
		<table width="100%" height="25" border="0" cellpadding="0" cellspacing="1" class="thin">
			...
			<tr>
				<td height="25" class="detailtitle" width="23%"><strong>登陆名称</strong></td>						
				<td height="25">
		   ...
		   <tr>
				   ...
				   <td height="25" class="detailtitle"><strong>申请服务类别</strong></td>
				   <td height="25">
				  				<dict:select style="width:100px" dictTypeName="serviceType" name="serviceType" defaultValue="A" value="<%=user.getServiceType()%>"/>
				   </td>	
			  	   </tr>
					<tr>
						<td height="25" class="detailtitle">
							<strong> 申请服务资源</strong>
						</td>
						<td colspan=3 height="25">
							<textarea name="res"  cols="40" rows="2" defaultValue=""><pg:cell colName="res" defaultValue=""/></textarea>
						</td>
					...
					<tr>
						...
						<td colspan=3 height="25">
							<textarea name="question"  cols="40" rows="2" defaultValue=""><pg:cell colName="question" defaultValue=""/></textarea>
						</td>
					...
					<tr>
						...
						<td colspan=3 height="25">
							<textarea name="answer"   cols="40" rows="2" defaultValue=""><pg:cell colName="answer" defaultValue=""/></textarea>
						</td>
					</tr>
					<tr>
						<td height="25" class="detailtitle">
						...
						<td colspan=3 height="25">
							<textarea name="enterpriseLinkman"   cols="40" rows="2" defaultValue=""><pg:cell colName="enterpriseLinkman" defaultValue=""/></textarea>
						</td>
					...
					<tr>
						...
						<td colspan=3 height="25">
							<textarea name="userAddress"   cols="40" rows="2" defaultValue=""><pg:cell colName="userAddress" defaultValue=""/></textarea>
						</td>
					</tr>
