...
public class CarManageCarYmjList implements DataInfoImpl{
	
	private static final Logger LOG = Logger.getLogger(CarManageCarYmjList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = carManageCarDao.findCarManageCarInfoList(carManageApplyinfoSearchBean, sortName, sortOrder, offset, maxPagesize);	
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
