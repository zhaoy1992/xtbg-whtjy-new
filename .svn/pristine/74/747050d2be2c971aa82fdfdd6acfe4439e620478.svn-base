...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%=path%>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.core.paper.list.PaperCountList',  
...
/*
	 ...
	 */
var toJson = function() {
	var str ="{'p_rep_unit_name':'"+$("#p_rep_unit_name").val()
...
*/
var upload = function() {
	var url = getCurrentFilePath()+"/ajaxexcecount.jsp?"  +"windowId=windowId_paperPS&sJson="+toJson(); 
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td width="150" class="cx_title_td"><input class="input_cx_title_150" type="text"  id="p_rep_unit_name" name="p_rep_unit_name" value="" />
						</td>
						<td  >
