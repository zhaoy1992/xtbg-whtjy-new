...
$(function() {
    ...
    $("#gridTable").jqGrid({
        ...
        url: '<%=path%>/pubListServlet?classNameId=com.chinacreator.xtbg.core.file.list.FileDocList', 
...
var addFileDocDetail = function () {
	  if(window.parent.role=="org"||window.parent.role=="dept"){
		  var typeurl = '<%=urlTmp%>';
			openAlertWindows('addFileDocDetailWindow', getCurrentFilePath() +f_file_detail+ '?'+typeurl+'&busi_id=&busiTypeCode=wj-001&windowId=addFileDocDetailWindow&userRole='+window.parent.role, '添加文件' ,1020,530,'10%','10%');
	  }else{
		var typeurl = '<%=urlTmp%>';
...
var toUserParamJosnA = function(objName,notEscape){
	if(window.parent.role=="org"||window.parent.role=="dept"){
    	...
    	param[objName+"userRole"] = parent.role;
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<th class="input_cx_title_th" style="width: 14%;">
									档案年份：
								</th>
								<td width="20%" class="cx_title_td">
									<input id="f_doc_year" name="f_doc_year" style="width: 95%;background:url(/xtbg/ccapp/oa/resources/style/blue/images/date_img_year.jpg) right 1px no-repeat;"
										class="date_120" type="text"
										onfocus="WdatePicker({dateFmt:'yyyy'})" />
								</td>
								<th style="width: 14%;" class="input_cx_title_th">
									所属部门：
								</th>
								<td width="20%" class="cx_title_td">
									<input type="text" id="f_dept_name" name="f_dept_name"
										class="input_cx_title_283" style="width: 95%;" />
								</td>
							</tr>
							<tr>
								<th style="width: 14%" class="input_cx_title_th">
								...
								<td width="10%" class="cx_title_td">
									<input type="text" id="f_doc_fontsize" name="f_doc_fontsize"
										class="input_cx_title_283" style="width: 93%;" />
								</td>
								<th class="input_cx_title_th" style="width: 14%;">
									文档标题：
								</th>
							...
							<tr>
								...
								<td valign="top" width="10%" class="cx_title_td">
									<div
										style="float: left; position: absolute; width: 24%; z-index: 2;">
										<%=selectData%>
									</div>
								</td>
								<th class="input_cx_title_th" style="width: 14%;">件号：</th>
										<td width="10%" class="cx_title_td">
											<input type="text" id="f_doc_num" name="f_doc_num" class="input_cx_title_283" style="width: 95%;" />
										</td>
								
							</tr>
							<tr>
							<th class="input_cx_title_th" style="width: 14%;"></th>
								<td width="10%">
									<input value="搜索" id="sel" type="button" onclick="search();"
										class="but_y_01" />
										<input value="重置" id="reset" type="button" class="but_y_01" style="margin-left: 15%"
										onclick='cleara()' />
									<script>
		                            cleara = function(){
										$('#f_doc_year').val("");<%--档案年份--%>
								...
								<th class="input_cx_title_th" style="width: 14%;"></th>
								<td width="10%">
					                <span id="selAreaImg" class="all_search_condition" style="margin-left: 0px;">
							...
							<tr>
						        ...
						        <table>
									<tr>
										<th style="width: 100px" class="input_cx_title_th">文件形成日期：</th>
									...
									<tr>
										<th  class="input_cx_title_th" style="width:100px;">备注栏(密级)：</th>
