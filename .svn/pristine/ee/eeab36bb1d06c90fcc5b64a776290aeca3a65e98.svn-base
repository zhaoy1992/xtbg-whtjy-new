...
<%
	...
	String is_fenyuan = "";
	if(org_level.equals("3")){//科室 
		org_id = "";
	}
	
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.officesupplies.list.OsAccountHistoryList";
	String path = request.getContextPath();
	
	String gdzc_id = request.getParameter("gdzc_id");
%>
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID','固定资产id','固定资产名','用户id','用户','部门id','部门','使用类型','使用时间','登记归还表id'],
...
var toUserParamJosn = function() {
	var str = "{'gdzc_id':'<%=gdzc_id%>','user_name':'"+StringCheck($("#user_name").val())+"','org_id':'<%=org_id%>'}";
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								<th width="90" class="input_cx_title_th" >用户名：</th>
