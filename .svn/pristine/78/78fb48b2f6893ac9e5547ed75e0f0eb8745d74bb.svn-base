...
$(function() {
	...
	//接收表
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/commonListServlet?classNameId=fuelCardmangeList',  //commonListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		colNames: ['car_id','车牌号','品牌','油卡卡号','油卡余额'],
...
var toUserParamJosn = function() {
	 var str = "{'car_num':'" + $("#car_num").val()
		 	+ "','car_brand':'" + $("#car_brand").val() 
		 	+ "','fuelcard_num':'" + $("#fuelcard_num").val()  
	 		+ "'}";
...
var viewCarinfo = function(id) {
	...
	var url = "<%=path%>/ccapp/xtbg/yimingju/carmanage/jsp/fuelCarinfo.jsp?car_id="+model.car_id;
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
				<tr>
					...
					<td  class="cx_title_td">
						<input class="input_cx_title_283" type="text" id="car_num" name="car_num" />
					</td>
			...
			<tr>
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable" id="hiddenArea" style="display:none">
						<tr>
							<th class="input_cx_title_th">品牌：</th>
							<td  class="cx_title_td">
								<input class="input_cx_title_283" type="text" id="car_brand" name="car_brand" />
							</td>
						</tr>
						<tr>
							<th class="input_cx_title_th">油卡卡号：</th>
							<td  class="cx_title_td">
								<input class="input_cx_title_283" type="text" id="fuelcard_num" name="fuelcard_num" />
							</td>
						</tr>
					</table>
						<!-- 隐藏查询 end-->
