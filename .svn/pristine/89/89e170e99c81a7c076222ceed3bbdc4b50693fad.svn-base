...
<SCRIPT LANGUAGE="JavaScript">
	...
	function okRecord(dealType) {
			...
			Form1.action="<%=rootpath%>/accessmanager/securityManager.do?method=siteAuthorization&isRecursion="+tt;
			Form1.submit();
...
<fieldset>
	   <LEGEND align=left><strong><FONT size=2>帮助</FONT></strong></LEGEND>
        ...
        %>
	    <table align=left><tr><td>必须对该资源（站点:<%=resname%>）授权才可以访问该资源，在没有授权的情况下不能访问该资源</td></tr></table>
        <%}%>
</fieldset>
<center>
