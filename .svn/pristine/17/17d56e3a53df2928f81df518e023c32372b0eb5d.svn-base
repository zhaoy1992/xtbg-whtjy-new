...
<title>申购计划</title>
	...
	function choseOsAppReg(){
		var path ="<%=path%>/ccapp/xtbg/tjy/canteenitemssupplies/jsp/osappoverexanoreglist.jsp?windowsId=windowIds";
	...
	function loadOsAppItemObject(OsAppIds,_busi_id){
		var url = "<%=path %>/ccapp/xtbg/tjy/canteenitemssupplies/jsp/getbackosappregobjectajax.jsp";
		...
		jQuery.ajax({
			...
			success: function(data){
				...
				for (var i = 0; i<data.length; i++){
					...
					jQuery("#TA_OA_CANOSAPPREGYHP__T_APPREGYHP_APPIDS").val(OsAppIds);
				}
		...
		jQuery("#TA_OA_CANOSAPPREGYHP__T_APPREGYHP_TITLE").focus();
	}
	...
	jQuery(function(){
		...
		<%    }
	  	...
	  	if('<%=action_defid %>' == 'yhply_wp1_act2'){   
	  		jQuery("#TA_OA_CANOSAPPREGYHP__T_APPREGYHP_BGSUSERID").val("<%=user_id %>");
	  		jQuery("#TA_OA_CANOSAPPREGYHP__T_APPREGYHP_BGSUSERNAME").val("<%=user_name %>");
	  	} --%>
	...
	function loadItNameSelect(OFUSTYPE_SELECT){
		...
		//类别
		var url1 = "<%=path %>/ccapp/xtbg/tjy/canteenitemssupplies/jsp/getbackoftypenameajax.jsp";
...
<form id="form1" name="form1" action="" method="post" >
	...
	<oa:input type="hidden" column="UNIT_ID" table="TA_OA_CANOSAPPREGYHP" value="<%= unit_id%>"/>
	<oa:input type="hidden" column="UNIT_NAME" table="TA_OA_CANOSAPPREGYHP" value="<%= unit_name%>"/>
	<input value="com.chinacreator.xtbg.tjy.canteenitemssupplies.service.impl.AddOrUpdateOsAppRegObject" id="<%=FlowBusiDataSaveDao.CUSTOM_CRUD_CLASSNAME_FLAG%>" 
			...
			<div class="content_02_box" style="width:100%;">
				...
				<div class="content_02_box_div" style="width: 100%;">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr><%--row1--%>
						<oa:input type="hidden" column="T_APPREGYHP_APPIDS" table="TA_OA_CANOSAPPREGYHP" value=""/>
						<oa:input type="hidden" column="T_APPREGYHP_ORG_ID" table="TA_OA_CANOSAPPREGYHP" value="<%= org_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>填写部室：</th>
							<td class="content_02_box_div_table_td" >
								<oa:input
										type="text" column="T_APPREGYHP_ORG_NAME" table="TA_OA_CANOSAPPREGYHP"
										other="class='input_cx_title_240' readonly='readonly'" value="<%=orgName%>"  />
							</td>
							<oa:input type="hidden" column="T_APPREGYHP_USER_ID" table="TA_OA_CANOSAPPREGYHP" value="<%= user_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>领取人：</th>
							<td class="content_02_box_div_table_td">
								<oa:input
										type="text" column="T_APPREGYHP_USER_NAME" table="TA_OA_CANOSAPPREGYHP"
						  ...
						  <th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>填写时间：</th>
							<td class="content_02_box_div_table_td">
								<oa:date dateFmt='yyyy-MM-dd' other="class='Wdate validate[required]'" style='height:22px;line-height: 22px;float:left;margin-top:3px;'
								   column="T_APPREGYHP_DATE" table="TA_OA_CANOSAPPREGYHP"/>
							</td>
						...
						<th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>申请标题：</th>
							<td class="content_02_box_div_table_td" colspan="3">
								<oa:input
										type="text" column="T_APPREGYHP_TITLE" table="TA_OA_CANOSAPPREGYHP"
						...
						<oa:input type="hidden" column="T_APPREGYHP_BGSUSERID" table="TA_OA_CANOSAPPREGYHP" value=""/>
						<td class="content_02_box_div_table_td" colspan="3">
							<oa:input
									type="text" column="T_APPREGYHP_BGSUSERNAME" table="TA_OA_CANOSAPPREGYHP"
			 	  ...
			 	  <table width="100%">
			 	  	<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_APPREGYHP_BGSYJ" table="TA_OA_CANOSAPPREGYHP" 
