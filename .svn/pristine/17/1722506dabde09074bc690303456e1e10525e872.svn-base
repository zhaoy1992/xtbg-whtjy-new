...
function test(){
    var sqls = new Array();
    var sql = "<no>insert into ta_duan(stu_id,xm,xb,score,remark) "+
    "values('test1','testa','female',50,'good')</no>";
    sqls.push(sql);
    var sql = "<no>insert into ta_duan(stu_id,xm,xb,score,remark) "+
    "values('testa','testb','female',89,'good')</no>";
    sqls.push(sql);
    alert(sqls.join(""));
