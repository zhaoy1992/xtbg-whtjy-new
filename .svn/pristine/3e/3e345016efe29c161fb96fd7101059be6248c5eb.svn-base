...
public class OsapPlanItemDaoImpl extends XtDbBaseDao implements OsapPlanItemDao{
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsapPlanItemDao#getOsapPlanItem(java.lang.String, java.sql.Connection) 
	  */
	@Override
	public List<Map<String, String>> getOsapPlanItem(String it_planid,
		...
		sql.append("select *");
		sql.append("  from TA_OA_DETOSAPPLANITEM ");
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsapPlanItemDao#deleteOsapPlanItemById(java.sql.Connection, java.lang.String) 
	  */
	@Override
	public boolean deleteOsapPlanItemById(Connection conn, String beanId)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_DETOSAPPLANITEM ");
