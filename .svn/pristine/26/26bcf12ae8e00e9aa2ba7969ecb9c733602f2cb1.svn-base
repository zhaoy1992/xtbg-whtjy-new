...
$(function() {
    ...
    $("#gridTable").jqGrid({
        ...
        url: '<%=path%>/pubListServlet?classNameId=com.chinacreator.xtbg.core.file.list.FileDocListForPhoto', 
    ...
    var toUserParamJosn = function() {
       if(window.parent.role=="org"||window.parent.role=="dept"){
    	   var f_doc_year_v = $('#f_doc_year').val();<%--档案年份--%>
	   		...
	   		str += "'f_file_quantity_min':'"+$('#f_file_quantity_min').val()+"',";
	   		str += "'f_file_quantity_max':'"+$('#f_file_quantity_max').val()+"',";
...
var updateFileDocDetailAfterCloseWin = function(f_doc_id,windowId){
	removeAlertWindowByWindowID(windowId);
	updateFileDocDetail(f_doc_id);
}
...
var className="com.chinacreator.xtbg.core.file.entity.FileDocPhotoExportBean";
                   ...
                   <tr>
						        ...
						        <table>
									...
									<tr>
										<th></th>
										<td></td>
										<th style="width: 100px" class="input_cx_title_th">照片数量：</th>
										<td style="width:110px;" class="cx_title_td">
											<input type="text"
											onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46" 
											onpaste="return clipboardData.getData('text').match(/\D/)"
											style="ime-mode:disabled;width: 100px;"
											ondragenter="return false"
											id="f_file_quantity_min" name="f_file_quantity_min" class="input_cx_title_283"  />
										</td>
										<th style="width: 10px" class="input_cx_title_th">至</th>
										<td style="width:110px;" class="cx_title_td">
											<input type="text" id="f_file_quantity_max" name="f_file_quantity_max" 
											onkeypress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46" 
											onpaste="return clipboardData.getData('text').match(/\D/)"
											style="ime-mode:disabled;width: 100px;"
											ondragenter="return false"
