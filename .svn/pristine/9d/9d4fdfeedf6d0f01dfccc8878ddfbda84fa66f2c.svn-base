...
var addRepair = function() {
	var pageName ="报修登记";
	openAlertWindows('windowId',"${pageContext.request.contextPath}/ccapp/xtbg/tjy/canteenitemssupplies/repair/jsp/repairDeviceDetail.jsp?windowsId=windowId&actionName=insert",pageName,500,430,'25%','25%');
}
...
var pageName ="修改报修登记";
openAlertWindows('windowId','${pageContext.request.contextPath}/ccapp/xtbg/tjy/canteenitemssupplies/repair/jsp/repairDeviceDetail.jsp?windowsId=windowId&actionName=update&repair_id='+ model.repair_id,pageName,500,430,'25%','25%');
}
