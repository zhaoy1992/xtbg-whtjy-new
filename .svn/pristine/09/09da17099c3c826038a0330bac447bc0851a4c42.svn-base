...
var addFileDocDetail = function () {
	var typeurl = '<%=urlTmp%>';
    openAlertWindows('updateFileDocDetailWindow', getCurrentFilePath() +f_file_detail+ '?'+typeurl+'&busi_id=&busiTypeCode=wj-001&windowId=updateFileDocDetailWindow', '添加文件' ,1020,530,'10%','10%');
}
