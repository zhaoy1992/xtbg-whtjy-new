...
<html>
	...
	<body topmargin="1" rightmargin="1" scroll=auto leftmargin="1">
		...
		<input type="hidden" name="compare_title" value="">
			...
			<table width="100%" border="1" align=center cellpadding="3" cellspacing="0" bordercolor="#B7CBE4"  class="Datalisttable" id="docListTable">
				<tr>
					...
					<div  class="DocumentOperT">文档操作：</div>		
						<a style="cursor:hand" onClick="sendPartOfDocs()"><div class="DocumentOper"><img 
									src="../images/new_doc.gif" class="operStyle">选送</div></a>
						
						<a style="cursor:hand" onClick="delDocs()"><div class="DocumentOper"><img 
									src="../images/new_doc.gif" class="operStyle">删除</div></a>
					</td>
				</tr>
				<pg:listdata dataInfo="com.chinacreator.cms.documentmanager.crawl.EDocumentList" keyName="EDocumentList" />
				<!--分页显示开始,分页标签初始化-->
				<pg:pager maxPageItems="<%=Integer.parseInt(maxPageItems_str)%>" scope="request" data="EDocumentList" isList="false">
					<tr class="cms_report_tr">
						...
						<td width="10%" height='30' nowrap="nowrap">操作</td>
					</tr>
					...
					%>
                        ...
                        <tr class="cms_data_tr" 
							...
							<td class="tablecells"  width="10%">
								<a style="cursor:hand" onclick="compare('<pg:cell colName="subtitle"/>','<%=channelId%>')">比对</a>
							</td>
						</tr>
					</pg:list>
					<%
