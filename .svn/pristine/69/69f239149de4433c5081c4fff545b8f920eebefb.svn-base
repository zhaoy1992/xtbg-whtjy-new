...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();" contxml="<root><div><id>div3</id></div><ExtUpload><id>ExtUpload5</id></ExtUpload></root>" billtaborder="<root></root>" dj_sn="20090708110304241253" caption="upload" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:3;DsMain_field:0;a:0;button:1;text:2;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:5;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100607093706211537" jslib="fcsavedj.js&#13;&#10;fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js">
...
<TABLE style="POSITION: static" cellSpacing=2 cellPadding=1 width=100 align=left border=1>
   <TBODY>
      <TR>
         <TD><DIV id=div3 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; LEFT: 0px; OVERFLOW: auto; BORDER-LEFT: black 1px solid; WIDTH: 557px; BORDER-BOTTOM: black 1px solid; POSITION: static; TOP: 0px; HEIGHT: 325px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="div"><DIV id=div_ExtUpload5 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV>&nbsp;<SCRIPT type=text/javascript>
Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';
var w_ExtUpload5 = 504;
var h_ExtUpload5 = 277;
var upobj_ExtUpload5;var refidtemp;var attachidtemp;
var fileListGrid_ExtUpload5;
var del_ExtUpload5 = eval('true');
var isflow = IsSpace(fcpubdata.cc_form_instanceid)?-1:1;
var ExtUpload5_retint = 0;
var ExtUpload5_onReady = function(){ 
 Ext.QuickTips.init();
if(ExtUpload5_retint==0) {ExtUpload5_retint = setInterval(ExtUpload5_onReady,200);return;}
if(document.readyState!="complete") return;
clearInterval(ExtUpload5_retint);ExtUpload5_retint = null ;
...
var uploadFinishFlag = false;
	...
	var uploader = new Ext.ux.SwfUploadPanel({
		title: '上传文件'
		, width: w_ExtUpload5		, height: h_ExtUpload5		,collapsible : true
 ...
 fileListGrid_ExtUpload5.store.reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});uploadFinishFlag=true;
});	upobj_ExtUpload5 = uploader;
	return uploader;
	}
...
cm.setHidden(1,!del_ExtUpload5);
	...
	fileListGrid_ExtUpload5  = grid ;
    return grid;
}
function deleteGrid(){
 var rows = fileListGrid_ExtUpload5.getSelectionModel().getSelections();
				if(rows.length==0){
                      ...
                      success: function(response, options) {
                       var responseArray = Ext.util.JSON.decode(response.responseText);
                            if(responseArray.success==true){
								fileListGrid_ExtUpload5.getStore().reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});
                            }
                            else{
             ...
             title : '上传控件面板',
             renderTo:'div_ExtUpload5',
             id : 'div_ExtUpload5',
					width: '80%',
					height: eval(parseFloat(document.getElementById('div3').style.height)*(parseFloat('90%')))/100,
             frame:true,
			 activeTab: 0,
             margins : '0 0 0 0',
             minHeight : 100,
...
creator_pt_uppanels.push({id:'ExtUpload5',obj:panel});
if(typeof(onUpPanelLoaded)=='function') setTimeout(onUpPanelLoaded,0);
};
function dodoupload(){
upobj_ExtUpload5.startUpload();
}ExtUpload5_onReady();</SCRIPT></DIV></TD>
         <TD></TD>
      </TR>
      <TR>
         <TD></TD>
