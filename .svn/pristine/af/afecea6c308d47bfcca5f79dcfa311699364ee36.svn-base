 ...
 *<p>Description:此标签用于WORD公文，隐藏了标题</p>
 ...
 *2013-5-24
 */
public class ArchiveWordTextTag extends TagSupport{
	...
	public int doEndTag() throws JspException {
		...
		try {
			...
			//加入控件
		    inputhtml = inputhtml.append("<script type='text/javascript' src='ccapp/oa/archive/wordarchive/wordiweboffice.js'></script>");
		    //加入个性化配置JS																				   
		    ...
		    inputhtml.append(" <OBJECT id='WebOffice' name ='WebOffice' style='POSITION: absolute;TOP: -19px;' height='"+height+"' width='"+width+"' classid='clsid:8B23EA28-2009-402F-92C4-59BE0E063499' codebase='"+url+"/ccapp/oa/resources/plug/iWebOffice2009/"+cebversion+"'></OBJECT> ");
			...
			hiddenhtml.append("<input name='is_split' id='is_split' type='hidden' value='"+ is_split +"' />");
			hiddenhtml.append("<input name='is_infotype' id='is_infotype' type='hidden' value='"+ is_infotype +"' />");
			...
			hiddenhtml.append("<input name='is_chief' id='is_chief' type='hidden' value='"+ is_chief +"' />");
			hiddenhtml.append("<input name='is_ckls' id='is_ckls' type='hidden' value='"+ is_ckls +"' />");
...
//	 * @throws Exception
//	 */
//	public boolean hasWordTextMQ(String mRecordID) throws Exception{
//		boolean flag = false;
//		DsCRUDDao dao = new DsCRUDDaoImpl();
//		flag= dao.hasText("singn"+mRecordID);
//		return flag;
//	}
}
