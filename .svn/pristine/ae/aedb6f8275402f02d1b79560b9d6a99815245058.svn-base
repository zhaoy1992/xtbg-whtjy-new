 ...
 *Sep 10, 2013
 */
public class MyFileLendingForMeBeforeList extends DataInfoImpl {
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(MyFileLendingForMeBeforeList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.MyFileLendingForMeBeforeList(model, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
