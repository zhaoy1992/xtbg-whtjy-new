...
<a id="reload" href="pic_kindchild_add.jsp" style="display:none">reload...</a>
        ...
        <tr>
          <td bgcolor="D7D7D7"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td height="22"><div align="center">&nbsp; 父 分 类:
                  <input  readonly name="parentsiteid3" type="text" class="cms_text" id="parentsiteid3" value="网页常用素材" />
              </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td height="22" align="center"><div align="center">图库分类描述:
            ...
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td height="22" align="center"><div align="center">图库保存目录:
