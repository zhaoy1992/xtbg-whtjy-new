						...
						<pg:pager maxPageItems="15" scope="request" data="ResSearchList" isList="false">
							...
							<pg:list>
								...
								>
									...
									<td class="tablecells" nowrap="nowrap" onclick="openWin('operList_res.jsp?resId2=<pg:cell colName="title" defaultValue="" />&resTypeId2=<%=restype%>&resTypeName=<pg:cell colName="title" defaultValue="" />&title=<pg:cell colName="title" defaultValue="" />&username=admin',600,500)">
