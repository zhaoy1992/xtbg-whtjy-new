...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.tjy.processing.list.DoneDeWorkList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		colNames: ['实例id','业务id','表单','办件编号 ',  '公文标题  ','业务类别','业务类型 ', '发起人 ', '发起时间  ', '处理环节 ','状态', '办件历史 ', 'busitype_code', 'act_index','环节实例ID','流程ID','模板ID','流程定义ID'],
