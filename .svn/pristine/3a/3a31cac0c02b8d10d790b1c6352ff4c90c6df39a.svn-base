...
public class newReleaseList extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(newReleaseList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.findNewsReleaseListPageBean(model, sortName, sortOrder,
					offset, maxPagesize);
