...
<title>申购计划</title>
	...
	function add_nomoveObject(){
		var path ="<%=path%>/ccapp/xtbg/tjy/detectionsupplies/jsp/choseosnomoveobjectlist.jsp?windowsId=windowIds";
	...
	function loadOsAppItemObject(OsAppIds,_bus_id){
		...
		var url = "<%=path %>/ccapp/xtbg/tjy/detectionsupplies/jsp/getbackosnomoveobjectajax.jsp";
		...
		jQuery.ajax({
			...
			success: function(data){
				...
				for (var i = 0; i<data.length; i++){
					...
					jQuery("#TA_OA_DETOSNOMOVE__T_HAVA_IDS").val(OsAppIds);
				}
		...
		//焦点设置
		jQuery("#TA_OA_DETOSNOMOVE__T_OSNOM_TITLE").focus();
	}
	...
	function deleteDay(tag,goodsId){
		...
		var t_hava_ids = jQuery("#TA_OA_DETOSNOMOVE__T_HAVA_IDS").val();
		...
		//重新赋值
		jQuery("#TA_OA_DETOSNOMOVE__T_HAVA_IDS").val(t_hava_ids)
	...
	jQuery(function(){
		<%if(!StringUtil.isBlank(appIds)) {%>
		    ...
		    jQuery("#TA_OA_DETOSNOMOVE__T_HAVA_IDS").val('<%=appIds%>');
		<%}
		...
		<%    }
	  	...
	  	if(action_defid=="gzjb_wp1_act1"){
	  		 jQuery("#TA_OA_DETOSNOMOVE__T_OSNOM_LYSBXQ").addClass("validate[required]");
	  	}
	});
...
<form id="form1" name="form1" action="" method="post" >
	...
	<input value="com.chinacreator.xtbg.tjy.detectionsupplies.service.impl.AddOrUpdateOsNoMoveObject" id="<%=FlowBusiDataSaveDao.CUSTOM_CRUD_CLASSNAME_FLAG%>" 
			...
			<div class="content_02_box" style="width:100%;">
				...
				<div class="content_02_box_div" style="width: 998px;">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr><%--row1--%>
						<oa:input type="hidden" column="T_HAVA_IDS" table="TA_OA_DETOSNOMOVE" value=""/>
						<oa:input type="hidden" column="T_OSNOM_ORG_ID" table="TA_OA_DETOSNOMOVE" value="<%= org_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>填写部室：</th>
							<td class="content_02_box_div_table_td" >
								<oa:input
										type="text" column="T_OSNOM_ORG_NAME" table="TA_OA_DETOSNOMOVE"
										other="class='input_cx_title_240' readonly='readonly'" value="<%=orgName%>"  />
							</td>
							<oa:input type="hidden" column="T_OSNOM_USER_ID" table="TA_OA_DETOSNOMOVE" value="<%= user_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>领取人：</th>
							<td class="content_02_box_div_table_td">
								<oa:input
										type="text" column="T_OSNOM_USER_NAME" table="TA_OA_DETOSNOMOVE"
						...
						<th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>申请标题：</th>
							<td class="content_02_box_div_table_td" colspan="3">
								<oa:input
										type="text" column="T_OSNOM_TITLE" table="TA_OA_DETOSNOMOVE"
						  ...
						  <th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>填写时间：</th>
							<td class="content_02_box_div_table_td" colspan="3">
								<oa:date dateFmt='yyyy-MM-dd' other="class='Wdate validate[required]'" style='height:22px;line-height: 22px;float:left;margin-top:3px;'
								   column="T_OSNOM_DATE" table="TA_OA_DETOSNOMOVE"/>
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="content_02_box_div" style="width: 998px;">
				<table class="content_02_box_div_table_02" width="100%" cellspacing="0" cellpadding="0" border="0">
						<tr >
							<td class="content_02_box_div_table_td">
									<oa:textarea
									column='T_OSNOM_LYSBXQ' table='TA_OA_DETOSNOMOVE' title='' 
			 	  ...
			 	  <table width="100%">
			 	  	<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSNOM_BMFZRYJ" table="TA_OA_DETOSNOMOVE" 
					...
					<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSNOM_BGSFZRYJ" table="TA_OA_DETOSNOMOVE" 
											style="border: 1;width:99%;overflow: auto;" other="class='validate[maxSize[1000]] textarea_556'" />
						</td>
					</tr>
					<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSNOM_ZGLDYJ" table="TA_OA_DETOSNOMOVE" 
											style="border: 1;width:99%;overflow: auto;" other="class='validate[maxSize[1000]] textarea_556'" />
						</td>
					</tr>
					<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSNOM_YZYJ" table="TA_OA_DETOSNOMOVE" 
											style="border: 1;width:99%;overflow: auto;" other="class='validate[maxSize[1000]] textarea_556'" />
						</td>
					</tr>
				 </table>
...
<script language="javascript" type="text/javascript">
	...
	*/
	function valiDevCode(t_ha_sbno){
		var flag = false;
		//验证设备编号是否已经存在
		var url= "<%=path %>/ccapp/xtbg/tjy/detectionsupplies/jsp/checkStockCode.jsp";
	...
	*/
	function valiDevState(t_ha_id){
		var flag = false;
		//验证设备是否已经领用
		var url= "<%=path %>/ccapp/xtbg/tjy/detectionsupplies/jsp/checkStockState.jsp";
