...
var myuuid=creator_getUUID();
alert(myuuid);
}

function showOrgTree()
{
  openTree('user',text1,text2,true);
}

function newword(){
 creator_newWebOffice(".doc","draft","222");
 }
 
 function addmymenu(){
  var iWebOffice = document.getElementsByName("WebOffice")[0];
      iWebOffice.AppendMenu("32","关闭文档");

 }

function getRtxStatus(){
  var i=QueryUserState("段志英");
  alert(i);
} 
</script>

<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();" contxml="<root><button><id>button1</id><id>button2</id><id>button5</id><id>button7</id></button><text><id>text1</id><id>text2</id></text></root>" billtaborder="<root><taborder>button1</taborder><taborder>button2</taborder><taborder>text1</taborder><taborder>text2</taborder><taborder>button5</taborder><taborder>button7</taborder></root>" dj_sn="20100129125138322879" caption="我的测试" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:1;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:7;text:2;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:0;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20091219104852735215" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js">
...
<BUTTON id=button2 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("showOrgTree()")'>机构树</BUTTON>
...
<BUTTON id=button5 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("newword()")'>新建WORD</BUTTON>

<DIV id=WebOffice1 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; LEFT: 9px; OVERFLOW: auto; BORDER-LEFT: black 1px solid; WIDTH: 663px; BORDER-BOTTOM: black 1px solid; POSITION: absolute; TOP: 39px; HEIGHT: 243px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="WebOffice">
   <OBJECT id=WebOffice_WebOffice1 style="LEFT: 0px; WIDTH: 100%; POSITION: absolute; TOP: 1px; HEIGHT: 100%" codeBase=../../../iWebOffice2006/iWebOffice2006.cab#version=<%=iWebOfficeVersion%> classid=clsid:8B23EA28-723C-402F-92C4-59BE0E063499 name=WebOffice>
      ...
      <PARAM NAME="WebUrl" VALUE="http://172.16.25.147:9080/creatoreppWeb/eformsys/fceform/design/">
...
<BUTTON id=button7 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("getRtxStatus()")'>button7</BUTTON>
</DIV>
