...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.officesupplies.list.OsUserTypeItemList";
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['ID','物品名称','物品排序','物品规格 ','排序号', '备注'],
		...
		toolbar:[true, "top" ,"<input class='but_y_01' id=add value='添加' type='button' onclick='addLevel()' value=''/><input class='but_y_01' value='删除' id=del type='hidden' onclick='delLevel()' value=''/>"],
		multiselect: true,
...
var toUserParamJosn = function() {
	var str = "{'it_name':'" + StringCheck($("#it_name").val()) +"','unit_id':'<%=unit_id%>','oftype_id':'<%=oftype_id%>'}";
...
var addLevel = function() {
 	var pageName ="添加物品规格";
	openAlertWindows('windowId',"../../../tjy/officesupplies/type/jsp/osusertypeIteminfo.jsp?windowsId=windowId&actionName=insert&oftype_id=<%=oftype_id%>",pageName,500,205,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改物品规格";
	openAlertWindows('windowId','../../../tjy/officesupplies/type/jsp/osusertypeIteminfo.jsp?windowsId=windowId&actionName=update&it_id='+ model.it_id,pageName,500,205,'25%','25%');
}
...
var delLevel = function(id) {
	...
	$(selectedIds).each(function () {
		...
		if(!IsSpace(model.it_id)){
			idsArrTemp.push(model.it_id);
		}
	});
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								<th width="90" class="input_cx_title_th" >规格名称：</th>
								<td width="296"  class="cx_title_td">
								<input type="text" id="it_name" class="input_cx_title_283" >
								</td>
...
<form id="delForm2" name="delForm2" method="post" action="osusertypeIteminfodo.jsp">
