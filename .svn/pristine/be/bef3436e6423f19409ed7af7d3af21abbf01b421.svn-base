...
<TABLE class=Ctable cellSpacing=1 cellPadding=1 width="100%">
         ...
         <TABLE cellSpacing=0 cellPadding=0 width="100%">
            <TBODY>
                     ...
                     <TABLE id=$tmp_cfcsmc$ cellSpacing=0 cellPadding=0 width="100%">
                        <TBODY>
                           <TR>
                              ...
                              <TD class=c2 width="50%">履行期限(天)</TD>
                           </TR>
               ...
               <TR id=cfje_$rmd_id$>
                  ...
                  <TD colSpan=3><INPUT id=tx_cfje_$rmd_id$ onmouseout=getFKJE() name=textfield>（元）</TD>
               </TR>
            </TBODY>
         </TABLE>
      </TD>
   ...
   <TR id=opsFlag>
      ...
      <TD><INPUT id=tx_fkzje readOnly name=textfield>（元）</TD>
      <TD class=c2>实际金额</TD>
      <TD><INPUT id=tx_fksjje name=textfield>（元）</TD>
   </TR>
   <TR>
      <TD align=middle colSpan=6><BUTTON class=button id=saveBtn style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("savePunishDecideInfo();")'>保存</BUTTON></TD>
   </TR>
</TBODY>
</TABLE>
</DIV>
