...
%>
	...
	var setting = {
		...
		async: {
	    	enable: true,//启用异步加载
	    	url: window.top.getContextPath() + '/commonTreeServlet?classNameId=com.chinacreator.xtbg.core.pubconfig.dao.impl.FlowBusiTypeTree', 
	    ...
	    */
		...
		function onclick(event,treeId,treeNode){
			if("false" != treeNode.click){
				...
				var url="flowbusitypelist.jsp?busitype_type_code="+treeNode.id;
		 ...
		 */
		function addtype() {
			var url ='<%=path %>' + '/ccapp/oa/pubconfig/jsp/flowbusitypeinfo.jsp?subid=windowid&busitype_type_code='+jQuery("#busitype_type_code").val()+'&type=addType';
			openAlertWindows('windowid',url,'添加业务类型分类','810','350','20%');
		}
		 ...
		 * return:  
		 */
		function updatetype(orgid,parentId) {
			var orgid = jQuery("#busitype_type_code").val();
			if(IsSpace(orgid)) {
				alert("请选择类型节点");
				return false;
			}
			var url = '<%=path %>/ccapp/oa/pubconfig/jsp/flowbusitypeinfo.jsp?subid=windowid1&type=updateType&busitype_type_code='+jQuery("#busitype_type_code").val();
			openAlertWindows('windowid1',url,'修改业务类型分类','810','350','20%');
		}
		...
		function deltype() {
			...
			var url = "flowbusitypeinfodo.jsp";
...
<input type="hidden" id="action" name="action" value="deleteType"></input>
	<div class="web_tree_box_y" align="left">业务类型分类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
	</div>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
	  	<tr height="30px" style="font-size: 15">
	    	<td align="center" ><a onclick="addtype()">新增</a></td>
	    	<td align="center"><a onclick="updatetype()">修改</a></td>
	    	<td align="center"><a onclick="deltype()">删除</a></td>
		</tr>
	</table>
	<table  width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
		<tr>
