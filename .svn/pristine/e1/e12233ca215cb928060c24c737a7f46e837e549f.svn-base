                ...
                document.onmousemove = function(e){
                    if (dragObj.moveable) {
                        ...
                        for (var k = 0; k < dragObj.dragArray.length; k++) {
                            ...
                            movePos.y > dragObj.dragArray[k].PosTop &&
                            movePos.y < dragObj.dragArray[k].PosTop + dragObj.dragArray[k].PosHeight) {
                            ...
                            if (movePos.x > startLeft && movePos.x < startLeft + dragTbl.rows[0].cells[j].offsetWidth) {
                                ...
                                if (dragTbl.rows[0].cells[j].getElementsByTagName("div").length == 0) {
                                    ...
                                    if (movePos.y < tmpUp) {///从最上面插入虚线框 
                                        ...
                                        if (movePos.y > tmpDown) {///从最下面插入虚线框 
...
<table id="dragTable" cellpadding="3"
	style="border: solid 0px green; width: 98%;">
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="1"
			...
			<tr id="titleBar1"
				style="height: 22px; text-align: left; background-color: #547BC9; color: White; padding: 3px; cursor: move;">
		...
		<div class="dragDiv" id="dragDiv6">
		<table cellpadding="0" cellspacing="0" border="1"
			style="width: 100%; border-collapse: collapse; border-color: Blue">
			<tr id="titleBar6"
				style="height: 22px; text-align: left; background-color: #547BC9; color: White; padding: 3px; cursor: move;">
				<th align="left" unselectable="on">Title6</th>
			</tr>
			<tr style="height: 130px; padding: 3px;" align="left" valign="top">
				<td unselectable="on">Content6...</td>
			</tr>
		</table>
		</div>
		</td>
