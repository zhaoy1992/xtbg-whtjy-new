...
<html>
	...
	<caption>监控系统环境配置信息</caption>
	<tr>
	<td width="20%">数据库监控</td><td><a href="dbmonitor.jsp" target="_blank">数据库监控页面</a></td>
	
	</tr>
	<!-- <tr>
	<td>在线用户数统计</td><td><a href="onlineUserCountInfo.jsp" target="_blank"  >用户数统计页面</a></td>
	</tr> -->
