	...
	<table width="100%">
		<tr>
			<td width="200px" class="td_tree_border_c3d0de" id="leftTd">
				<iframe src="psdatabasetree.jsp<%=urlTmp%>" scrolling="no" width="210px" height="610px" frameborder="0"></iframe>
			</td>
			<td class="td_tree_border_c3d0de">
				<iframe id="rightIframe1" src="psdatabaselist.jsp<%=urlTmp%>" scrolling="no" width="100%" height="610px" frameborder="0"></iframe>
			</td>
		</tr>
	</table>
</body>
