...
<table width="100%"  cellpadding=0 cellspacing=0 border=0>
	<tr>
		...
		<td valign="middle"
			align="left"  nowrap class="text">内部用户操作</td>
		<td id="doubleclickcolumn" title="双击以最大化" valign="middle"
			align="right" width="*"  nowrap class="text">
		<table  cellpadding=0 cellspacing=0 border=0>
		<tr>
		
			<td class=normal name="tool1" id="tools1" title=内部用户列表" valign=middle align=center onmousedown=mousedown(this) onmouseout=mouseout(this) onmouseover=mouseover(this) onmouseup=mouseup(this) onclick="bussinessAction(6)" ><table border=0 cellPadding=0 cellSpacing=0 class="text">
...
<!------------------------------------------------------------------------------------------------------------------>
			...
			<td class=normal name="tool1" id="tools1" title="内部用户基本信息" valign=middle align=center onmousedown=mousedown(this) onmouseout=mouseout(this) onmouseover=mouseover(this) onmouseup=mouseup(this) onclick="userinfo()" ><table border=0 cellPadding=0 cellSpacing=0 class="text">
