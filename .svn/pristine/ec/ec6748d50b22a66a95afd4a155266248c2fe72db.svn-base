...
<frameset name="frame1" cols="0,30,70" frameborder="no" border="0" framespacing="0" >
  ...
  <frame src="userList1.jsp?displayNameInput=<%=displayNameInput%>&displayValueInput=<%=displayValueInput%>" name="userList" scrolling="No" noresize="noresize" id="userList" />  
</frameset>
<noframes>
