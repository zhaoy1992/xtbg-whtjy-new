...
var w_ExtUpload2 = 450;
var h_ExtUpload2 = 250;
...
function deleteGrid(){
 var rows = fileListGrid_ExtUpload2.getSelectionModel().getSelections();
             ...
             minHeight : 100,
             autoHeight : false,
             items : [				createGridList()             ]             });				var win = new Ext.Window({					title: '上传窗口'					, width: w_ExtUpload2+20					, height: h_ExtUpload2+60					, resizable: true					, items: [					panel					]				});				win.show();
