...
<!--
function uf_ok(){
	var roles = role_treeFrame.document.getElementsByName("roleid");
	var roleIds = "";
	var roleNames = "";		
...
<html>
	...
	<body class="contentbodymargin">
		<div align="center">
			<br />
			<iframe name="role_treeFrame" height=85% width="100%"	src="role_treeFrameSrc.jsp?showmode=<%=showmode %>" frameborder="0"></iframe>
			<br />
			<br />
			<div align="center">
