...
<%
    ...
    String selectData = DictDropDownList.buildSelect(sql.toString(),"f_doc_state","","",true,"","width:140px;");
    //
...
var updateFileDocDetail = function(bean) {
	if(bean.f_files_id){
		openAlertWindows('updateFileDocDetailWindow', getCurrentFilePath() +f_file_detail+ '?busi_id='+bean.f_doc_id+'&busiTypeCode=wj-001&windowId=updateFileDocDetailWindow&isview=1&isgd=yes&f_files_id='+bean.f_files_id, '查看文件' ,1020,520,'10%','10%');
	}else{
		openAlertWindows('updateFileDocDetailWindow', getCurrentFilePath() +f_file_detail+ '?busi_id='+bean.f_doc_id+'&busiTypeCode=wj-001&windowId=updateFileDocDetailWindow&isview=1&isgd=yes', '查看文件' ,1020,520,'10%','10%');
	} 
}
        ...
        <tr>
            ...
            <!-- 固定查询 -->
                 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
                 	<tr>
                 		<th  class="input_cx_title_th" style="width:10%;">档案年份：</th>
                 		<td width="10%" class="cx_title_td">
                 			<input style="background:url(/xtbg/ccapp/oa/resources/style/blue/images/date_img_year.jpg) right 1px no-repeat;" id="f_doc_year" name="f_doc_year" class="date_120" type="text" onfocus="WdatePicker({dateFmt:'yyyy'})" />
						</td>
						
						<th style="width:10%;" class="input_cx_title_th">所属部门：</th>
                        <td width="10%" class="cx_title_td">
                    ...
                    <tr>
                        <th style="width:70px;" class="input_cx_title_th">文号：</th>
                        <td width="200" class="cx_title_td">
                        	<input type="text" id="f_doc_fontsize" name="f_doc_fontsize" class="input_cx_title_283" style="width:95%;"/>
                        </td>
                        <th  class="input_cx_title_th" style="width:70px;">文档标题：</th>
                    ...
                    <tr>
                    	  	<th  class="input_cx_title_th" style="width:10%">归档状态：</th>
						<td valign="top" width="10%"  class="cx_title_td">
							<div style="float:left;position: absolute;width:24%;z-index: 2;">                         
								<%=selectData%>
                            </div> 
                        </td>
                        <th  class="input_cx_title_th" style="width:10%;">档号：</th>
                        <td valign="top"  width="10%"  class="cx_title_td" style="padding-top:0px;">
                             <input id="f_filesno" name="f_filesno" type="hidden" style="width:150px;" class="input_cx_title_283" />
                             <input id="f_file_no" name="f_file_no" type="text" style="width:95%;" class="input_cx_title_283" />
                        </td>
                         <td width="60" >
                            <input value="重置" id="reset" type="button" class="but_y_01" onclick='clearA();'/>
                            <script>
                            clearA = function(){
								$('#f_doc_year').val("");<%--档案年份--%>
