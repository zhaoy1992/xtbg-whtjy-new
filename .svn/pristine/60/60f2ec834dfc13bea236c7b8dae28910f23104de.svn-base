...
<html>
	...
	<%@ include file="/epp/css/cssControl.jsp"%><body
		...
		<table width="100%" height="100%" border="0" cellpadding="0"
			...
			<tr>
				<td>
					<tab:tabContainer id="jawe-class-tab"
						selectedTabPaneId="pt-jawe-class">
						<tab:tabPane id="pt-jawe-class" tabTitle="平台" lazeload="true">
						...
						<tab:tabPane id="yy-jawe-class" tabTitle="应用" lazeload="true">
