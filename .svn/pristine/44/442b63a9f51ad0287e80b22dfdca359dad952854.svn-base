...
function handle(id){   
	...
	url = url+"&list_type=worklis&operType=yiban&act_name=借阅申请&actiontype_code=04&busiTypeCode=uuid-336&template_id=&Template=word&fromPage=filelendingflowdonelist";
