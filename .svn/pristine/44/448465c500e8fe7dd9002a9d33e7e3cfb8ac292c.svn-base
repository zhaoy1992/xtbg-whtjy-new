...
<html>
	...
	function orderList(ordercon) {
		...
		var url = "monitor_workflow_list.jsp?ordercondition=" + ordercon + orderType;
	...
	<%@ include file="/epp/css/cssControl.jsp"%><body class="contentbodymargin"  scrolling="no">
		<div id="contentborder" align="center">
			<FORM name="work" id="work" action="monitor_workflow_list.jsp" method="post">
				...
				<TABLE width="100%" cellpadding="1" cellspacing="1" bordercolor="#EEEEEE" class="thin">
					<pg:listdata dataInfo="com.chinacreator.commonworkflow.list.SHKMonitorWorkList" keyName="SHKMonitorWorkList" />
					<pg:pager maxPageItems="10" scope="request" data="SHKMonitorWorkList" isList="false">
						<tr>
						<%
