...
//response.setCharacterEncoding("gbk");
   ...
   // excel文件名
       ...
       PersonSearchBean personSearchBean = new PersonSearchBean();
	    ...
	    dao.findPublicAddressBook4RoleuserList(personSearchBean, "", "", 1, 1);
	    List<PublicAddressDirectoryBean> list =  null;
    ...
    String path = LoadPropertiesUtil.getInstance().getPropertiesValue("config/oacommon.properties","towordtemppath");  //根据实际情况写路径
	...
	try {
		 if (list.size() > 0) {
				...
				Label lab2 = new Label(0, 1, "公共通讯录", wcf);
				//ws.addCell(lab1);
				ws.addCell(lab2);
				Label lab3 = new Label(0, 2, "姓名");
				Label lab4 = new Label(1, 2, "职务");
				Label lab5 = new Label(2, 2, "办公手机");
				Label lab6 = new Label(3, 2, "常用手机");
				Label lab7 = new Label(4, 2, "办公电话");
				Label lab8 = new Label(5, 2, "电子邮件");
				Label lab9 = new Label(6, 2, "所在单位");
				ws.addCell(lab3);
				ws.addCell(lab4);
				ws.addCell(lab5);
				ws.addCell(lab6);
				...
				for (int i = 3; i < list.size() + 3; i++) {
					Label lab21 = new Label(0, i, list.get(i - 3).getDirectoryname());
					Label lab22 = new Label(1, i, list.get(i - 3).getPost());
					Label lab23 = new Label(2, i, list.get(i - 3).getMobile());
					Label lab24 = new Label(3, i, list.get(i - 3).getMobile());
					Label lab25 = new Label(4, i, list.get(i - 3).getWorkphone());
					Label lab26 = new Label(5, i, list.get(i - 3).getEmail());
					Label lab27 = new Label(6, i, list.get(i - 3).getOrgname());
