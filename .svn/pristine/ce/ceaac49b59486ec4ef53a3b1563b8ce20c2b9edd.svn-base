...
//tab2
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/commonListServlet?classNameId=agencyList',  //commonListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
...
var addLevel = function() {
	openAlertWindows('windowId','../../../public/agency/setAgency.jsp','设置交办',500,210,'25%','30%');
}
...
var updateLevel = function(id) {
	...
	openAlertWindows('windowId','../../../public/agency/setAgency.jsp?work_id='+ model.work_id,'修改交办',500,210,'25%','30%');
}
