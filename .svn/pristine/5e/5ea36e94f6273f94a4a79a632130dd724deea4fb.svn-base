...
var ExtGrid1_onReady = function(){ 
 Ext.QuickTips.init();
var dataset = document.getElementById("dataset3");
...
var store  = new Ext.data.Store({
	proxy: new Ext.data.CreatorMemoryProxy("dataset3"), 
...
creator_pt_grids.push({id:'ExtGrid1',obj:ExtGrid1,dataset:'dataset3',isEdit:'false'});
