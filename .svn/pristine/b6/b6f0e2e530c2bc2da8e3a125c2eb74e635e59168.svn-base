...
<%
	...
	String url = "../../grantmanager/operList_global.jsp?resTypeId=group&currRoleId="+ roleId + "&role_type=organization";
	String groupuseraddRes = "../../grantmanager/usergroupsetTree.jsp?resTypeId=group&currRoleId=" + roleId + "&role_type=organization";
%>
