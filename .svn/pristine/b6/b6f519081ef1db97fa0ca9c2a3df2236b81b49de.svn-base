      ...
      <TR>
         <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=1>
               <TBODY>
                  <TR>
                     <TD class=c2 width="35%">收据编号</TD>
                     <TD width="65%"><INPUT class=input_out onmousemove="this.className='input_move'" id=text1 onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 20px" onfocus="this.className='input_on';this.onmouseout='" onmovestart=moveStart() onmouseout="this.className='input_out'" controltype="text"></TD>
                  </TR>
                  <TR>
                     <TD class=c2 width="35%">缴纳金额</TD>
                     <TD width="65%"><INPUT class=input_out onmousemove="this.className='input_move'" id=text2 onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 20px" onfocus="this.className='input_on';this.onmouseout='" onmovestart=moveStart() onmouseout="this.className='input_out'" controltype="text"></TD>
                  </TR>
                  <TR>
                     <TD class=c2 width="35%">缴纳日期</TD>
                     <TD width="65%"><INPUT class=input_out onmousemove="this.className='input_move'" id=text3 onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};" style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 20px" onfocus="this.className='input_on';this.onmouseout='" onmovestart=moveStart() onmouseout="this.className='input_out'" controltype="text" onclick='bill_onclick("SelectDate()")'></TD>
                  </TR>
                  <TR>
                     <TD class=c2 width="35%">是否为滞纳金</TD>
                     <TD width="65%"><INPUT type=radio value=1 name=LATE_FEE>是</INPUT><INPUT type=radio value=0 name=LATE_FEE>否</INPUT></TD>
            </TR>
         </TBODY>
      </TABLE>
   </TD>
...
<TR>
   <TD align=middle><BUTTON class=button id=button1 style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button">保存</BUTTON><BUTTON class=button id=button2 style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button">取消</BUTTON></TD>
</TR>
</TBODY>
</TABLE>
</DIV>
