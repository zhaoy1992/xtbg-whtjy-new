...
function addOrg(){
   ...
   var op=document.all("allist").options[i];
	 ...
	 var orgId1="<%=orgId1%>";
	 var flag = "1";		
	 send_request('<%=rootpath%>/sysmanager/user/saveUJOAlot.jsp?uid='+uid+'&jobId='+jobId+'&orgId1='+orgId1+'&flag='+flag);
...
function send_request(url){
			...
			function changebox(){				 
				 ...
				 send_request('<%=rootpath%>/sysmanager/user/savaUJOAlot.jsp?uid='+uid+'&jobId='+jobId+'&orgId1='+orgId1);
			}
</SCRIPT>
  <link rel="stylesheet" type="text/css" href="../sysmanager/css/windows.css">
...
<tr class="tabletop">
  ...
  <tr class="tabletop">
    ...
    <td width="40%" align="center">所选用户加入岗位</td>
  </tr>
  <tr class="tabletop">
    <td width="40%" align="center">&nbsp;</td>
    <td width="20%" align="center">&nbsp;</td>
