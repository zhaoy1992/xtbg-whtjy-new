...
<table>
  ...
  <td align="center">
    ...
    <table>
        <tr><td align="left"><!-- dynamic="false" -->
         <tree:tree tree="szzb_column_tree"
    	           node="szzb_column_tree.node"
    			   ...
    			   <tree:checkbox name="orgid" recursive="true" uprecursive="false"></tree:checkbox>
    			   <tree:treedata treetype="com.chinacreator.eform.systemManager.ColumnTree"
    	                   scope="request"                  
    	                   rootid="0"  
    	                   rootName="栏目树"
    	                   expandLevel="1"
    ...
    <div align="center" boder=1>
			<table width="25%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td><div align="left">
					     <input name="button1" type="button" class="input" value="确定"
											onClick="uf_ok()">
						</div>
					</td>
					<td>
						<div align="left">
						  <input name="button2" type="button" class="input" value="取消"
