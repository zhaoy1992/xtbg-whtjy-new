			...
			<TD>
				<div>
					<div id="tabs">
						...
						<div id="tabs-1" >
							<iframe src="myfilelendingbeforelist.jsp" id="frame1" frameborder="0"
								width="100%" height="500px" scrolling="no"></iframe>
						</div>
						<div id="tabs-2" >
							<iframe src="myfilelendingnowlist.jsp" id="frame2" frameborder="0"
								width="100%" height="500px"></iframe>
						</div>
						<div id="tabs-3" >
							<iframe src="myfilelendingbacklist.jsp" id="frame2" frameborder="0"
								width="100%" height="500px"></iframe>
						</div>
					</div>
				</div>
