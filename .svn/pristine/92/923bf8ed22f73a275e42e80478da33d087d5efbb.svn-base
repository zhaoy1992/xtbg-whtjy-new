 ...
 *Jul 23, 2013
 */
public class FileLendingDetailOfUserSelfList extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(FileLendingDetailOfUserSelfList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryList(bean, sortName, sortOrder, offset, maxPagesize); 
		} catch (Exception e) {
