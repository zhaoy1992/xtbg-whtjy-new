...
import com.chinacreator.xtbg.core.file.entity.FileFJBeanVO;
 ...
 *Oct 23, 2013
 */
public class FileTJList2 extends DataInfoImpl {
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(FileTJList2.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryList2(bean, sortName, sortOrder, offset, maxPagesize,"page");
		} catch (Exception e) {
