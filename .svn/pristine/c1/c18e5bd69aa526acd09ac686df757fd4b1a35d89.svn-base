...
<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" class="thin">
      ...
      <% if(isEgp 
      		||( !"orgupdate".equals(dataSet.getString(Integer.parseInt(rowid),"id"))
      		&& !"newdeluser".equals(dataSet.getString(Integer.parseInt(rowid),"id"))
      		&& !"userupdate".equals(dataSet.getString(Integer.parseInt(rowid),"id")))
      		){%>
      <tr class="tr">
