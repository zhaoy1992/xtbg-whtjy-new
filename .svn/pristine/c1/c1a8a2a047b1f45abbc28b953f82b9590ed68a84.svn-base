	...
	function saveorg()
	{
		...
		if(validateForm(form1)){
		    ...
		    for(var i=0;i<suborgs.length;i++){
		  	...
		  	document.forms[0].action="../orgmanager/org.do?method=savesubOrg";
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="thin">
  <tr>    
    ...
    <td class="detailcontent"><input name="orgnumber" type="text" 
				  cnname="机构编号" value="<%=orgnumber%>" <%if(orgNumberHiberarchy)out.print("onblur='checkOrgNumber(this)'"); %>></td>	
  ...
  <tr>
    ...
    <td class="detailcontent">
    	<input name="org_xzqm" cnname="行政区码" type="text" value="<%=parentOrgXzqm%>">
    </td>
	</tr>                   
   ...
   <tr>     
          <td align="center" colspan="4"><div align="center">
             ...
             <input name="Submit" type="button" class="input" value="返回" onclick="javascript:history.back()">                  
