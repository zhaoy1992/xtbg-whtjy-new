...
<a id="reload" href="site_ftplink.jsp" style="display:none">reload...</a>
        ...
        <tr>
          <td bgcolor="D7D7D7"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr >
              ...
              <td height="20">&nbsp;<span class="cms_title_blue">FTP站点测试</span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width="3%">&nbsp;</td>
              <td width="3%">&nbsp;</td>
              <td width="95%" height="22">恭喜！该ftp站点连接成功！</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
