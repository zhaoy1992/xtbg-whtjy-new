...
<%@page import="com.chinacreator.xtbg.pub.util.DaoUtil"%><html xmlns="http://www.w3.org/1999/xhtml">
<HEAD>
<%
		...
		var setting = {
		    ...
		    */
			...
			async: {
				...
				otherParam:{"toporgId":"<%=theRootOrgid%>","resourceType":"<%=resourceType%>"}
				//dataFilter: filter
			},
			callback: {
...
<table border="0" cellpadding="0" cellspacing="0" class="ztree_tcbox">
  <tr>
    <td class="ztree_tctitle">机构用户树</td>
  </tr>
  <tr>
    <td>
