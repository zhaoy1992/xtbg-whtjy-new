...
function addMB() {
    ...
    var tempURL = "../../../ccapp/app_xzcf/jsp/wordedit/wordedit_index.jsp";
    var tmp = showModalDialog(tempURL,window,tempPara);
    //window.open(tempURL,'newwindow','height=768px,width=1250px,top=0,left=0,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no') 
    reloadExtGrid(); 
}
...
function updateMB(grid,rowIndex,e) {
    ...
    //window.showModalDialog(url,'newwindow','height=768px,width=1024px,top=0,left=0,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no')
    reloadExtGrid();
}
...
function deleteMB() {
    ...
    var ids = FormUtil.getExtGridSelectedIds('mb_id', grid);
    if(ids.length==0){    
       alert("请选择要删除的记录");
    }else{
       if(!confirm("确定要删除选择的模板吗？")){
             return;
       }
       var rv = WordReport.deleteWordReport(ids);
       if(rv){
           alert("删除模板信息成功");
       }else{
           alert("删除模板信息失败");
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();init();" contxml="<root><div><id>div1</id></div><button><id>btnQuery</id><id>btnReset</id><id>btnSave</id><id>btnDelete</id></button><text><id>mb_mc</id></text><dataset><id>dataset1</id></dataset><ExtGrid><id>ExtGrid1</id></ExtGrid></root>" billtaborder="<root><taborder>btnSave</taborder><taborder>btnDelete</taborder><taborder>btnReset</taborder><taborder>mb_mc</taborder><taborder>btnQuery</taborder></root>" dj_sn="20101101100413937130" caption="WORD模版列表" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:0;text:0;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:0;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName="app_xzcf" creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="否" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20101027105323156235" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Common.js&#13;&#10;../../../ccapp/app_xzcf/js/util/DBUtil.js&#13;&#10;../../../ccapp/app_xzcf/js/util/FormUtil.js&#13;&#10;../../../ccapp/app_xzcf/js/word/business/WordReport.js&#13;&#10;../../../ccapp/app_xzcf/js/word/dao/WordReportDao.js">
            ...
            <TABLE class=Ctable height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
               <TBODY>
                  ...
                  <TR>
                     ...
                     <TD width="85%"><INPUT class=input_out id=mb_mc style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() controltype="text"></TD>
                  </TR>
               </TBODY>
            </TABLE>
         </TD>
...
if(typeof(retcm[0].getCount)!='undefined') sm = retcm[0] ;
 ExtGrid1 = new Ext.grid.GridPanel({
	...
	width: '100%',
					height: eval(document.body.clientHeight*(parseFloat('46%')))/100,
		split: true,
		region: 'north',
		title:'查询结果列表',
		frame:true
