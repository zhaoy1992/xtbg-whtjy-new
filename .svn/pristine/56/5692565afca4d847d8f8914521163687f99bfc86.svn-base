...
<%
	...
	String resTypeId = "site.doc";//"channeldoc";
	...
	List hasOper = operManager.getOperResRoleList(role_type,roleid,resid,"site.doc");
	if(list == null){
		list = new ArrayList();
	}	
...
<SCRIPT LANGUAGE="JavaScript"> 
	...
	function setCheck5(currCheck,priority)
	{
	...
	function sitedocRecord(dealType,id) {
			...
			Form5.action="<%=rootpath%>/accessmanager/securityManager.do?method=sitedocAuthorization&isRecursion="+tt+"&resTypeId="+id;
			Form5.submit();
	}
	function back(){
		parent.window.close();
...
<div id="contentborder">
			<form target="sitedoc" name="Form5" action="" method="post" >
			...
			<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" class="thin">
				  ...
				  <tr>
					...
					if (flag1 == true) {%>
							  <tr>
			        <td>
			        <input type="checkBox" hideFocus=true name="checkBoxAll5" onClick="checkAll5('checkBoxAll5','alloper3')"checked disabled="true">
			        </td>
			        <td>>>>>全选</td>
			        <td>&nbsp;<input name="isRecursion5" onclick="" type="checkbox" checked disabled="true">递归授权子站点</td>
			      </tr>
			      ...
			      <tr class="tr">
			        ...
			        %>
			        value="<pg:cell colName="id"/>" onclick="changebox5(this,'<pg:cell colName="priority" defaultValue=""/>','<pg:cell colName="id"/>')"checked disabled="true">
			        </td>
					...
					<%}else{%>
							  <tr>
			        <td>
			        <input type="checkBox" hideFocus=true name="checkBoxAll5" onClick="checkAll5('checkBoxAll5','alloper3')">
			        </td>
			        <td>>>>>全选</td>
			        <td>&nbsp;<input name="isRecursion5" onclick="" type="checkbox">递归授权子站点</td>
			      </tr>
			      <pg:list requestKey="operList" needClear="false">
			      <tr class="tr" 
			      <%
			      ...
			      >
			       ...
			       <tr>
			        ...
			        <td></td>
			        <td>
			        <input type="submit" value="确定" class="input" onclick="javascript:sitedocRecord(1,'site.doc'); return false;" 
			        <%
			...
			<IFRAME name="sitedoc" width="0" height="0">
			</IFRAME>
