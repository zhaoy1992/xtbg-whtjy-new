package com.chinacreator.xtbg.pub.personwork.entity;
/**
 ...
 *@date 2012-2-16
 */
public class PublicAddressDirectoryBean {
	...
	private String is_relation;//是否被个人通讯录引用
	...
	private String department ; //是否是党政一把手
	
	private String remark2;//手机短号码
