 ...
 *<p>Description:采购申请处室已审批list数据显示</p> 
 *<p>Company:湖南科创</p>
 *@author 刘春元
 *@version 1.0
 *2012-03-01
...
public class ApprovalAlreadRoomList implements DataInfoImpl,java.io.Serializable{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(ApprovalAlreadRoomList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = daojson.findAlreadyList(instanceBean, sortName, sortOrder, offset, maxPagesize);
