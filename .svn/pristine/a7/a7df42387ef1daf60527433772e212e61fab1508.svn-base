...
$(function() {
    ...
    $("#gridTable").jqGrid({
       ...
       //表头设置       
        ...
        rowList : [ 5, 10, 30 ],//一个数组，用于设置Grid可以接受的rowNum值。例如[10,20,30]
    ...
    var toUserParamJosn = function() {
        var str = "{'p_manage_id':'<%=p_manage_id%>','p_read_status':'0','p_type_id':'1'}";
        return descape(escape(str));
    }
    var toUserParamJosn2 = function() {
        var str = "{'p_manage_id':'<%=p_manage_id%>','p_read_status':'0','p_type_id':'2'}";
        return descape(escape(str));
    }
