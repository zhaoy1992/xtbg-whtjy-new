...
<script>
function init(){
//alert(creator_getQueryString("djbh"));
}
...
var w_ExtUpload1 = 400;
var h_ExtUpload1 = 250;
...
var uploadFinishFlag = false;
 ...
 fileListGrid_ExtUpload1.store.reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});uploadFinishFlag=true;
	try{uploadM();	}catch(e){	}});	upobj_ExtUpload1 = uploader;
	return uploader;
	}
				...
				if(btn=='yes'){    
                 ...
                 method : 'POST',
                  params : {
					...
					try{deleteM();					}catch(e){						}				}  		});	}}    var panel = new Ext.TabPanel({
             title : '上传控件面板',
...
<BUTTON id=button1 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("deleteMs();")'>button1</BUTTON>
</DIV>
