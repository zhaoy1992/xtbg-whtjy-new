...
var addLevel = function() {
	...
	openAlertWindows('windowId',"../../../tjy/officesupplies/jsp/officedetailinfo.jsp?windowsId=windowId&actionName=insert&org_id=<%=org_id%>",pageName,550,550,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	openAlertWindows('windowId','../../../tjy/officesupplies/jsp/officedetailinfo.jsp?windowsId=windowId&actionName=update&org_id=<%=org_id%>&id='+ model.id,pageName,550,550,'25%','25%');
}
