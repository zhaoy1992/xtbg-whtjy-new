...
<script>
	function sub()
	{
		var siteId_indexId = document.searchForm.siteId_indexId.value;
		var array = siteId_indexId.split(":");
		document.searchForm.siteId.value = array[0];
		document.searchForm.indexId.value = array[1];
		document.searchForm.searchType.value = array[2];
		...
		<tr><td colspan="2" background="images/line.gif" height="1"></td>
		 ...
		 <tr><td colspan="2" background="images/line.gif" height="1"></td>
          ...
          <tr>
            ...
            <td><select name="siteId_indexId" class="cms_select" style="width:120">
                <%
					List list = null;
                ...
                <pg:list requestKey="list">
                  <option value="<pg:cell colName="siteId"/>:<pg:cell colName="id"/>:<pg:cell colName="searchType"/>">
          ...
          <tr>
            ...
            <td>
              ...
              <input type="text" name="dayEnd"  size="18"  class="cms_text" >
                  <input name="button2" type="button" onClick="showtime(document.all('dayEnd'))" value="时间" style="cursor:hand">            </td>
          </tr>
		   <tr><td colspan="2" background="images/line.gif" height="1"></td>
		  <tr><td colspan="2" align="center"><input name="button" type="button" onClick="sub();" value="<%=searchTypeDes%>" style="width:60; height:25;cursor:hand" >
		      <input name="button3" type="button" onClick="reset()" value="重置" style="width:60; height:25;cursor:hand"></td>
		  </tr>
        </table>
		</FORM>
		  </td>
