...
(isSpace(jQuery("#m_room_id").val())) ? "" : jQuery("#m_room_id").find("option:selected").text()
/*
	函数:  getJson
				...
				<table border="0" cellspacing="0" cellpadding="0" class="content_02_box_div_table" style="width: 100%;">
					<tr>
						...
						<td class="content_02_box_div_table_td" colspan="5" id ="p_title_test_id">
							<input  type="text" class="validate[required,maxSize[100]] input_cx_title_240 m_title" style="width:753px;height:24px;" name="m_title" id="m_title"  onblur="onchangemsg(this.id)"/>
					...
					<tr>
						...
						<td class="content_02_box_div_table_td"  colspan="3" id ="p_title_test_id">
							<input type="text" class="validate[required,maxSize[80]] input_cx_title_240 m_title" style="width:465px;" value="" name="m_address" id="m_address"  onblur="onchangemsg(this.id)"/>	
						</td>
					</tr>
					<tr>	
					...
					<tr id="more" style="display: none">
						...
						<th class="content_02_box_div_table_th"><span id="isneedsignup" style="display: none">报名截止时间：</span></th>
						<td class="content_02_box_div_table_td" >
							<input class="date_120 Wdate" style="display: none"
					...
					<tr  id="more" style="display: none">
						...
						<td class="content_02_box_div_table_td" colspan="5">
							<textarea id="m_remark" name="m_remark" class="validate[maxSize[500]] textarea_575" cols="110" rows="2" ></textarea>
						</td>
					</tr> 
				</table>
			</div>
				...
				<table border="0" cellspacing="0" cellpadding="0" class="content_02_box_div_table" style="width: 100%;">
					...
					<tr>
						<td class="content_02_box_div_table_td" colspan="5"><!-- 手工输入 -->
							<textarea id="m_other_user_input" name="m_other_user_input"  class="validate[maxSize[500]] textarea_575" cols="80" rows="2" ></textarea>
						</td>
					</tr>
				</table>
			</div>
