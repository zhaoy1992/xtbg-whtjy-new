...
$(function() {
	...
	$("#gridTable").jqGrid({
		...
		colNames: ['car_id','车牌号','修配厂','维修保养日期','类型','经办人','预计费用','实计费用'],
...
var viewApplyinfo = function(id) {
	...
	var url = "<%=path%>/ccapp/xtbg/yimingju/carmanage/jsp/carWxMxInfo.jsp?car_id="+model.car_id+"&isSp=yes"+"&passCheck=2";
