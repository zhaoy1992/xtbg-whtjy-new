...
$(function() {
	...
	$("#gridTable").jqGrid({
		...
		colNames: ['借阅详细ID','借阅类型id','借阅类型','件号','档号','文件标题','借阅人','借阅日期','借阅人所属部门','归还日期','归还经手人'],
    	...
    	{
   			name: 'f_back_username',
   			index: 'f_back_username',
   			width: '20'
    	}
		],
			...
			<table border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable_box" style="width: 100%">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					   ...
					   <td class="cx_title_td" style="width:180px;">
