...
<div class="content_02_top" style="margin-bottom:10px;" id="divA">
	<input type="button" class="but_y_01" value="退回" onclick="sendmsg();" id="btn_insert"/>
	<input type="button" class="but_y_01" value="返回" onclick="backTo();" id="btn_update"/>
</div>
<div class="content_02_box_title_bg"><span>退回</span></div>
<form id="conferenceBase" name="conferenceBase" method="post" action="filefilesquerydo.jsp">
<input type="hidden" name="action" value="filedoctodeptrollbackJSP"/>
<input type="hidden" name="filetype" value="<%=request.getParameter("type")%>"/>
...
<table id='formTable' border="0" cellspacing="0" cellpadding="0"  class="content_02_box_div_table" width="100%">
	<tr>
 	     <td width="10%" class="content_02_box_div_table_th"><font color='red'>*</font>退回理由：</td>
         <td  class="content_02_box_div_table_td" >
         	 <textarea  class="validate[required] textarea_575"  rows="8" cols=""  name="message_content" id="message_content"></textarea>
         </td>
     </tr>
	<tr>
    ...
    <tr>
 	     <td width="10%" class="content_02_box_div_table_th">&nbsp;&nbsp;提醒内容：</td>
         <td  class="content_02_box_div_table_td" >
         	 <textarea  class="textarea_575"  rows="8" cols=""  name="message_info" id="message_info"></textarea>
         </td>
     </tr>
</table>
</form>
