...
function loadOsAppItemObject(OsAppIds){
	var url = "<%=path %>/ccapp/xtbg/tjy/officesupplies/jsp/getbackosexaobjectajax.jsp";
...
function choseOsExa(){
	var path ="<%=path%>/ccapp/xtbg/tjy/officesupplies/jsp/osexaovernohavalist.jsp?windowsId=windowIds2";
