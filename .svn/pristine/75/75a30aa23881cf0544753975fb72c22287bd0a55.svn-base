...
<%
	...
	if(isEdit){
		...
		String appId = (String)request.getSession().getAttribute("subsystem_id_nouse");
...
<html>
	<head>
        ...
        <script type="text/javascript" src="./js/fcpub.js"></script>		
			...
			<form method="post" name="formClassForm" action="addFormClass_do.jsp">
				<table width="100%" height="25" border="0" cellpadding="0" cellspacing="1" class="thin">
					...
					<tr class="tr">
						...
						<td height="25">
							<input type=text name="ec_sn" style="width=50%" maxlength="100" value="<%=isEdit?formClass.getEc_sn():ec_sn%>"/>
						</td>
					</tr>						
