...
<link rel="stylesheet" type="text/css" href="../../fceform/js/Ext/css/ext-all.css" /><script>mylink.setAttribute('href',stylePath+'css/creatorBlue/allStyle.css');var myhead = document.getElementsByTagName('head')[0];myhead.appendChild(mylink);fcpubdata.creatorStyle='creatorBlue';</script><script language='javascript'>adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/fcsavedj.js');adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/fcbasecont.js');adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/selectdate.js');adv_loadjsfile('eformsys/jxc/dj/../../fceform/../fceformext/js/userfunc.js');adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/fcdate.js');</script><link href=../../fceform/css/tabstyle.css type=text/css rel=stylesheet><link type='text/css' rel='stylesheet' href='../../fceform/css/Button.css'/><link type='text/css' rel='stylesheet' href='../../fceform/css/TextStyle.css'/><link rel='stylesheet' type='text/css' href='../../fceform/js/Ext/css/SwfUploadPanel.css' /><script type='text/javascript' charset='GBK' src='../../fceform/js/Ext/SwfUpload.js'></script><script type='text/javascript' charset='GBK'src='../../fceform/js/Ext/SwfUploadPanel.js'></script><link rel='stylesheet' href='../../../FusionCharts/Contents/Style.css' type='text/css' /><script type='text/javascript' charset='GBK' src='../../../FusionCharts/JSClass/FusionCharts.js'></script><script type='text/javascript' charset='GBK' src='../../../FusionCharts/jquery-1.2.6.min.js'></script><script type='text/javascript' charset='GBK' src='../../../s2u.js'></script>
<script>function init(){
creator_newWebOffice(".doc","修改无痕迹","sdfsdf")
}</script><DIV id=SKbillsheet jslib="fcsavedj.js&#13;&#10;fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js" creatorType="20090826084448609544" type="ZW" toolbar="不带工具栏" testDbName dj_sn="20090702150743267323" caption="测试word跟office" mkbh creatorStyle="creatorBlue" codeheader="BBB" keyfield BLONopen="setAuthority();" BLONclose="UnLoadWebOffice();" window="当前窗口" entertype="修改" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" posleft postop poswidth posheight isfile="否" OtherSave="否" creator_csslib idtype="1" version="1.0" creator_pagination billtaborder="<root><taborder>workflowControl_selectAct</taborder><taborder>button_xzxr</taborder><taborder>button_yfzxzxr</taborder><taborder>button_qdlc</taborder><taborder>button_wchd</taborder><taborder>button_ht</taborder><taborder>button_hs</taborder><taborder>button_zc</taborder><taborder>DYNAMICPERFORMER_NAME</taborder><taborder>DYNAMICPERFORMER</taborder><taborder>ANDSPLITUSERS_ACTNAME</taborder><taborder>ANDSPLITUSERS</taborder><taborder>workflowControl_result</taborder></root>" controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:0;text:0;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:1;ExtTree:0;Fusionchar:0" contxml="<root><combobox><id>workflowControl_selectAct</id></combobox><div><id>workflowControl_selectAct_div</id><id>workflowControl_selectUser</id><id>workflowControl_selectAndUser</id><id>workflowControl_start</id><id>workflowControl_complete</id><id>workflowControl_back</id><id>workflowControl_recycle</id><id>workflowControl_tempSaveForm</id><id>workflowControl_backToPrior</id></div><button><id>button_xzxr</id><id>button_yfzxzxr</id><id>button_qdlc</id><id>button_wchd</id><id>button_ht</id><id>button_hs</id><id>button_zc</id></button><text><id>DYNAMICPERFORMER_NAME</id><id>DYNAMICPERFORMER</id><id>ANDSPLITUSERS_ACTNAME</id><id>ANDSPLITUSERS</id><id>workflowControl_result</id></text><ExtUpload><id>ExtUpload1</id></ExtUpload></root>">&nbsp;
<DIV id=div_ExtUpload1 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV>&nbsp;
<SCRIPT type=text/javascript>Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';var w_ExtUpload1 = 489;var h_ExtUpload1 = 256;var upobj_ExtUpload1;var fileListGrid_ExtUpload1;var del_ExtUpload1 = eval('true');var isflow = IsSpace(fcpubdata.cc_form_instanceid)?-1:1;var ExtUpload1_retint = 0;var ExtUpload1_onReady = function(){if(ExtUpload1_retint==0) {ExtUpload1_retint = setInterval(ExtUpload1_onReady,200);return;}if(document.readyState!="complete") return;clearInterval(ExtUpload1_retint);ExtUpload1_retint = null ;var urls = eval('getContextPath()');var _djsn = localWindowParams("djsn");var _djid = localWindowParams("djid");var _djbh = localWindowParams("djbh");if(typeof(creator_pt_djbh)!='undefined') _djbh=creator_pt_djbh;if(IsSpace(_djbh)&&isflow==-1) return;var urls = urls+'/servlet/CreatorPTServlet?key=ExtUpload';urls += '&uploadid=ExtUpload1';urls += '&djsn='+_djsn;urls += '&djid='+_djid;urls += '&djbh='+_djbh;urls += '&savetofile=undefined';urls += '&savefiledir=undefined';var uploadFinishFlag = false;	function createUpload(){	var uploader = new Ext.ux.SwfUploadPanel({		title: '上传文件'		, width: w_ExtUpload1		, height: h_ExtUpload1		,collapsible : true		,file_size_limit : '16000'		,fc_addfiles : true		,fc_delfiles : true		,fc_uploadfiles :true		, upload_url:urls		, flash_url: '../../fceform/js/Ext/swfupload.swf'		, single_file_select: false		, confirm_delete: false		, remove_completed: false        , file_types : '*.*'	});	uploader.on('uploadStart',function(obj,file){		var note = obj.store.getById(file.id).get('note');note=IsSpace(note)?"":note;		this.addPostParam( 'note',note );		if(IsSpace(_djbh) && isflow==1) {this.addPostParam( 'cc_form_instanceid',fcpubdata.cc_form_instanceid);}	});	uploader.on('swfUploadLoaded',function(obj,file){		uploader.focus();	});	uploader.on('startUpload', function(t) {	});	uploader.on('fileDialogStart', function(t) {if(uploadFinishFlag) {t.store.removeAll(); uploadFinishFlag=false;};	});  uploader.on('fileUploadSuccess',function(t,file,data){t.store.getById(file.id).set('attachid',data.attachid);fcpubdata.cc_form_instanceid=data.cc_form_instanceid;}); uploader.on('allUploadsComplete', function(t, file){ fileListGrid_ExtUpload1.store.reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});uploadFinishFlag=true;});	upobj_ExtUpload1 = uploader;	return uploader;	}function createGridList(){	var uploadRecode = Ext.data.Record.create([        {name: 'refid', type: 'string'},        {name: 'addTime', type: 'string'},        {name: 'filename', type: 'string'},        {name: 'filetype', type: 'string'},        {name: 'note', type: 'string'},        {name: 'attachid', type: 'string'}    ]);    var store = new Ext.data.Store({        proxy: new Ext.data.HttpProxy({url: urls+'&showlist=showlist'}),        reader: new Ext.data.JsonReader({        totalProperty: 'totalCount',        root: 'result'        },uploadRecode)  });       var sm =new Ext.grid.CheckboxSelectionModel();       sm.handleMouseDown = Ext.emptyFn;        var cm = new Ext.grid.ColumnModel([        new Ext.grid.RowNumberer(),        sm,        {header: '文件名', dataIndex: 'filename',width: '20%',renderer:function(val){return decodeURI(val);}},        {header: '添加时间', dataIndex: 'addTime',width: '20%'},		{header: '类型', dataIndex: 'filetype',width: '20%',renderer:function(val){return decodeURI(val);}},        {header: '备注', dataIndex: 'note',width: '20%',renderer:function(val){return decodeURI(IsSpace(val)?"":val);}}    ]);        cm.defaultSortable = true;if(!del_ExtUpload1){cm.setHidden(1,!del_ExtUpload1);}        var grid = new Ext.grid.GridPanel({        title: '已上传文件列表',        region: 'center',        loadMask: true,        width: w_ExtUpload1,	    height: h_ExtUpload1,             margins : '0 0 0 0',        store: store,        cm: cm,        sm: sm,        tbar: [        {            text: '删除',        iconCls:'deletepanel',            xtype:del_ExtUpload1?"":'hidden',            handler :deleteGrid        },'->'        ],        viewConfig: {        columnsText:'显示的列',        sortAscText:'升序',        sortDescText:'降序',        forceFit: true		}    });	grid.on('rowdblclick',function(g,index){		 window.open(getContextPath()+'/servlet/CreatorPTServlet?key=Extdownload&refid='+g.getStore().getAt(index).get('refid'));	});    store.load({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});	fileListGrid_ExtUpload1  = grid ;    return grid;}function deleteGrid(){ var rows = fileListGrid_ExtUpload1.getSelectionModel().getSelections();				if(rows.length==0){				Ext.MessageBox.alert('警告', '最少选择一条信息，进行删除!');				}else{				Ext.MessageBox.confirm('提示框', '您确定要进行该操作？',function(btn){				 var delid="";				if(btn=='yes'){    					for(var i=0;i<rows.length;i++){					 delid=delid+rows[i].get('refid')+'^';   					}				  Ext.Ajax.request({                  url : urls,                 method : 'POST',                  params : {                      ids : delid,					  deletes :'delete'	                  },                      success: function(response, options) {                       var responseArray = Ext.util.JSON.decode(response.responseText);                            if(responseArray.success==true){								fileListGrid_ExtUpload1.getStore().reload({params:{cc_form_instanceid:fcpubdata.cc_form_instanceid}});                            }                            else{                                Ext.Msg.alert('失败',responseArray.msg);                            }                         }              });				}  		});	}}    var panel = new Ext.TabPanel({             title : '上传控件面板',             renderTo:'div_ExtUpload1',             id : 'div_ExtUpload1',             width : w_ExtUpload1+10,             height : h_ExtUpload1+10,             frame:true,			 activeTab: 0,             margins : '0 0 0 0',             minHeight : 100,             autoHeight : false,             items : [				createUpload(),				createGridList()             ]             });if(localWindowParams('operType')=='readonly'){panel.setActiveTab(panel.items.item(1));panel.items.item(0).setDisabled(true);panel.items.item(1).getTopToolbar().setVisible(false);}if(typeof(creator_pt_uppanels)=='undefined'){creator_pt_uppanels=new Array();}creator_pt_uppanels.push({id:'ExtUpload1',obj:panel});if(typeof(onUpPanelLoaded)=='function') setTimeout(onUpPanelLoaded,0);};function dodoupload(){upobj_ExtUpload1.startUpload();}ExtUpload1_onReady();</SCRIPT>
