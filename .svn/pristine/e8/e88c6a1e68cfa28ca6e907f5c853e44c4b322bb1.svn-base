...
EAL.prototype = {
	...
	start : function(id) {
		...
		//alert("father.name is "+father.name+" and father.id is "+father.id);
...
EAL.prototype.resize_area = function(e) {
	...
	if (allow == "both" || allow == "y") {
		...
		alert(document.getElementById("edit_area_resize"));
