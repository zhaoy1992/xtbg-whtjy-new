...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.detectionsupplies.list.OsUserTypeItemList";
...
var addLevel = function() {
 	var pageName ="添加物品规格";
	openAlertWindows('windowId',"../../../tjy/detectionsupplies/type/jsp/osusertypeIteminfo.jsp?windowsId=windowId&actionName=insert",pageName,500,205,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改物品规格";
	openAlertWindows('windowId','../../../tjy/detectionsupplies/type/jsp/osusertypeIteminfo.jsp?windowsId=windowId&actionName=update&it_id='+ model.it_id,pageName,500,205,'25%','25%');
}
