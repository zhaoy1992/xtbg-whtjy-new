...
var PageParms = {
    ...
    ecId : IsSpace(creator_getQueryString("ec_id"))? "1341":creator_getQueryString("ec_id"),//事项ID
...
function sendWork(){
 ...
 if($("workflowControl_selectAct").options.length>0 && $("workflowControl_selectAct").options[$("workflowControl_selectAct").selectedIndex].text=="退窗"){
    result="否";
 }
...
function backWork(){
 ...
 if(!bool) return;
 creator_setSession("cc_form_instanceid",PageParms.ccFormId);
 InsertTask(getTaskData("否"));
 creator_djsave('回退',false,true,'../../../common_workflow/main.jsp')
}
...
<TABLE width="100%">
   <TBODY>
      ...
      <TR>
         <TD vAlign=top align=right><BUTTON class=btn id=btnHistory onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("showFlowHistoryByInsId(PageParms.procInsId);")'>办理历史</BUTTON><BUTTON class=btn id=btnViewBaseInfo onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("openBaseInfoView()")'>查看审批规范</BUTTON><BUTTON class=btn id=btnBack2List onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("history.back(-1);")'>返回</BUTTON><BUTTON class=btn id=btnReject style="DISPLAY: none" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("doReject()")'>退窗</BUTTON><BUTTON class=btn_long id=workflowControl_resume onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("openSpecialResultView()")'>恢复</BUTTON><BUTTON class=btn id=btnWord onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("editWord()")'>WORD文档</BUTTON><BUTTON class=btn id=workflowControl_suspend style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("openSpecialApplyView()")'>挂起</BUTTON></TD>
      </TD>
   </TR>
   <TR>
      <TD>
               ...
               <TR>
                  <TD>
                     <TABLE class=table_function_other id=instanceDefaultHideArea style="DISPLAY: none" width="100%">
                        <TBODY>
                           <TR>
                              <TD class=color width="15%">备注<INPUT id=STATUS style="DISPLAY: none; LEFT: 0px; WIDTH: 21px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() size=3 controltype="text" field="STATUS" china="STATUS" dataset="instanceDataset"></TD>
                     ...
                     <TABLE class=table_function_other id=applyCorpDefaultHideArea style="DISPLAY: none" width="100%">
                        <TBODY>
                           ...
                           <TR>
                              ...
                              <TD width="35%"><SELECT id=CORP_TYPE style="WIDTH: 100%; POSITION: static; HEIGHT: 25px" disabled onmovestart=moveStart() sqltrans controltype="combobox" field="CORP_TYPE" china="CORP_TYPE" dataset="applycorpDataset" tempvalue="国有企业&#13;&#10;非国有企业" temptext="国有企业&#13;&#10;非国有企业" sql check="1" backwidth="229" backheight="25"><OPTION value=国有企业 selected>国有企业</OPTION><OPTION value=非国有企业>非国有企业</OPTION></SELECT></TD>
                              <TD width="15%"></TD>
                              <TD></TD>
                           </TR>
                           <TR>
      ...
      <TD>
         <TABLE class=table_sidle width="100%">
            <TBODY>
               <THEAD>
                  <TR>
                     <TD width="30%">常用意见<IMG id=imgMemo style="LEFT: 0px; POSITION: static; TOP: 0px" onclick=openMemoView() onmovestart=moveStart() height=13 src="../../../ccapp/app_5/images/edit.gif" width=15 controltype="img" srcsk="../../../ccapp/app_5/images/edit.gif"></TD>
                     <TD>处理意见<FONT color=red>*</FONT></TD>
                  </TR>
               </THEAD>
               <TBODY>
                  <TR>
                     ...
                     <TD><TEXTAREA id=HANDLE_AREA style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 77px" onmovestart=moveStart() rows=1 cols=110 controltype="textarea" value="textarea1" induce="否"></TEXTAREA></TD>
                  </TR>
               </TBODY>
            </TABLE>
         </TD>
