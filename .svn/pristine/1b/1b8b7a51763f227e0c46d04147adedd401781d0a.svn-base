          ...
          <td bgcolor="D7D7D7"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            ...
            <tr >
              <td height="77" colspan="4" valign="top" background="../images/toolbar_common_func_gallery.jpg"><table width="96%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="28">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 图片添加</td>
                </tr>
                <tr>
                  <td height="48" valign="bottom" style="padding-bottom:0px"><div align="right"><span class="STYLE6">图片按默认大小上传至图库</span><img src="../images/tan.gif" width="11" height="11"></div></td>
                </tr>
              </table></td>
              </tr>
            <tr >
              ...
              <td height="20" colspan="2">&nbsp;<span class="cms_title_blue">图片添加</span></td>
              </tr>
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td width="26%">&nbsp;</td>
              <td width="70%" height="27"><div align="left">当前图库:         
                <input  name="parentsiteid3" type="text" class="cms_text" id="parentsiteid3" value="网页常用素材" size="30"  readonly />
            ...
            <tr>
              ...
              <td>&nbsp;</td>
              <td align="center">&nbsp;</td>
              <td height="27" align="center"><div align="left">图片描述:
            ...
            <tr>
              <td height="22" colspan="4"><div align="center">
                <input name="btn_close" type="submit" class="cms_button"  value="入库" />
