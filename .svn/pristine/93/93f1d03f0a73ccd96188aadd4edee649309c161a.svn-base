...
if(!bDgMode) out.println("  adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/../../../ccapp/app_xzcf/js/vo/EvidenceVo.js');");
if(bDgMode) out.println("<script src='../../fceform/js/../../../ccapp/app_xzcf/js/vo/EvidenceVo.js'></script>");
if(!bDgMode) out.println("  adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/../../../ccapp/app_xzcf/js/business/Evidence.js');");
if(bDgMode) out.println("<script src='../../fceform/js/../../../ccapp/app_xzcf/js/business/Evidence.js'></script>");
if(!bDgMode) out.println("  adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/../../../ccapp/app_xzcf/js/dao/EvidenceDao.js');");
if(bDgMode) out.println("<script src='../../fceform/js/../../../ccapp/app_xzcf/js/dao/EvidenceDao.js'></script>");
...
<!-- 提示：以下为页面自定义JS内容 -->
<script>
var or_id = creator_getQueryString("or_id");//获取违法记录的ID
var djbh = "<%=request.getParameter("djbh")%>" 
if(IsSpace(djbh )) {
   
    document.location.href += "&djbh=" + 123;
}
...
function  addEvidence(){
   ...
   var obj=new EvidenceVo.evidence();
   var vo=DBUtil.getVoFromPage(obj);
   if(insert_validate()){
       vo.OR_ID=or_id;
     var  rv= Evidence.saveEvidence(vo);
     if(rv){
        alert("保存成功!");
    }
     else {
...
function insert_validate(){
    ...
    //证据材料类型
    if(flag){
       flag = SValidator.validate(${'MT_ID'}.value, {
        CHECK_TYPE : "required",
        ARGUMENT : {placeholders : ["证据材料类型"]}
        }, true);
    }
      //采集日期
    if(flag){
       flag = SValidator.validate(${'EL_ACQUISITION_TIME'}.value, {
        CHECK_TYPE : "required",
        ARGUMENT : {placeholders : ["采集日期"]}
        }, true);
    }
    if(flag){
        if(!isdate(${'EL_ACQUISITION_TIME'}.value)){
           alert("日期格式错误，只能如2000-10-11的形式");
           flag=false
        }
     }
     //材料名称
    ...
    if(flag){
       flag = SValidator.validate(${'EL_NUM'}.value, {
        CHECK_TYPE : "required",
        ARGUMENT : {placeholders : ["材料份数"]}
        }, true);
    }
    if(flag){
        if(!isdigit(${'EL_NUM'}.value)){
            alert("材料份数只能是数字");
            flag=false;
        }
     }
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();" contxml="<root><textarea><id>EL_REMARK</id></textarea><combobox><id>MT_ID</id></combobox><button><id>button1</id><id>button2</id></button><text><id>EL_ACQUISITION_TIME</id><id>EL_DESCRIPTION</id><id>EL_NUM</id></text><ExtUpload><id>ExtUpload1</id></ExtUpload></root>" billtaborder="<root><taborder>EL_REMARK</taborder><taborder>MT_ID</taborder><taborder>EL_ACQUISITION_TIME</taborder><taborder>EL_NUM</taborder><taborder>button1</taborder><taborder>EL_DESCRIPTION</taborder><taborder>button2</taborder></root>" dj_sn="20100919103433319897" caption="添加证据" mkbh codeheader="BBB" entertype="修改" poswidth="760px" posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:1;combobox:2;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:2;text:4;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:1;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName="app_xzcf" creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100902181244984828" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Namespace.js&#13;&#10;../../../ccapp/app_xzcf/js/common/nsreg.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Common.js&#13;&#10;../../../ccapp/app_xzcf/js/vo/EvidenceVo.js&#13;&#10;../../../ccapp/app_xzcf/js/business/Evidence.js&#13;&#10;../../../ccapp/app_xzcf/js/dao/EvidenceDao.js">
         ...
         <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=1>
               <TBODY>
                  ...
                  <TR>
                     <TD vAlign=top align=right width="15%">&nbsp;证据材料类型：</TD>
                     <TD width="30%">&nbsp;<SELECT id=MT_ID style="LEFT: 0px; WIDTH: 219px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() sqltrans="%F4%D8%E6%D8%D4%F6Xrn%F6j%E8%F6%CC%E0%D6Xr%94%F6j%E8%F6%CC%EA%D0%E8%D8Xrn%DA%F2%EC%E8Xrn%F6%D0%CC%E8%D0%F6%D8%F2%E0%D0%E6%CC%F6%u0100%EE%D8Xrn%F6" controltype="combobox" tempvalue temptext sql check="2"></SELECT></TD>
                     <TD vAlign=top align=right width="15%">采集日期：</TD>
                     <TD width="30%"><P>&nbsp;<INPUT id=EL_ACQUISITION_TIME style="LEFT: 0px; WIDTH: 155px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() size=28 controltype="text" onclick='bill_onclick("SelectDate()")'></P></TD>
                  </TR>
                  <TR>
                     <TD vAlign=top align=right width="15%">材料名称：</TD>
                     <TD width="30%" colSpan=3><INPUT id=EL_DESCRIPTION style="LEFT: 0px; WIDTH: 68%; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() controltype="text"></TD>
                  </TR>
                  <TR>
                     <TD vAlign=top align=right width="15%">&nbsp;简要描述：</TD>
                     <TD colSpan=3>&nbsp;<TEXTAREA id=EL_REMARK style="LEFT: 0px; WIDTH: 68%; POSITION: static; TOP: 0px; HEIGHT: 85px" onmovestart=moveStart() controltype="textarea" value="textarea1" induce="否"></TEXTAREA></TD>
                  </TR>
                  <TR>
                     <TD vAlign=top align=right width="15%">材料份数：&nbsp;</TD>
                     <TD width="30%">&nbsp;<INPUT id=EL_NUM style="LEFT: 0px; WIDTH: 82px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() size=14 controltype="text"></TD>
                     <TD width="15%">&nbsp;</TD>
                     <TD width="30%">&nbsp;</TD>
                  </TR>
                  <TR>
                     <TD vAlign=top align=right width="15%">证据上传：</TD>
                     <TD width="30%" colSpan=3><DIV id=div_ExtUpload1 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV>&nbsp;<SCRIPT type=text/javascript>
Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';
var w_ExtUpload1 = 523;
var h_ExtUpload1 = 149;
...
upobj_ExtUpload1.startUpload();
                  ...
                  <TR>
                     ...
                     <TD width="30%" colSpan=3><BUTTON id=button1 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("addEvidence()")'>确定</BUTTON>&nbsp;&nbsp;<BUTTON id=button2 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button">关闭</BUTTON></TD>
                  </TR>
                  <TR>
                     <TD colSpan=4>&nbsp;</TD>
                  </TR>
