...
public class ArchiveToGWCSService_ServiceLocator extends org.apache.axis.client.Service implements com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSService_Service {
    ...
    private java.lang.String ArchiveToGWCSServiceImplPort_address = "http://172.16.17.147:8888/gwcs/services/ArchiveToGWCSService";
    ...
    public com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSService_PortType getArchiveToGWCSServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSService_PortType getArchiveToGWCSServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSServiceSoapBindingStub _stub = new com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSServiceSoapBindingStub _stub = new com.chinacreator.xtbg.pub.oagwcs.oa.service.ArchiveToGWCSServiceSoapBindingStub(new java.net.URL(ArchiveToGWCSServiceImplPort_address), this);
                _stub.setPortName(getArchiveToGWCSServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
