  ...
  <tr >
     ...
     <select name="allist"  multiple style="width:80%" onDBLclick="addOrg()" size="18">
		  <pg:list requestKey="allOrg">
			...
			<pg:null colName="orgName"><pg:cell colName="remark5"/></pg:null>
			<pg:notnull colName="orgName">
				<pg:equal colName="orgName" value=""><pg:cell colName="remark5"/></pg:equal>
				<pg:notequal colName="orgName" value=""><pg:cell colName="orgName"/></pg:notequal>
			</pg:notnull>
			</option>
		  </pg:list>			
	</select>
