...
<%
	...
	String appUrl = "report_tree.jsp?appId=" + appId;
%>
<html>
	<head>
	...
	<%@ include file="/epp/css/cssControl.jsp"%><body
		...
		<table width="100%" height="100%" border="0" cellpadding="0"
			...
			<tr>
				<td>
					<tab:tabContainer id="report-class-tab"
						selectedTabPaneId="pt-report-class">
						<tab:tabPane id="pt-eform-class" tabTitle="平台" lazeload="true">
							<tab:iframe id="orgmanage" src="report_tree.jsp?appId=module"
								frameborder="0" scrolling="no" width="100%" height="95%">
							</tab:iframe>
						</tab:tabPane>
						<%if(!"module".equals(appId)){ %>
						<tab:tabPane id="yy-report-class" tabTitle="应用" lazeload="true">
