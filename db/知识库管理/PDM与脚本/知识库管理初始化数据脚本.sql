delete OA_DICT_DATA d where d.dict_id = '97764a38-8572-4dba-8e00-8f0c323d0ef0';
commit;
delete OA_DICT_TYPE t where t.dict_id = '97764a38-8572-4dba-8e00-8f0c323d0ef0';
commit;
insert into OA_DICT_TYPE (dict_id, dict_parent_id, dict_name, dict_code, dict_remark, dict_is_valid, dict_order, dict_type)
values ('97764a38-8572-4dba-8e00-8f0c323d0ef0', '0', '文档状态', 'wdzt', '文档审核可否下载的状态', '1', 1, '0');
commit;
...
values ('0a7f98af-2160-4a54-b99c-9510294542cb', '97764a38-8572-4dba-8e00-8f0c323d0ef0', '0', '待审', '0', null, '1', 2);
insert into OA_DICT_DATA (dictdata_id, dict_id, dictdata_parent_id, dictdata_name, dictdata_value, dictdata_remark, dictdata_is_valid, dictdata_order)
values ('2bb4b4a4-f03b-4f11-84af-2d7f75f1c3cd', '97764a38-8572-4dba-8e00-8f0c323d0ef0', '0', '审核不通过', '2', null, '1', 4);
insert into OA_DICT_DATA (dictdata_id, dict_id, dictdata_parent_id, dictdata_name, dictdata_value, dictdata_remark, dictdata_is_valid, dictdata_order)
values ('0bb487a4-12b6-440b-b647-cc8fc682efb3', '97764a38-8572-4dba-8e00-8f0c323d0ef0', '0', '草稿', '3', null, '1', 1);
insert into OA_DICT_DATA (dictdata_id, dict_id, dictdata_parent_id, dictdata_name, dictdata_value, dictdata_remark, dictdata_is_valid, dictdata_order)
values ('666cc162-e8c6-49c8-871a-ca2727bf585f', '97764a38-8572-4dba-8e00-8f0c323d0ef0', '0', '审核通过', '1', null, '1', 3);
commit;
...
delete  from TD_SM_ROLE  t where t.role_name = '知识库管理员';
commit;
insert into TD_SM_ROLE (role_id, role_name, role_type, role_desc, role_usage, remark1, remark2, remark3, owner_id)
values (SEQ_TD_SM_ROLE.NEXTVAL, '知识库管理员', '1', '知识库 的 管理员', null, null, null, null, 1);
commit;
