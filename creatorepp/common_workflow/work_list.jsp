...
<%
	...
	//add by minghua.guo[2011-04-14]兼职借调处理 是否启动兼职借调 
...
<%}%>
	...
	// add by yaohui.luo	2008-10-15
	// 根据活动实例id获得活动状态
	function isActivityOnUse(actInsId) {
		var ret = sendWorkflowOperationRequest("isactivityonuse",actInsId);
		if (ret == 'true') {
			alert("该任务已被其它执行人打开！");
			return;
		}
	...
	function orderList(ordercon) {
		...
		var url = "work_list.jsp?ordercondition=" + ordercon + orderType;
	...
	<body class="contentbodymargin" scrolling="no">
		<div id="contentborder" align="center">
			<FORM name="work" id="work" action="work_list.jsp" method="post" onsubmit="validateForm(this)">				
				...
				<TABLE width="100%" cellpadding="1" cellspacing="1"
					...
					<pg:listdata dataInfo="com.chinacreator.commonworkflow.list.SHKWorkList" keyName="SHKWorkList" />
					<pg:pager maxPageItems="10" scope="request" data="SHKWorkList"
						isList="false">
						<tr>
						<%
						...
						<pg:list>
							...
							<tr class="labeltable_middle_tr_01"
								...
								//modify by minghua.guo[2011-04-14]兼职借调处理 是否启动兼职借调 
								%>
