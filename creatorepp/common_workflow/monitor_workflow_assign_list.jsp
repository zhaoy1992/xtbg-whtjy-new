...
<%
	...
	String tableName = "V_APP_PROCESS_ASSIGN_LIST";
...
<html>
	...
	function handle(procInsId){
      ...
      window.open("monitor/ShowProcessInstanceMonitor.jsp?procInsId="+procInsId,"","height=630,width=850,status=yes,toolbar=no,menubar=no,location=no");
	}
	function search(){
	...
	function orderList(ordercon) {
		...
		var url = "monitor_workflow_assign_list.jsp?ordercondition=" + ordercon + orderType;
		document.location = url;
	}
</script>
	<%@ include file="/epp/css/cssControl.jsp"%><body class="contentbodymargin"  scrolling="no">
		<div id="contentborder" align="center">
			<FORM name="work" id="work" action="monitor_workflow_assign_list.jsp" method="post" onsubmit="validateForm(this)">			
			<table width="100%" border="0" cellpadding="1" cellspacing="1"
				...
				<TABLE width="100%" cellpadding="1" cellspacing="1" bordercolor="#EEEEEE" class="thin">
					<pg:listdata dataInfo="com.chinacreator.commonworkflow.list.SHKMonitorWorkAssignList" keyName="SHKMonitorWorkAssignList" />
					<pg:pager maxPageItems="10" scope="request" data="SHKMonitorWorkAssignList" isList="false">
					<tr>
						<%
