...
var panel = new Ext.FormPanel({   
	...
	items:[{
		...
		items:[
			...
			{xtype: 'label', html: '<input type="text" id="AUTOASSIGNMENT" width="100%"/>'},
			{xtype: 'textfield',name: 'activityId',cls: 'x-hidden'}
		]
	},{
		layout:"column", 
		items:[
			{xtype: 'checkbox',boxLabel: '动态选择执行人', name: 'DYNAMICPERFORMER',width:'33%'},
			...
			{xtype: 'checkbox',boxLabel: '<span ext:qtip="影响动态选择执行人">动态选人只显示本机构用户</span>', name: 'CURRENTORGUSER',width:'33%'},
			{xtype: 'checkbox',boxLabel: '<span ext:qtip="不能在与分支环节使用">手动指定下一步活动</span>', name: 'NEXT_ACT',width:'33%'},
			{xtype: 'checkbox',boxLabel: '活动自动完成', name: 'AUTO_COMPLETE',width:'33%'}
		]
	}],   
	buttons: [{
            text: '保存',
