...
<%
	...
	String tableName = "V_APP_SUSPENDWORK_LIST";
...
<html>
	...
	function handle(actInsId,busiId,moduleId,userName){
       document.location = "handle_suspend_work.jsp?actInsId="+actInsId+"&busiId="+busiId+"&moduleId="+moduleId+"&userName="+userName;
	}
	...
	function orderList(ordercon) {
		...
		var url = "suspend_work_list.jsp?ordercondition=" + ordercon + orderType;
	...
	<body class="contentbodymargin" scrolling="no">
		<div id="contentborder" align="center">
			<FORM name="work" id="work" action="suspend_work_list.jsp" method="post" onsubmit="validateForm(this)">
				...
				<TABLE width="100%" cellpadding="1" cellspacing="1"
					...
					<pg:listdata dataInfo="com.chinacreator.commonworkflow.list.SHKSuspendWorkList" keyName="SHKSuspendWorkList" />
					<pg:pager maxPageItems="10" scope="request" data="SHKSuspendWorkList"
						isList="false">
						<tr>
							<%
						...
						<pg:list>
							...
							<tr class="labeltable_middle_tr_01"
								...
								ondblclick="handle('<pg:cell colName="actInsId"/>','<pg:cell colName="busiId"/>','<%=moduleId %>','<pg:cell colName="curUserName"/>')">
								<%
								...
								%>
								<td class="tablecells" width="8%" nowrap="nowrap">
									<INPUT type="button" class="input" name="handle_ass" value="处理任务"
									 onclick="handle('<pg:cell colName="actInsId"/>','<pg:cell colName="busiId"/>','<%=moduleId %>','<pg:cell colName="curUserName"/>')">
								</td>
							</tr>
						</pg:list>
