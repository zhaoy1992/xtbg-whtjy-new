...
<%
	...
	String tableName = "V_APP_DONEWORK_LIST";
...
<html>
	...
	function handle(actInsId,busiId,procInsId,moduleId,userName){
       document.location = "handle_done_work.jsp?actInsId="+actInsId+"&busiId="+busiId+"&procInsId="+procInsId+"&moduleId="+moduleId+"&userName="+userName;
	}
	function orderList(ordercon) {
		...
		var url = "done_work_list.jsp?ordercondition=" + ordercon + orderType;
	...
	<body class="contentbodymargin" scrolling="no">
		<div id="contentborder" align="center">
			<FORM name="work" id="work" action="done_work_list.jsp" method="post" onsubmit="validateForm(this)">			
				...
				<TABLE width="100%" cellpadding="1" cellspacing="1"
					...
					<pg:listdata dataInfo="com.chinacreator.commonworkflow.list.SHKDoneWorkList" keyName="SHKDoneWorkList" />
					<pg:pager maxPageItems="10" scope="request" data="SHKDoneWorkList"
						isList="false">
						<tr>
							<%
						...
						<%
							...
							<tr class="labeltable_middle_tr_01"
								...
								ondblclick="handle('<pg:cell colName="actInsId"/>','<pg:cell colName="busiId"/>','<pg:cell colName="procInsId"/>','<%=moduleId%>','<pg:cell colName="curUserName"/>')">
								<%
								...
								<td class="tablecells" width="15%" nowrap="nowrap">
									<INPUT type="button" class="input" name="handle_ass" value="查看"
										onclick="handle('<pg:cell colName="actInsId"/>','<pg:cell colName="busiId"/>','<pg:cell colName="procInsId"/>','<%=moduleId%>','<pg:cell colName="curUserName"/>')">
								</td>
							</tr>
						</pg:list>
