...
/**
 * FusionCharts报表 载入函数
 * @param chartType 选择报表的展示图类型
 * @param divId 　指定报表展示位置
 * @param width，height　 图形宽　高　
 * @param dataFile 　指定数据或包含数据的文件路径
 * @autor zhiwu.chen 09/12/10
 */
function loadChart(chartType,divId,width,height,dataFile) {
  chartType = "../../FusionCharts/"+chartType;
  var chartId = "myChart_"+divId;
  var myChart = new FusionCharts(chartType,chartId,width,height);
