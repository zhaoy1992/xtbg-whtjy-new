...
<BUTTON id=button2 onmoveend=moveEnd() style="LEFT: 54px; WIDTH: 355px; POSITION: absolute; TOP: 41px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("open2();")' onreizeStart()>QMB-02顾客要求评审表</BUTTON>
...
<BUTTON style="LEFT: 54px; WIDTH: 355px; POSITION: absolute; TOP: 116px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("open4();")' oncontrol>QMB-04单项负责人审批表</BUTTON>
...
<BUTTON id=button7 style="LEFT: 54px; WIDTH: 355px; POSITION: absolute; TOP: 259px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("open7();")'>QMB-07</BUTTON>
</DIV>
