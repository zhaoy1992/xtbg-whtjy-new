...
if(!bDgMode) out.println("  adv_loadjsfile('eformsys/jxc/dj/../../fceform/js//userjs/myjs/test.js');");
if(bDgMode) out.println("<script src='../../fceform/js//userjs/myjs/test.js'></script>");
...
<script>
function myclick(){
   var myinput=trim($('text1').value);
   if(myCheckEmpty(myinput)){
   alert('empty');
   }
   else
   {
...
function test(){
    var sqls = new Array();
    var sql = "<no>insert into ta_duan(cc_form_instanceid,stu_id,xm,xb,score,remark) "+
    "values('12','S009','testa','female',50,'good')</no>";
    sqls.push(sql);
    var sql = "<no>insert into ta_duan(cc_form_instanceid,stu_id,xm,xb,score,remark) "+
    "values('2','S008','testb','female',89,'good')</no>";
    sqls.push(sql);
    alert(sqls.join(","));
    InsertSqls(sqls.join(""));    
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();" contxml="<root><button><id>button1</id><id>button2</id></button><text><id>text1</id></text><dataset><id>dataset1</id></dataset><ExtGrid><id>ExtGrid1</id></ExtGrid></root>" billtaborder="<root><taborder>button1</taborder><taborder>text1</taborder><taborder>button2</taborder></root>" dj_sn="20100122102203845798" caption="js和CSS应用" mkbh codeheader="STU" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:2;text:1;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:1;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:1;ExtUpload:0;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield="cc_form_instanceid" isfile="否" OtherSave="否" idtype="2" testDbName creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20091219104852735215" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js&#13;&#10;/userjs/myjs/test.js">

<INPUT id=text1 style="LEFT: 0px; WIDTH: 110px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() controltype="text">

<BUTTON id=button1 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("myclick()")'>button1</BUTTON>

<BUTTON id=button2 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("test()")'>测试insertsqls</BUTTON>
