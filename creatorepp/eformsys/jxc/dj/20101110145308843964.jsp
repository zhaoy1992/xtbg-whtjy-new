...
if(!bDgMode) out.println("  adv_loadjsfile('eformsys/jxc/dj/../../fceform/js/../../../ccapp/app_xzcf/js/word/report/WordReport.js');");
if(bDgMode) out.println("<script src='../../fceform/js/../../../ccapp/app_xzcf/js/word/report/WordReport.js'></script>");
...
<TABLE height="100%" width="100%" border=1>
   <TBODY>
      ...
      <TR>
         <TD height=40><DIV align=center><BUTTON id=savaButton style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("SaveWordInstance();")'>保存</BUTTON><BUTTON id=refreshButton style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("updateData();")'>刷新数据</BUTTON><BUTTON id=button7 style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("WebCopysCtrlPrint();")'>打印</BUTTON><BUTTON id=button8 style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("close_window();")'>关闭</BUTTON></DIV></TD>
      </TR>
   </TBODY>
</TABLE>
</DIV>
