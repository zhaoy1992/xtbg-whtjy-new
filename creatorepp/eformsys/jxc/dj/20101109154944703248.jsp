...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
   <TBODY>
      <TR>
         <TD>
            <TABLE class=Ctable cellSpacing=0 cellPadding=0 width="100%" border=0>
               <TBODY>
                  <TR>
                     <TD width="20%">控件类型<FONT color=red>*</FONT></TD>
                     <TD colSpan=3><SELECT id=kj_type style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() onchange='bill_onclick("kjQuery();")' sqltrans controltype="combobox" tempvalue="&#13;&#10;autoText&#13;&#10;orderlyTable&#13;&#10;textInput&#13;&#10;dropDown" temptext="--请选择--&#13;&#10;自动文本&#13;&#10;有序表格&#13;&#10;输入框&#13;&#10;下拉框" sql check="1"><OPTION value="" selected>--请选择--</OPTION><OPTION value=autoText>自动文本</OPTION><OPTION value=orderlyTable>有序表格</OPTION><OPTION value=textInput>输入框</OPTION><OPTION value=dropDown>下拉框</OPTION></SELECT></TD>
                  </TR>
                  <TR>
                     <TD width="20%">控件名称<FONT color=red>*</FONT><INPUT id=kj_id style="DISPLAY: none; LEFT: 0px; WIDTH: 110px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly controltype="text"></TD>
                  ...
                  <TR>
                     <TD width="20%" rowSpan=2>控件取值<FONT color=red>*</FONT></TD>
                     <TD width="20%"><INPUT id=kj_bllx type=radio value=1 name=kj_lx>变量</TD>
                     <TD colSpan=2><SELECT id=bl_name style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() sqltrans controltype="combobox" tempvalue='""' temptext="--请选择--" sql check="1"><OPTION value='""' selected>--请选择--</OPTION></SELECT></TD>
                  </TR>
                  <TR>
                     <TD width="20%"><INPUT id=kj_sjjlx type=radio value=2 name=kj_lx>数据集</TD>
                     <TD colSpan=2><SELECT id=sjj_name style="LEFT: 0px; WIDTH: 100%; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() sqltrans controltype="combobox" tempvalue='""' temptext="--请选择--" sql check="1"><OPTION value='""' selected>--请选择--</OPTION></SELECT></TD>
                  </TR>
               </TBODY>
            </TABLE>
         </TD>
      ...
      <TR>
         <TD align=right><BUTTON class=button id=btnSave style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("kjSave();")'>保存</BUTTON><BUTTON class=button id=btnDelete style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("kjDelete();")'>删除</BUTTON><BUTTON class=button id=btnReset style="LEFT: 0px; POSITION: static; TOP: 0px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("kjResert();")'>重置</BUTTON></TD>
      </TR>
      <TR>
         <TD><?xml:namespace prefix = fc /><fc:dataset id=dataset1 showtypeXml="<root><showType><name>checked</name><showRule>%5B%7Bshowtype%3A%27checkbox%27%7D%5D</showRule></showType></root>" columnHeight1Xml="undefined" columnWidth1Xml="<root><columnWidth1><name>checked</name><columnWidth2>20</columnWidth2></columnWidth1><columnWidth1><name>bl_mc</name><columnWidth2>50</columnWidth2></columnWidth1><columnWidth1><name>bl_ms</name><columnWidth2></columnWidth2></columnWidth1><columnWidth1><name>bl_mrz</name><columnWidth2>50</columnWidth2></columnWidth1><columnWidth1><name>bl_qz</name><columnWidth2>50</columnWidth2></columnWidth1></root>" format="<fields><field><fieldname>checked</fieldname><datatype>字符</datatype><displaylabel>全选</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype><showRule>%5B%7Bshowtype%3A%27checkbox%27%7D%5D</showRule></showtype><columnHeight1></columnHeight1><columnWidth1><columnWidth2>20</columnWidth2></columnWidth1></field><field><fieldname>name</fieldname><datatype>字符</datatype><displaylabel>控件名称</displaylabel><size>500</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>value_type</fieldname><datatype>字符</datatype><displaylabel>取值类型</displaylabel><size>30</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>value_name</fieldname><datatype>字符</datatype><displaylabel>取值名称</displaylabel><size>100</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>kj_type_name</fieldname><datatype>字符</datatype><displaylabel>控件类型</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>mb_id</fieldname><datatype>字符</datatype><displaylabel>模版ID</displaylabel><size>32</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>否</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>id</fieldname><datatype>字符</datatype><displaylabel>变量ID</displaylabel><size>32</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>否</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>value</fieldname><datatype>字符</datatype><displaylabel>取值</displaylabel><size>32</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>help</fieldname><datatype>字符</datatype><displaylabel>帮助</displaylabel><size>500</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>flag</fieldname><datatype>字符</datatype><displaylabel>状态</displaylabel><size>500</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>remark</fieldname><datatype>字符</datatype><displaylabel>备注</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>kj_type</fieldname><datatype>字符</datatype><displaylabel>类型</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field></fields>" onSetText='bill_ondatasetsettext("<dsid><checked></checked><name></name><value_type></value_type><value_name></value_name><kj_type_name></kj_type_name><mb_id></mb_id><id></id><value></value><help></help><flag></flag><remark></remark><kj_type></kj_type></dsid>")' onGetText='bill_ondatasetgettext("<dsid><checked></checked><name></name><value_type></value_type><value_name></value_name><kj_type_name></kj_type_name><mb_id></mb_id><id></id><value></value><help></help><flag></flag><remark></remark><kj_type></kj_type></dsid>")' onValid='bill_ondatasetvalid("<dsid><checked></checked><name></name><value_type></value_type><value_name></value_name><kj_type_name></kj_type_name><mb_id></mb_id><id></id><value></value><help></help><flag></flag><remark></remark><kj_type></kj_type></dsid>")' opensortno="1" temptable="TMP_DATASET2" multiResult="否"></fc:dataset><DIV id=div1 style="BORDER-RIGHT: black 0px solid; BORDER-TOP: black 0px solid; LEFT: 0px; OVERFLOW: auto; BORDER-LEFT: black 0px solid; WIDTH: 100%; BORDER-BOTTOM: black 0px solid; POSITION: static; TOP: 0px; HEIGHT: 200px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="div" NotBg="否"><IMG style="DISPLAY: none" src="undefined"><DIV id=div_ExtGrid1 style="LEFT: 0px; POSITION: static; TOP: 0px"></DIV><SCRIPT type=text/javascript>var ExtGrid1;
