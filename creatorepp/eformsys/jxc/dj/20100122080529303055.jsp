...
<BUTTON id=button_gq style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick="bill_onclick(&quot;creator_djsave('挂起',true,true,'../../../common_workflow/main.jsp')&quot;)">流程挂起</BUTTON>

<BUTTON id=button_hf style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick="bill_onclick(&quot;creator_djsave('恢复',true,true,'../../../common_workflow/main.jsp')&quot;)">流程恢复</BUTTON>
</DIV>
