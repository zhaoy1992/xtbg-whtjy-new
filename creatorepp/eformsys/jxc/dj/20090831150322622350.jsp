...
if(!bDgMode) out.println("  adv_loadjsfile('eformsys/jxc/dj/../../fceform/js//userjs/test.js');");
if(bDgMode) out.println("<script src='../../fceform/js//userjs/test.js'></script>");
