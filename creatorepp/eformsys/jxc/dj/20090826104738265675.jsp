...
<TD colSpan=3><INPUT class=nolinetext id=ITEM_NAME style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; WIDTH: 100%; BORDER-BOTTOM: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=65 controltype="text" dataset="baseInfoDataset" field="ITEM_NAME" china="审批项目名称"></TD></TR>
<TR>
<TD class=color width="15%">事项编码 </TD>
<TD width="35%"><INPUT class=nolinetext id=ITEM_CODE style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; WIDTH: 100%; BORDER-BOTTOM: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=22 controltype="text" dataset="baseInfoDataset" field="ITEM_CODE" china="审批项目编号"></TD>
<TD class=color width="15%">事项类型</TD>
<TD><SELECT id=TRANSTYPE style="WIDTH: 100%; HEIGHT: 25px" disabled onmovestart=moveStart() controltype="combobox" dataset="baseInfoDataset" field="TRANSTYPE" china="项目类型" temptext tempvalue check="2" sql backheight="25" backwidth="120" sqltrans="%F4%D8%E6%D8%D4%F6Xrn%F6%F2%D0%EA%F4%F6%u0100%EE%D8%CC%E0%D6Xr%94Xrn%F6%F2%D0%EA%F4%F6%u0100%EE%D8%CC%EA%D0%E8%D8Xrn%DA%F2%EC%E8Xrn%90%AE%AE%CCxj%F6%D0%CC%EE%D0%F2%D0%E8%CC%F6%F2%D0%EA%F4%F6%u0100%EE%D8"></SELECT></TD></TR>
<TR>
<TD class=color>事项类别</TD>
<TD><SELECT id=ITEM_TYPE style="WIDTH: 100%; HEIGHT: 25px" disabled onmovestart=moveStart() controltype="combobox" dataset="baseInfoDataset" field="ITEM_TYPE" china="项目类别" temptext tempvalue check="2" sql backheight="25" backwidth="120" sqltrans="%F4%D8%E6%D8%D4%F6Xrn%A0%B6%98%A8%B6%C0%AE%98%CC%BA%90%A6%B8%98Xr%94%A0%F6%D8%E8%F6%u0100%EE%D8%CC%EA%D0%E8%D8Xrn%DA%F2%EC%E8Xrn%90%AE%AE%CCxj%F6%D0%CC%EE%D0%F2%D0%E8%CC%A0%F6%D8%E8%F6%u0100%EE%D8"></SELECT></TD>
<TD class=color>服务类型</TD>
<TD><INPUT id=SERVICE_TYPENAME style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; LEFT: 0px; BORDER-LEFT: 0px; WIDTH: 100%; BORDER-BOTTOM: 0px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=16 controltype="text" dataset="baseInfoDataset" field="SERVICE_TYPENAME" china="SERVICE_TYPENAME"></TD></TR>
<TR>
<TD class=color>收费类型</TD>
<TD><SELECT id=ISCHARGE style="WIDTH: 100%; HEIGHT: 25px" disabled onmovestart=moveStart() controltype="combobox" dataset="baseInfoDataset" field="ISCHARGE" china="收费类型" temptext="不收费&#13;&#10;收费" tempvalue="N&#13;&#10;Y" check="1" sql backheight="25" backwidth="120" sqltrans><OPTION value=N selected>不收费</OPTION><OPTION value=Y>收费</OPTION></SELECT></TD>
<TD class=color>是否颁证</TD>
<TD><SELECT id=IS_CERTIFY style="WIDTH: 100%; HEIGHT: 25px" disabled onmovestart=moveStart() controltype="combobox" dataset="baseInfoDataset" field="IS_CERTIFY" china="证件颁证" temptext="是&#13;&#10;否" tempvalue="Y&#13;&#10;N" check="1" sql backheight="25" backwidth="120" sqltrans><OPTION value=Y selected>是</OPTION><OPTION value=N>否</OPTION></SELECT></TD></TR>
<TR>
<TD class=color>是否有效</TD>
<TD><SELECT id=IS_VALID style="WIDTH: 100%; HEIGHT: 25px" disabled onmovestart=moveStart() controltype="combobox" dataset="baseInfoDataset" field="IS_VALID" china="是否有效" temptext="有效&#13;&#10;无效" tempvalue="Y&#13;&#10;N" check="1" sql backheight="25" backwidth="122" sqltrans><OPTION value=Y selected>有效</OPTION><OPTION value=N>无效</OPTION></SELECT></TD>
<TD class=color>是否可外网预受理</TD>
<TD><SELECT id=IS_OUTERAPPLY style="WIDTH: 100%; HEIGHT: 25px" disabled onmovestart=moveStart() controltype="combobox" dataset="baseInfoDataset" field="IS_OUTERAPPLY" china="IS_OUTERAPPLY" temptext="是&#13;&#10;否" tempvalue="Y&#13;&#10;N" check="1" sql backheight="25" backwidth="120" sqltrans><OPTION value=Y selected>是</OPTION><OPTION value=N>否</OPTION></SELECT></TD></TR>
<TR>
<TD class=color>事项时限</TD>
<TD><INPUT class=nolinetext id=ITEM_LIMIT style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; WIDTH: 60px; BORDER-BOTTOM: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=10 controltype="text" dataset="baseInfoDataset" field="ITEM_LIMIT" china="ITEM_LIMIT">工作日</TD>
<TD class=color>顺序号</TD>
<TD><INPUT class=nolinetext id=ITEM_ORDER style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; LEFT: 0px; BORDER-LEFT: 0px; WIDTH: 100%; BORDER-BOTTOM: 0px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=16 controltype="text" dataset="baseInfoDataset" field="ITEM_ORDER" china="审批顺序"></TD></TR>
<TR>
<TD class=color>受理单位</TD>
<TD colSpan=3><INPUT class=nolinetext id=ORGNAME style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; WIDTH: 100%; BORDER-BOTTOM: 0px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=13 controltype="text" dataset="baseInfoDataset" field="ORGNAME" china="ORGNAME"></TD></TR>
<TR>
<TD class=color>备注</TD>
<TD colSpan=3><TEXTAREA id=REMARK style="WIDTH: 100%; HEIGHT: 29px" onmovestart=moveStart() rows=1 readOnly cols=86 controltype="textarea" dataset="baseInfoDataset" field="REMARK" china="描述" induce="否" value="textarea2"></TEXTAREA></TD></TR></TBODY></TABLE></TD></TR>
<TR>
<TD vAlign=top align=right colSpan=6>
<TABLE width="100%">
<TBODY>
...
<TD><TEXTAREA id=WORK_GUIDE style="WIDTH: 100%; HEIGHT: 67px" rows=5 readOnly controltype="textarea" dataset="extraInfoDataset" field="WORK_GUIDE" china="WORK_GUIDE" induce="否" value="textarea1" HEIGHT: WIDTH:>      </TEXTAREA></TD></TR>
<TR>
<TD class=color>办事流程</TD>
<TD><TEXTAREA id=WORK_FLOW style="WIDTH: 100%; HEIGHT: 58px" rows=1 readOnly controltype="textarea" dataset="extraInfoDataset" field="WORK_FLOW" china="WORK_FLOW" induce="否" value="textarea3" HEIGHT: WIDTH:>       </TEXTAREA> </TD></TR>
<TR>
...
<SCRIPT type=text/javascript>Ext.BLANK_IMAGE_URL = '../../fceform/js/Ext/images/default/s.gif';var ExtGrid6_retint = 0;var ExtGrid6_onReady = function(){var dataset = document.getElementById("flfgDataset");try{var temp = dataset .Fields.Field.length;}catch(e){if(ExtGrid6_retint==0) ExtGrid6_retint = setInterval(ExtGrid6_onReady,200);dataset =null;return;}finally{if(temp!=null)temp=null;}clearInterval(ExtGrid6_retint);ExtGrid6_retint = null ;var pagesize =5;dataset.PageSize = pagesize ;var mapping = creator_pt_getmapping(dataset);var store  = new Ext.data.Store({	proxy: new Ext.data.CreatorMemoryProxy("flfgDataset"), 	reader: new Ext.data.XmlStringReader({       record: 'tr',       totalRecords: 'pages'   }, mapping)});var sm = new Ext.grid.RowSelectionModel({singleSelect: true});var retcm = creator_pt_getcm(dataset,sm);var cm = new Ext.grid.ColumnModel(retcm);if(typeof(retcm[0].getCount)!='undefined') sm = retcm[0] ; var grid = new Ext.grid.GridPanel({		el: 'div_ExtGrid6',        store: store,        cm:cm,		sm: sm,		viewConfig: {			forceFit: true		},       loadMask: true,		width:706,        height:170,		split: true,		region: 'north',		title:'法律法规',		frame:true		,plugins: new Ext.ux.PanelResizer({            minHeight: 100        }),       bbar: new Ext.PagingToolbar({            pageSize: pagesize,            store: store,            displayInfo: true,            displayMsg:'当前显示第 {0} - {1} 条，共 {2} 条',            plugins: new Ext.ux.SlidingPager()        })		    });/**
使用说明                      
1.注释不要用 //。
...
cm.setHidden(0,true);
cm.setHidden(1,true);
cm.setHidden(5,true); grid.render();store.load({params:{start:0, limit:pagesize}});if(typeof(creator_pt_grids)=='undefined'){creator_pt_grids=new Array();}creator_pt_grids.push({id:'ExtGrid6',obj:grid,dataset:'flfgDataset',isEdit:'false'});};ExtGrid6_onReady();</SCRIPT>
...
<TD></TD></TR>
<TR>
<TD><INPUT id=EC_ID style="DISPLAY: none; LEFT: 0px; WIDTH: 50px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() size=9 controltype="text" dataset="baseInfoDataset" field="EC_ID" china="审批基本信息ID"></TD>
<TD><INPUT id=PARENT_ID style="DISPLAY: none; LEFT: 0px; WIDTH: 50px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() size=9 controltype="text" dataset="baseInfoDataset" field="PARENT_ID" china="PARENT_ID"></TD>
<TD></TD>
<TD><INPUT class=nolinetext id=ORGID style="DISPLAY: none; WIDTH: 22px; HEIGHT: 20px" disabled onmovestart=moveStart() readOnly size=2 controltype="text" dataset="baseInfoDataset" field="ORGID" china="ORGID"></TD>
<TD><INPUT id=EXTRA_ID style="DISPLAY: none; LEFT: 0px; WIDTH: 56px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() size=10 controltype="text" dataset="extraInfoDataset" field="EXTRA_ID" china="EXTRA_ID"></TD>
<TD><INPUT class=nolinetext id=SERVICE_TYPEID style="DISPLAY: none; WIDTH: 17.07%; HEIGHT: 20px" onmovestart=moveStart() size=4 controltype="text" dataset="baseInfoDataset" field="SERVICE_TYPEID" china="服务类型"></TD>
<TD></TD>
...
<TD><INPUT id=flowId style="DISPLAY: none; LEFT: 51px; WIDTH: 37px; POSITION: static; TOP: 443px; HEIGHT: 20px" onmovestart=moveStart() readOnly size=6 controltype="text" dataset="flowInfoDataset" field="FLOW_ID" china="FLOW_ID"></TD>
