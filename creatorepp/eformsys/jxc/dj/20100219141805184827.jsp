...
function getoneRecord(){
    var rows = ExtGrid1.getSelectionModel().getSelections();
    if(!rows.length){
        alert("请选择行！");
        return;
    }
    for(var i=0;i<rows.length;i++){
       var stu_id = rows[i].get('stu_id');
       alert("你选择的学生ID为："+stu_id);                   
    }   
}
...
<fc:dataset id=dataset1 showtypeXml="<root><showType><name>BIRTHDAY</name><showRule>%5B%7Bedittype%3A%27date%27%7D%5D</showRule></showType><showType><name>XB</name><showRule>%5B%7BRule%3A%27%24%7Bxb%7D%3D%3D%22F%22%27%2Cshowtype%3A%27%3Cspan%20style%3D%22color%3Ared%22%3E%24%7Bxb%7D%3C/span%3E%27%7D%2C%7BRule%3A%27%24%7Bxb%7D%3D%3D%22%u7537%22%27%2Cshowtype%3A%27%3Cspan%20style%3D%22color%3Agreen%22%3E%24%7Bxb%7D%3C/span%3E%27%7D%5D</showRule></showType><showType><name>FIELD1</name><showRule>%5B%7Bshowtype%3A%27checkbox%27%7D%5D</showRule></showType></root>" columnHeight1Xml="undefined" columnWidth1Xml="undefined" format="<fields><field><fieldname>STU_ID</fieldname><datatype>字符</datatype><displaylabel>STU_ID</displaylabel><size>20</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>XB</fieldname><datatype>字符</datatype><displaylabel>XB</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype><showRule>%5B%7BRule%3A%27%24%7Bxb%7D%3D%3D%22F%22%27%2Cshowtype%3A%27%3Cspan%20style%3D%22color%3Ared%22%3E%24%7Bxb%7D%3C/span%3E%27%7D%2C%7BRule%3A%27%24%7Bxb%7D%3D%3D%22%u7537%22%27%2Cshowtype%3A%27%3Cspan%20style%3D%22color%3Agreen%22%3E%24%7Bxb%7D%3C/span%3E%27%7D%5D</showRule></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>XM</fieldname><datatype>字符</datatype><displaylabel>XM</displaylabel><size>30</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field></fields>" sqltrans="%F4%D8%E6%D8%D4%F6XrnbXrn%DA%F2%EC%E8Xrn%F6%D0%CC%D6%F8%D0%EA" onSetText='bill_ondatasetsettext("<dsid><STU_ID></STU_ID><XB></XB><XM></XM></dsid>")' onGetText='bill_ondatasetgettext("<dsid><STU_ID></STU_ID><XB></XB><XM></XM></dsid>")' onValid='bill_ondatasetvalid("<dsid><STU_ID></STU_ID><XB></XB><XM></XM></dsid>")' opensortno="1" temptable="TMP_DATASET2" multiResult="否"></fc:dataset>

<BUTTON id=button1 style="LEFT: 0px; WIDTH: 75px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("getoneRecord()")'>查看信息</BUTTON>
</DIV>
