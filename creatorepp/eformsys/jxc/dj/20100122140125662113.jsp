...
<INPUT id=1264140012684mycharthidinput type=hidden value=baseFontSize=%60rotateValues=0%60eformDataSetName=dataset1%60linehead=REMARK%60caption=%E5%AD%A6%E7%94%9F%E6%88%90%E7%BB%A9%E5%88%86%E5%B8%83%E5%9B%BE%60canvasBgColor=%60yAxisName=%E5%A7%93%E5%90%8D%60placeValuesInside=0%60chartHeight=209%60xAxisName=%E5%88%86%E6%95%B0%60drilldown.type=nodrill%60canvasBgAlpha=%60showBorder=1%60chartWidth=541%60bgColor=%60subCaption=2010%E5%B9%B4%60yAxisMinValue=%60bgAlpha=%60decimals=%60showValues=1%60outCnvBaseFontSize=%60numberPrefix=%60numberSuffix=%60useRoundEdges=1%60formatNumberScale=1%60yAxisMaxValue=%60selectedfield=SCORE%0D%0A%0D%0A%0D%0A%0D%0A>

<DIV id=1264140012684mychartdivid style="LEFT: 0px; POSITION: absolute; TOP: 0px" align=center>loadingdata...</DIV>

<SCRIPT defer type=text/javascript>var dataset_dataset1 = document.getElementById('dataset1');if(typeof(varfuns_dataset1)=='undefined'){varfuns_dataset1 = new Array();}varfuns_dataset1.push(function(){var xml=dataset_dataset1.xml; var propertiesValue = decodeURI(document.getElementById('1264140012684mycharthidinput').value);$.ajax({    url: getContextPath()+'/fusionchar',    type: 'POST',	 data: 'datasetxml='+toUN.on(xml)+'&propertiesValue='+toUN.on(propertiesValue)+'&chart_modelname=Column2D_1264140012684mychart&chart_action=3',    async: true ,    error: function(){       $('#1264140012684mychartdivid').html('load data error!');    },    success: function(xml){	 	 $('#1264140012684mychartdivid').html(' ');        var fusionxml = xml;    		 var chart = new FusionCharts('../../../FusionCharts/Charts/Column2D.swf', '1264140012684mychartchartid', '541', '209');		 chart.setDataXML(decodeURI(fusionxml));		 chart.render('1264140012684mychartdivid');    }});}); dataset_dataset1.AfterOpen=function(){if(typeof(varfuns_dataset1)!=null) for(var i=0;i<varfuns_dataset1.length;++i){varfuns_dataset1[i]();}}</SCRIPT>
</DIV>
