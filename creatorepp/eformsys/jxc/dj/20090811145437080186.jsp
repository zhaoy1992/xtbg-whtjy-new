...
<DIV id=WebOffice1 style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; LEFT: 1px; OVERFLOW: auto; BORDER-LEFT: black 1px solid; WIDTH: 719px; BORDER-BOTTOM: black 1px solid; POSITION: absolute; TOP: 58px; HEIGHT: 444px; BACKGROUND-COLOR: #ffffff" onmovestart=moveStart() controltype="WebOffice">
