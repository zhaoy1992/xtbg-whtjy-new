...
out.println("<script src='../../fceform/js/../../../dwr/engine.js'></script>");
out.println("<script src='../../fceform/js/../../../dwr/util.js'></script>");
out.println("<script src='../../fceform/js/../../../dwr/interface/processConfigManager.js'></script>");
%>
...
function init(){
  ...
  //dataset1.Open("select aa,bb from ta_test where cc_form_instanceid ='"+cc_form_instanceid+"'");
  pubdjbh=dataset1.Fields.Field["BB"].Value;

}


function test(){
alert(processConfigManager);
   processConfigManager.removeAssignments('admin','<%=actInsId%>', 'wanhuan',function(date){alert(date);});
...
<fc:dataset id=dataset1 format="<fields><field><fieldname>AA</fieldname><datatype>字符</datatype><displaylabel>AA</displaylabel><size>30</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>BB</fieldname><datatype>字符</datatype><displaylabel>BB</displaylabel><size>30</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>是</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field></fields>" sqltrans="%F4%D8%E6%D8%D4%F6Xrn%D0%D0Xr%94%D2%D2Xrn%DA%F2%EC%E8Xrn%B6%90%CC%B6%98%B4%B6" onSetText='bill_ondatasetsettext("<dsid><AA></AA><BB></BB></dsid>")' onGetText='bill_ondatasetgettext("<dsid><AA></AA><BB></BB></dsid>")' onValid='bill_ondatasetvalid("<dsid><AA></AA><BB></BB></dsid>")' opensortno="1" temptable="TMP_DATASET1" saveastable="TA_TEST" multiResult="否"></fc:dataset>

<BUTTON id=button1 style="LEFT: 0px; WIDTH: 126px; POSITION: static; TOP: 0px; HEIGHT: 25px" onmovestart=moveStart() dropstyle="否" controltype="button" onclick='bill_onclick("test();")'>删除某个活动执行人</BUTTON>
</DIV>
