...
<!-- 提示：以下为页面自定义JS内容 -->
<script>
var WFT_ID = creator_getQueryString("WFT_ID");//事项ID

function init() {
    var sql = Ajsl.queryDsrByWftId(WFT_ID);
    xzDsrDataset.Open(sql);
    reloadExtGrid();
}
...
function choosePiUnit(){
    ...
    for(var i = 0; i < rows.length; i++){
       var fieldId = rows[i].get('ltt_id');
       var fieldName = rows[i].get('ltt_name');
       rmdId = fieldId;
...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();init();" contxml="<root><button><id>chooseUnit</id><id>btnClose</id></button><dataset><id>xzDsrDataset</id></dataset><ExtGrid><id>extGrid</id></ExtGrid></root>" billtaborder="<root><taborder>chooseUnit</taborder><taborder>btnClose</taborder></root>" dj_sn="20101016144747234036" caption="选择当事人" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:0;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:0;text:0;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:0;dataset:0;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:0;ExtUpload:0;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName="app_xzcf" creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="否" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination type="ZW" creatorType="20100913200141634274" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Namespace.js&#13;&#10;../../../ccapp/app_xzcf/js/common/nsreg.js&#13;&#10;../../../ccapp/app_xzcf/js/common/Common.js&#13;&#10;../../../ccapp/app_xzcf/js/business/Ajsl.js&#13;&#10;../../../ccapp/app_xzcf/js/dao/AjslDao.js">
...
var extGrid_onReady = function(){ 
 Ext.QuickTips.init();
var dataset = document.getElementById("xzDsrDataset");
...
var store  = new Ext.data.Store({
	proxy: new Ext.data.CreatorMemoryProxy("xzDsrDataset"), 
...
**/
cm.setHidden(2,true);extGrid.render();
store.load({params:{start:0, limit:pagesize}});
if(typeof(creator_pt_grids)=='undefined'){creator_pt_grids=new Array();}
creator_pt_grids.push({id:'extGrid',obj:extGrid,dataset:'xzDsrDataset',isEdit:'false'});
...
<fc:dataset id=xzDsrDataset showtypeXml="<root><showType><name>checked</name><showRule>%5B%7BRule%3A%271%3D%3D1%27%2Cshowtype%3A%27%3Cinput%20type%3Dradio%20name%3D%22sex%22/%3E%27%7D%5D</showRule></showType><showType><name>BU_ID</name><showRule></showRule></showType><showType><name>radio</name><showRule>%5B%7BRule%3A%271%3D%3D1%27%2Cshowtype%3A%27%3Cinput%20type%3Dradio%20name%3Did%20value%3D%24%7Bltt_id%7D%20/%3E%27%7D%5D</showRule></showType></root>" columnHeight1Xml="undefined" columnWidth1Xml="<root><columnWidth1><name>a</name><columnWidth2>10%25</columnWidth2></columnWidth1><columnWidth1><name>checked</name><columnWidth2>5%25</columnWidth2></columnWidth1><columnWidth1><name>BU_NAME</name><columnWidth2>50%25</columnWidth2></columnWidth1><columnWidth1><name>BU_BRIEF_CODE</name><columnWidth2>45%25</columnWidth2></columnWidth1></root>" format="<fields><field><fieldname>radio</fieldname><datatype>字符</datatype><displaylabel>单选</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>否</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype><showRule>%5B%7BRule%3A%271%3D%3D1%27%2Cshowtype%3A%27%3Cinput%20type%3Dradio%20name%3Did%20value%3D%24%7Bltt_id%7D%20/%3E%27%7D%5D</showRule></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>LTT_NAME</fieldname><datatype>字符</datatype><displaylabel>当事人名称</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>否</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>LTT_ID</fieldname><datatype>字符</datatype><displaylabel>选择</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>否</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field></fields>" onSetText='bill_ondatasetsettext("<dsid><radio></radio><LTT_NAME></LTT_NAME><LTT_ID></LTT_ID></dsid>")' onGetText='bill_ondatasetgettext("<dsid><radio></radio><LTT_NAME></LTT_NAME><LTT_ID></LTT_ID></dsid>")' onValid='bill_ondatasetvalid("<dsid><radio></radio><LTT_NAME></LTT_NAME><LTT_ID></LTT_ID></dsid>")' opensortno="1" temptable="TMP_DATASET1" multiResult="是"></fc:dataset>
</SCRIPT>
</TBODY>
</TABLE>
</DIV>
