...
function init() {
    var sql = Ajsl.queryCfsx(userId, buId);
    CfsxDataset.Open(sql);
    reloadExtGrid();
}
...
function choosePiUnit(){
    ...
    for(var i = 0; i < rows.length; i++){
       var fieldId = rows[i].get('pi_id');
       var fieldName = rows[i].get('pi_name');
       ids = fieldId;
       piName = fieldName.trim();     
    }
    if(ids.length==0){    
       alert("请选择处罚事项");
    }else{
...
var ExtGrid2_onReady = function(){ 
 Ext.QuickTips.init();
var dataset = document.getElementById("CfsxDataset");
...
var store  = new Ext.data.Store({
	proxy: new Ext.data.CreatorMemoryProxy("CfsxDataset"), 
...
**/
cm.setHidden(2,true);ExtGrid2.render();
store.load({params:{start:0, limit:pagesize}});
if(typeof(creator_pt_grids)=='undefined'){creator_pt_grids=new Array();}
creator_pt_grids.push({id:'ExtGrid2',obj:ExtGrid2,dataset:'CfsxDataset',isEdit:'false'});
...
<fc:dataset id=CfsxDataset showtypeXml="<root><showType><name>checked</name><showRule>%5B%7BRule%3A%271%3D%3D1%27%2Cshowtype%3A%27%3Cinput%20type%3Dradio%20name%3D%22sex%22/%3E%27%7D%5D</showRule></showType><showType><name>BU_ID</name><showRule></showRule></showType><showType><name>radio</name><showRule>%5B%7BRule%3A%271%3D%3D1%27%2Cshowtype%3A%27%3Cinput%20type%3Dradio%20name%3Did%20value%3D%24%7Bpi_id%7D%20/%3E%27%7D%5D</showRule></showType></root>" columnHeight1Xml="undefined" columnWidth1Xml="<root><columnWidth1><name>a</name><columnWidth2>10%25</columnWidth2></columnWidth1><columnWidth1><name>checked</name><columnWidth2>5%25</columnWidth2></columnWidth1><columnWidth1><name>BU_NAME</name><columnWidth2>50%25</columnWidth2></columnWidth1><columnWidth1><name>BU_BRIEF_CODE</name><columnWidth2>45%25</columnWidth2></columnWidth1></root>" format="<fields><field><fieldname>radio</fieldname><datatype>字符</datatype><displaylabel>单选</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>否</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype><showRule>%5B%7BRule%3A%271%3D%3D1%27%2Cshowtype%3A%27%3Cinput%20type%3Dradio%20name%3Did%20value%3D%24%7Bpi_id%7D%20/%3E%27%7D%5D</showRule></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>PI_NAME</fieldname><datatype>字符</datatype><displaylabel>处罚事项名称</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>否</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>PI_ID</fieldname><datatype>字符</datatype><displaylabel>选择</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>否</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field></fields>" onSetText='bill_ondatasetsettext("<dsid><radio></radio><PI_NAME></PI_NAME><PI_ID></PI_ID></dsid>")' onGetText='bill_ondatasetgettext("<dsid><radio></radio><PI_NAME></PI_NAME><PI_ID></PI_ID></dsid>")' onValid='bill_ondatasetvalid("<dsid><radio></radio><PI_NAME></PI_NAME><PI_ID></PI_ID></dsid>")' opensortno="1" temptable="TMP_DATASET1" multiResult="是"></fc:dataset>
</SCRIPT>
</TBODY>
</TABLE>
</DIV>
