...
<!-- 提示：以下为页面DOM元素内容 -->
<DIV id=SKbillsheet style="visibility:hidden" toolbar="不带工具栏" BLONopen="setAuthority();" contxml="<root><checkbox><id>checkbox1</id></checkbox><button><id>firstpagegrid1</id><id>prevpagegrid1</id><id>nextpagegrid1</id><id>lastpagegrid1</id></button><grid><id>grid1</id></grid><dataset><id>dataset1</id></dataset><ExtGrid><id>ExtGrid1</id></ExtGrid></root>" billtaborder="<root><taborder>checkbox1</taborder><taborder>grid1</taborder><taborder>firstpagegrid1</taborder><taborder>prevpagegrid1</taborder><taborder>nextpagegrid1</taborder><taborder>lastpagegrid1</taborder></root>" dj_sn="20100114094635805830" caption="平台测试" mkbh codeheader="BBB" entertype="修改" poswidth posheight controlno="SKButton:0;SKDBedit:0;checkbox:1;label:0;radio:0;listbox:0;textarea:0;combobox:0;password:0;upload:0;SKDBtext:0;chart:0;dbimg:0;img:0;SKBILLgrid:0;shape:0;tab:0;div:0;DsMain_field:0;a:0;button:0;text:0;hr:0;checkboxlist:0;radiolist:0;dropdownlist:0;grid:1;dataset:1;spin:0;excel:0;tree:0;ebshow:0;creatorSubForm:0;creator_div:0;ExtGrid:1;ExtUpload:0;ExtTree:0;Fusionchar:0" window="当前窗口" posleft postop keyfield isfile="否" OtherSave="否" idtype="1" testDbName creatorStyle="creatorBlue" BLONclose="UnLoadWebOffice();" creator_remark hasWorkflowButton="否" creator_elementAuthoritySwitch="否" creator_showAlert="是" creator_office_isBindForm="否" islog="否" isprotect="是" creator_csslib version="1.0" creator_pagination="grid1,dataset1,10;" type="ZW" creatorType="20100715141826312774" jslib="fcbasecont.js&#13;&#10;selectdate.js&#13;&#10;~userfunc.js&#13;&#10;fcdate.js">

<?xml:namespace prefix = fc />

<fc:dataset id=dataset1 showtypeXml="<root><showType><name>XZ</name><showRule>%5B%7Bshowtype%3A%27checkbox%27%7D%5D</showRule></showType></root>" columnHeight1Xml="undefined" columnWidth1Xml="undefined" format="<fields><field><fieldname>XZ</fieldname><datatype>字符</datatype><displaylabel>选择</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype><showRule>%5B%7Bshowtype%3A%27checkbox%27%7D%5D</showRule></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>LOG_OPERUSER</fieldname><datatype>字符</datatype><displaylabel>LOG_OPERUSER</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field><field><fieldname>OPER_MODULE</fieldname><datatype>字符</datatype><displaylabel>OPER_MODULE</displaylabel><size>10</size><precision>0</precision><fieldkind>数据项</fieldkind><defaultvalue></defaultvalue><displayformat></displayformat><isnull>否</isnull><iskey>否</iskey><valid>是</valid><procvalid>否</procvalid><link>否</link><target></target><href></href><visible>是</visible><primarykey>否</primarykey><fieldvalid></fieldvalid><tag></tag><showtype></showtype><columnHeight1></columnHeight1><columnWidth1></columnWidth1></field></fields>" sqltrans="%F4%D8%E6%D8%D4%F6Xrn%A6%AC%9C%CC%AC%AE%98%B2%B8%B4%98%B2Xr%94%AC%AE%98%B2%CC%A8%AC%96%B8%A6%98Xrn%DA%F2%EC%E8Xrn%B6%96%CC%B4%A8%CC%A6%AC%9C" onSetText='bill_ondatasetsettext("<dsid><XZ></XZ><LOG_OPERUSER></LOG_OPERUSER><OPER_MODULE></OPER_MODULE></dsid>")' onGetText='bill_ondatasetgettext("<dsid><XZ></XZ><LOG_OPERUSER></LOG_OPERUSER><OPER_MODULE></OPER_MODULE></dsid>")' onValid='bill_ondatasetvalid("<dsid><XZ></XZ><LOG_OPERUSER></LOG_OPERUSER><OPER_MODULE></OPER_MODULE></dsid>")' opensortno="1" temptable="TMP_DATASET1" multiResult="否"></fc:dataset>
...
"dataset1"), 
	...
	sortInfo:{field: 'log_operuser', direction: 'ASC'},
    groupField:'oper_module'
...
if(typeof(retcm[0].getCount)!='undefined') sm = retcm[0] ;
 ExtGrid1 = new Ext.grid.GridPanel({
		...
		view:view,		width:0,      height:0,		split: true,
		region: 'north',
		title:'uuuuu',
		frame:true
...
<DIV id=checkbox1 style="LEFT: 0px; WIDTH: 80px; POSITION: static; TOP: 0px; HEIGHT: 20px" onmovestart=moveStart() noWrap controltype="checkbox" value="否" truevalue="是" falsevalue="否" divtype="checkbox">
   <INPUT oncontrolselect=controlselectcancel() type=checkbox>
   <SPAN>复选框</SPAN>
</DIV>

<DIV style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; LEFT: 0px; OVERFLOW: auto; BORDER-LEFT: 0px; WIDTH: 300px; BORDER-BOTTOM: 0px; POSITION: static; TOP: 150px; HEIGHT: 34px" onmovestart=moveStart() name="Ctrlgrid1" controltype="div" NotBg="是">
...
<fc:webgrid id=grid1 onkeydown='bill_ongridkeydown("<grid1><col></col><col></col><col></col></grid1>")' ondblclick='bill_ongriddblclick("<grid1><col></col><col></col><col></col></grid1>")' onclick='bill_ongridclick("<grid1><col></col><col></col><col></col></grid1>")' top="0" width="300px" height="123" format="<cols><col><fname>XZ</fname><cname>选择</cname><width>10</width><dtype>字符</dtype><readonly>勾</readonly><visible>是</visible><u></u><v></v><s></s><r></r><columnwidth>80</columnwidth><align>left</align></col><col><fname>LOG_OPERUSER</fname><cname>LOG_OPERUSER</cname><width>10</width><dtype>字符</dtype><readonly>否</readonly><visible>是</visible><u></u><v></v><s></s><r></r><columnwidth>80</columnwidth><align>left</align></col><col><fname>OPER_MODULE</fname><cname>OPER_MODULE</cname><width>10</width><dtype>字符</dtype><readonly>否</readonly><visible>是</visible><u></u><v></v><s></s><r></r><columnwidth>80</columnwidth><align>left</align></col></cols>" dataset="dataset1" visible="是" canselect="是" autoheight="否" autowidth="否" autoappend="否" readonly="否" SetRowHeight="是" hideVscroll="否" hideHscroll="否" autosize="否" bodyrowheight="-1" bodyrows="-1" left="0">
