...
<head>
	...
	<SCRIPT LANGUAGE="JavaScript"> 		
		...
		function uf_ok(){
				...
				for(i=0;i<pre_orgids.length;i++){
				   ...
				   if(typeof(node)!="object" &&pre_orgids[i].length>0 &&orgids==""){
				      orgids=pre_orgids[i]+",";
	...
	<body class="contentbodymargin">		
		<div align="center">
		 <br />
		 <iframe name=orgTreeFrame height=85% width="100%"	src="tree/orgTree.jsp?checkModel=single&rootId=<%=rootId %>&rootName=<%=rootName %>&expandLevel=<%=expandLevel %>" frameborder="0"></iframe>
		 <br />
		 <br />
		 <div align="center">
