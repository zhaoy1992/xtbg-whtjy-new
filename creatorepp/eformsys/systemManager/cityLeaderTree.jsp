				...
				<pg:beaninfo requestKey="Apply">
					...
					<fieldset style="width: 90%;">
						...
						<table width="100%" height="35" border="0" align="left"
							...
							<tr><!-- dynamic="false"  mode="static" -->
								<td width="" class="detailcontent">
									<tree:tree tree="city_leader_tree_checkbox"
										node="city_leader_tree_checkbox.node"
										...
										<tree:checkbox name="orguser" recursive="false"
											uprecursive="false" />										
										<tree:treedata
											treetype="com.chinacreator.eform.systemManager.CityLeaderTree"
