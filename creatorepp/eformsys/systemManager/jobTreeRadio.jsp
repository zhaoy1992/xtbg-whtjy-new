...
<script language="javascript">
	function uf_ok(){
			var jobs = jobTreeRadioFrame.document.getElementsByName("jobid");
			var jobIds = "";
			var jobNames = "";		
...
<html>
	...
	<body class="contentbodymargin">
		<div align="center">
				<br />
					<iframe name="jobTreeRadioFrame" height=85% width="100%"	src="jobTreeRadioFrameSrc.jsp?showmode=<%=showmode %>" frameborder="0"></iframe>
				<br />
				<br />
    			<div align="center">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
  <tr>
    <td>
		...
		<table >
        <tr><td><!-- dynamic="false" -->
         <tree:tree tree="app_job_tree_radio"
    	           node="app_job_tree_radio.node"
    			  ...
    			  <tree:radio name="jobid"/>
    			  <tree:treedata treetype="com.chinacreator.eform.systemManager.JobTreeRadio"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="岗位列表"
    	                   expandLevel="1"
