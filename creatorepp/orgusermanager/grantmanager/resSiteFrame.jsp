...
<frameset name="siteFrame" cols="30,70" frameborder="no" border="0" framespacing="0" >
  	<frame src="siteSetTree.jsp?resTypeId=<%=resTypeId%>&currRoleId=<%=currRoleId%>&currOrgId=<%=currOrgId%>&role_type=<%=role_type%>" name="globalOperList" id="globalOperList" scrolling="auto"/>
