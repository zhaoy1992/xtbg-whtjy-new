...
function saveReadorgname(){
	...
	var url = "saveTreeRoleresop_handle.jsp?resTypeId=<%=resTypeId%>&currRoleId=<%=currRoleId%>&role_type=<%=role_type%>&opId=usergroupset&currOrgId=<%=currOrgId%>&isBatch=<%=isBatch%>";
