...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
  ...
  <tr >
     <td class="detailcontent" align="left"><div class="win" id="dd_1" align="left" style="width:150" title="下拉选择框的右边边框可以左右拖动">
    ...
    <td class="detailcontent" align="right"><div class="win" id="dd_2" align="left" style="width:150" title="下拉选择框的右边边框可以左右拖动">
     <select name="jobId"  multiple style="width:98%" onChange="showUserList()" onDBLclick="deletejob()" size="18" title="下拉选择框的右边边框可以左右拖动">
	...
	<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
        <td align="center" class="detailcontent"><input name="button11" type="button" class="input" value="角色设置" onClick="roleset()"></td>
      </tr>
      <tr>
        <td align="center" class="detailcontent">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" class="detailcontent"><input name="button22" type="button" class="input" value="到顶部" onClick="upall()"></td>
      </tr>
      <tr>
        <td align="center" class="detailcontent">&nbsp;</td>
      </tr>
      <tr>
        <td align="center"><input name="button33" type="button" class="input" value="向上移" onClick="up1()"></td>
      </tr>
      <tr>
        <td align="center" class="detailcontent">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" class="detailcontent"><input name="button44" type="button" class="input" value="向下移" onClick="down1()"></td>
      </tr>
      <tr>
        <td align="center" class="detailcontent">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" class="detailcontent"><input name="button55" type="button" class="input" value="到底部" onClick="downall()"></td>
      </tr>
      <tr>
        <td align="center" class="detailcontent">&nbsp;</td>
      </tr>
  ...
  <tr>
    <td align="center" colspan="4"><input name="button111" type="button" class="input" value="递归设置子机构岗位" onClick="addsuborg();"></td>
  </tr>		
  <tr>
  	<td>&nbsp;</td>
  </tr>	
  <tr>
    <td align="center" colspan="4"><input name="button222" type="button" class="input" value="递归取消子机构岗位" onClick="deletesuborg();"></td>
  </tr> 
  <tr>
    <td align="center" colspan="4">
    	<br>
	  	...
	  	<br>
	  	<br>
    	<input name="button333" type="button" class="input" value="返回" onclick="window.close();">
    </td>
  </tr>  
  </tr>
  </table>
