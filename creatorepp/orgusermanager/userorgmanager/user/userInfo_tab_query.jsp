		   ...
		   <tr><td height="25" class="detailtitle"> 用户类型</td>
			   ...
			   <td height="25">
					...
					<tr>
						...
						<td height="25">
							<input readonly="true" type="text" name="userBirthday" onclick="showdate(document.all('userBirthday'))" readonly="true" value="<pg:cell colName="userBirthday"  defaultValue=""  />" validator="stringNull" cnname="生日" maxlength="40">
						</td>
						<td height="25" class="detailtitle">
							 用户地址
						</td>
					...
					<tr>
						...
						<td height="25">
							...
							<input type="text" name="userSn" value="<pg:cell colName="userSn"  defaultValue="" />" validator="stringNull" cnname="用户排序号" maxlength="40" readOnly=true>
