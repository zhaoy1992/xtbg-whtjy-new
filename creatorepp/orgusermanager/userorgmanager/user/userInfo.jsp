...
<%
	...
	// 当前应用ID
	String currentApplyID = AppIdThreadLocal.get();
%>
			...
			<pg:beaninfo requestKey="currUser">
				...
				<table width="100%" height="25" border="0" cellpadding="0"
					...
					<%
						...
						<%} %>
								<td style="border: 0px;">
									<input type="checkbox" value="<%=app_id %>" id="checkbox_sel_appid" name="checkbox_sel_appid"
									<% if(currentApplyID.equals(app_id)){ %> 
									checked="checked"
									disabled="disabled"
									<%} %>
									><%=app_name %>
