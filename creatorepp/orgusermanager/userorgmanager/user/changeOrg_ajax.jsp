...
<div id="contentborder">
	...
	<input name="orgId" value="<%=orgId%>" type="hidden">
		<table width="31%" border="0" cellpadding="0" cellspacing="1">
			...
			<tr>
				<td colspan="3">
				<p align="right"><div class="win" id="dd_1" align="left" title="下拉选择框的右边边框可以左右拖动">
				<select name="orgList"  style="width:98%" size="18" title="下拉选择框的右边边框可以左右拖动">
			...
			<tr>
				...
				<td align="center"><input name="but3" type="button" class="input" value="返回" onclick="closed();"></td>
			</tr>
			<tr>
