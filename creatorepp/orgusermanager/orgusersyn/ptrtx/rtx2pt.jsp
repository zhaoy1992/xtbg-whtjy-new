...
<html>
	...
	<frameset name="userOrgFrame" cols="25%,*" border=0 framespacing="0">
		<frame frameborder=1 scrolling="yes" name="org_tree" src="rtx_org_tree.jsp" marginWidth=0 marginHeight=0 >
		</frame>
		<frame frameborder=0 scrolling="yes" name="rtxuser_list" src="rtxuser_list.jsp" marginWidth=0 marginHeight=0 >
		</frame>
	</frameset>
</html>
