...
function link(orgId,orgName){
	...
	document.ldapuser_list.submit();
	//parent.ldapuser_list.location.href = "<%=request.getContextPath()%>/orgusermanager/orguser_tb/ptldap/ldapuser_list.jsp?queryString="+queryString+"&orgId="+orgId+"&resName="+orgName+"&queryString1="+queryString1;
}
function pttb(type){
	var confirmStr = "";
...
<form name="ldapuser_list" action="ldapuser_list.jsp" target="ldapuser_list" method="post">
