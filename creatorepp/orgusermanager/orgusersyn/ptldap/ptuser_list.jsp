...
<%@ include file="/epp/css/cssControl.jsp"%>
  ...
  <body>
			...
			<form name="userList" method="post" action="ptuser_list.jsp">
		  		<table cellspacing="0" cellpadding="0" border="0" bordercolor="#EEEEEE" width=100% class="thin">
				<tr><td align="center">平台同步到LDAP</td></tr>
				</table>
		  		<table cellspacing="0" cellpadding="0" border="0" bordercolor="#EEEEEE" width=100% class="thin">
			  			<tr>
	           				    <td colspan=3 nowrap>
				...
				<div align="right">
					...
					<input type=button name=bt1 value="增量同步&gt;LDAP" class="input" onclick="pttbldap('ptzl2ldap')"/>
					<input type=button name=bt2 value="完全同步&gt;LDAP" class="input" onclick="pttbldap('ptwq2ldap')"/>						
