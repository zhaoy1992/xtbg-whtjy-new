function changeViewCms(selectName){
	try
	{
		...
		parent.globalOperList.location = "../../cms/userManage/operList_global.jsp?resTypeId=" + restype;
		parent.operList.location = "../../cms/userManage/operdefault.jsp";
