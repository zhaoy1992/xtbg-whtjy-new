...
<%
	...
	//处理全局的资源
	String url = "../grantmanager/operList_global.jsp?resTypeId=orgunit&currRoleId=" + roleId + "&role_type=role";
	
	String urlreadorgname = "../grantmanager/resReadOrgNameTree.jsp?resTypeId=orgunit&currRoleId="+ roleId + "&role_type=role";
