...
<%
	...
	if("edit".equals(action)){
		...
		styleDesc = request.getParameter("styleDesc");
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function subform()
	{
		if(tempStyleForm.styleName.value=="")
		{
			alert("请填写模板名称！");
...
<form  method="post"  name="tempStyleForm" target="tempStyleFrame" id="tempStyleForm">
			...
			<td colspan="2">
				<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#f0f0f0">
					<tr>
						...
						<td height="24">
							<input type="text" id="styleName" name="styleName" class="cms_text" style="width:180px"  maxlength="20" value="<%=styleName%>"/>
					...
					<tr>
						...
						<td height="24">
							<textarea name="styleDesc" cols="28" rows="5" class="cms_textarea"><%=styleDesc%></textarea>	
						</td>
					</tr>
				</table>
			</td>
