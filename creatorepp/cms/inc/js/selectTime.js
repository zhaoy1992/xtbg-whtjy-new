...
strHTML+="var hourStr;";
strHTML+="if (parseInt(hour.value)<10) hourStr = '0'+hour.value;";
strHTML+="else hourStr = hour.value;";

strHTML+="var minuteStr;";
strHTML+="if (parseInt(minute.value)<10) minuteStr = '0'+minute.value;";
strHTML+="else minuteStr = minute.value;";

strHTML+="var secondStr;";
strHTML+="if (parseInt(second.value)<10) secondStr = '0'+second.value;";
...
for(i=intYear-6;i<intYear+42;i++){
	strHTML+="<option value=\""+i+"\"";
