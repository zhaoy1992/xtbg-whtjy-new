...
function GetHttpUrl(url){
	...
	alert(sURL.substring(0,sURL.lastIndexOf("/cms/editor/eWebeditor/dialog/")+1));
	return sURL.substring(0,sURL.lastIndexOf("/cms/editor/eWebeditor/dialog/")+1)+url;
	*/
	var sURL=document.URL;
	return sURL.substring(0,sURL.lastIndexOf("/cms/editor/eWebeditor/dialog/"))+url;
}

// 针对于files.htm文件中的附件图标
