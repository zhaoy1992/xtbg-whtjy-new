		  ...
		  return false;
		   ...
		   //判定是否新加的文档来源，是设置
			...
			if(closeFlag==5)
			{
				...
				myform.action="<%=request.getContextPath()%>/cms/zwgkml/previewDoc.jsp";
						...
						<td height="23" colspan="3">
							<table border="0" cellpadding="3" cellspacing="0">
								<tr>
									...
									<td align="right">
										<a href="<%=request.getContextPath()%>/cms/zwgkml/doc_gather_links.jsp?siteid=<%=siteid%>&channelName=<%=channelname%>&channelId=<%=channelId%>">
