...
<%
	...
	String[][] sessionArray = new String[100][100];
	...
	if (flag!=2 && flag!=3){
		...
		if (flag!=2&&flag!=3){
			if (!"".equals(strOptionID)){
			    ...
			    {
			      sessionArray[Integer.parseInt(optionIDs[k])][voteMgr.getQidByitemId(optionIDs[k])]="1";
			    }
...
<%
	if (!(flag!=2&&flag!=3&&"".equals(strOptionID)&&flag!=1)){
		...
		session.setAttribute("sessionArray",sessionArray);
%>
<BODY></BODY>
</html>
