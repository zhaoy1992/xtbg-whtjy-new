...
<html><head>
		...
		function commonQuery(){	
			form1.action="queryFrame.jsp?siteid=<%=siteid%>&channelName=<%=channelname%>&channelId=<%=channelId%>"
					...
					<td  style="background:url(../images/querybox_bg.gif) repeat-x top"><table width="100%" border="0" cellpadding="4" cellspacing="0">
							<tr>
								<td height="23">&nbsp; 当前位置:
									...
									频道								</td>
								<td align="right">
									<a style="cursor:hand; color:'#9A2F2F';  padding-top:5px"  class="cms_button" onClick="commonQuery()">普通查询</a>
							<td>							</tr>
						</table>	
