...
<script language="javascript">
	...
	function chooseImage(){
		...
		//window.open("<%=request.getContextPath()%>/cms/channelManage/chooseImageFrameset.jsp");
	}
	...
	function saveform(closeFlag){
		...
		if(myform.title.value==""){
			myform.title.value=myform.subtitle.value;
		...
		<tr>
			<td height="18">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td height="26">&nbsp;</td>
						<td width="6%" height="23" nowrap><span class="STYLE3">视频新闻标题:</span></td>
						<td width="43%">
						  <span class="cms_title_blue">
								<input  style=" border-bottom-width:0px; border-top-width:0px; border-left-width:0px; border-right-width:0px;background-color:#F3F4F9; color:#F3F4F9" name="title" type="text" class="cms_text" size="60" />
						  </span><span>&nbsp;&nbsp;</span>						</td>
						<td height="23" width="30%" style="display:none">
					...
					<tr>
						<td height="26">&nbsp;</td>
						<td height="23" nowrap><strong>视频新闻标题:</strong></td>
						<td height="23">
					...
					<tr style="display:none">
						...
						<td height="23">
							<input name="secondtitle" type="text" class="cms_text" size="60">						</td>
						<td height="23"> 
						    <strong>编稿时间:</strong>
						    <span class="black">
								<span class="cms_title_blue">
									<input name="docwtime" type="text" class="cms_text" value="<%=riqi%>" readonly="true" size="22">
								</span>							</span>
					...
					<tr style="display:none">
					    ...
					    <td height="23"> 
						    ...
						    <span class="black">
								<span class="cms_title_blue">
									<input name="ordertime" type="text" class="cms_text" value="<%=riqi%>" readonly="true" size="22">
								</span>							</span>
					...
					<tr style="display:none">
						...
						<td>
							...
							<input type="button" class="Channel_5wordsBtn" name="addpic" onClick="chooseImage()" value="选择图片"/>						</td>
						<td style="display:none">&nbsp;</td>
					</tr>
					<tr >
					  <td height="26">&nbsp;</td>
					  <td colspan="2"><strong>新闻日期:</strong>
					...
					<tr>
					  ...
					  <td height="23" colspan="1"><input name="button" type="button" onClick="saveform(1)" class="cms_button"  value="保存">
                        <input style="display:none" name="button" type="button" class="cms_button" onClick="saveform(5);" value="发布预览">
