...
<script language="javascript">
	...
	function saveform(closeFlag){
		...
		if(myform.publishfilename.value.length>50){
			alert("发布名称过长!");
			return false;
		}
		if(myform.docabstract.value.length>1000){
			alert("摘要内容过长！");
			return false;
		}
		if(myform.keywords.value.length>250){
		    alert("关键词过长!");
		    return false;
		}
		if(inputsource==null||inputsource=="")
		{
		  ...
		  return false;
		   ...
		   //判定是否新加的文档来源，是设置
			...
			if(content.length < 1 || content.replace(/\s/g,"") == "")
			{
				alert("请输入文档内容!");
				document.all.auditorDiv.innerHTML="";
				document.all.publisherDiv.innerHTML="";
		...
		<tr>
			<td height="18">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td height="26">&nbsp;</td>
						<td width="6%" height="23"><strong>文档标题:</strong></td>
						<td width="43%">
					...
					<tr>
						<td height="26">&nbsp;</td>
						<td height="23"><strong>显示标题:</strong></td>
						<td height="23">
					...
					<tr>
						...
						<td>
							...
							<input type="button" class="Channel_7wordsBtn" name="addpic" onClick="chooseImage()" value="选择图片或flash"/> <input type="button" name="reset" class="Channel_5wordsBtn" value="清空" onclick="document.myform.picpath.value=''"/>
						</td>
						<td> 
							<strong>发布名称:</strong>
					...
					<tr>
					    ...
					    <td>
					    	<input type="text" name="mediapath" value="" class="cms_text" readonly size="30"/>
					  		<input type="button" class="Channel_5wordsBtn" name="addmedia" onClick="choosemedia()" value="选择文件"/> <input type="button" name="reset" class="Channel_5wordsBtn" value="清空" onclick="document.myform.mediapath.value=''"/>
					    </td>
