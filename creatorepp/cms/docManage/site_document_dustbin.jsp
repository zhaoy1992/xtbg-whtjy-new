...
<table width="100%" height="565" border="0"   cellpadding="0" align="center" cellspacing="0">
  <tr>
    <td height="82" valign=top background="../images/pagebar.jpg" style="background-repeat:no-repeat"><table width="100%" border="0">
      <tr>
        <td height="23">&nbsp;&nbsp;&nbsp;&nbsp; 当前位置:我的工作－个人回收站</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
  ...
  <tr>
    <td  height="483" valign=top background="../images/tile.jpg" bgcolor="#FFFFFF"><table width="98%" border="0" align="center">
      ...
      <tr>
        ...
        <td width="18%"><div align="center">安全级别：
              <select name="select" class="cms_select">
                <option>全部</option>
                <option>最高</option>
                <option>高</option>
      ...
      <tr>
        <td colspan="5"><table width="98%" border="0" align="center">
          <tr class="cms_report_tr">
            ...
            <td width="8%" height="19"><div align="center">文档状态</div></td>
            <td width="42%"><div align="center">文档标题</div></td>
            <td width="14%"><div align="center">所属频道</div></td>
            <td width="23%"><div align="center">入库时间</div></td>
          </tr>
          <tr class="cms_data_tr">
            ...
            <td><div onClick="openWin('template_edit.jsp',900,800)" style="cursor:hand">
			 ...
			 <td><div align="left">
			   <div onClick="openWin('../templateManage/Managetemplate_edit.jsp',900,800)" style="cursor:hand"><u>中南大学首页模板</u></div>
			 </div></td>
      ...
      <tr>
        <td colspan="5"><div align="center">第1页 共1页| 上一页 | 下一页 | 尾页<span class="STYLE1"> Go</span>
          <label>
          <select name="select" class="cms_select">
