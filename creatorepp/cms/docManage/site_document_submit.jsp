...
<form id="100%" name="form1" method="post" action="">
<table width="100%" height="565" border="0"   cellpadding="0" align="center" cellspacing="0">
  <tr>
    <td height="82" valign=top background="../images/pagebar.jpg" style="background-repeat:no-repeat"><table width="100%" border="0">
      <tr>
        <td height="23">&nbsp;&nbsp;&nbsp;&nbsp; 当前位置:我的工作－已呈文档</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td colspan="5"><table width="98%" border="0" align="center">
          <tr class="cms_report_tr">
            ...
            <td width="18%" ><div align="center">文档状态</div></td>
            <td width="24%" height="19"><div align="center">文档标题</div></td>
            <td width="12%"><div align="center">呈送人</div></td>
            <td width="17%"><div align="center">所属频道</div></td>
            <td width="23%"><div align="center">呈送时间</div></td>
          </tr>
          <tr class="cms_data_tr">
            ...
            <td><div align="left">新闻</div></td>
            <td><div align="left">2006－11－27</div></td>
          </tr>
          <tr class="cms_data_tr">
            <td>
              <div align="left">
