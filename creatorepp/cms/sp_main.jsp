...
<table border="0" align="center"   cellpadding="0" cellspacing="0" bgcolor="#E6E6F0" class="outbox">
  <tr>
    <td height="104" valign=middle><table width="80%" border="0" cellspacing="0" cellpadding="0">
     <tr>
        <td width="58"><img src="images/main_banner_left.jpg" width="450" height="120"></td>
        <td background="images/main_banner_right.gif"><div style=" float:left; width:auto;margin:10px; padding:4px;background-color:#7596BF;  font-size:12px;"><a href="#" onClick="window.open('../sysmanager/user/userManager.do?method=getUserInfo','','width=750,height=600,resizable=no left=250 top=170');"><font style="color:#FFFFFF;"><strong>个人资料</strong></font></a></div>
              <div style=" float:left; width:auto;margin:10px; padding:4px;background-color:#7596BF;font-size:12px;"><a href="#" onClick="window.open('../sysmanager/password/modifySelfPassword.jsp','','width=600,height=450,resizable=no left=250 top=170');"><font style="color:#FFFFFF;"><strong>个人密码修改</strong></font></a></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td valign=top style="background-repeat:no-repeat"><table width="80%" border="0" cellpadding="0" cellspacing="0" background="images/main_menu_Midd_BG.gif" style="text-align:center">
      <tr>
        <td width="22"><img src="images/main_menu_left_BG.gif" width="22" height="52"></td>
        <td><a href="docManage/docAudit.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image16','','images/Main_menu01.jpg',1)"><img src="images/Main_menu01Mouseout.jpg" name="Image16" width="50" height="52" border="0"></a><font color="red">(<%=docm.getTaskCount(curUserId,0)%>条)</font></td>
        <td><a href="docManage/newdoc_list_frmset.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','images/Main_menu02.jpg',1)"><img src="images/Main_menu02Mouseout.jpg" name="Image16" width="50" height="52" border="0"></a><a href="docManage/newdoc_list_frmset.jsp"></a><font color="red">(<%=docm.getTaskCount(curUserId,1)%>条)</font></td>
        <td><a href="docManage/docPublish.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','images/Main_menu03.jpg',1)"><img src="images/Main_menu03Mouseout.jpg" name="Image16" width="50" height="52" border="0"></a><a href="docManage/docPublish.jsp"></a><font color="red">(<%=docm.getTaskCount(curUserId,3)%>条)</font></td>
        <td><a href="docManage/workAgain.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','images/Main_menu04.jpg',1)"><img src="images/Main_menu04Mouseout.jpg" name="Image16" width="50" height="52" border="0"></a><a href="docManage/workAgain.jsp"></a><font color="red">(<%=docm.getTaskCount(curUserId,2)%>条)</font></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td width="30"><!--  <img src="images/main_menu_R_BG.gif" width="20" height="52">-->&nbsp;</td>
      </tr>
    </table>
    
      <table width="80%" border="0" cellspacing="0" cellpadding="0" background="images/main_M_ball.jpg"  width="810" height="267">
          <tr>
