...
//默认光标停留在文档标题输入框
	...
	<body class="info"  onload="">
		...
		<%if(isaddorupdate.equals("1")){%>
			<tr>
				<td height="25" class="detailtitle" width="23%">申请会员类型</td>						
			...
			<%}%>
			<tr>
				<td height="25" class="detailtitle" width="23%">会员名称</td>						
				<td height="25">
				...
				<td height="25" class="detailtitle" width="20%"> 真实姓名</td>						
				<td height="25">
		   ...
		   <tr>
			   ...
			   <td height="25">
<!--							<dict:select style="width:100px" dictTypeName="userType" name="userType" defaultValue="0" value="<%=user.getUserType()%>"  disabled="true" />-->
								<input type="userType" name="userType" value="<pg:cell colName="userType"  defaultValue="内部会员"/>"  readonly="true">
			   </td>						
