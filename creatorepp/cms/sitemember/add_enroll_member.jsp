		...
		<table width="100%" height="25" border="0" cellpadding="0" cellspacing="1" >
			 <tr height="35">
				<td colspan=4 height="25" class="detailtitle">
				  <div align="center">
			        <%if(isNew.equals("1")){%>
					  <span class="style2">新增注册用户</span>
			        <%}else{%>
					  <span class="style2">修改注册用户信息</span>
			        <%}%>
				    </div></td>
			</tr>
			 <tr height="35">
			...
			<%if(isNew.equals("1")){%>
				 ...
				 <td height="25" class="detailtitle" width="23%"></td>
                  <td height="25" class="detailtitle" width="23%"><strong>会员所在市(县)：</strong></td>
                  <td height="25">  
			...
			<tr>
  			...
  			<tr>
                  ...
                  <td height="25" width="20%" class="detailtitle" width="23%"><strong>用户状态:</strong></td>
  				  <td height="25" >
				  		<input type="text" style="width:160px" name="" value="新申请" readonly="true">
				  </td>
			...
			<tr>
				 ...
				 <td height="25">
				  		<input type="text" style="width:160px" name="" value="F类角色" readonly="true">
				 </td>	
