...
<table width="100%"  cellpadding=0 cellspacing=0 border=0 >
	...
	<%
		...
		if(_type!=null&&_type.equals("form")) out.print("表单管理");
		else out.print("业务类别管理");
	%>		
	</td>
	<td valign="middle" align="center" width=25 ><a
        ...
        alt="刷新" title="刷新" href="javascript:void 0;" onclick="getNavigatorContent().location.reload();return false;" ></a></td>
	</tr>
