...
相对或绝对路径
对于在线编辑器来说，路径问题一直是一个难点，基本上市面上的在线编辑器所编辑出来的内容链接都用的是带域名的绝对全路径（如：http://www.xxx.com/xxx/xxx.gif）。eWebEditor充分解决了此问题，只要简单设置一下三种路径形式可选（相对路径、绝对根路径、绝对全路径），完全摆脱了站点或系统或目录迁移而带来的路径问题。 
图形热点链接
