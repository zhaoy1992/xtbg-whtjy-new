...
config.StyleEditorHeader = "<head><link href=\""+sPath+"css/<%=sStyleCSS%>/EditorArea.css\" type=\"text/css\" rel=\"stylesheet\"></head><%@ include file="/epp/css/cssControl.jsp"%><body  MONOSPACE>" ;
config.StyleMenuHeader = "<head><link href=\""+sPath+"css/<%=sStyleCSS%>/MenuArea.css\" type=\"text/css\" rel=\"stylesheet\"></head><%@ include file="/epp/css/cssControl.jsp"%><body  scroll=\"no\" onConTextMenu=\"event.returnValue=false;\">";
...
<%@ include file="/epp/css/cssControl.jsp"%><body  SCROLLING=no onConTextMenu="event.returnValue=false;" onfocus="VerifyFocus()">
