...
function setCheck(currCheck,priority)
{
	...
	function okRecord(dealType) {
			...
			Form1.action="<%=rootpath%>/accessmanager/roleManager.do?method=storeAuthorization&isRecursion="+tt;
			Form1.submit();
...
<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" class="thin">
      ...
      <tr class="tr">
        ...
        <td height="22" class="td" >&nbsp;<input name="isRecursion" onclick="" type="checkbox">递归授权子机构</td>
