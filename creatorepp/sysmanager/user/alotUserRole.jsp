...
<%	
	...
	if("1".equals(accessControl.getUserID())){
		sql = "select * from td_sm_role where role_id not in('2','3','4') order by role_type,role_name";
	}else{
		sql = "select * from td_sm_role where role_id not in('1','2','3','4') order by role_type,role_name";
	}
