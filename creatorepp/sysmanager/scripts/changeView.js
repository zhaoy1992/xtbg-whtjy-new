function changeView(selectName){
	try
	{
		...
		parent.globalOperList.location = "../accessmanager/role/operList_global.jsp?resTypeId=" + restype;
		parent.operList.location = "../accessmanager/role/operdefault.jsp?resTypeId=" + restype;
