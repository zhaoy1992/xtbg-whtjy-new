...
-->
	...
	function submitSD(){     
    	...
    	if(document.getElementById("isRemind").value == "0"){
    		...
    		if(document.getElementById("isSys").checked == false
    			&& document.getElementById("isEmail").checked == false
    			&& document.getElementById("isMessage").checked == false){
    			alert("请选择提醒方式！");
    			return;
    		}
    	}
							...
							<pg:beaninfo requestKey="newSchedular">
								...
								<table cellpadding="0" cellspacing="0" width="99%"
									...
									<tr>
										...
										<td height="23">
											<input name="place" type="text" validator="stringLegalSpace"
									...
									<tr id="rmtr2" style="display:none">
										...
										<td height="23" width="30%">
											<input type="checkBox" name="isSys"
												onClick="check('checkBox','isSys')"/><strong>RTX</strong>
											<input type="checkBox" name="isEmail"
												onClick="check('checkBox','isEmail')"/><strong>邮件</strong>
											<input type="checkBox" name="isMessage"
												onClick="check('checkBox','isMessage')"/><strong>短信</strong>
									</tr>
