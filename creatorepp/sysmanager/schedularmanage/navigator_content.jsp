...
.calendarLink { font-family: "Arial", "Helvetica", "sans-serif", "宋体"; font-size: 11pt; font-weight: bold; color: #333333; text-decoration: none; background-color: #EEEEEE; text-align: center; height: 18px;}
