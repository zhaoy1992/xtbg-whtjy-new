				...
				<tbody>
					<tr>
						...
						<td style="BACKGROUND-IMAGE: url(msgTopBg.gif); PADDING-TOP:2px;PADDING-right:2px" align=center align=right width=19>
							<span title=关闭 style="CURSOR:hand;color:#FF8A00;font-size:12px;font-weight:bold;margin-right:4px;" onClick=closeDiv()>×</span>
							<!-- <IMG title=关闭 style="CURSOR: hand" onclick=closeDiv() hspace=3
src="msgClose.jpg"> -->
						</td>
					</tr>
					<tr>
