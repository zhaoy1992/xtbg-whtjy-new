...
<%@ page import="com.chinacreator.sysmgrcore.manager.db.*,com.chinacreator.sysmgrcore.manager.*,
				com.chinacreator.sysmgrcore.manager.db.CSMenuManagerImpl.ReportMenu,
				com.chinacreator.sysmgrcore.manager.db.CSMenuManagerImpl.ReportMenus"%>
...
<% 
    ...
    ReportMenus csMenu = CSMenuManagerImpl.getReportMenus();
    
    ReportMenu reportMenu = csMenu.getReportMenu(resId);
    String pathh = CSMenuManagerImpl.getReportMenuPath(resId);
	...
	String Title = "................... ";
	String Id = "";
	String Name = reportMenu.getName();
