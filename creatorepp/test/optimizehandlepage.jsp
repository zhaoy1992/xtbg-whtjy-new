...
<%
	...
	Event event = null;
	if (eventType.equals("")) {
	 event = new EventImpl(map, WebOfficeEventType.OPTIMIZE_TYPE,eventTarget, Event.REMOTE);
	} else {
	 event = new EventImpl(map, AttachEventType.OPTIMIZE_TYPE,eventTarget, Event.REMOTE);
	}
