...
<html>
	<head>
		...
		<script language="JavaScript" type="text/javascript">
			...
			function edit(){
			    ...
			    var winaddorg = window.showModalDialog(url,window,"dialogWidth:"+(800)+"px;dialogHeight:"+(600)+"px;help:no;scroll:no;status:no;maximize=yes;minimize=0");
				if(winaddorg=="ok")
				{
	...
	<body class="contentbodymargin" scroll="no">
		<form name="myform" action="userCheckInOrgBySecondEndUser.jsp" method="post">
						...
						<tr>
							...
							<div style="border:0px solid ; padding:5px;height:200px;overflow:auto;" > 
								<table width="100%" border="0" cellpadding="0" cellspacing="1"
									class="thin">
									<pg:listdata
										dataInfo="com.chinacreator.sysmgrcore.purviewmanager.usercheckorg.menu.UserCheckInOrgBySecondEndUserList"
										...
										<%userIDs.append(dataSet.getString("user_id")).append(","); %>
											<tr class="labeltable_middle_tr_01">
												<td class="tablecells" nowrap="true">
													<P align="left">
														<INPUT type="radio" name="checkBoxOne"															
