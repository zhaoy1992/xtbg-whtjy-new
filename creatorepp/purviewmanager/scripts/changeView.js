function changeView(selectName){
	try
	{
	    ...
	    parent.globalOperList.location = "../userorgmanager/user/operList_global.jsp?resTypeId=" + restype;
		parent.operList.location = "../userorgmanager/user/user_operdefault.jsp?resTypeId=" + restype;
		//alert(parent.operList.location);
