...
<%
	...
	String url = "../grantmanager/operList_global.jsp?resTypeId=dict&currRoleId="+roleId +"&role_type=role";
	String leftUrl = "../grantmanager/resDictFrame.jsp?resTypeId=dict&currRoleId=" + roleId + "&role_type=role";
%>
