							...
							<pg:list>
								<tr class="cms_data_tr" onMouseOver="high(this)" onMouseOut="unhigh(this)">
									...
									<td class="tablecells" nowrap="nowrap" height='30' style="cursor:hand" bgcolor="#F6FFEF"
										...
										<%} %>
										title="<pg:cell colName="title" defaultValue=""/>"
									>
									<input type="hidden" name="title" value="<pg:cell colName="title" defaultValue="" />"/>
										<%--<pg:cell colName="title" defaultValue="" maxlength="10"/>--%>
										<%=null!=dataSet.getString("title")&&!dataSet.getString("title").trim().equals("")?dataSet.getString("title").length()>10?dataSet.getString("title").substring(0,10)+"...":dataSet.getString("title"):"&nbsp;" %>
									</td>
									<td class="tablecells" nowrap="nowrap" height='30' title="<pg:cell colName="path" defaultValue=""/>">
										<%--<pg:cell colName="path" defaultValue="暂时为空" maxlength="14" />--%>
										<%=null!=dataSet.getString("path")&&!dataSet.getString("path").trim().equals("")?dataSet.getString("path").length()>10?dataSet.getString("path").substring(0,10)+"...":dataSet.getString("path"):"&nbsp;" %>
									</td>
