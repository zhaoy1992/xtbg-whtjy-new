			...
			<table width="100%" height="22" border="0" cellpadding="0" cellspacing="1" class="thin">
				  ...
				  <tr>
			        <td height='30' colspan="3">
			         <LEGEND align=left><strong><FONT size=2><%if(orgname != null){out.print(orgname + " >> ");}%>授予操作项</FONT></strong></LEGEND>
			        </td>
			      </tr>	
				  <tr>
			        <td>
			        ...
			        <td>>>>>全选</td>
			        <td>&nbsp;<input name="isRecursion" onclick="" type="checkbox">递归授权子机构</td>
			      </tr>
				  ...
				  //只能是超级管理员拥有的权限
			       ...
			       <tr>
			        ...
			        <td></td>
			        <td>
			        <input type="submit" value="确定" class="input" onclick="saveReolresop();" 
			        <%
