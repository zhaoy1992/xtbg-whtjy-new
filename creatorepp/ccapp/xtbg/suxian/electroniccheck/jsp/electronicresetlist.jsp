...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.suxian.electroniccheck.list.ElectronicresetList";
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID', '适用部门 ','上班时间', '下班时间','自动考勤','是否启用','操作'],
		...
		toolbar:[true, "top" ,"<input class='but_y_01' id=add value='新增' type='button' onclick='addLevel()' value=''/><input class='but_y_01' id='workIP' type='button' onclick='setWorkIP()' value='设置办公IP' />"],
		multiselect: true,
...
var toUserParamJosn = function() {
	var str = "{'ru_name':'" + StringCheck($("#ru_name").val()) +
		"'}";
...
var addLevel = function() {
 	var pageName ="考勤设置";
	openAlertWindows('windowId',"../../../suxian/electroniccheck/jsp/electronicreset.jsp?windowsId=windowId&actionName=insert",pageName,800,280,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改考勤设置";
	openAlertWindows('windowId','../../../suxian/electroniccheck/jsp/electronicreset.jsp?windowsId=windowId&actionName=update&elect_id='+ model.elect_id,pageName,800,280,'25%','25%');
}
...
var delLevel = function(id) {
	...
	$(selectedIds).each(function () {
		...
		if(!IsSpace(model.elect_id)){
			idsArrTemp.push(model.elect_id);
		}
	});
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								<th width="90" class="input_cx_title_th" >部门名称：</th>
								<td width="296"  class="cx_title_td">
								<input type="text" id="ru_name" class="input_cx_title_283" >
								</td>
...
<form id="delForm2" name="delForm2" method="post" action="reviewUserinfodo.jsp">
