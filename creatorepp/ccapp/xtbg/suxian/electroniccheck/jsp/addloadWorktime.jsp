...
<%@page import="com.chinacreator.xtbg.pub.countOlinePerson.service.SessionListener"%>
...
function Ok() {
	...
	if(IsSpace('<%=electresetBean.getStart_time()%>')){
		alert("请先设置好上班时间");
	}
	else{
...
<body style="overflow-y:hidden;">
	<form id="form1" action="addloadworktimedo.jsp" method="post">
		<input type="hidden" name="start_ip" id="start_ip"
