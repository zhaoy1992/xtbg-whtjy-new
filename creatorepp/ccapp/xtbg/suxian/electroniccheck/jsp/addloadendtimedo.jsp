...
<%
	...
	String endUser_name = StringUtil.deNull(request.getParameter("endUser_name"));
	String[][] arryUser = DaoUtil.SqlToFieldsArray("select t.user_id,t.user_name,t.user_realname from td_sm_user t where t.user_name='"+endUser_name+"'");
	
	String result = ""; //消息信息
	boolean resultFlag = false;
	if(arryUser.length!=0){
		ElectServiceIfc electserviceifc = new ElectServiceImpl();
		String[] arrResult = electserviceifc.punchEndClock(arryUser[0][0]+"",arryUser[0][1]+"",arryUser[0][2]+"",ip);
