...
var querybookinfo = function(id) {
	var model = jQuery("#gridTable").jqGrid('getRowData', id);
	var url = "<%=path%>/ccapp/xtbg/caizhengting/ibrary/jsp/ibrarybookinfo.jsp?subid=queryinfo&readonly=readonly&book_id="+model.book_id;
	openWindows('queryinfo','图书信息查询',url,'queryinfo',false,window);
}
...
<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable_box">
					...
					<tr><td>
					<!-- 隐藏查询 -->
						<table width="100%" border="0" cellspacing="0" cellpadding="2" class="tabs_search_ctable" id="hiddenArea" style="display:none;margin-left: 3px;">
							<tr>
								<th width="90" class="input_cx_title_th">图书编号：</th>
								<td width="296"  class="cx_title_td">
								<input name="book_no" id="book_no" type="text" class="input_cx_title_283" /></td>
								<th width="90" class="input_cx_title_th" >内容：</th>
								<td width="296"  class="cx_title_td">
								<input name="remark" id="remark" type="text" class="input_cx_title_283" /></td>
							</tr>
							<tr>
								...
								<td width="296"  class="cx_title_td">
								<input name="book_author" id="book_author" type="text" class="input_cx_title_283" /></td>
							</tr>
						</table>
						<!-- 隐藏查询 end-->
				</td></tr>
	...
	<tr>
		...
		$("#gridTable").jqGrid({
			...
			colNames: ['book_id','图书名称','图书编号','有效状态','装订特征','作者','所属id','所属类别','登记时间','数量'],
			...
			colModel: [ //最重要的数组之一，用于设定各列的参数
				...
				{
					name: 'book_name',index: 'book_name',width: '50',sortable:true
				},
				{
					name: 'book_no',index: 'book_no',width: '20',sortable:true
				},
				{
					name: 'validstate',index: 'validstate',width: '20',sortable:true
				},
				{
					name: 'zdtz',index: 'zdtz',width: '30',sortable:true
				},
				{
					name: 'book_author',index: 'book_author',width: '20',sortable:true
				},
				{
					name: 'tree_id',index: 'tree_id',width: '15',sortable:false,hidden:true
				},
				{
					name: 'tree_name',index: 'tree_name',width: '30',sortable:true
				},
				{
					name: 'booker_date',index: 'booker_date',width: '35',sortable:true
				},
				{
					name: 'book_number',index: 'book_number',width: '18',sortable:true
				}
			],
			viewrecords: true,
			sortname:"booker_date",
			sortorder:"desc",
