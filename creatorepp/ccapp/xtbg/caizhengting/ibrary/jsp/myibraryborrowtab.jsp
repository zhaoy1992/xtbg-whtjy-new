					...
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								...
								<li><a href="#tabs-2">已借阅</a></li>
								<li><a href="#tabs-3">已超期</a></li>
							</ul>
						</div>
						<div id="tabs-1" >
							<iframe src="myibrarylendinglist.jsp" id="frame1" frameborder="0"
								width="100%" height="500px" scrolling="no"></iframe>
						</div>
						<div id="tabs-2" >
							<iframe src="myibrarybacklist.jsp" id="frame2" frameborder="0"
								width="100%" height="500px"></iframe>
						</div>
						<div id="tabs-3">
							<iframe src="myibrarychaoqilist.jsp" id="frame3" frameborder="0"
								width="100%" height="500px"></iframe>
						</div>
					</div>
				</div>
