...
<%
	...
	String boorow_user_name = URLDecoder.decode(request.getParameter("boorow_user_name"),"UTF-8");
...
jQuery(document).ready(function() {
	if(phone_number.length==0 && phone_number==""){
		jQuery("#isTypebox").attr("disabled","disabled");
	}
...
<form id="conferenceBase" name="conferenceBase" method="post" action="ibrarymessageDo.jsp" >
<input type="hidden" id="isType" name="isType"/>
<input type="hidden" id="isnow" name="isnow"/>
<input type="hidden" id="boorow_user_id" name="boorow_user_id" value="<%=boorow_user_id%>"/>
<input type="hidden" id="boorow_user_name" name="boorow_user_name" value="<%=boorow_user_name%>"/>
