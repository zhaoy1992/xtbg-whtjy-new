...
var updateactuvuty = function(id) {
	...
	var url = "<%=path%>/ccapp/xtbg/caizhengting/ibrary/jsp/ibraryborrowadd.jsp?subid=queryinfo&readonly=readonly&t_regb_id="+model.t_regb_id;
...
<table width="100%" style="margin-left: 0" class="tabs_search_ctable_box">
	...
	<tr>
		...
		function toParamJosn(){
			...
			var str = "{'whatTabs':'3','jy_start_time':'"+jy_start_time+"','jy_end_time':'"+jy_end_time+"','t_regb_gh_date':'<%=nowDateString%>','t_regb_user_id':'<%=user_id%>'}";
			...
			gridComplete: function() { // var idss=jQuery("#gridTable").jqGrid('getColNames');
				...
				for (var i = 0; i < ids.length; i++) {
					...
					if(model.t_regb_state == "6"){
						...
						if(days < 0) {
							col = "<strong><span class=rowhighlight>已超期</span></a></strong>";
						}
					}
