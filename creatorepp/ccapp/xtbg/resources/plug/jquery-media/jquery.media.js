	...
	if(showDom && showDom.length){
      if(This.type == "word"){// 暂时内容为word的操作
          if(This.editAble){// 可编辑
    	    showDom.attr("src",path+"/ccapp/xtbg/public/util/jsp/iwebOffice2009.jsp?RecordID="+This.file+"&EditType=1,4&ShowType=1&showWordTempTaohong="+this.showWordTempTaohong+"&saveDocumentFlag="+this.saveDocumentFlag);
          }else{// 不可编辑
