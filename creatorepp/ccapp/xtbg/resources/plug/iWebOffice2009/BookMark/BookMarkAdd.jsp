...
if (DbaObj.OpenConnection())
{
  ...
  try
  {
    ...
    else
    {
        ...
        mSql="Insert Into BookMarks (BookMarkID,BookMarkName,BookMarkDesc,BookMarkText) values ('" +String.valueOf(mBookMarkID) + "','" + mBookMarkName + "','" + mBookMarkDesc + "','" + mBookMarkText + "')";
