								...
								var M = function(e, f) {
									...
									if (!a.grid.hDiv.loading) {
										...
										if (b.isFunction(a.p.datatype))
											...
											var data =  b.isFunction(a.p.serializeGridData) ? a.p.serializeGridData.call(a,a.p.postData):a.p.postData;											
											
											if(a.p.pageCached ===undefined||a.p.pageCached!==false)
											{
												//debuger("成立");
												var jsonKey = a.p.url.replace(/\//ig,'').replace('?','_').replace('=','_')+'_json';
												
												if(window.sessionStorage)
												{
												   var gridData = sessionStorage.getItem(jsonKey);
												   
												   if(gridData)
												   {
													   data=b.extend(JSON.parse(gridData),{nd:(new Date).getTime()});
												   }
												}
											}else{
												//debuger("不成立");
								...
								b(a)
										...
										.bind(
												...
												function(e, f) {
													...
													if(window.sessionStorage)
													{
													    sessionStorage.setItem(jsonKey,JSON.stringify(b.extend(data,{page:1,search:true})));
													}
											...
											if (a.p.reccount === 0 && !a.p.pagerintoolbar)
												...
												if (a.p.pagerinBottombar) {
													...
													b("#t_bottombar_content"+ a.p.id )
															.html(
																	t_bootombar_string);
													pWraper = pWraper.add("#t_bottombar_content"+ a.p.id );
												}
												
												 b(".but_y_01", pWraper).mouseover(function(){
													  $(this).removeClass();
													  $(this).addClass("but_y_02");
													  
											  });
												  
												  b(".but_y_01", pWraper).mouseout(function(){
													  $(this).removeClass();
												...
												if (_pager_count > 1
													...
													var _fn_set_button = function(
															_pager_count) {
															if (a.p.page <= 1) {
																b("._pg_up_but", pWraper)
																		.removeClass(
																				"_pg_up_but_valid");
																b("._pg_up_but", pWraper)
																		.addClass(
																				"_pg_up_but_invalid");
																b("._pg_up_but", pWraper).attr("disabled","disabled");
															...
															if (a.p.page > 1) {
																...
																b("._pg_up_but", pWraper)
																		.addClass(
																				"_pg_up_but_valid");
																b("._pg_up_but", pWraper).removeAttr("disabled");
															}
															if(a.p.page > 1){
																b("._pg_go_first", pWraper)
																.removeClass(
																		"_pg_up_but_invalid");
														b("._pg_go_first", pWraper)
																.addClass(
																		"_pg_up_but_valid");
														b("._pg_go_first", pWraper).removeAttr("disabled");
															}else{
																b("._pg_go_first", pWraper)
																.removeClass(
																		"_pg_up_but_valid");
														b("._pg_go_first", pWraper)
																.addClass(
																		"_pg_up_but_invalid");
														b("._pg_go_first", pWraper).attr("disabled","disabled");
															}
															
															if(a.p.page < _pager_count){
																b("._pg_go_end", pWraper)
																.removeClass(
																		"_pg_up_but_invalid");
														b("._pg_go_end", pWraper)
																.addClass(
																		"_pg_up_but_valid");
														b("._pg_go_end", pWraper).removeAttr("disabled");
															}else{
																b("._pg_go_end", pWraper)
																.removeClass(
																		"_pg_up_but_valid");
														b("._pg_go_end", pWraper)
																.addClass(
																		"_pg_up_but_invalid");
														b("._pg_go_end", pWraper).attr("disabled","disabled");
															}
															if (a.p.page >= _pager_count) {
																b(
																		"._pg_next_but", pWraper)
																		.removeClass(
																				"_pg_next_but_valid");
																b("._pg_next_but", pWraper)
																		.addClass(
																				"_pg_up_next_invalid");
																b("._pg_next_but", pWraper).attr("disabled","disabled");
															}
															if (a.p.page < _pager_count) {
																b(
																		"._pg_next_but", pWraper)
																...
																b(
																		...
																		.addClass(
																				"_pg_up_next_valid");
																b("._pg_next_but", pWraper).removeAttr("disabled");
															}
													...
													var _fn_modify_pager = function(
														...
														if (a.p.page != _val
															...
															if(a.p.pageCached ===undefined||a.p.pageCached!==false)
															{
																if(window.sessionStorage)
																{
																    sessionStorage.setItem(jsonKey,JSON.stringify(b.extend(data,{page:a.p.page})));
																}			
															}
															
															ka();
															
																b(".id_pg_text", pWraper)
																		.val(
																				b.jgrid
																						.format(
																								a.p.pg_text
																...
																b(
																		".c_pager_toolbar_select", pWraper)
																		.html(
																				"");
																b(
																		".c_pager_toolbar_select", pWraper)
													...
													b("._pg_go_input", pWraper).keyup(function(){
														var ppp =b(this).val();
														if(isNaN(ppp)){
															ppp=1;
														}
														b("._pg_go_input", pWraper).val(ppp);
														
												    	
													});
													if (_pager_count > 1) {
														b(".pager_toolbar_select", pWraper)
														.change(
																function() {
																	_fn_modify_pager(
																			"1",
														...
														b("._pg_go_a", pWraper).click(function(){
															var psg=b(this).prev().val();
															if(psg > _pager_count){
																psg = _pager_count;
															}
															b("._pg_go_input", pWraper).val(psg)
															_fn_modify_pager("1",psg)
														});
														b("._pg_go_first", pWraper).click(function(){
															_fn_modify_pager("1",1)
														});
														b("._pg_go_end", pWraper).click(function(){
