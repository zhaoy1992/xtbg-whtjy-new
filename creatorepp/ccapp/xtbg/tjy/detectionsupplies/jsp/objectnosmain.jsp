				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								<!-- 
								<li><a href="#tabs-1">固定资产库存</a></li> -->
								<li><a href="#tabs-2">易耗品库存</a></li>
							</ul>
						</div>
						<!--
						<div id="tabs-1" >
							<iframe src="osnomoveobjectmainlist.jsp" id="frame1" frameborder="0"
								width="100%" height="500px" scrolling="no"></iframe>
						</div>-->
						<div id="tabs-2" >
							<iframe src="osmoreobjectlist.jsp" id="frame2" frameborder="0"
