				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								<li><a id="tabs1" href="#tabs-1" >申购计划查询</a></li>
								<!-- <li><a id="tabs2" href="#tabs-2" >申购审批查询</a></li> -->
								<li><a id="tabs3" href="#tabs-3" >易耗领用查询</a></li>
								<li><a id="tabs4" href="#tabs-4" >资产领用查询</a></li>
							</ul> 
						</div>
						
						<div id="tabs-1">
							<iframe src="showpersonosplan.jsp?busitype_codes=uuid_5201" id="frame1" frameborder="0"
								width="100%" height="500px" scrolling="yes"></iframe>
						</div>
						<!-- <div id="tabs-2">
							<iframe src="showpersonosplan.jsp?busitype_codes=uuid_5211" id="frame2" frameborder="0"
								width="100%" height="500px" scrolling="yes"></iframe>
						</div> -->
						<div id="tabs-3">
							<iframe src="showpersonosplan.jsp?busitype_codes=uuid_6201" id="frame3" frameborder="0"
								width="100%" height="500px" scrolling="yes"></iframe>
						</div>
						<div id="tabs-4">
							<iframe src="showpersonosplan.jsp?busitype_codes=uuid_6211" id="frame4" frameborder="0"
								width="100%" height="500px" scrolling="yes"></iframe>
						</div>
