...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.detectionsupplies.list.OsupplieTypeList";
...
var addLevel = function() {
	...
	openAlertWindows('windowId',"../../../tjy/detectionsupplies/type/jsp/osupplietypeinfo.jsp?windowsId=windowId&actionName=insert&oftype_flag=<%=oftype_flag%>",pageName,500,205,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	openAlertWindows('windowId','../../../tjy/detectionsupplies/type/jsp/osupplietypeinfo.jsp?windowsId=windowId&actionName=update&oftype_flag=<%=oftype_flag%>&oftype_id='+ model.oftype_id,pageName,500,205,'25%','25%');
}
