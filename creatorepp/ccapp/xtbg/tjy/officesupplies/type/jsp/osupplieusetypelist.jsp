...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.officesupplies.list.OsupplieUseTypeList";
...
var addLevel = function() {
 	var pageName ="添加常用物品";
	openAlertWindows('windowId',"../../../tjy/officesupplies/type/jsp/osupplieusetypeinfo.jsp?windowsId=windowId&actionName=insert",pageName,500,175,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改常用物品";
	openAlertWindows('windowId','../../../tjy/officesupplies/type/jsp/osupplieusetypeinfo.jsp?windowsId=windowId&actionName=update&ofustype_id='+ model.ofustype_id+'&ofustype_id='+model.ofustype_id,pageName,500,175,'25%','25%');
}
