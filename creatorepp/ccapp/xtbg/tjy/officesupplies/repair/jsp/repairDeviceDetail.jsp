...
<%@page import="com.chinacreator.xtbg.tjy.officesupplies.dao.OsupplieRepairDao"%>
...
function choseObject(){
	var path ="<%=path%>/ccapp/xtbg/tjy/officesupplies/repair/jsp/choseosnomoveobjectlist.jsp?windowsId=windowIds";
