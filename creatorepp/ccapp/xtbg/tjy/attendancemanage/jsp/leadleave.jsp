	...
	var busi_id = "<%=busi_id%>";
	  jQuery(function(){
		   ...
		   jQuery("#TA_OA_ATTENDANCELEAVE__T_TITLE").focus();
    		...
    		//登记人初始化
    		if(!jQuery("#TA_OA_ATTENDANCELEAVE__T_REGIST_NAME").val()){
    			jQuery("#TA_OA_ATTENDANCELEAVE__T_REGIST_NAME").val("<%=user_name%>")
    			jQuery("#TA_OA_ATTENDANCELEAVE__T_REGIST_USER_ID").val("<%=user_id%>")
    		}
    		if(!jQuery("#TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_NAME").val()){
    			jQuery("#TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_NAME").val("<%=orgName%>")
    			jQuery("#TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_ID").val("<%=org_id%>")
    		}
	  ...
	  */
	  ...
	  var chooseRegister = function (userId,userName,orgId,orgName,treetypestr){
	...
	<div class="vcenter" style="float: left; overflow-x: hidden;" scrolling="yes">
			...
			<div class="content_02_box" style="width:996px;">
				<div class="content_02_box_title_bg" style="width: 98%;">
					<span>湖北省特种设备检验检测研究院请假审批单</span>
				</div>
				<div class="content_02_box_div" style="width: 996px;">
					<table border="0" cellspacing="0" cellpadding="0"
						class="content_02_box_div_table" style="width: 98%;">
						<tr><%--row1--%>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>登记人：</th>
							<td class="content_02_box_div_table_td" >
								<oa:input type="hidden" column="T_REGIST_USER_ID" table="TA_OA_ATTENDANCELEAVE"  />
								<oa:input
										type="text" column="T_REGIST_NAME" table="TA_OA_ATTENDANCELEAVE"
										other="class='input_160 validate[required,maxSize[50]] readonly='readonly' onclick =\"chooseRegister('TA_OA_ATTENDANCELEAVE__T_REGIST_USER_ID','TA_OA_ATTENDANCELEAVE__T_REGIST_NAME','TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_ID','TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_NAME','radio')\"" style="width:105px;" />
								<input name="" type="button" value="" class="but_x" 
								onclick="chooseRegister('TA_OA_ATTENDANCELEAVE__T_REGIST_USER_ID','TA_OA_ATTENDANCELEAVE__T_REGIST_NAME','TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_ID','TA_OA_ATTENDANCELEAVE__T_REGIST_DEPART_NAME','radio')"/>
							</td>
						
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>登记部门：</th>
							<td class="content_02_box_div_table_td" >
								<oa:input type="hidden" column="T_REGIST_DEPART_ID" table="TA_OA_ATTENDANCELEAVE"  />
								<oa:input
										type="text" column="T_REGIST_DEPART_NAME" table="TA_OA_ATTENDANCELEAVE"
										other="class='input_160 validate[required,maxSize[50]]' readonly='readonly'" style="width:160px;"/>
							</td>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>申请时间：</th>
							<td class="content_02_box_div_table_td" >
								<!--  
								<oa:input
										type="text" column="T_ZW" table="TA_OA_ATTENDANCELEAVE"
										other="class='input_title_text validate[maxSize[50]]'"  />-->
								<oa:date dateFmt='yyyy-MM-dd'  style="float:none" column="T_SQ_TIME" table="TA_OA_ATTENDANCELEAVE" 
									other="class='date_120 Wdate validate[required]'" />
							</td>
						</tr>
						<tr>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>请假人：</th>
							<td class="content_02_box_div_table_td" >
								<oa:input type="hidden" column="T_USER_ID" table="TA_OA_ATTENDANCELEAVE"  />
								<oa:input
										type="text" column="T_NAME" table="TA_OA_ATTENDANCELEAVE"
										other="class='input_160 validate[required,maxSize[50]]' readonly='readonly' onclick =\"chooseRegister('TA_OA_ATTENDANCELEAVE__T_USER_ID','TA_OA_ATTENDANCELEAVE__T_NAME','TA_OA_ATTENDANCELEAVE__T_DEPART_ID','TA_OA_ATTENDANCELEAVE__T_DEPART_NAME','radio')\""  style="width:105px;"/>
								<input name="" type="button" value="" class="but_x" 
								onclick="chooseRegister('TA_OA_ATTENDANCELEAVE__T_USER_ID','TA_OA_ATTENDANCELEAVE__T_NAME','TA_OA_ATTENDANCELEAVE__T_DEPART_ID','TA_OA_ATTENDANCELEAVE__T_DEPART_NAME','radio')"/>
							</td>
						
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>请假部门：</th>
							<td class="content_02_box_div_table_td" >
							...
							<td class="content_02_box_div_table_td" >
								...
								optionsql="select ' ' as T_TYPE,'--请选择--' as typemc  from dual  union
										   ...
										   select '学习培训假' as T_TYPE,'学习培训假' as typemc  from dual" style="width: 140px;"
										   initDefautValue="" defautValue="" other="class='validate[required]' onchange='mathLeaveDays()' "></oa:select>
							</td>
						</tr>
						<tr>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>请假方式：</th>
							
							<td class="content_02_box_div_table_td" colspan="1">
								<oa:select column="T_DATA_TYPE" table="TA_OA_ATTENDANCELEAVE"
								optionsql="select '2' as T_DATA_TYPE,'正常请假' as typemc  from dual  union
										   select '1' as T_DATA_TYPE,'补假' as typemc  from dual " style="width: 140px;"
										   initDefautValue="" defautValue="2" other="class='validate[required]'"></oa:select>
							</td>
						...
						<tr>
							...
							<td class="content_02_box_div_table_td" colspan="1">
								...
								optionsql="select '2' as T_DATA_TYPE,'一天假及以上' as typemc  from dual  union
										   select '1' as T_DATA_TYPE,'半天假' as typemc  from dual " style="width: 140px;"
						...
						<tr>
							...
							<td class="content_02_box_div_table_td" colspan="5">
								<oa:textarea
										column="T_TITLE" table="TA_OA_ATTENDANCELEAVE"
										other="class='textarea_556 validate[required,maxSize[50]]'"  />
							</td>
						</tr>
						<!-- 
						<tr>
