    ...
    /*
   	...
   	*/
   	function changeSelect(action_defid,selectAct){
	 	//-------分院其他人员  流程-------
		//1.分院综合办公室审核
		if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act2"){
			selectAct.find("option[value=ksqtryqj_wp1_act3]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act1]").remove();
		} else if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act3"){//分院科室主要负责人审核
			selectAct.find("option[value=ksqtryqj_wp1_act9]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act2]").remove();
		} else if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act9"){//分院分管院长审核
			selectAct.find("option[value=ksqtryqj_wp1_act10]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act3]").remove();
		} else if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act10"){//分院院长审核
			selectAct.find("option[value=ksqtryqj_wp1_act7]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act9]").remove();
		} else if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act4"){//分院科室主要负责人审核
			selectAct.find("option[value=ksqtryqj_wp1_act5]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act1]").remove();
		} else if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act5"){//分院分管院长审核
			selectAct.find("option[value=ksqtryqj_wp1_act6]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act4]").remove();
		} else if(!IsSpace(action_defid)&&action_defid=="ksqtryqj_wp1_act6"){//分院院长审核
			selectAct.find("option[value=ksqtryqj_wp1_act7]").attr("selected","selected").change();
			selectAct.find("option[value=ksqtryqj_wp1_act5]").remove();
		} 
   	}
