...
<script language="javascript" type="text/javascript">
  	...
  	*/
  	function changeSelect(action_defid,selectAct){
  		...
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act8"){//人力资源部复审
  		...
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act5"){//分管领导审核
  			selectAct.find("option[value=bmzyldqj_wp1_act10]").attr("selected","selected").change();
  			selectAct.find("option[value=bmzyldqj_wp1_act8]").remove();
  			
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act10"){//院长审核
  			selectAct.find("option[value=bmzyldqj_wp1_act11]").attr("selected","selected").change();
  			selectAct.find("option[value=bmzyldqj_wp1_act5]").remove();
  			
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act11"){//办公室备案
  			selectAct.find("option[value=bmzyldqj_wp1_act6]").attr("selected","selected").change();
  			selectAct.find("option[value=bmzyldqj_wp1_act10]").remove();
  			
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act3"){//分管领导审核
  			selectAct.find("option[value=bmzyldqj_wp1_act4]").attr("selected","selected").change();
  			selectAct.find("option[value=bmzyldqj_wp1_act1]").remove();
  			
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act4"){//院长审核
  			selectAct.find("option[value=bmzyldqj_wp1_act12]").attr("selected","selected").change();
  			selectAct.find("option[value=bmzyldqj_wp1_act3]").remove();
  			
  		} else if(!IsSpace(action_defid)&&action_defid=="bmzyldqj_wp1_act12"){//办公室备案
  			selectAct.find("option[value=bmzyldqj_wp1_act6]").attr("selected","selected").change();
  			selectAct.find("option[value=bmzyldqj_wp1_act4]").remove();
  		} 
