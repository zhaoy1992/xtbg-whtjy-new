     ...
     /*
   	...
   	*/
   	function changeSelect(action_defid,selectAct){
   		//-------省院一般人员请假   流程-------
   		//1.人力资源部审核
   		if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act2"){
   			selectAct.find("option[value=bmybryqj_wp1_act3]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act1]").remove();
   		} else if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act3"){//人力资源部复审
   			selectAct.find("option[value=bmybryqj_wp1_act5]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act2]").remove();
   		} else if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act5"){//部门负责人审核
   			selectAct.find("option[value=bmybryqj_wp1_act4]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act3]").remove();
   		} else if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act4"){//分管领导审核
   			selectAct.find("option[value=bmybryqj_wp1_act9]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act5]").remove();
   		} else if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act6"){//部门负责人审核
   			selectAct.find("option[value=bmybryqj_wp1_act7]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act1]").remove();
   		} else if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act7"){//分管领导审核
   			selectAct.find("option[value=bmybryqj_wp1_act8]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act6]").remove();
   		} else if(!IsSpace(action_defid)&&action_defid=="bmybryqj_wp1_act8"){//院长审核
   			selectAct.find("option[value=bmybryqj_wp1_act9]").attr("selected","selected").change();
   			selectAct.find("option[value=bmybryqj_wp1_act7]").remove();
   		} 
   	}
