...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '${pageContext.request.contextPath}/pubListServlet?classNameId=com.chinacreator.xtbg.tjy.canteenitemssupplies.list.OsupplieRepairList',  //commonListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		{
			name: 'repair_unitname',
			index: 'repair_unitname',
			width: 80
		},
		{
			name: 'deal_status',
...
var toUserParamJosn = function() {
	var str = "{'place_info':'" + StringCheck($("#place_info").val()) +"','repair_type':'floor','unit_id':'<%=unit_id%>'}";
...
var addRepair = function() {
	var pageName ="报修登记";
	openAlertWindows('windowId',"${pageContext.request.contextPath}/ccapp/xtbg/tjy/canteenitemssupplies/repair/jsp/repairFacilityDetail.jsp?windowsId=windowId&actionName=insert",pageName,500,400,'25%','25%');
}
...
var pageName ="修改报修登记";
openAlertWindows('windowId','${pageContext.request.contextPath}/ccapp/xtbg/tjy/canteenitemssupplies/repair/jsp/repairFacilityDetail.jsp?windowsId=windowId&actionName=update&repair_id='+ model.repair_id,pageName,500,400,'25%','25%');
}
