...
<form id="form1" name="form1" action="" method="post" >
	...
	<input value="com.chinacreator.xtbg.tjy.canteenitemssupplies.service.impl.AddOrUpdateOsAppServiceImpl" id="<%=FlowBusiDataSaveDao.CUSTOM_CRUD_CLASSNAME_FLAG%>" 
			...
			<div class="content_02_box" style="width:100%;">
				...
				<div class="content_02_box_div" style="width: 900px;">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr><%--row1--%>
						<oa:input type="hidden" column="UNIT_ID" table="TA_OA_CANOSAPPLAN" value="<%= unit_id%>"/>
						<oa:input type="hidden" column="UNIT_NAME" table="TA_OA_CANOSAPPLAN" value="<%= unit_name%>"/>
						<oa:input type="hidden" column="T_ORG_ID" table="TA_OA_CANOSAPPLAN" value="<%= org_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>部室：</th>
							<td class="content_02_box_div_table_td" >
								<oa:input
										type="text" column="T_ORG_NAME" table="TA_OA_CANOSAPPLAN"
							...
							<td class="content_02_box_div_table_td">
								<oa:date dateFmt='yyyy-MM-dd' other="class='Wdate validate[required]'" style='height:22px;line-height: 22px;float:left;margin-top:3px;'
								   column="T_CREATOR_TIME" table="TA_OA_CANOSAPPLAN"/>
							</td>
						</tr>
						<tr>
						<%--row2--%>
							...
							<td class="content_02_box_div_table_td" colspan="3">
								<oa:input
										type="text" column="T_TITLE" table="TA_OA_CANOSAPPLAN"
										other="class='input_cx_title_240'" style="width:705px;" />
							</td>
						</tr>
						<tr>
						<%--row3--%>
						<oa:input type="hidden" column="T_USER_ID" table="TA_OA_CANOSAPPLAN" value="<%= user_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>申请人：</th>
							<td class="content_02_box_div_table_td" colspan="3">
								<oa:input
										type="text" column="T_USER_NAME" table="TA_OA_CANOSAPPLAN"
			 	  ...
			 	  <table width="100%">
			 	  	<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_BMFZYJ" table="TA_OA_CANOSAPPLAN" 
