...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.tjy.canteenitemssupplies.list.OsHavaNoMoveList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		colNames: ['物品类型ID','物品类型名称','总数','在库 ','在修','领用','报废'],
		...
		toolbar: [true,"top","<input class='but_y_01' id=add value='返回' type='button' onclick='addLevel()'/>"],
		multiselect: false,
...
function addLevel(id){   
	var path ="<%=path%>/ccapp/xtbg/tjy/canteenitemssupplies/jsp/osnomoveobjectmainlist.jsp";
