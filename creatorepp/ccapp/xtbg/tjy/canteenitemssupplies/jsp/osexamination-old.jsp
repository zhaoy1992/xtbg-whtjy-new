...
<%
	...
	allOsupplieUseList = osupplieUseTypeService.queryAllOsupplieUseType();
...
function open_OsAppList(){
	var path ="<%=path%>/ccapp/xtbg/tjy/officesupplies/jsp/osappovernoexalist.jsp?windowsId=windowIds";
...
function deleteDay(tag,goodsId){
	...
	var t_Ids = jQuery("#TA_OA_OSEXAMINATION__T_IDS").val();
	...
	//重新赋值
	jQuery("#TA_OA_OSEXAMINATION__T_IDS").val(t_Ids)
...
function loadOsAppItem(OsAppIds,_bus_id){
	...
	var url = "<%=path %>/ccapp/xtbg/tjy/officesupplies/jsp/getbackosappajax.jsp";
	...
	jQuery.ajax({
		...
		success: function(data){
			...
			jQuery("#TA_OA_OSEXAMINATION__T_IDS").val(OsAppIds);
...
function loadOsAppItemObject(OsAppIds,_bus_id){
	...
	var url = "<%=path %>/ccapp/xtbg/tjy/officesupplies/jsp/getbackosappobjectajax.jsp";
	var params = {osappitem:OsAppIds,bus_id:_bus_id};
...
<form id="form1" name="form1" action="" method="post" >
	...
	<input value="com.chinacreator.xtbg.tjy.officesupplies.service.impl.AddOrUpdateOsExaObjectServiceImpl" id="<%=FlowBusiDataSaveDao.CUSTOM_CRUD_CLASSNAME_FLAG%>" 
...
<div id="tabs1" style="width:70%">
	...
	<div class="vcenter" style="float: left; overflow-x: hidden;" scrolling="yes">
			...
			<div class="content_02_box" style="width:100%;">
				...
				<div class="content_02_box_div" style="width: 998px;">
					<table border="0" cellspacing="0" cellpadding="0"
						...
						<tr><%--row1--%>
						<oa:input type="hidden" column="T_IDS" table="TA_OA_OSEXAMINATION" value=""/>
						<oa:input type="hidden" column="T_OSEXA_ORG_ID" table="TA_OA_OSEXAMINATION" value="<%= org_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red" id="bt_id" >*</FONT>填写部室：</th>
							<td class="content_02_box_div_table_td">
								<oa:input
										type="text" column="T_OSEXA_ORG_NAME" table="TA_OA_OSEXAMINATION"
										other="class='input_cx_title_240' readonly='readonly'" value="<%=orgName%>" style="width:180px;"/>
							</td>
							<oa:input type="hidden" column="T_OSEXA_USER_ID" table="TA_OA_OSEXAMINATION" value="<%= user_id%>"/>
							<th class="content_02_box_div_table_th"><FONT style="COLOR: red">*</FONT>审批人：</th>
							<td class="content_02_box_div_table_td">
								<td class="content_02_box_div_table_td">
								<oa:input
										type="text" column="T_OSEXA_USER_NAME" table="TA_OA_OSEXAMINATION"
										other="class='input_cx_title_240' readonly='readonly'" value="<%=user_name%>" style="width:180px;"/>
							</td>
						</tr>
						<tr>
						<%--row2--%>
							...
							<td class="content_02_box_div_table_td" colspan="4">
								<oa:input
										type="text" column="T_OSEXA_TITLE" table="TA_OA_OSEXAMINATION"
						...
						<tr><%--row3--%>
							...
							<td class="content_02_box_div_table_td">
								<oa:date dateFmt='yyyy-MM-dd' other="class='Wdate validate[required]'" style='height:22px;line-height: 22px;float:left;margin-top:3px;'
								   column="T_OSEXA_DATE" table="TA_OA_OSEXAMINATION"/>
							</td>
						</tr>
			...
			<a onclick="open_OsAppList();" id="addButton"><img src="ccapp/xtbg/resources/images/add.gif"/>添加计划表</a>
			</div>
			</div>
			<div class="content_02_box_div" style="width: 998px;">
							...
							<tr  id ="osapprowhidden" name="osapprowhidden">
								...
								<td class="content_02_box_div_table_td"> 
										 <div class="content_02_box_del" style="height:24px; margin:0;float: none;text-align: center;">
															<a onClick="deleteDay(this,'')" name="delbtn"> <img src="ccapp/xtbg/resources/images/del.gif" id="del"/>删除</a>
										 </div>
			 	  ...
			 	  <table width="100%">
			 	  	<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSEXA_BGSYJ" table="TA_OA_OSEXAMINATION" 
					...
					<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSEXA_ZGYJ" table="TA_OA_OSEXAMINATION" 
											style="border: 1;width:99%;overflow: auto;" other="class='validate[maxSize[1000]] textarea_556'" />
						</td>
					</tr>
					<tr>
			 	  		<td class="content_02_box_div_table_td">
							 ...
							 <oa:view column="T_OSEXA_YZYJ" table="TA_OA_OSEXAMINATION" 
											style="border: 1;width:99%;overflow: auto;" other="class='validate[maxSize[1000]] textarea_556'" />
						</td>
					</tr>
				 </table>
