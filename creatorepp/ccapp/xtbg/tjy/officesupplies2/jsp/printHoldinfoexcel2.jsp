...
<%@page import="com.chinacreator.xtbg.tjy.officesupplies.data.OsHavaLyOrgExcelToData2"%>
...
<%
	//文件下载数据
	// excel文件名
	String t_appregyhp_id = StringUtil.deNull(request.getParameter("t_appregyhp_id"));
	...
	//得数据
	OsHavaLyOrgExcelToData2 osHavaLyOrgExcelToData = new OsHavaLyOrgExcelToData2();
	...
	try {
		String exportTempFilePath = osHavaLyOrgExcelToData.exportExcelToData(osAppRegObjectList);
		...
		if (tempExportFile.exists()) {
			...
			response.addHeader("Content-disposition",
					"attachment; filename="+toChinese("湖北特检院办公耗材领用表.xls"));
