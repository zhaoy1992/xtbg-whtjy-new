...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.officesupplies.list.OsupplieTypeList";
...
//tab2
	$("#gridTable").jqGrid({
		...
		toolbar:[true, "top" ,"<input class='but_y_01' id=add value='添加分类' type='button' onclick='addLevel()' value=''/>"+
		         "<input class='but_y_01' value='添加子分类' id=del type='button' onclick='addLevel1()' value=''/>"+
		         "<input class='but_y_01' value='删除' id=del type='button' onclick='delLevel()' value=''/>"],
		multiselect: true,
...
var toUserParamJosn = function() {
	var str = "{'oftype_name':'" + StringCheck($("#oftype_name").val()) +"','oftype_id':'<%=oftype_id%>'}";
...
var addLevel = function() {
 	var pageName ="添加办公用品类型";
	openAlertWindows('windowId',"../../../tjy/officesupplies2/jsp/osupplietypeinfo.jsp?windowsId=windowId&actionName=insert",pageName,500,205,'25%','25%');
}
...
var addLevel1 = function() {
 	var pageName ="添加办公用品子类型";
	openAlertWindows('windowId',"../../../tjy/officesupplies2/jsp/osupplietypeinfo.jsp?windowsId=windowId&actionName=insert1",pageName,500,240,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改办公用品类型";
	openAlertWindows('windowId','../../../tjy/officesupplies2/jsp/osupplietypeinfo.jsp?windowsId=windowId&actionName=update&oftype_id='+ model.oftype_id,pageName,500,240,'25%','25%');
}
	...
	try{
		if(result.indexOf("delete")!=-1){
			...
			if(result.split(",").length>1){
					result = result.split(",");
					alert(result[0]);
					parent.setLeftIframeSrc("osmoreobjecttree.jsp?type=type&oftype_id=''");
					userSearch();
			} else {
				alert(result);
				parent.setLeftIframeSrc("osmoreobjecttree.jsp?type=type&oftype_id=''");
...
<form id="delForm2" name="delForm2" method="post" action="osupplietypedo.jsp">
