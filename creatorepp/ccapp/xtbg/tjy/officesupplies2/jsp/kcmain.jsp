				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								<li><a id="tabs1" href="#tabs-1" >物品库存</a></li>
								<!--<li><a id="tabs2" href="#tabs-2" >申购审批查询</a></li>  -->
								<li><a id="tabs3" href="#tabs-3" >采购入库</a></li>
								<li><a id="tabs4" href="#tabs-4" >领用出库</a></li>
							</ul> 
						</div>
						
						<div id="tabs-1">
							<iframe src="osmoreobjectmain.jsp" id="frame1" frameborder="0"
						...
						<div id="tabs-3">
							<iframe src="osrukulist.jsp" id="frame3" frameborder="0"
								width="100%" height="500px" scrolling="yes"></iframe>
						</div>
						<div id="tabs-4">
							<iframe src="oschukulist.jsp?type=chuku" id="frame4" frameborder="0"
								width="100%" height="500px" scrolling="yes"></iframe>
						</div>
