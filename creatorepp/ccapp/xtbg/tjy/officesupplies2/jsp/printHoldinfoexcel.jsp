...
<%@page import="com.chinacreator.xtbg.tjy.officesupplies.data.OsHavaLyOrgExcelToData"%>
<%@page import="com.chinacreator.xtbg.tjy.officesupplies.entity.OsAppRegObjectBean"%>
<%@page import="com.chinacreator.xtbg.tjy.officesupplies.dao.OsAppRegObjectDao"%>
<%@page import="com.chinacreator.xtbg.tjy.officesupplies.dao.impl.OsAppRegObjectDaoImpl"%>
...
<%
	...
	//得数据
	OsHavaLyOrgExcelToData osHavaLyOrgExcelToData = new OsHavaLyOrgExcelToData();
	...
	PagingBean pagingbean = dao.getListByOrg(bean,"","",0,2000);
	List result = pagingbean.getList();
	
	File tempExportFile = null;
	try {
		String exportTempFilePath = osHavaLyOrgExcelToData.exportExcelToData(result);
		...
		if (tempExportFile.exists()) {
			...
			response.addHeader("Content-disposition",
					"attachment; filename="+toChinese("湖北特检院办公耗材部门统计表.xls"));
		...
		osHavaLyOrgExcelToData.deleteExportTempFile(tempExportFile);
	}
%>
