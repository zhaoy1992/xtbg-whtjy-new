...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.review.list.ReviewUserList";
...
//tab2
	$("#gridTable").jqGrid({
		...
		toolbar:[true, "top" ,"<input class='but_y_01' id=add value='职称登记' type='button' onclick='addLevel()' value=''/><input class='but_y_01' value='删除' id=del type='button' onclick='delLevel()' value=''/>"],
		multiselect: true,
...
var addLevel = function() {
 	var pageName ="专家登记";
	openAlertWindows('windowId',"../../../tjy/review/jsp/reviewUserinfo.jsp?windowsId=windowId&actionName=insert",pageName,500,175,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改专家信息";
	openAlertWindows('windowId','../../../tjy/review/jsp/reviewUserinfo.jsp?windowsId=windowId&actionName=update&ru_id='+ model.ru_id,pageName,500,175,'25%','25%');
}
...
var delLevel = function(id) {
	...
	$(selectedIds).each(function () {
		...
		if(!IsSpace(model.ru_id)){
			idsArrTemp.push(model.ru_id);
		}
	});
