...
<%@page import="com.chinacreator.xtbg.tjy.review.entity.ReviewUserBean"%>
...
<%
	...
	if("addInfo".equals(action)){
		responseCode = "1";
		ReviewUserBean bean = new ReviewUserBean();
		bean = (ReviewUserBean)RequestBeanUtils.getValuesByRequest(request,bean);
		String beanId = service.insertOrUpdateReviewUser(bean);
	...
	if("deleteInf".equals(action)){
		...
		if(deleteArr.length>0){
			flagStr = service.deleteReviewUserByIds(deleteArr);
		}
