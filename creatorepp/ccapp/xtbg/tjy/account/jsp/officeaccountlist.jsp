...
<%
	...
	String sql = "select a.org_level from td_sm_organization a where a.org_id = '"+org_id+"'";
	String org_level = DaoUtil.sqlToField(sql);
	String is_fenyuan = "";
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.officesupplies.list.OsAccountList";
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['机构ID ','部门', '最后修改时间','使用资产数量'],
...
var toUserParamJosn = function() {
	var str = "{'org_name':'"+StringCheck($("#org_name").val())+"','is_fenyuan':'<%=is_fenyuan%>','org_id':'<%=org_id%>','classify':'<%=classify%>'}";
...
var updateLevel = function(id) {
	...
	var pageName ="台帐详细界面";
	var url ="../../../tjy/account/jsp/officedetaillist.jsp?windowsId=windowId&classify=<%=classify%>&org_id="+model.org_id;
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								<th width="90" class="input_cx_title_th" >部门：</th>
...
<form id="delForm2" name="delForm2" method="post" action="">
