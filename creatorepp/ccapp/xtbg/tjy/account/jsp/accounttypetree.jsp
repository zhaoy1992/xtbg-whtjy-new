...
var setting = {
	...
	async: {
    	enable: true,//启用异步加载
    	url: window.top.getContextPath() + '/commonTreeServlet?classNameId=com.chinacreator.xtbg.core.common.tree.dao.impl.AccountTypeTree', 
		autoParam:["dictdata_id", "name=dictdata_id", "level=lv"],
		otherParam:{"type":"<%=type%>","orgids":""}
    },
	data: {
		simpleData: { //简单json类型
			enable: true, 
...
function orgOnclick(event,treeId,treeNode) {
	var url;
	url="accountlist.jsp?type_id="+treeNode.id;
...
$(document).ready(function(){
	...
	<body style="overflow-y: auto;" >
		<div class="left_tree" >
			<h3><b>固定资产分类</b></h3>
			<ul id="treeDemo" class="ztree" style="height: 490px"></ul>
		</div>
	</body>
</html>
