...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.officesupplies.list.OsofficeAccountList";
...
var updateLevel = function(id) {
	if(orgOfficeManage=="true"||adminOfficeManage=="true"){
		...
		var pageName ="台帐详细界面";
		var url ="../../../tjy/officesupplies/jsp/officedetaillist.jsp?windowsId=windowId&org_id="+ model.org_id;
