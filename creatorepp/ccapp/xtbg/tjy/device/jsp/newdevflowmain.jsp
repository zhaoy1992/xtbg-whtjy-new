...
String busitypeCode = "";
//政府采购管理
if("yqzfcgl".equals(busitype_type_code)){
	busitypeCode = "'uuid_720','uuid_724'";
//使用管理
} if("yqsygl".equals(busitype_type_code)){
	busitypeCode = "'uuid_725','uuid_722','uuid_726','yqsb_zcgh','yqsb_zccz','yqsb_zcdb','xxsbwx'";
} else {
	busitypeCode = "'uuid_720','uuid_724'";
}
