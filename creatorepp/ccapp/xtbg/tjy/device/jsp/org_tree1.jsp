...
function orgOnclick(event,treeId,treeNode) {
	...
	parent.getTempValue("officedetaillist.jsp?org_id=" + treeNode.org_id);
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
	...
	%>
	  	<tr>
	    	<td align="center"><a onclick="neworg()">新增</a></td>
	    	<td align="center"><a onclick="modifyOrgInfo()">修改</a></td>
	    	<td align="center"><a onclick="delOrg()">删除</a></td>
		    <td align="center"><a onclick="changeOrgAdmin()">管理员设置</a></td>
		</tr>
	<%
	   	}
	}
...
<table  width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
	<tr>
	  	...
	  	<td align="left">
	  		 <input type="button" onclick="searchTree()" value="搜索" class="_z_tree_seachter_input_but"></input>
	  	</td>
  	</tr>
</table>
