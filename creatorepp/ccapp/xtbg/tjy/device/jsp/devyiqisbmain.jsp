...
<body style="overflow-y: hidden;">
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td width="200px">
				<iframe src="devyqsbtree.jsp" scrolling="no" width="220px" height="550" frameborder="0"></iframe>
			</td>
			<td>
				<iframe id="ifuserlist" src="devaccountinfolist2.jsp" scrolling="no" width="100%" height="550px" frameborder="0"></iframe>
			</td>
		</tr>
	</table>
</body>
