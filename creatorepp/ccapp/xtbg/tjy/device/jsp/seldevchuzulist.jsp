...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.device.list.DevBorrowList";
	String path = request.getContextPath();
	//设备ID
	String t_sb_id= StringUtil.deNull(request.getParameter("t_sb_id"));
	//为空的处理
	if("".equals(t_sb_id)){
		t_sb_id = "t_sb_id";
	}
%>
<title>借用记录列表界面</title>
<!-- 公共部分开始 -->
<!-- 引入jQuery -->
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID', '出租时间','归还时间', '出租人','出租金额'],
		...
		toolbar:[true, "top" ,"<span>出租记录<span>"],
		multiselect: false,
...
var toUserParamJosn = function() {
		  var str = "{'t_sb_id':'<%=t_sb_id%>','jieyong_or_chuzu':'2'}";
...
<form id="delForm2" name="delForm2" method="post" >
