...
$(function(){
	...
	$("#gridTable").jqGrid({
		...
		colModel: [ //最重要的数组之一，用于设定各列的参数
			...
			{label:'设备编号',name: 'dev_code',index: 'dev_code',width: '100',hidden:true},
			{label:'设备名称',name: 'dev_name',index: 'dev_name',width: '100',hidden:true},
		...
		toolbar: [true,"top","<span>标对记录<span>"],
		multiselect: false,
