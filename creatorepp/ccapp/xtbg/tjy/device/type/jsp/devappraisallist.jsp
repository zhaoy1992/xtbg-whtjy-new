...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID', '设备编号 ','设备名称', '检定证书编号','检定单位','检定日期','有效期','参数范围'],
...
var addLevel = function() {
 	var pageName ="新增检定记录";
	openAlertWindows('windowId',"../../../tjy/device/type/jsp/devappraisalinfo.jsp?windowsId=windowId&actionName=insert",pageName,530,370,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改检定记录";
	openAlertWindows('windowId','../../../tjy/device/type/jsp/devappraisalinfo.jsp?windowsId=windowId&actionName=update&appr_id='+ model.appr_id,pageName,530,370,'25%','25%');
}
