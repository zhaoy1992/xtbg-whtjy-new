...
<%
	...
	String GET_LIST_CLASS1="com.chinacreator.xtbg.tjy.device.list.DevCompareRecodeList";
	String path = request.getContextPath();
%>
<title>对比记录列表界面</title>
<!-- 公共部分开始 -->
<!-- 引入jQuery -->
...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID', '设备编号 ','设备名称', '比对设备编号','比对设备名称','比对结果','比对时间','备注','对比设备ID'],
...
var addLevel = function() {
 	var pageName ="新增对比记录";
	openAlertWindows('windowId',"../../../tjy/device/type/jsp/devcomparerecodeinfo.jsp?windowsId=windowId&actionName=insert",pageName,530,410,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改对比记录";
	openAlertWindows('windowId','../../../tjy/device/type/jsp/devcomparerecodeinfo.jsp?windowsId=windowId&actionName=update&comp_id='+ model.comp_id,pageName,530,410,'25%','25%');
}
...
var delLevel = function(id) {
	...
	$(selectedIds).each(function () {
		...
		if(!IsSpace(model.comp_id)){
			idsArrTemp.push(model.comp_id);
		}
	});
...
<form id="delForm2" name="delForm2" method="post" action="devcomparerecodeinfodo.jsp">
