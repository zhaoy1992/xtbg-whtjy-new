...
<%
	...
	if("addInfo".equals(action)){
		responseCode = "1";
		DevCheckInfoBean bean = new DevCheckInfoBean();
		bean = (DevCheckInfoBean)RequestBeanUtils.getValuesByRequest(request,bean);
		String beanId = service.insertOrUpdateDevCheckInfo(bean);
	...
	if("deleteInf".equals(action)){
		...
		if(deleteArr.length>0){
			flagStr = service.deleteDevCheckInfoByIds(deleteArr);
		}
