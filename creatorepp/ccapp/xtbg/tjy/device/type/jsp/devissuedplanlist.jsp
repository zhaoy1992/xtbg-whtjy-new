...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID','待检设备编号','待检设备名称','核检负责人', '检验类型 ', '计划完成时间','完成状态'],
...
var addLevel = function() {
	...
	openAlertWindows('windowId',"../../../tjy/device/type/jsp/devissuedplaninfo.jsp?windowsId=windowId&actionName=insert",pageName,650,490,'25%','25%');
}
/*
 函数:  updateLevel
 说明:  修改缓急程度
...
var updateLevel = function(id) {
	...
	openAlertWindows('windowId','../../../tjy/device/type/jsp/devissuedplaninfo.jsp?windowsId=windowId&actionName=update&type=<%=type%>&plan_id='+ model.plan_id,pageName,650,490,'25%','25%');
}
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							   <tr>
									<th width="90" class="input_cx_title_th">待检设备编号：</th>
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable" id="hiddenArea" style="display:none">
							<tr>
								<th width="90" class="input_cx_title_th">待检设备名称：</th>
								<td>
