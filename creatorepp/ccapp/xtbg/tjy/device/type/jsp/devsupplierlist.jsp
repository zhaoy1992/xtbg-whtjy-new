...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['主键ID', '供应商名称 ','收录时间', '供方类别','供方地址','法定代表人','联系代表','联系电话','提供产品','信誉度'],
...
var addLevel = function() {
 	var pageName ="新增供应商";
	openAlertWindows('windowId',"../../../tjy/device/type/jsp/devsupplierinfo.jsp?windowsId=windowId&actionName=insert",pageName,480,450,'25%','25%');
}
...
var updateLevel = function(id) {
	...
	var pageName ="修改供应商";
	openAlertWindows('windowId','../../../tjy/device/type/jsp/devsupplierinfo.jsp?windowsId=windowId&actionName=update&devsup_id='+ model.devsup_id,pageName,480,450,'25%','25%');
}
...
var delLevel = function(id) {
	...
	$(selectedIds).each(function () {
		...
		if(!IsSpace(model.devsup_id)){
			idsArrTemp.push(model.devsup_id);
		}
	});
