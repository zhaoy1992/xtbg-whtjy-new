...
$(function() {
	...
	*/
	...
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/commonListServlet?classNameId=carManageViolationrecordYmjList',  //commonListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		{
			label:"驾驶人",
			name: 'drive_person_name',
			index: 'drive_person_name',
			width: 400,
			editable: true
		},
		{
...
var addInfo = function() {
	 openWindows('addViolationrecordInfo_main_page','新增','addViolationrecordInfo.jsp?opt=add&subId=addViolationrecordInfo_main_page','addViolationrecordInfo_main_page',false,window);
}
/*
	 函数:  udateInfo
	 说明:  修改程序界面
...
var udateInfo = function(ci) {
	var model = jQuery("#gridTable").jqGrid('getRowData', ci);
		openWindows('updViolationrecordInfo_main_page','查看信息','addViolationrecordInfo.jsp?opt=upd&subId=updViolationrecordInfo_main_page&id='+model.endorsement_id,'updViolationrecordInfo_main_page',false,window);
	}
				...
				<tr>
					<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
							<tr>
								<th class="input_cx_title_th">记录日期：</th>
...
<!-- 查询列表区 --></div>
<form id="delForm1" name="delForm1" method="post" action="addViolationrecord.jsp">
