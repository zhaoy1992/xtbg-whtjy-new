...
$(function() {
	...
	$("#gridTable").jqGrid({
		...
		filterNames:["type","sp_state"],
		filterOptions:[
					    [["","类型"],["1","保养"],["2","维修"]],
					    [["","状态"],["1","等待审批"],["2","审批通过"],["3","审批未通过"]]
		              ],
		...
		toolbar: [true,"top","<input type='button' class='but_y_03' value='维修保养申请' onMouseOver=javascript:$(this).attr('class','but_y_03'); onMouseOut=javascript:$(this).attr('class','but_y_03'); onclick='addCarWxbyinfo()'/>"],
		multiselect: false,
...
var toUserParamJosn = function() {
	 var str = "{'apply_personid':'" + loginUserID 
	 		...
	 		+ $("#use_endtime").val() + "','car_num':'" + $("#car_num").find("option:selected").text() 
	 		+ "'}";
...
var viewApplyinfo = function(id) {
	...
	var url = "<%=path%>/ccapp/xtbg/yimingju/carmanage/jsp/carWxMxInfo.jsp?car_id="+model.car_id;
