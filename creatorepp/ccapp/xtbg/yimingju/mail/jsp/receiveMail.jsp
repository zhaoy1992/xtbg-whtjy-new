...
$(function() {
	...
	//接收表
	$("#gridTable").jqGrid({
		url: '<%= path %>' + '/commonListServlet?classNameId=mailList',  //commonListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
 ...
 */
 var viewMailinfo = function(id) {
		...
		var url = "<%=path%>/ccapp/xtbg/yimingju/mail/jsp/mailInfo.jsp?mid="+model.mid+"&isread=yees"+"&back=re";
