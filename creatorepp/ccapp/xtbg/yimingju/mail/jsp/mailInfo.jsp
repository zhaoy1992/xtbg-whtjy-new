...
jQuery(function(){
	//初始化附件
	MyFancyupload.createUpload("file_list", "file_attach", "<%=path%>", "<%=path%>/servlet/pubFileUpload?buessid=<%=attachment_id%>", false, '<%=attachment_id%>','','','011');
	//加载人员  发送人员
	    var ps = new Object();
...
<!-- 表格-->
	...
	<div id="vcenter" style="float: left; width: 100%; overflow: scroll" scrolling="yes" >
 		<div class="content_02_box">
				...
				<div class="content_02_box_div" id="info">
				<%if(userArea.equals("421005")||userArea.equals("410001")){ %>	<!-- 望城邮件列表功能 -->
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="content_02_box_div_table_02">
						<tr>
