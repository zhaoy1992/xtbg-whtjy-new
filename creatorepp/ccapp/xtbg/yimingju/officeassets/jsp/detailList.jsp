				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;" id="_top">
							<ul>
								<li><a href="#tabs-1">待采购</a></li>
								<li><a href="#tabs-2">已采购</a></li>
							</ul>
						</div>
						<div id="tabs-1">
							<iframe src="approvalWaitList.jsp?whatDo=detail" id="frame1" frameborder="0"
								width="100%" height="460px"></iframe>
						</div>
						<div id="tabs-2">
							<iframe src="detailAlreadypurchase.jsp" id="frame2" frameborder="0"
								width="100%"height="460px"></iframe>
						</div>
					</div>
				</div>
