...
String readonly = request.getParameter("readonly");	//是否只读，1：只读，0：可编辑(add by 望城人事档案管理 陈建华)
...
if("431003".equals(areacode)){
	treeName = "人员信息树" ;
} else if("421005".equals(areacode)){
	treeName = "组织机构" ;
}
String showLevel="";
...
<body onload="adaptationWH('','treeDemo',120)">
<div class="web_tree_box" style="width:220px;"></div>
<div class="header_class" >
	<div class="header_img"></div>
	<%=treeName%>
</div>
<ul id="treeDemo" class="ztree" style="width:220px;height: 590px; overflow:scroll;overflow-x:hidden;" scrolling="yes"></ul>
</body>
</html>