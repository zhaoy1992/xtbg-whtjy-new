...
var editFlowInfo = function(id) {
	...
	//var url = "flowinfoconfigdetail.jsp?flow_id="+model.flow_id+"&type=flag";
	//location.href = url;
	url = "../../flowinfoconfig/jsp/flowinfoconfigdetail.jsp?flow_id="+model.flow_id+"&type=flag"+"&operwindowid=sub_flowinfoconfigdetail";
	openWindows('sub_flowinfoconfigdetail'+model.edit_id,'流程配置',url,'flowuserConfig',false,window);
}
...
var chooseOrg = function (){
	...
	// }
	 ...
	 var s = new $.z_tree();
	  ...
	  s.isType='dept';
	  s.headerName="选取机构";
	  s.url='<%=path%>' + "/orgTreeServlet";
	  s.autoParam=["item_id", "name=item_id", "level=lv"];
	  s.item_id = 'org_id';
  ...
  s.otherParam={
  			...
  			"userid":"<%=userid%>",
	      	"resourceType":"",
	      	"backchooseorgids":$('#orgId').val(),
	      	"showLevel":"3"};
	  //document.getElementById(text_id_obj).value
	  s.init();
