...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%=path%>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.core.pubconfig.list.FormBusitypeList',//pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		colNames: ['类型编码','类型名称', '类型描述 ', '是否有效', '表ID'],
		...
		toolbar: [true,"top","<input class='but_y_01' id=add type='button' onclick='addFormBusitype()' value='添加'/><input class='but_y_01' id=del type='button' onclick='deleteFormBusitype()' value='删除'/>"],
		multiselect: true,
...
var addFormBusitype = function() {
	var url = "pubinfoconfigdetail.jsp";
	openWindows('sub_flowinfoconfigdetail','流程配置','<%=path%>/ccapp/oa/pubconfig/jsp/pubinfoconfigdetail.jsp?operwindowid=sub_flowinfoconfigdetail','processConfig',false,window);
}
...
var updateformbusitypeInfo = function(id) {
	...
	//location.href = url;
	url = "<%=path%>/ccapp/oa/pubconfig/jsp/pubinfoconfigdetail.jsp?busitype_code="+model.busitype_code+"&type=flag1"+"&operwindowid=sub_flowinfoconfigdetail";
	openWindows('sub_flowinfoconfigdetail'+model.edit_id,'流程配置',url,'processConfig',false,window);
}

var deleteFormBusitype = function() {
	debugger;
	var ids = "";
...
*/
var toUserParamJosn = function() {
var str = "{'busitype_name':'"+$("#busitype_name").val()+"'}";
...
<!-- 查询列表区 -->
<form id="form1" name="form1" method="post"><input id="busitype_codes"
	name="busitype_codes" type="hidden"></input></form>
