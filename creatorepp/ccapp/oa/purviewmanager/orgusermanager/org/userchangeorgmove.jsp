...
var setting = {
	...
	async: {
    	enable: true,//启用异步加载
    	url: window.top.getContextPath() + '/commonTreeServlet?classNameId=com.chinacreator.xtbg.core.common.tree.dao.impl.UserChangeOrgTree', 
...
function zTreeOnDrop(event, treeId, treeNodes, targetNode, moveType) {//拖拽完成时间
	...
	var userid =treeNodes[0].id; 
    params="userid="+ userid+"&orgid="+node.org_id;
	$.ajax({
			url: 'userchangeorg_do.jsp',
			type: 'POST',
			dataType: 'json',
			data: params,
...
<div style="border-top:1px solid #EAEAEA;">
	...
	<ul id="treeDemo" class="ztree" style="width:389px;height: 750px; overflow:scroll;overflow-x:hidden;" scrolling="yes"></ul>
</div>
</form>
