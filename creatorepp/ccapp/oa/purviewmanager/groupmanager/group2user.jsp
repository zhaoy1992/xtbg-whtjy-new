...
<html>
	...
	<frameset name="frame1" cols="30%,40%" frameborder="no" border="0" framespacing="0" >
	  <frame src="orgTree.jsp?subid=<%=subid %>" name="orgTree" id="orgTree" />
	  <frame src="userList_ajax.jsp?subid=<%=subid %>" name="userList" scrolling="No" noresize="noresize" id="orgList" />
	</frameset>
	<noframes>
