...
<%
	String one_user_id = StringUtil.deNull(request.getParameter("userId"));
	String tree_class = "tree_class";
	if(!StringUtil.isBlank(one_user_id)) {
		tree_class = "tree_class_two";
	}
%>
...
var one_user_id = '<%=one_user_id%>'; //配置单个人的时候，人的全局参数
  $(function(){
...
<div style="width:100%; float: left;">
	<div class="input_class" id="top">
		...
		<div style="width: 100%" id="vcenter">
			...
			<div  class="<%=tree_class %>" id="configtrees">
				<div class="header_class">
					 <div class="header_img"></div>
