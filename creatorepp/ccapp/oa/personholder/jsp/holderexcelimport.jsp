...
<%
	...
	String modelPath = "/ccapp/oa/personholder/excel/holdExcelImport.xls";
%>
<html>
<head>
...
<script>
	...
	function Ok(){
		...
		form1.action="holderexcelimportdo.jsp?&wdo=batch";
		$("#form1").submit();
	}
	 ...
	 */
	function setChange(){
		$("#impIfr").attr("src","<%=path%>/ccapp/oa/resources/util/excel/downloadExcelTemplate.jsp?modelPath=<%=modelPath%>");
	}	
</script>
		...
		<div id="vcenter" style="float:left; width:100%; " >
			<div style="float: left; width: 775px; ">
				<div class="content_02_box_div">	
					<table >
						<tr>
							<th class="content_02_box_div_table_th" rowspan="2"><FONT style="COLOR: red">*</FONT>选择人员持证信息表</th>
						...
						<!-- <tr>
							<td class="content_02_box_div_table_td" width="250px;">
								&nbsp;请先导出填写人员持证信息表&nbsp;&nbsp;&nbsp;<a onclick="setChange()" href="#"  style="color: blue">人员持证信息下载</a>
							</td>
						</tr> -->
					</table>
					&nbsp;请按照模板格式填写&nbsp;&nbsp;&nbsp;
					<a onclick="setChange()" href="#"  style="color: blue">模版下载</a>
					<table width="456px">
