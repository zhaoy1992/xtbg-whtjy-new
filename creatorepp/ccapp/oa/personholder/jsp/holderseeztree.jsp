...
<%
	...
	if (StringUtil.isBlank(request.getParameter("showLevel"))) {
		...
		showLevel = StringUtil.deNull(request.getParameter("showLevel"));
	}
	...
	<SCRIPT type="text/javascript">
		...
		function onclick(event,treeId,treeNode){
			if("false" != treeNode.click){
				var url="holderseelist.jsp?orgid="+treeNode.org_id+"&readonly="+<%=readonly%>+"&parent_id="+treeNode.parent_id;
