...
<%
	...
	String[] userArray = personholderexceltodata.selectUserId(); */
	File tempExportFile = null;
	try {
		String exportTempFilePath =  FileUtil.getAppContextPath()+ CacheCommonManageProxy.getSystemParam("personholder_excelTemplateFilePath");
		...
		if (tempExportFile.exists()) {
			...
			response.addHeader("Content-disposition",
					"attachment; filename="+toChinese(tempExportFile.getName()+".xls"));
