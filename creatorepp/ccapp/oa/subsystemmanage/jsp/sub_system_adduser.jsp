...
<%@page import="com.chinacreator.xtbg.core.subsystemmanage.dao.SubSystemUseInfoDao"%>
...
<%
	...
	SubSystemUseInfoDao subSystemUseInfoDao = (SubSystemUseInfoDao)LoadSpringContext.getApplicationContext().getBean("subSystemUseInfoDaoImpl");
	 ...
	 <div class="content_02_box_div">
	   <table  border="0" cellspacing="0" cellpadding="0"  class="content_02_box_div_table">
         ...
         <tr>
           ...
           <td class="content_02_box_div_table_td" colspan="3"><input type="password"  class="validate[maxSize[1000]] input_title_text" name="sys_user_password" id="sys_user_password" value="<%=viewMap.get("sys_user_password")%>"/></td>
         </tr> 
</table>
	 </div>
	</div>
