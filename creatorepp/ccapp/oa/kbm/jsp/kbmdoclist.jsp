...
//         }
        ...
        <!--特检院OA 列表页将【增加】按钮修改为【编制】 2014-03-27 start -->
       /* 	toolbar : [ true, "top" ,"<input class='but_y_01' onMouseOver=javascript:$(this).attr('class','but_y_02'); onMouseOut=javascript:$(this).attr('class','but_y_01'); id=add value='增加' type='button' onclick='addKbmDocDetail()' value=''/><input class='but_y_01' onMouseOver=javascript:$(this).attr('class','but_y_02'); onMouseOut=javascript:$(this).attr('class','but_y_01'); value='删除' id=del type='button' onclick='deleteFn()' value=''/>"], */
       	...
       	<!--特检院OA 列表页将【增加】按钮修改为【编制】 2014-03-27 end -->
       	multiselect : true, 
    ...
    var toUserParamJosn = function() {
        var str = "{'opentype':'"+opentype+"','k_title':'"+jQuery("#k_title").val()+"','k_create_user':'"+k_create_user+"'}";
