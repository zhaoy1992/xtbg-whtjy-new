...
<%
	...
	String opentype = StringUtil.deNull(request
			.getParameter("opentype"));
	...
	String k_doc_id = StringUtil.deNull(request
			.getParameter("k_doc_id"));
	String k_title = "";
	String k_code = "";
	String k_type_id = "";
	String k_type_name = "";
...
function initFormValues(){
	...
	jQuery("#_filebut").width(1).height(1);//上传按钮“隐藏”
	if(isCanDownLoad=="yes"){
