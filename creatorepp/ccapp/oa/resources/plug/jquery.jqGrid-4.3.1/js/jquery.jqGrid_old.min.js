												...
												if (_pager_count > 1
													...
													if (_pager_count > 1) {
														...
														.click(
																function() {
																	_fn_modify_pager(
																			...
																			1)
																		if (b.isFunction(a.p.onPaging))
																				r = a.p.onPaging.call(a, w);//add by tian.xia1 下一页翻页触发
																});
														b("._pg_up_but")
														.click(
																function() {
																	_fn_modify_pager(
																			...
																			2)
																			if (b.isFunction(a.p.onPaging))
																				r = a.p.onPaging.call(a, w);//add by tian.xia1 上一页翻页触发
																});
														b("._pg_go_a").click(function(){
															...
															if (b.isFunction(a.p.onPaging))
																r = a.p.onPaging.call(a, w);//add by tian.xia1 Go翻页触发
														});
														b("._pg_go_first").click(function(){
															_fn_modify_pager("1",1)
															if (b.isFunction(a.p.onPaging))
																r = a.p.onPaging.call(a, w);//add by tian.xia1 首页触发
														});
														b("._pg_go_end").click(function(){
															_fn_modify_pager("1",_pager_count)
															if (b.isFunction(a.p.onPaging))
																r = a.p.onPaging.call(a, w);//add by tian.xia1 尾页触发
														});
													}
												}
												/* shenliancheng modify end */
