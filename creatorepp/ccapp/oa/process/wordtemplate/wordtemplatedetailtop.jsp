...
function textInputWindow() {
  ...
  openAlertWindows('windowId1','<%=path %>/ccapp/oa/process/wordtemplate/wordparam.jsp?template_id='+template_id+'&kj_type=textInput&window_source=1&windowsId=windowId1','选择输入框','420px','310px','25%','25%',closeAlertWindowFun);
}
/*
