				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;">
							<ul>
								<li><a href="#tabs-1" onclick="setIndexReturn('1')">待办列表</a></li>
								<li><a href="#tabs-2" onclick="setIndexReturn('2')">暂存列表</a></li>
								<li><a href="#tabs-3" onclick="setIndexReturn('3')">已办列表</a></li>
							</ul>
						</div>
						<div id="tabs-1" >
							<iframe src="doworklist.jsp?flag=<%=homepage%>&showMessId=<%=showMessId%>" id="frame1" frameborder="0"
								width="100%" height="500px" scrolling="no"></iframe>
						</div>
						<div id="tabs-2" >
							<iframe src="tobeworklist.jsp" id="frame2" frameborder="0"
								width="100%" height="500px"></iframe>
						</div>
						<div id="tabs-3">
							<iframe src="doneworklist.jsp" id="frame3" frameborder="0"
								width="100%" height="500px"></iframe>
						</div>
					</div>
				</div>
