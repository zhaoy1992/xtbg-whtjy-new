...
$(function() {
   ...
   jQuery("#degree_of_importance").change(function(){
         ...
         },
        {
            ...
            formatter : function(value,column,row){
        	  ...
        	  if("0" != row.report_count){
                return "<span style='color:#333'><span style='color:red;font-weight:bold;'>[未读回复"+row.report_count+"]</span></span>"+value;
        	  }
        	  return value;
            }
        },
    ...
    gridComplete: function() {
    	if(status=="index"){
			if(1==num){
				parent.window.countTotaltTask($("#gridTable").jqGrid('getGridParam','records'));
			}
			num++;
		}
	},
...
var tasksAssignedSearch = function() {
    ...
    var updateInfo = function(id) {
            ...
            var url = 'taskview.jsp?windowId=sub_updatetasks&id='+model.id+'&status='+model.task_status;
