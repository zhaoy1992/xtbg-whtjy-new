...
<%
	...
	String userid=StringUtil.deNull(accesscontroler.getUserID());
...
jQuery(function() {
	...
	jQuery("#gridTable").jqGrid({
		url: '<%= path %>' + '/pubListServlet?classNameId=com.chinacreator.xtbg.core.common.iweboffice.list.ThWordTemplateList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
...
var Ok = function(id) {
	...
	var toTemplateParamJosn = function() {
		var str = "{'remark':'Y','org_id':'<%=orgid%>','busitype_code':'<%=busiTypeCode%>'}"; 
