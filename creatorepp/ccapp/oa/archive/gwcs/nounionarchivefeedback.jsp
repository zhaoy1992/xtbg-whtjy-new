...
$(function() {
	...
	$("#gridTable").jqGrid({
    	...
    	},
		{
			...
			editable: true,
			formatter : function(value,column,model){
				if(model.is_send == "<font color='red'>未完成</font>" && model.is_gz=="1"){
...
var sendArchive = function(archive_returnid){
	var ajaxurl="nounionarchivefeedbackdo.jsp";
	var params = {'archive_returnid':archive_returnid};
	jQuery.ajax({
		url: ajaxurl,
		type: 'POST',
		dataType:'json',
