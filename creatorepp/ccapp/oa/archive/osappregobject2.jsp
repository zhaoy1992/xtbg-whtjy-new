...
<div id="tabs1" style="width:100%;border: 0px;">
		...
		<div id="tabs-1">
			<article>
				...
				<div class="gridster">
					<ul>
						<li id="07a247b1-2884-41d6-b6af-169757eec3a9" data-col="1" data-row="1" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 50px; line-height: 30px;' column='null'  table='' value= '领用部室：' />
						</li>
						<li id="dddd80fd-af5a-4822-800f-88b694c371c2" data-col="6" data-row="1" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="1f6a03e7-f423-4c72-a57d-9749d2602b3c" data-col="16" data-row="1" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 70px; line-height: 30px;' column='null'  table='' value= '申领人：' />
						</li>
						<li id="e2a6d527-45e3-4cae-9a20-80b42938d3d0" data-col="21" data-row="1" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="9baef583-40cc-4995-ac5f-ec38d90afe81" data-col="1" data-row="2" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 50px; line-height: 30px;' column='null'  table='' value= '填写时间：' />
						</li>
						<li id="cea379e7-c690-4dcb-89bb-41d92e019898" data-col="6" data-row="2" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="424c6dbc-0768-4ac7-b638-a7ab6b12b128" data-col="16" data-row="2" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left:50px; line-height: 30px;' column='null'  table='' value= '采购清单：' />
						</li>
						<li id="2729a3fc-897c-446a-9e62-d44e4eb64414" data-col="21" data-row="2" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<input class="but_y_06" type="button" id="osappreg" value="选择采购清单" onclick="choseOsAppReg()"/>
						</li>
						<li id="2fff949d-8e7d-4c9a-9cbd-39ef734936ec" data-col="1" data-row="3" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 50px; line-height: 30px;' column='null'  table='' value= '申领标题：' />
						</li>
						<li id="50663be8-4b0f-40bb-897e-2c8d096aea6f" data-col="6" data-row="3" data-sizex="25" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="71369329-492e-44d6-8886-461ef419552c" data-col="1" data-row="4" data-sizex="5" data-sizey="2" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left:0; line-height: 30px;' column='null'  table='' value= '部门负责人意见：' />
						</li>
						<li id="bbc03b5b-eaa1-43bf-a8fd-c3e1e5611d21" data-col="6" data-row="4" data-sizex="25" data-sizey="2" class="gs_w" style="display: list-item; background: white; width: 774px; height: 61px;">
						...
						<li id="6d7b74ac-8a62-4d2c-b5dc-3b605bdfc67b" data-col="1" data-row="6" data-sizex="5" data-sizey="2" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 0; line-height: 30px;' column='null'  table='' value= '后勤部负责人意见：' />
						</li>
						<li id="d650b74b-b429-4510-bc13-3b200083f9df" data-col="6" data-row="6" data-sizex="25" data-sizey="2" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="c03814ba-1b59-4ca9-95ce-eb0f0fcafad3" data-col="1" data-row="8" data-sizex="5" data-sizey="2" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 0; line-height: 30px;' column='null'  table='' value= '仓库管理员办结：' />
						</li>
						<li id="fcf0486a-fe0c-44bb-b6c9-58c7f86fa148" data-col="6" data-row="8" data-sizex="25" data-sizey="2" class="gs_w" style="display: list-item; background: white;"> 
						...
						<table id="dayTable" class="content_02_box_div_table_02" width="100%" cellspacing="0" cellpadding="0" border="0">
							...
							<tr  id ="dayrowhidden" name="dayrowhidden">
								...
								<td class="content_02_box_div_table_td">
							        ...
							        <input type="text" id="OFUSTYPE_NAME_VALUE" name="OFUSTYPE_NAME_VALUE" readonly="readonly" class="validate[required] input_title_text" style="text-align: center;" /> 
