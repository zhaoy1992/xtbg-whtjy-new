...
//tab2
	$("#gridTable").jqGrid({
		...
		colNames: ['id','代理人id','工作名称', '开始时间','结束时间','委托人'],
		...
		toolbar:[false, "top" ,"<input class='but_y_01' id=add value='设置' type='button' onclick='addLevel()' value=''/><input class='but_y_01' value='撤销' id=del type='button' onclick='delLevel()' value=''/>"],
		multiselect: false,
...
var toUserParamJosn = function() {
	var str = "{'work_name':'" + $("#work_name").val() + "','username':'"+$("#username").val()+"','flow_id':'find'}";
