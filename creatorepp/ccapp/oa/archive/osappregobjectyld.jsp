...
<div id="tabs1" style="width:100%;border: 0px;">
		...
		<div id="tabs-1">
			<article>
				...
				<div class="gridster">
					<ul>
						<li id="cc6bac05-602d-4cbc-9213-f02e5f93d757" data-col="1" data-row="1" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 50px; line-height: 30px;' column='null'  table='' value= '领用部室：' />
						</li>
						<li id="5740e173-1fad-4496-b760-830f50498153" data-col="6" data-row="1" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="6892eb7e-47bf-4026-af92-16afd6e3521f" data-col="16" data-row="1" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left:70px; line-height: 30px;' column='null'  table='' value= '申领人：' />
						</li>
						<li id="06562310-3cc3-40e6-8891-62de494c57d3" data-col="21" data-row="1" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="5ef71980-ae06-44e5-b74e-2c088ce7b342" data-col="1" data-row="2" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left:50px; line-height: 30px;' column='null'  table='' value= '填写时间：' />
						</li>
						<li id="3111c492-e46b-4816-80e2-9272b8e0ef3c" data-col="6" data-row="2" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="04adda4e-49f7-4b8e-9886-137b687a367d" data-col="16" data-row="2" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 50px; line-height: 30px;' column='null'  table='' value= '采购清单：' />
						</li>
						<li id="19cca9bb-2b93-4cf9-9a4a-24c4fc631f09" data-col="21" data-row="2" data-sizex="10" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<input class="but_y_06" type="button" id="osappreg" value="选择采购清单" onclick="choseOsAppReg()"/>
						</li>
						<li id="0241b10c-d6e1-4a3f-a973-1203b6f87e08" data-col="1" data-row="3" data-sizex="5" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left:50px; line-height: 30px;' column='null'  table='' value= '申领标题：' />
						</li>
						<li id="4e6d4c32-26d7-47b4-af3a-ce41ddbcecfe" data-col="6" data-row="3" data-sizex="25" data-sizey="1" class="gs_w" style="display: list-item; background: white;">
						...
						<li id="63fa43ce-f7bd-42ac-8456-a10ba01a1e0b" data-col="1" data-row="4" data-sizex="5" data-sizey="2" class="gs_w" style="display: list-item; background: white; position: absolute;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left:0; line-height: 30px;' column='null'  table='' value= '后勤部负责人意见：' />
						</li>
						<li id="fcaf4e98-fa3a-434f-b5c2-8025e32a786f" data-col="6" data-row="4" data-sizex="25" data-sizey="2" class="gs_w" style="display: list-item; background: white; position: absolute;">
						...
						<li id="4286ffbe-2dad-4954-8478-06eb1773bf69" data-col="1" data-row="6" data-sizex="5" data-sizey="2" class="gs_w" style="display: list-item; background: white; position: absolute;">
							<oa:span style='font-size: 20px; color: #ff0000; padding-left: 0; line-height: 30px;' column='null'  table='' value= '仓库管理员办结：' />
						</li>
						<li id="3b21f595-8636-4c4c-bef8-1231248214f4" data-col="6" data-row="6" data-sizex="25" data-sizey="2" class="gs_w" style="display: list-item; background: white; position: absolute;"> 
