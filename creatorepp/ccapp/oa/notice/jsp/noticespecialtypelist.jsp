...
var veiwNotice = function(id) {
	var model = jQuery("#gridTable").jqGrid('getRowData', id);
	 openWindows('sub_main_updateannouncements','查看基本信息','../../notice/jsp/noticespecialtypeview.jsp?n_notice_id='+ model.n_notice_id+ '&urls=fby'+'&subid=sub_main_updateannouncements','ggfs',false,window);
}
/*
...
var toNoticeParamJosn = function() {
	var str = "{'n_type':'<%=n_type%>','n_title':'" + $("#n_title").val() + "','n_creator_time':'" + $("#n_creator_time").val()
	+ "','n_release_time':'" + $("#n_release_time").val() + "','n_creator_userid':''}";
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td width="296" class="cx_title_td"><input
							class="input_cx_title_283" type="text" id="n_title" name="n_title" onkeyup="checkInsert(this)" onbeforepaste="checkPaste()"/>
							</td>
