...
%>
	...
	var setting = {
		...
		async: {
	    	enable: true,//启用异步加载
	    	url: window.top.getContextPath() + '/commonTreeServlet?classNameId=com.chinacreator.xtbg.core.file.dao.imploracle.FileStorageLocationTree', 
			autoParam:["f_storage_id", "name=f_storage_id", "level=lv"],
	    ...
	    */
		...
		function onclick(event,treeId,treeNode){
			if("false" != treeNode.click){
				var url="filestoragelocationlist.jsp?orgid="+treeNode.org_id+"&orgname="+treeNode.name+"&treeNode="+treeNode;
