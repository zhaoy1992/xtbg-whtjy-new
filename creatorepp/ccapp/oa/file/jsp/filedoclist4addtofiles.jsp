    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if(data && data.flag){
                ...
                try{
                if(pwindow && jQuery("#frame1",pwindow.parent.window.document.body)[0].contentWindow.createFilenoAuto){
                	jQuery("#frame1",pwindow.parent.window.document.body)[0].contentWindow.createFilenoAuto();
                }
                }catch(e){}
              //刷新当前页面列表
                search();     
...
var initOther = function(){
	jQuery('#f_dept_name').click(function(){
...
<body>
    <table id="searchTable" width="100%" border="0" cellspacing="3" cellpadding="0" class="tabs_search_ctable">
          <tr>
              ...
              <th  class="input_cx_title_th" style="width:70px;">所属部门 ：</th>
               <td width="200" class="cx_title_td">                       
                  ...
                  <input type='hidden' value='<%=StringUtil.deNull(bean.getF_dept_id())%>' name= 'f_dept_id' id='f_dept_id'>
              </td>
          ...
          <tr>
              <th style="width:70px;" class="input_cx_title_th">文件名：</th>
