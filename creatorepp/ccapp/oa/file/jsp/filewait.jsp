...
$(function() {
	...
	$("#gridTable").jqGrid({
		url: '<%=path%>/pubListServlet?classNameId=com.chinacreator.xtbg.core.file.list.MyFileLendingBeforeList',  //pubListServlet列表公共的servlet,classNameId在servletBean.xml文件中配置要调用的类,isPage:是否翻页(true,false),默认为true
		...
		multiselect: true,
		toolbar: [true,"top",""+
					 "<input class='but_y_01' type='button' onMouseOver=javascript:$(this).attr('class','but_y_07');',' onMouseOut=javascript:$(this).attr('class','but_y_06'); onclick='borrowOut();' value='借出'/>"+
					 "<input class='but_y_06' style='margin-left:3px;' type='button' onMouseOver=javascript:$(this).attr('class','but_y_07');',' onMouseOut=javascript:$(this).attr('class','but_y_06'); onclick='borrowAdd();' value='档案借阅登记'/>"+
					 "<input class='but_y_06' style='margin-left:3px;' type='button' onMouseOver=javascript:$(this).attr('class','but_y_07');',' onMouseOut=javascript:$(this).attr('class','but_y_06'); onclick='borrowOutAndBack();' value='馆内查询'/>"],
...
var toUserParamJosn = function() {
	...
	str += ",'f_type_name':'"+jQuery("#f_type_name").val()+"'";
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
					   ...
					   <td class="cx_title_td" style="width:100px;">
						...
						<th class="input_cx_title_th" style="width:60px;">文件分类：</th>
					    <td class="cx_title_td" style="width:100px;">
					   	 <input id="f_type_name" name="f_type_name" style="width: 100px" type="text" class="input_cx_title_283" />
					    </td>
					...
					<tr>
						...
						<th class="input_cx_title_th" style="width:40px;">借阅人：</th>
						<td class="cx_title_td" style="width:100px;">
							<input id="f_lending_userid" name="f_lending_userid"  style="width: 100px" type="text" class="input_cx_title_283" />
						</td>
						<th class="input_cx_title_th" style="width:40px;">所属部门：</th>
						<td class="cx_title_td" style="width:20%;">
							<input id="f_dept_name" name="f_dept_name"  style="width: 100px" type="text" class="input_cx_title_283" />
						</td>
					</tr>
				</table>
						<!-- 固定查询 end-->
