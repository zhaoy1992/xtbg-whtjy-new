        ...
        <tr>
            ...
            <!-- 固定查询 -->
                 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable">
                    ...
                    <tr>
                        <th style="width:70px;" class="input_cx_title_th">刻录人：</th>
                        <td width="200" class="cx_title_td">
                        	<input type="text" id="F_BURN_USER_ID" name="F_BURN_USER_ID" class="input_cx_title_283" style="width:200px;"/>
                        </td>
                        <th  class="input_cx_title_th" style="width:70px;">地址：</th>
                       	<td width="100" class="cx_title_td">
