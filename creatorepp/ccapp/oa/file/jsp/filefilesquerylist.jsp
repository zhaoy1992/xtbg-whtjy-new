...
<%
	...
	String GET_LIST_CLASS="com.chinacreator.xtbg.core.file.list.FileFilesQueryList";
        ...
        <td width="100%" align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="cx_title_td" style="width:150px;">
                        <input id="f_dept_name" name="f_dept_name" style="width:150px;" class="input_cx_title_283" type="text"/>
                    </td>
                    <th class="input_cx_title_th" style="width:60px;">归档状态：</th>
                    <td class="cx_title_td" style="width:150px;">
                        <input id="f_doc_state" name="f_doc_state" type="text" style="width:150px;" class="input_cx_title_283" />
                    </td>
                ...
                <tr>
                    ...
                    <th class="input_cx_title_th" style="width:60px;">编号：</th>
                    <td class="cx_title_td" style="width:150px;">
                    ...
                    <%--
                    <th class="input_cx_title_th" style="width:60px;">案卷号：</th>
                    <td class="cx_title_td" style="width:150px;">
                        <input id="f_filesno" name="f_filesno" type="text" style="width:150px;" class="input_cx_title_283" />
                    </td>
                    --%>
                    <th class="input_cx_title_th" style="width:10px;">&nbsp;</th>
                    <td>
...
var clearSearch = function() {
	...
	jQuery("#f_dept_name").val("");
	jQuery("#f_doc_state").val("");
