...
$(function() {
       ...
       //表头设置       
        colModel : [

                    {
                        ...
                        label : "月份内册数",
                        name : 'f_file_monthbookindex',
                        index : 'f_file_monthbookindex',
                        editable : false,
                        width:'60'
                    },{
                        label : "汇帐凭证起止号码",
                        name : 'f_file_startno',
                        index : 'f_file_startno',
                        width:60,
                        editable : false
                    }, {
                        label : "案卷状态",
    ...
    jQuery(".ui-th-div-ie").each(function(){
      jQuery(this).attr("align","center").css("text-align","center");
     });
    ...
    var toUserParamJosn = function(objName,notEscape){
    	 if(window.parent.role=="org"||window.parent.role=="dept"){
    		 var param = new Object();
   	        ...
   	        param[objName+"f_files_title"] = jQuery("#f_files_title").val();
	...
	*/
    ...
    function exportExcelList(){
        var exportKey = [ "f_filesno", "f_files_title","f_file_month","f_file_monthbookindex",
                         "f_file_startno","f_doc_deadline_name","f_files_content"];
        var exportHeader = ["案卷号", " 案    卷    题    名 ", "时    间", " 月份内卷、册数 "," 汇帐凭证起止号码  "," 保管期限 ","备  考"];
        var data = {
            exportKey : exportKey.join(","),
            exportHeader : descape(escape(exportHeader.join(","))),
            exportTitle : descape(escape("会计档案凭证目录"))
        };
        exportExcel("exportFileList4acc",data);
    }
    ...
    function exportExcel(method,data){
         var url = path+'/ajaxServlet?className=com.chinacreator.xtbg.core.file.action.FileExportExcelAction&method='+method;      
            ...
            html.push("<input type='hidden' name='userName' value='"
                    +descape(escape("<%=userName%>"))+"'/> ");
            html.push('</form>');
            html.push("</div>");
            //加载到body，提交后再删除
    ...
    <table id="queryTable" width="100%" border="0" cellspacing="0" cellpadding="0" class="tabs_search_ctable_box">
        <tr>
            ...
            <!-- 固定查询 -->
                <table id="searchTable" style="width:830px;" border="0" cellspacing="3" cellpadding="0" >
                    ...
                    <tr>
                       <th  class="input_cx_title_th">案卷题名：</th>
                         <td class="cx_title_td">
                             <input type="text"
                                    class="input_cx_title_283"  style="width:118px;" id="f_files_title" name="f_files_title"/>
                        </td>
                       ...
                       <th class="input_cx_title_th" >
                          ...
                          <td class="cx_title_td">
                              <input  id="f_filesno" name="f_filesno" type="text" class="input_cx_title_283" style="width:100px;" />
                          </td>
        ...
        <!-- 隐藏查询 -->
           <table style="width:830px;display:none;margin: 0px;" border="0" cellspacing="3" cellpadding="0" id="hiddenArea" >
                      <tr>                              
                          <th style="width:90px;" class="input_cx_title_th">归档日期：</th>
                          ...
                          <td class="cx_title_td"  style="width:530px;">    
