...
var updateFileDocDetail = function(bean) {
	openAlertWindows('updateFileDocDetailWindow', getCurrentFilePath() +'filedocdetail.jsp?isview=isview&busiTypeCode=wj-001&busi_id='+bean.f_id+'&windowId=updateFileDocDetailWindow', '查看已提交档案文件' ,1020,520,'10%','10%');
}
var search = function() {
      var sdata = { //构建查询需要的参数 
