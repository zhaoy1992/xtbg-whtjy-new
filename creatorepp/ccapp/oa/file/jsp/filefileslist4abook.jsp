...
$(function() {
	...
	*/
	...
	function exportExcel(){
	    var url = getCurrentFilePath()+"/ajaxexcelfile.jsp?"
	    +"windowId=windowId_paperTJ";      
        var html = new Array();
    ...
    function exportExcelList(){
        var exportKey = [ "f_filesno", "f_files_title","f_doc_year","f_files_num",
                         "f_listno","f_doc_deadline_name","f_files_content"];
        var exportHeader = ["案卷号", " 案     卷     题     名 ", " 档案年份 ", " 数  量 "," 所在页数 "," 保管期限 "," 备    考 "];
        var data = {
            exportKey : exportKey.join(","),
            exportHeader : descape(escape(exportHeader.join(","))),
            exportTitle : descape(escape("会计档案明细表"))
        };
...
<div>
        ...
        <!-- 隐藏查询 -->
           <table style="width:830px;display:none;margin: 0px;" border="0" cellspacing="3" cellpadding="0" id="hiddenArea" >
                      <tr>
                          ...
                          <th style="width:90px;" class="input_cx_title_th">所在页数：</th>
                          <td class="cx_title_td" style="width:100px;">
                           ...
                           <th class="input_cx_title_th" style="width:90px;">数量：</th>
    ...
    <div id="tool_buttons" class="ui-jqgrid .ui-userdata ui_t_bottombar_content" 
         style="width:97%;height:28px;margin-left:10px;margin-bottom:0px;float: none;border: #ebebeb 1px solid;">            
           ...
           <input name="copyFile1" id="copyFile1" onclick="copyFile();"  value="复制案卷" type="button" class="but_y_01" style="float: left;margin-left: 5px;" />
