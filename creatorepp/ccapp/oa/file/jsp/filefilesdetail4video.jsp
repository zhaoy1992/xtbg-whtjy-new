...
var userId = "<%=StringUtil.deNull(userId) %>";//用户id
    jQuery(function(){
        ...
        //实物类型默认选中 影像
        jQuery("#OA_FILE_FILES__F_ENTITY_TYPE option[value=4]").attr("selected","selected");
                      ...
                      <th class="content_02_box_div_table_th">
                        ...
                        <td  class="content_02_box_div_table_td" >
                         <oa:input type="text" column="F_DOC_YEAR" table="OA_FILE_FILES"
                                value="<%=StringUtil.deNull(year) %>" 
                                other='style = "width:150px;;background:url(/xtbg/ccapp/oa/resources/style/blue/images/date_img_year.jpg) right 1px no-repeat;" class="validate[required,maxSize[4]] date_120 Wdate" onclick="WdatePicker({dateFmt:\'yyyy\',maxDate:\'%y\'})"' /> 
                        </td>
