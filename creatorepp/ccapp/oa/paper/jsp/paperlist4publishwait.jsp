...
var userid = '<%=userid%>';
var opentype ="waitpublish";
var p_flag_id = "<%=PaperConstants.STATUS_WAIT_PUBLISH%>";
var accunit = "<%=accunit%>";
       ...
       //表头设置       
        ...
        onCellSelect:function (id,icol)
		{
			if(icol != 0)
			{
        		...
        		urlTmp = "&loadurl=paperlist4publishwait&actionName=updatefromwait&p_manage_id="+model.p_manage_id;
