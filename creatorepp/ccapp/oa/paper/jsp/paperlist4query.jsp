...
$(function() {
    ...
    $("#gridTable").jqGrid({
       ...
       //表头设置       
        colModel : [ 
        {
            ...
            label : "发布单位",
            name : 'p_pub_unit_name',
            index : 'p_pub_unit_name',
            width: '100'
        }, {	
            label : "发布时间",
            name : 'p_pub_time',
            ...
            label : "批示",
            name : 'p_leader_remark',
            index : 'p_leader_remark',
            width: '100'   
        }, {	
            label : "p_flag_id",
            name : 'p_flag_id',
        ...
        onCellSelect:function (id,icol)
		{
			if(icol != 0)
			{
        		...
        		//urlTmp = "&loadurl=paperlist4query&actionName=query&p_manage_id="+model.p_manage_id;
				//toNewPage2(urlTmp,"信息浏览");
				openWindows('pdfpage','查看',getCurrentFilePath() +'paperpdfbyid.jsp?p_manage_id='+model.p_manage_id,'查询文档',false,window);
    ...
    var toUserParamJosn = function() {
        var str = "{'opentype':'"+opentype
        	...
        	+"','p_flag_id':'"+p_flag_id
        	+"','p_pub_time':'"+getWhere4Date()
        	+"','p_pub_unit_id':'"+jQuery("#p_pub_unit_id").val()
			...
			<tr>
				<td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<th width="90" class="input_cx_title_th">发布日期：</th>
							...
							<th width="90" class="input_cx_title_th">发布单位：</th>
							<td width="200" class="cx_title_td">
								<input onclick="chooseCheckOrg('p_pub_unit_id','p_pub_unit_name');" name="p_pub_unit_name" id="p_pub_unit_name" type="text" readonly="readonly" class="input_cx_title_150" style="width: 133px;" /> 
								<input name="p_pub_unit_id" id="p_pub_unit_id" type="hidden" />
							</td>
