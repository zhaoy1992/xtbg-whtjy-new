...
var userid = '<%=userid%>';
var opentype ="revise";
var p_flag_id = "<%=PaperConstants.STATUS_REVISE%>";
var accunit = "<%=accunit%>";
       ...
       //表头设置       
        ...
        onCellSelect:function (id,icol)
		{
			if(icol != 0)
			{
        		...
        		urlTmp = "&loadurl=paperlist4publishrevise&actionName=updatefromrevise&p_manage_id="+model.p_manage_id;
				toNewPage2(urlTmp,"发布（草稿）");
			}
		}
    });
