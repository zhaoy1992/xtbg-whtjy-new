		...
		$("#tabs").tabs({//每个页面只刷新一次
			select : function(event, ui) {
				...
				if ($(iframeitem).attr("id")=="frame2"){
					$(iframeitem).attr("src", "paperlist4managepending.jsp");//已送审
				}else if($(iframeitem).attr("id")=="frame3"){
					$(iframeitem).attr("src", "paperlist4managetmp.jsp");//草稿箱
				}else if($(iframeitem).attr("id")=="frame1"){
					$(iframeitem).attr("src", "paperlist4manageaccepted.jsp");//已采编
				}
			}
		});
				...
				<div>
					<div id="tabs">
						<div id="titleids" style="display:none;" id="_top">
							<ul>
								<li><a href="#tabs-1">已采编信息</a></li>
								<li><a href="#tabs-2">已送审信息</a></li>
								<li><a href="#tabs-3">草稿箱</a></li>
							</ul>
						</div>
						<div id="tabs-1">
							<iframe src="paperlist4manageaccepted.jsp" id="frame1" frameborder="0"
								width="100%"></iframe>
						</div>
						<div id="tabs-2">
