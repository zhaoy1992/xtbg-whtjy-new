...
$(function() {
    ...
    $("#gridTable").jqGrid({
        url: path+"/ajaxServlet?className=com.chinacreator.xtbg.core.inspect."
             +"action.InspectManageAction&method=findBaseInfoPageBean4recept", 
    ...
    var toUserParamJosn = function(){ 
        ...
        param["recept_userid" ] = "<%=userId%>";
        param["recept.recept_state" ] = "<%=state%>";    
        if(jQuery("#recept_state").val()){
             param["recept.recept_state"] = jQuery("#recept_state").val();    
        }    
            ...
            <!-- 固定查询 -->
                <table id="searchTable" style="width:830px;" border="0" cellspacing="3" cellpadding="0" >
                    ...
                    <tr>                          
                          ...
                          <th  class="input_cx_title_th" style="width:90px;">反馈状态：</th>
                        <td valign="top" class="cx_title_td">
                            <select id='recept_state' name="recept_state" 
