...
String m_is_read = request.getParameter("m_is_read");//已阅读
%>
<meta>
<title>会议通知阅读情况列表查询--已阅读</title>
<!-- 引入jQuery -->
...
<div>
	...
	<div class="content_02_box" style="width: 99%">
		<div class="content_02_box_title_bg" style="width: 99%">
			<span>单位</span>
		</div>
	</div>
