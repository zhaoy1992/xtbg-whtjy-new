       ...
       //表头设置       
        colModel : [ 
        {
            ...
            formatter : function(value,column,model){
        	    return  "<strong><a href='javascript:void(0);' "+
	                " onclick='readRate(\""+model.m_minutes_id
...
var update = function(id) {
  ...
  * 阅读情况查看
  */
 var readRate = function(id){         
     var url = getCurrentFilePath()+"meetingminutereader_tab.jsp?windowId=windowId_readRate&id="+id;
     openAlertWindows('windowId_readRate',url,'会议纪要阅读情况查看','700px','450px','10%','25%');
 }
</script>
<!-- 公共部分结束 -->
</head>
