...
/**
 * 
 *<p>Title:EmailList.java</p>
 *<p>Description:分页查询收信箱邮件</p>
 ...
 *2013-11-19
 */
public class EmailList extends DataInfoImpl {

	private static final Log LOG=LogFactory.getLog(EmailList.class);
	/**
	 * 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.findMailInfoList(mailBean, sortName, sortOrder, offset, maxPagesize);	
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
