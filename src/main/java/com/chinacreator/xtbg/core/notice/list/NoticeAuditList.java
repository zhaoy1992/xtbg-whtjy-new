 ...
 *2013-11-27
 */
public class NoticeAuditList  extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(NoticeAuditList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = noticeBaseInfoDao.selNoticeAuditList(parmjson, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
