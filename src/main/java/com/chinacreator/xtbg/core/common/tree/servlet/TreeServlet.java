...
import com.chinacreator.xtbg.core.common.tree.service.impl.TreeBusinessService;


/**
 * 
 *<p>Title:TreeServlet.java</p>
 *<p>Description:所有树跳转的servlet</p>
...
public class TreeServlet extends HttpServlet {
	...
	static {
		CLASSES.put("find", new TreeBusinessService());
		CLASSES.put("config", new TreeBusinessService());
		CLASSES.put("commontree", new CommonTreeDaoImpl());
