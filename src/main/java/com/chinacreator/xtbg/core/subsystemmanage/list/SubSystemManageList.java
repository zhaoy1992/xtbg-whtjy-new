...
/**
 * 
 *<p>Title:SubSystemManageList.java</p>
 *<p>Description:</p>
 ...
 *2013-5-2
 */
public class SubSystemManageList extends DataInfoImpl{

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(SubSystemManageList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			SubSystemManageDao dao = (SubSystemManageDao)LoadSpringContext.getApplicationContext().getBean("subSystemManageDaoImpl");
			pb = dao.findSubSystemInfoList(map, sortName, sortOrder, offset, maxPagesize);
