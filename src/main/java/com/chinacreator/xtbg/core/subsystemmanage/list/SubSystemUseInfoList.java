...
/**
 * 
 *<p>Title:SubSystemUseInfoList.java</p>
 *<p>Description:</p>
 ...
 *2013-5-2
 */
public class SubSystemUseInfoList extends DataInfoImpl{

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(SubSystemUseInfoList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			SubSystemUseInfoDao dao = (SubSystemUseInfoDao)LoadSpringContext.getApplicationContext().getBean("subSystemUseInfoDaoImpl");
			pb = dao.findSubSystemUseInfoList(map, sortName, sortOrder, offset, maxPagesize);
