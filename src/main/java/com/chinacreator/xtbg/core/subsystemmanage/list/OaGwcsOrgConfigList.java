 ...
 *2014-3-26
 */
public class OaGwcsOrgConfigList extends DataInfoImpl{

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(OaGwcsOrgConfigList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.findOaGwcsOrgConfigList(map, sortName, sortOrder, offset, maxPagesize);
