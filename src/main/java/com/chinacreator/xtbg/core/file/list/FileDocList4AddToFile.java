...
/**
 * 
 *<p>Title:FileDocList4AddToFile.java</p>
 *<p>Description:入卷时，查询文件列表</p>
 ...
 *2013-7-24
 */
public class FileDocList4AddToFile extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(FileDocList4AddToFile.class);
	private FileDocBean bean ;
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {		
			...
			pb = dao.findDocPageBean4AddToFile(bean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
	...
	* @return
	...
	public FileDocBean getBean() {
		return bean;
	}

	public void setBean(FileDocBean bean) {
		this.bean = bean;
	}
