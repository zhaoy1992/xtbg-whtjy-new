...
/**
 * 
 *<p>Title:FileTypeList.java</p>
 *<p>Description:查询档案分类</p>
 ...
 *Jul 16, 2013
 */
public class FileTypeList extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(FileTypeList.class);
	/**
	 * 
	 * <b>Summary: </b>
	 *     复写方法 getDataList
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = dao.getFileTypeList(parmjson, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
