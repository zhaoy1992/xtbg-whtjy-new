 ...
 *2014-5-5
 */
public class FilesJieShouList extends DataInfoImpl {
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(FilesJieShouList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryFilesJieShouList(bean, sortName, sortOrder, offset, maxPagesize);
