...
/**
 * 
 *<p>Title:FileDocListForFiles.java</p>
 *<p>Description:查询档案对应的文件信息</p>
 ...
 *2013-7-22
 */
public class FileDocListForFiles extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(FileDocListForFiles.class);
	private String filesId ;//文档id
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			map.put("maxPagesize", String.valueOf(maxPagesize));
