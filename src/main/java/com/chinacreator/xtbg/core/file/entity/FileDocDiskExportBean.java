...
public class FileDocDiskExportBean extends ExportBean{
	
	private static final Logger LOG = Logger.getLogger(FileDocDiskExportBean.class);
	/**
	 * 
	 * <b>Summary: </b>
	 *     复写方法 getFieldName
	...
	public List<Map<String, String>> getData(HttpServletRequest request,
		...
		try {
		    ...
		    PagingBean pb = dao.queryFileDocDiskList(model, sortName, sortOrder, offset, maxPagesize);
