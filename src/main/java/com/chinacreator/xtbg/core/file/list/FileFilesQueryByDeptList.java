 ...
 *Jul 23, 2013
 */
public class FileFilesQueryByDeptList extends DataInfoImpl{
	private static final Logger LOG = Logger.getLogger(FileFilesQueryByDeptList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryFileFilesListByDept(bean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
