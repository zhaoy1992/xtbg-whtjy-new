 ...
 *Sep 10, 2013
 */
public class MyFileLendingBeforeList extends DataInfoImpl {
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(MyFileLendingBeforeList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryMyFileLendingBeforeList(model, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
