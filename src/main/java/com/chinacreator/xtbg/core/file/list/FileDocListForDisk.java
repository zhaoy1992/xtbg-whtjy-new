 ...
 *2013-7-16
 */
public class FileDocListForDisk extends DataInfoImpl {
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(FileDocListForDisk.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.queryFileDocDiskList(model, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
