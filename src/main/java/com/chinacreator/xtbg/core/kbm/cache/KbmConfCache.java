package com.chinacreator.xtbg.core.kbm.cache;
...
/**
 * 
 *<p>Title:KbmConfCache.java</p>
 *<p>Description:知识库首页缓存加载</p>
 ...
 *2013-8-15
 */
public class KbmConfCache {

	private static final Log LOG = LogFactory.getLog(KbmConfCache.class);
	
	//配置文件
	private String frist_config_path = "\\coreconfig\\first_config_kbm.xml";
	...
	*/
	...
	public void init() throws Exception {
		Document doc = null;
		try {
			File file = new File(StringUtil.getClassPath(KbmConfCache.class) + frist_config_path);
			if (!file.exists()){
