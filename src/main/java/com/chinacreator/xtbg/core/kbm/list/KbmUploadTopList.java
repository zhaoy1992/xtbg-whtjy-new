...
/**
 * 
 *<p>Title:KbmUploadTopList.java</p>
 *<p>Description:上传排行榜查询列表</p>
 ...
 *2013-8-12
 */
public class KbmUploadTopList extends DataInfoImpl {

	private static final Log LOG=LogFactory.getLog(KbmUploadTopList.class);
	/**
	 * 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = dao.queryKbmUploadTopList(model, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
