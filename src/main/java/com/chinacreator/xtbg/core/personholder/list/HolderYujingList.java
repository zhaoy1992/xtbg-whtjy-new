 ...
 *2014-2-21
 */
public class HolderYujingList extends DataInfoImpl{
	
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(HolderYujingList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = daojson.findPersonHolderYujingList(parmjson, sortName, sortOrder, offset, maxPagesize);
