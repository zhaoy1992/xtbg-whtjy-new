 ...
 *2012-02-16
 */
public class DirectoryXCList extends DataInfoImpl{

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(DirectoryXCList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = daojson.findTypeXCList(directoryBean, sortName, sortOrder, offset, maxPagesize);
