...
/**
 * 
 *<p>Title:MeetingMinutesViewList.java</p>
 *<p>Description:阅读人员接收会议纪要列表</p>
 ...
 *2013-6-27
 */
public class MeetingMinutesViewList  extends DataInfoImpl{
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = dao.findMeetingMinutePageBean4View(bean, sortName, sortOrder,
					offset, maxPagesize);
