package com.chinacreator.xtbg.core.persondata;
 ...
 *</p>
 *<p>Description:
 *生成库表对应的 bean属性 及get set 方法（带注释）
 *及该库表的 insert语句 和 update语句
 *
 *</p>
...
public class TestColumnName {
	...
	/**
	 * 
	*<b>Summary:*生成库表对应的 bean属性 及get set 方法（带注释）
	*及该库表的 insert语句 和 update语句 </b>
	* printColumnName(请用一句话描述这个方法的作用)
	* @param tableName 表名
	* @param getSetFlag 是否要有getset方法
	* @throws SQLException
	 */
	public void printColumnName(String tableName,boolean getSetFlag) throws SQLException{
...
//		td_sm_organization
		...
		StringBuffer getAndSetBeanMethodStr = new StringBuffer();//get set 方法字符串
		String tempColumn = "";
		String temp = "";
		try {
			...
			String sql = "select NLS_LOWER(t.column_name) as column_name ,NLS_LOWER(r.data_type) as data_type,t.comments  from user_col_comments t " +
					" left join user_tab_columns r on t.table_name=r.table_name and t.column_name=r.column_name where t.table_name = NLS_UPPER(?)";
			...
			while (rs.next()) {
				...
				System.out.println("private "+column_type+" "+rs.getString("column_name")+";		//"+rs.getString("comments"));

				if(getSetFlag){
					getAndSetBeanMethodStr.append(createGetAndSetMethod(rs.getString("column_name"), rs.getString("comments"),column_type));
				}
	...
	/**
	 * 
	*<b>Summary:创建get set 方法 </b>
	* createGetAndSetMethod(请用一句话描述这个方法的作用)
	* @param column_name 字段名
	* @param comments 字段注释
	* @param comment_type 字段类型
	* @return 形成的get set 方法字符串
	 */
	private String createGetAndSetMethod(String column_name,String comments,String comment_type){

		StringBuffer sql = new StringBuffer();
		sql.append("/**\n*<b>Summary: 获取"+comments+"</b>\n*/\n");
		sql.append("public "+comment_type+" get"+firstCodeToUpperCase(column_name)+"() {\n");
		sql.append("	return "+column_name+";\n");
		sql.append("}\n");
		sql.append("/**\n*<b>Summary: 设置"+comments+"</b>\n*/\n");
		sql.append("public void set"+firstCodeToUpperCase(column_name)+"("+comment_type+" "+column_name+") {\n");
	...
	/**
	 * 
	*<b>Summary:字符串首字母变大写 </b>
	* firstCodeToUpperCase(请用一句话描述这个方法的作用)
	* @param str
	* @return
	 */
	...
	* @return
	...
	public static void main(String...strings) throws SQLException{
		...
		test.printColumnName("TA_OA_REGBOOK",true);
