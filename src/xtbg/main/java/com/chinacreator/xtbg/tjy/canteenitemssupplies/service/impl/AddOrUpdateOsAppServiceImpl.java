...
public class AddOrUpdateOsAppServiceImpl extends XtDbBaseDao implements FlowBusiDataSaveDao{
	...
	public boolean saveBusiInfo(HttpServletRequest request, Connection conn)
        ...
        //机构ID
        String org_id  =  request.getParameter("TA_OA_CANOSAPPLAN__T_ORG_ID");
        // 所属单位
        String unit_id  =  request.getParameter("TA_OA_CANOSAPPLAN__UNIT_ID");
        String unit_name  =  request.getParameter("TA_OA_CANOSAPPLAN__UNIT_NAME");
        //机构名称
        String orgName  =  request.getParameter("TA_OA_CANOSAPPLAN__T_ORG_NAME");
