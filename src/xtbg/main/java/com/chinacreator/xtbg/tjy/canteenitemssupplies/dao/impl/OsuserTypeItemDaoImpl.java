...
import com.chinacreator.xtbg.tjy.canteenitemssupplies.dao.OsuserTypeItemDao;
import com.chinacreator.xtbg.tjy.canteenitemssupplies.entity.OsuserTypeItemBean;
...
public class OsuserTypeItemDaoImpl extends XtDbBaseDao implements OsuserTypeItemDao{
	...
	public PagingBean selOsuserTypeItemList(String parmjson, String sortName,
		...
		try {
			...
			sql.append(" from ta_oa_canosusertypeitem i left join ta_oa_canosupplieusetype t ");
	...
	public Map<String, String> getOsuserTypeItem(String it_id, Connection conn) throws Exception {
		...
		StringBuffer sql = new StringBuffer();
		sql.append("select *");
		sql.append("  from ta_oa_canosusertypeitem ");
	...
	public boolean deleteOsuserTypeItemsById(Connection conn, String beanId)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from ta_oa_canosusertypeitem ");
	...
	public int isOsuserTypeItem(Connection conn, String beanId)
		...
		sql.append("  from ta_oa_canosapp_object t, oa_flow_instance ins ");
		...
		sqlhava.append("  from ta_oa_canhava_object ");
		...
		sqlosAppreg.append("  from  TA_OA_CANOSAPPREG_OBJECT t,oa_flow_instance ins  ");
		...
		sqllingyong.append("  from ta_oa_canlingyong_object ");
		...
		sqlosExa.append("  from ta_oa_canosexa_object t,oa_flow_instance ins ");
	...
	* @throws Exception
	...
	public Map<String, String> queryOsoFtypeItemList(String ofustypeId) throws Exception{
		...
		sql.append("  from ta_oa_canosupplieUseType oftypes, ta_oa_canosupplietype usestype ");
