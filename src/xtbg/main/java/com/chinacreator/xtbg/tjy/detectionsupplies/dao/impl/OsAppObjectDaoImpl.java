...
import com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsAppObjectDao;
...
public class OsAppObjectDaoImpl extends XtDbBaseDao implements OsAppObjectDao {
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsAppObjectDao#selectOsAppObject(java.lang.String, java.sql.Connection)
	 */
	public List<Map<String, String>> selectOsAppObject(String t_id) throws Exception {
		...
		sql.append("select *");
		sql.append("  from TA_OA_DETOSAPP_OBJECT ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsAppObjectDao#deleteOsAppObject(java.lang.String, java.sql.Connection)
	 */
	public boolean deleteOsAppObject(String t_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_DETOSAPP_OBJECT ");
