...
public class OsExaminationObjectDaoImpl extends XtDbBaseDao implements
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#selectOsAppByIds(java.lang.String)
	 */
	public List<Map<String, String>> selectOsAppByIds(String osAppIds,String bus_id)
		...
		sql2.append(" select v.STATUS_CODE from view_oa_instance v,TA_OA_CANOSEXAMINATION t");
		...
		if (staute_code.equals("02")) {  //已经审核完的数据
			sql.append("   from TA_OA_CANOSAPPLAN t where t.t_id in (" +osAppIds+")");
		}else{
			sql.append("   from TA_OA_CANOSAPPLAN t where t.t_id in (" +osAppIds+") and t.t_state is null");
		}
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao
	  * #findOsAppList(com.chinacreator.xtbg.tjy.officesupplies.entity.OsExaminationBean, java.lang.String, java.lang.String, long, int)
	 */
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#selectOsAppObjectByIds(java.lang.String)
	 */
	public List<Map<String, String>> selectOsAppObjectByIds(String osAppIds,String bus_id)
		...
		sql.append("   from TA_OA_CANOSAPP_OBJECT t, TA_OA_CANOSAPPLAN o");
		if (staute_code.equals("02")) {  //已经审核完的数据
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#selectOsExaObject(java.lang.String)
	 */
	public List<Map<String, String>> selectOsExaObject(String t_id)
		...
		sql.append("  from TA_OA_CANOSEXA_OBJECT t");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#deleteOsExaObject(java.lang.String, java.sql.Connection)
	 */
	public boolean deleteOsExaObject(String t_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_CANOSEXA_OBJECT ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#updateOsApplanState(java.lang.String, java.sql.Connection)
	 */
	public boolean updateOsApplanState(String ids, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		String appIds = StringUtil.splitString(ids, ",", "'");
		sql.append(" update TA_OA_CANOSAPPLAN t set t.T_STATE='1' ");
	 ...
	 * 
	  ...
	  * @return 
	 * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#queryOsAppIdsForExaId(java.lang.String)
	 */
	public String queryOsAppIdsForExaId(String exaId) throws Exception {
		StringBuffer sql = new StringBuffer();
		String exaIds = "";
		sql.append(" select t.T_IDS  ");
		sql.append(" from TA_OA_CANOSEXAMINATION t ");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#selectOsExaObjectByIds(java.lang.String)
	 */
	public List<Map<String, String>> selectOsExaObjectByIds(String t_ids)
		...
		sql.append("  from TA_OA_CANOSEXA_OBJECT t,TA_OA_CANOSUPPLIEUSETYPE os , TA_OA_CANOSUPPLIETYPE ost");
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#findOsExaList(com.chinacreator.xtbg.tjy.officesupplies.entity.OsExaBean, java.lang.String, java.lang.String, long, int)
	 */
	public PagingBean findOsExaList(OsExaBean osExaBean, String sortName,
		...
		sql.append("   from TA_OA_CANOSEXAMINATION t, view_oa_instance v ");
	...
	* @throws Exception
	...
	public PagingBean findOsShowOrgList(OsAppObjectBean osappobjectbean, String sortName, String sortOrder, long offset, int maxPagesize)throws Exception{
		...
		try {
			...
			sql.append("          from TA_OA_CANOSAPP_OBJECT m");
			...
			sql.append("  from TA_OA_CANOSAPP_OBJECT t");
	...
	public void insertApplanObject(OsApplanBean osApplanBean, Connection conn)
		...
		sqlStr.append("insert into TA_OA_CANOSAPPLAN ");
		sqlStr.append("  (t_id, ");
	...
	public void insertApplanObject(OsHavaObjectBean osHavaObjectBean,
		...
		StringBuffer sqlStr = new StringBuffer();
		sqlStr.append("insert into TA_OA_CANHAVA_OBJECT ");
		...
		sqlStr.append("   t_ha_org_name,unit_id,unit_name) ");
		sqlStr.append("values ");
		...
		pdb.setString(k++, StringUtil.deNull(osHavaObjectBean.getUnit_id()));
		pdb.setString(k++, StringUtil.deNull(osHavaObjectBean.getUnit_name()));
		pdb.executePrepared(conn);
	}
