 ...
 *
 */
public class OsFafangList extends DataInfoImpl{
	private static final Log LOG=LogFactory.getLog(OsFafangList.class);
	@Override
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = dao.getMyObjectList(bean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
