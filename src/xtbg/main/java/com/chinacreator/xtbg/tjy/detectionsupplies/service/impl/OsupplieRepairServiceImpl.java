...
import com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsupplieRepairDao;
import com.chinacreator.xtbg.tjy.detectionsupplies.dao.impl.OsupplieRepairDaoImpl;
import com.chinacreator.xtbg.tjy.detectionsupplies.entity.OsupplieRepairBean;
import com.chinacreator.xtbg.tjy.detectionsupplies.service.OsupplieRepairService;
...
public class OsupplieRepairServiceImpl implements OsupplieRepairService {
	...
	public Map<String, String> getRepairInfo(
		...
		try {
			...
			sql.append("  from TA_OA_DETOSAPREPAIR t ");
	...
	public String delete(String ids) {
		OsupplieRepairDao osupplieRepairDao= new OsupplieRepairDaoImpl();
		StringBuffer sql = new StringBuffer();
		sql.append("delete TA_OA_DETOSAPREPAIR where repair_id in ("+ids+")");
		try {
