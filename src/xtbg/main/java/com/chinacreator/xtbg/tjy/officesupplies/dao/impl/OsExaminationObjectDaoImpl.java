...
public class OsExaminationObjectDaoImpl extends XtDbBaseDao implements
	...
	public List<Map<String, String>> selectOsAppByIds(String osAppIds,String bus_id)
		...
		sql2.append(" select v.STATUS_CODE from view_oa_instance v,TA_OA_OSEXAMINATION t");
		...
		if (staute_code.equals("02")) {  //已经审核完的数据
			sql.append("   from TA_OA_OSAPPLAN t where t.t_id in (" +osAppIds+")");
		}else{
			sql.append("   from TA_OA_OSAPPLAN t where t.t_id in (" +osAppIds+") and t.t_state is null");
		}
	 ...
	 * 
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsExaminationObjectDao#findOsAppList(com.chinacreator.xtbg.tjy.officesupplies.entity.OsExaminationBean, java.lang.String, java.lang.String, long, int)
	 */
	...
	public List<Map<String, String>> selectOsAppObjectByIds(String osAppIds,String bus_id)
		...
		sql.append("   from TA_OA_OSAPP_OBJECT t, TA_OA_OSAPPLAN o");
		if (staute_code.equals("02")) {  //已经审核完的数据
	...
	public List<Map<String, String>> selectOsExaObject(String t_id)
		...
		sql.append("  from TA_OA_OSEXA_OBJECT t");
	...
	public boolean deleteOsExaObject(String t_id, Connection conn)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_OSEXA_OBJECT ");
	...
	public boolean updateOsApplanState(String ids, Connection conn)
		...
		sql.append(" update TA_OA_OSAPPLAN t set t.T_STATE='1' ");
	...
	public String queryOsAppIdsForExaId(String exaId) throws Exception {
		...
		sql.append(" from TA_OA_OSEXAMINATION t ");
	...
	public List<Map<String, String>> selectOsExaObjectByIds(String t_ids)
		...
		sql.append("  from TA_OA_OSEXA_OBJECT t,ta_oa_osupplieusetype os , TA_OA_OSUPPLIETYPE ost");
	...
	public PagingBean findOsExaList(OsExaBean osExaBean, String sortName,
		...
		sql.append("   from TA_OA_OSEXAMINATION t, view_oa_instance v ");
	...
	* @throws Exception
	...
	public PagingBean findOsShowOrgList(OsAppObjectBean osappobjectbean, String sortName, String sortOrder, long offset, int maxPagesize)throws Exception{
		...
		try {
			...
			sql.append("          from ta_oa_osapp_object m");
			...
			sql.append("  from ta_oa_osapp_object t");
	...
	public void insertApplanObject(OsApplanBean osApplanBean, Connection conn)
		...
		sqlStr.append("insert into TA_OA_OSAPPLAN ");
		sqlStr.append("  (t_id, ");
	...
	public void insertApplanObject(OsHavaObjectBean osHavaObjectBean,
		...
		StringBuffer sqlStr = new StringBuffer();
		sqlStr.append("insert into ta_oa_hava_object ");
