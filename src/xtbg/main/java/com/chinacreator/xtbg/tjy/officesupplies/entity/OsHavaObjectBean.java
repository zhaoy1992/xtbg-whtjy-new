...
public class OsHavaObjectBean extends XtDbBaseBean {
	...
	public OsHavaObjectBean(){
		super("TA_OA_HAVA_OBJECT", "t_ha_id");
	}
	...
	private String t_ha_rkuser_date;//入库时间
	...
	private int ofustype_no;//排序号
	
	
	
	
	public int getOfustype_no() {
		return ofustype_no;
	}
	public void setOfustype_no(int ofustypeNo) {
		ofustype_no = ofustypeNo;
	}
	public String getT_ha_rkuser_date() {
		return t_ha_rkuser_date;
	}
	public void setT_ha_rkuser_date(String tHaRkuserDate) {
		t_ha_rkuser_date = tHaRkuserDate;
	}
	/**
	*<b>Summary: 获取主键ID</b>
	*/
