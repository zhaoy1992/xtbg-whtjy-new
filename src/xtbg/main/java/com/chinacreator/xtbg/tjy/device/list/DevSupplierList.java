...
/**
 *<p>Title:DevSupplierList.java</p>
 *<p>Description:供应商名录列表</p>
 ...
 *2014-2-27
 */
public class DevSupplierList extends DataInfoImpl{
	
	private static final Log LOG=LogFactory.getLog(DevSupplierList.class);
	 /** 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
	  * @param parmjson
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb = devsupplierdao.selDevSupplierList(parmjson, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
