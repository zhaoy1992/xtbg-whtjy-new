...
import com.chinacreator.xtbg.tjy.officesupplies.dao.OsupplieRepairDao;
import com.chinacreator.xtbg.tjy.officesupplies.entity.OsupplieRepairBean;
import com.chinacreator.xtbg.tjy.officesupplies.service.OsupplieRepairService;
...
public class OsupplieRepairServiceImpl implements OsupplieRepairService {
	...
	private OsupplieRepairDao osupplieRepairDao=(OsupplieRepairDao)LoadSpringContext.getApplicationContext().getBean("osupplieRepairDaoImpl");
	 ...
	 * 
	  ...
	  * @return 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.service.OsupplieRepairService#getRepairInfo(com.chinacreator.xtbg.tjy.officesupplies.entity.OsupplieRepairBean)
	 */
	public Map<String, String> getRepairInfo(
		...
		try {
			...
			sql.append("  from ta_oa_osaprepair t ");
	 ...
	 * 
	  ...
	  * @param osupplieRepairBean
	  * @return 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.service.OsupplieRepairService#saveOrUpdate(com.chinacreator.xtbg.tjy.officesupplies.entity.OsupplieRepairBean)
	 */
	...
	public String delete(String ids) {
		StringBuffer sql = new StringBuffer();
		sql.append("delete ta_oa_osaprepair where repair_id in ("+ids+")");
		try {
