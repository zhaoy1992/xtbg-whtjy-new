...
public class OsHavaLYObjectBean extends XtDbBaseBean {
	...
	public OsHavaLYObjectBean(){
		super("TA_OA_LINGYONG_OBJECT", "t_nomove_ob_id");
	}
	...
	private String p_type_id;//父类别
	private String p_type_name;//父类别名
	
	public String getP_type_id() {
		return p_type_id;
	}
	public void setP_type_id(String pTypeId) {
		p_type_id = pTypeId;
	}
	public String getP_type_name() {
		return p_type_name;
	}
	public void setP_type_name(String pTypeName) {
		p_type_name = pTypeName;
	}
	/**
	*<b>Summary: 获取主键ID</b>
	*/
