...
/**
 *<p>Title:ToBeAnswersList.java</p>
 *<p>Description:查询有问必答暂存列表</p>
 ...
 *2015-2-3
 */
public class ToBeAnswersList extends DataInfoImpl{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(ToBeAnswersList.class);
	/**
	 * 
	  * <b>Summary: </b>
	  *     复写方法 getDataList
