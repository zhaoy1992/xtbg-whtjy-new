...
import com.chinacreator.xtbg.tjy.detectionsupplies.dao.OsofficeAccountDao;
...
public class OsofficeAccountDaoImpl extends XtDbBaseDao implements OsofficeAccountDao {
	  ...
	  * @return
	  * @throws Exception 
	  * @see com.chinacreator.xtbg.tjy.officesupplies.dao.OsofficeAccountDao
	  * #OsofficeAccountByOrgList(java.lang.String, java.lang.String, java.lang.String, long, int) 
	  */
	@Override
	public PagingBean OsofficeAccountByOrgList(String parmjson,
		...
		sql.append("                               from TA_OA_DETOFFICEACCOUNT t");
		...
		sql.append("                     ");
		sql.append("                       from TA_OA_DETOFFICEACCOUNT offices");
	...
	* @throws Exception
	...
	public PagingBean OsofficeDetailList(String parmjson, String sortName,
		...
		try {
			...
			sql.append("  from TA_OA_DETOFFICEACCOUNT ");
			sql.append("  where 1=1");
			if(osofficeaccountbean!=null){
				...
				if (!StringUtil.nullOrBlank(osofficeaccountbean.getReceive_Stime())) {
					sql.append(" and receive_day >= ").append(" to_date('")
					   .append(osofficeaccountbean.getReceive_Stime())
					   .append(" 00:00:00','yyyy-MM-dd HH24:mi:ss') ");
				}
				//领用结束时间
				if (!StringUtil.nullOrBlank(osofficeaccountbean.getReceive_Etime())) { 
					sql.append(" and receive_day <= ").append(" to_date('")
					   .append(osofficeaccountbean.getReceive_Etime())
	...
	public boolean deleteOfficeDetailByIds(Connection conn, String beanId)
			throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" delete from TA_OA_DETOFFICEACCOUNT ");
