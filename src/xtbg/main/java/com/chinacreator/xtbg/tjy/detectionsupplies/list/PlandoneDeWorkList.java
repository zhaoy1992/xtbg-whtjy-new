...
import com.chinacreator.xtbg.tjy.processing.dao.Impl.ProFlowBusiSearchDaoImpl;
/**
 * 
 *<p>Title:PlandoneDeWorkList.java</p>
 *<p>Description:申购计划查询 易耗品申购计划表已办列表</p>
 ...
 *2013-4-22
 */
public class PlandoneDeWorkList extends DataInfoImpl{
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(PlandoneDeWorkList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			ProFlowBusiSearchDao fInfodao = new ProFlowBusiSearchDaoImpl();
			pb = fInfodao.findDETPlandoneDeWorkList(workFlowSearchBean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
