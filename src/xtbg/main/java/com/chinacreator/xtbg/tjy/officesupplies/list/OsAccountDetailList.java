 ...
 *
 */
public class OsAccountDetailList extends DataInfoImpl{
	private static final Log LOG=LogFactory.getLog(OsAccountDetailList.class);
	@Override
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			pb  = dao.getAccountDetailList(bean, sortName, sortOrder, offset, maxPagesize);
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
