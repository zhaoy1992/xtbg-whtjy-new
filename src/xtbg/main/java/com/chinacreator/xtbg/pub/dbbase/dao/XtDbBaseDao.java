...
import com.chinacreator.xtbg.pub.dbbase.entity.XtDbConstant;
import com.chinacreator.xtbg.pub.dbbase.entity.XtShowInfoHashMap;
...
public abstract class XtDbBaseDao implements BaseDao {
	...
	* @throws Exception
	 ...
	 * @param xtdbBaseBean
	 *            底层持久对象
	 * @return XtDbBaseBean 如果没查询到任何相应的值，则返回为空bean
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public XtDbBaseBean queryToBeanDeNull(XtDbBaseBean xtdbBaseBean,Connection conn) throws Exception {
		Map<String,String> map = queryToSingleMap(xtdbBaseBean,conn);
	 ...
	 * @throws Exception
	 */
	public XtDbBaseBean queryToBeanDeNull(XtDbBaseBean xtdbBaseBean) throws Exception {
		Connection conn = null;
		conn = DbManager.getInstance().getConnection();
		Map<String,String> map = queryToSingleMap(xtdbBaseBean,conn);
		if(map.isEmpty()){//如果查询出来的map为空，则说明没查到匹配的数据，理应返回空；
