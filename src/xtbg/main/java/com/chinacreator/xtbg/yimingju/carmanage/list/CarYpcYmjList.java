...
public class CarYpcYmjList implements DataInfoImpl{
	
	private static final long serialVersionUID = 1L;
	private static final Logger LOG = Logger.getLogger(CarYpcYmjList.class);
	...
	public PagingBean getDataList(String parmjson, String sortName,
		...
		try {
			...
			pb = carManageApplyinfoDao.findCarManageApplyinfoYpcList(carManageApplyinfoSearchBean, sortName, sortOrder, offset, maxPagesize);	
		} catch (Exception e) {
			LOG.error(e);
		}
		return pb;
